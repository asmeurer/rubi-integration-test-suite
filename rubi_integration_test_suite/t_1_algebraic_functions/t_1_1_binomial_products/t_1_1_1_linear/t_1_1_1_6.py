...
SOURCE_FILE = '1 Algebraic functions/1.1 Binomial products/1.1.1 Linear/1.1.1.6 P(x) (a+b x)^m (c+d x)^n (e+f x)^p.m'
...
TEST_CASES = [
    RubiTestSuiteCase(
        integrand=(e + f*x)**3*sqrt(-d*x + 1)*sqrt(d*x + 1)*(A + B*x + C*x**2),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(e + f*x)**2*sqrt(-d*x + 1)*sqrt(d*x + 1)*(A + B*x + C*x**2),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(e + f*x)*sqrt(-d*x + 1)*sqrt(d*x + 1)*(A + B*x + C*x**2),
        variable=x,
        num_steps=5,
        integral=-C*(e + f*x)**2*(-d**2*x**2 + 1)**(sympy.S(3)/2)/(5*d**2*f) + x*sqrt(-d**2*x**2 + 1)*(4*A*d**2*e + B*f + C*e)/(8*d**2) + (4*A*d**2*e + B*f + C*e)*asin(d*x)/(8*d**3) - (-d**2*x**2 + 1)**(sympy.S(3)/2)*(-4*C*(3*d**2*e**2 - 2*f**2) - 3*d**2*f*x*(-5*B*f + 3*C*e) + 20*d**2*f*(A*f + B*e))/(60*d**4*f),
    ),
    RubiTestSuiteCase(
        integrand=sqrt(-d*x + 1)*sqrt(d*x + 1)*(A + B*x + C*x**2),
        variable=x,
        num_steps=5,
        integral=-B*(-d**2*x**2 + 1)**(sympy.S(3)/2)/(3*d**2) - C*x*(-d**2*x**2 + 1)**(sympy.S(3)/2)/(4*d**2) + x*(4*A*d**2 + C)*sqrt(-d**2*x**2 + 1)/(8*d**2) + (4*A*d**2 + C)*asin(d*x)/(8*d**3),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2)/((e + f*x)*sqrt(-d*x + 1)*sqrt(d*x + 1)),
        variable=x,
        num_steps=6,
        integral=-C*sqrt(-d**2*x**2 + 1)/(d**2*f) + (A*f**2 - B*e*f + C*e**2)*atan((d**2*e*x + f)/(sqrt(d**2*e**2 - f**2)*sqrt(-d**2*x**2 + 1)))/(f**2*sqrt(d**2*e**2 - f**2)) - (-B*f + C*e)*asin(d*x)/(d*f**2),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2)/((e + f*x)**2*sqrt(-d*x + 1)*sqrt(d*x + 1)),
        variable=x,
        num_steps=6,
        integral=C*asin(d*x)/(d*f**2) + sqrt(-d**2*x**2 + 1)*(A*f**2 - B*e*f + C*e**2)/(f*(e + f*x)*(d**2*e**2 - f**2)) - (-A*d**2*e*f**2 + B*f**3 + C*d**2*e**3 - 2*C*e*f**2)*atan((d**2*e*x + f)/(sqrt(d**2*e**2 - f**2)*sqrt(-d**2*x**2 + 1)))/(f**2*(d**2*e**2 - f**2)**(sympy.S(3)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2)/((e + f*x)**3*sqrt(-d*x + 1)*sqrt(d*x + 1)),
        variable=x,
        num_steps=5,
        integral=(C*(d**2*e**2 + 2*f**2) - d**2*(-A*(2*d**2*e**2 + f**2) + 3*B*e*f))*atan((d**2*e*x + f)/(sqrt(d**2*e**2 - f**2)*sqrt(-d**2*x**2 + 1)))/(2*(d**2*e**2 - f**2)**(sympy.S(5)/2)) - sqrt(-d**2*x**2 + 1)*(-3*A*d**2*e*f**2 + B*d**2*e**2*f + 2*B*f**3 + C*d**2*e**3 - 4*C*e*f**2)/(2*f*(e + f*x)*(d**2*e**2 - f**2)**2) + sqrt(-d**2*x**2 + 1)*(A*f**2 - B*e*f + C*e**2)/(2*f*(e + f*x)**2*(d**2*e**2 - f**2)),
    ),
    RubiTestSuiteCase(
        integrand=(e + f*x)**3*(A + B*x + C*x**2)/(sqrt(-d*x + 1)*sqrt(d*x + 1)),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(e + f*x)**2*(A + B*x + C*x**2)/(sqrt(-d*x + 1)*sqrt(d*x + 1)),
        variable=x,
        num_steps=5,
        integral=-C*(e + f*x)**3*sqrt(-d**2*x**2 + 1)/(4*d**2*f) + (e + f*x)**2*(-4*B*f + C*e)*sqrt(-d**2*x**2 + 1)/(12*d**2*f) + sqrt(-d**2*x**2 + 1)*(4*C*(d**2*e**3 - 8*e*f**2) - f*x*(-2*d**2*e*(-4*B*f + C*e) + f**2*(12*A*d**2 + 9*C)) - 16*f*(3*A*d**2*e*f + B*(d**2*e**2 + f**2)))/(24*d**4*f) + (C*(4*d**2*e**2 + 3*f**2) + 4*d**2*(A*(2*d**2*e**2 + f**2) + 2*B*e*f))*asin(d*x)/(8*d**5),
    ),
    RubiTestSuiteCase(
        integrand=(e + f*x)*(A + B*x + C*x**2)/(sqrt(-d*x + 1)*sqrt(d*x + 1)),
        variable=x,
        num_steps=4,
        integral=-C*(e + f*x)**2*sqrt(-d**2*x**2 + 1)/(3*d**2*f) + (2*A*d**2*e + B*f + C*e)*asin(d*x)/(2*d**3) - sqrt(-d**2*x**2 + 1)*(-2*C*(d**2*e**2 - 2*f**2) - d**2*f*x*(-3*B*f + C*e) + 6*d**2*f*(A*f + B*e))/(6*d**4*f),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2)/(sqrt(-d*x + 1)*sqrt(d*x + 1)),
        variable=x,
        num_steps=4,
        integral=-B*sqrt(-d**2*x**2 + 1)/d**2 - C*x*sqrt(-d**2*x**2 + 1)/(2*d**2) + (2*A*d**2 + C)*asin(d*x)/(2*d**3),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2)/((e + f*x)*sqrt(-d*x + 1)*sqrt(d*x + 1)),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=x*(a + b*x + c*x**2)/(sqrt(-d*x + 1)*sqrt(d*x + 1)),
        variable=x,
        num_steps=4,
        integral=b*asin(d*x)/(2*d**3) - c*x**2*sqrt(-d**2*x**2 + 1)/(3*d**2) - sqrt(-d**2*x**2 + 1)*(6*a*d**2 + 3*b*d**2*x + 4*c)/(6*d**4),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x + c*x**2)/(sqrt(-d*x + 1)*sqrt(d*x + 1)),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=sqrt(c + d*x)*sqrt(e + f*x)*(A + B*x + C*x**2)/(a + b*x),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=sqrt(c + d*x)*sqrt(e + f*x)*(A + B*x + C*x**2)/(a + b*x)**2,
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=sqrt(c + d*x)*sqrt(e + f*x)*(A + B*x + C*x**2)/(a + b*x)**3,
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*x)**2*sqrt(c + d*x)*(A + B*x + C*x**2)/sqrt(e + f*x),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*x)*sqrt(c + d*x)*(A + B*x + C*x**2)/sqrt(e + f*x),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=sqrt(c + d*x)*(A + B*x + C*x**2)/sqrt(e + f*x),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=sqrt(c + d*x)*(A + B*x + C*x**2)/((a + b*x)*sqrt(e + f*x)),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=sqrt(c + d*x)*(A + B*x + C*x**2)/((a + b*x)**2*sqrt(e + f*x)),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=sqrt(c + d*x)*sqrt(e + f*x)*(A + B*x + C*x**2)/(a + b*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=sqrt(c + d*x)*sqrt(e + f*x)*(A + B*x + C*x**2)/(a + b*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=sqrt(c + d*x)*sqrt(e + f*x)*(A + B*x + C*x**2)/(a + b*x)**(sympy.S(9)/2),
        variable=x,
        num_steps=10,
    ...
    RubiTestSuiteCase(
        integrand=sqrt(c + d*x)*(A + B*x + C*x**2)/(sqrt(a + b*x)*sqrt(e + f*x)),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=sqrt(c + d*x)*(A + B*x + C*x**2)/((a + b*x)**(sympy.S(3)/2)*sqrt(e + f*x)),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=sqrt(c + d*x)*(A + B*x + C*x**2)/((a + b*x)**(sympy.S(5)/2)*sqrt(e + f*x)),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=sqrt(c + d*x)*(A + B*x + C*x**2)/((a + b*x)**(sympy.S(7)/2)*sqrt(e + f*x)),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2)/((a + b*x)**(sympy.S(5)/2)*sqrt(c + d*x)*sqrt(e + f*x)),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2)/((a + b*x)**(sympy.S(7)/2)*sqrt(c + d*x)*sqrt(e + f*x)),
        variable=x,
        num_steps=9,
