...
SOURCE_FILE = '1 Algebraic functions/1.1 Binomial products/1.1.1 Linear/1.1.1.5 P(x) (a+b x)^m (c+d x)^n.m'
...
TEST_CASES = [
    RubiTestSuiteCase(
        integrand=(a + b*x)**3*(A + B*x + C*x**2 + D*x**3)/sqrt(c + d*x),
        variable=x,
        num_steps=2,
        integral=2*D*b**3*(c + d*x)**(sympy.S(13)/2)/(13*d**7) + 2*b**2*(c + d*x)**(sympy.S(11)/2)*(C*b*d + 3*D*a*d - 6*D*b*c)/(11*d**7) + 2*b*(c + d*x)**(sympy.S(9)/2)*(3*D*a**2*d**2 + 3*a*b*d*(C*d - 5*D*c) - b**2*(-B*d**2 + 5*C*c*d - 15*D*c**2))/(9*d**7) + (c + d*x)**(sympy.S(7)/2)*(2*D*a**3*d**3 + 6*a**2*b*d**2*(C*d - 4*D*c) - 6*a*b**2*d*(-B*d**2 + 4*C*c*d - 10*D*c**2) + 2*b**3*(A*d**3 - 4*B*c*d**2 + 10*C*c**2*d - 20*D*c**3))/(7*d**7) - (c + d*x)**(sympy.S(5)/2)*(-2*a*d + 2*b*c)*(a**2*d**2*(C*d - 3*D*c) - a*b*d*(-3*B*d**2 + 8*C*c*d - 15*D*c**2) + b**2*(3*A*d**3 - 6*B*c*d**2 + 10*C*c**2*d - 15*D*c**3))/(5*d**7) - 2*(c + d*x)**(sympy.S(3)/2)*(-a*d + b*c)**2*(a*d*(-B*d**2 + 2*C*c*d - 3*D*c**2) - b*(3*A*d**3 - 4*B*c*d**2 + 5*C*c**2*d - 6*D*c**3))/(3*d**7) - 2*sqrt(c + d*x)*(-a*d + b*c)**3*(A*d**3 - B*c*d**2 + C*c**2*d - D*c**3)/d**7,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x)**2*(A + B*x + C*x**2 + D*x**3)/sqrt(c + d*x),
        variable=x,
        num_steps=2,
        integral=2*D*b**2*(c + d*x)**(sympy.S(11)/2)/(11*d**6) + 2*b*(c + d*x)**(sympy.S(9)/2)*(C*b*d + 2*D*a*d - 5*D*b*c)/(9*d**6) + (c + d*x)**(sympy.S(7)/2)*(2*D*a**2*d**2 + 4*a*b*d*(C*d - 4*D*c) - 2*b**2*(-B*d**2 + 4*C*c*d - 10*D*c**2))/(7*d**6) + (c + d*x)**(sympy.S(5)/2)*(2*a**2*d**2*(C*d - 3*D*c) - 4*a*b*d*(-B*d**2 + 3*C*c*d - 6*D*c**2) + 2*b**2*(A*d**3 - 3*B*c*d**2 + 6*C*c**2*d - 10*D*c**3))/(5*d**6) + (c + d*x)**(sympy.S(3)/2)*(-2*a*d + 2*b*c)*(a*d*(-B*d**2 + 2*C*c*d - 3*D*c**2) - b*(2*A*d**3 - 3*B*c*d**2 + 4*C*c**2*d - 5*D*c**3))/(3*d**6) + 2*sqrt(c + d*x)*(-a*d + b*c)**2*(A*d**3 - B*c*d**2 + C*c**2*d - D*c**3)/d**6,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x)*(A + B*x + C*x**2 + D*x**3)/sqrt(c + d*x),
        variable=x,
        num_steps=2,
        integral=2*D*b*(c + d*x)**(sympy.S(9)/2)/(9*d**5) + (c + d*x)**(sympy.S(7)/2)*(2*C*b*d + 2*D*a*d - 8*D*b*c)/(7*d**5) + (c + d*x)**(sympy.S(5)/2)*(2*a*d*(C*d - 3*D*c) - 2*b*(-B*d**2 + 3*C*c*d - 6*D*c**2))/(5*d**5) - (c + d*x)**(sympy.S(3)/2)*(2*a*d*(-B*d**2 + 2*C*c*d - 3*D*c**2) - 2*b*(A*d**3 - 2*B*c*d**2 + 3*C*c**2*d - 4*D*c**3))/(3*d**5) - sqrt(c + d*x)*(-2*a*d + 2*b*c)*(A*d**3 - B*c*d**2 + C*c**2*d - D*c**3)/d**5,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2 + D*x**3)/sqrt(c + d*x),
        variable=x,
        num_steps=2,
        integral=2*D*(c + d*x)**(sympy.S(7)/2)/(7*d**4) + (c + d*x)**(sympy.S(5)/2)*(2*C*d - 6*D*c)/(5*d**4) - (c + d*x)**(sympy.S(3)/2)*(-2*B*d**2 + 4*C*c*d - 6*D*c**2)/(3*d**4) + sqrt(c + d*x)*(2*A*d**3 - 2*B*c*d**2 + 2*C*c**2*d - 2*D*c**3)/d**4,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2 + D*x**3)/((a + b*x)*sqrt(c + d*x)),
        variable=x,
        num_steps=4,
        integral=2*D*(c + d*x)**(sympy.S(5)/2)/(5*b*d**3) + (c + d*x)**(sympy.S(3)/2)*(2*C*b*d - 2*D*a*d - 4*D*b*c)/(3*b**2*d**3) + sqrt(c + d*x)*(2*D*a**2*d**2 - 2*a*b*d*(C*d - D*c) - 2*b**2*(-B*d**2 + C*c*d - D*c**2))/(b**3*d**3) - (2*A*b**3 - 2*a*(B*b**2 - C*a*b + D*a**2))*atanh(sqrt(b)*sqrt(c + d*x)/sqrt(-a*d + b*c))/(b**(sympy.S(7)/2)*sqrt(-a*d + b*c)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2 + D*x**3)/((a + b*x)**2*sqrt(c + d*x)),
        variable=x,
        num_steps=5,
        integral=2*D*(c + d*x)**(sympy.S(3)/2)/(3*b**2*d**2) - (A - a*(B*b**2 - C*a*b + D*a**2)/b**3)*sqrt(c + d*x)/((a + b*x)*(-a*d + b*c)) + sqrt(c + d*x)*(2*C*b*d - 4*D*a*d - 2*D*b*c)/(b**3*d**2) - (-5*D*a**3*d + 3*a**2*b*(C*d + 2*D*c) - a*b**2*(B*d + 4*C*c) + b**3*(-A*d + 2*B*c))*atanh(sqrt(b)*sqrt(c + d*x)/sqrt(-a*d + b*c))/(b**(sympy.S(7)/2)*(-a*d + b*c)**(sympy.S(3)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2 + D*x**3)/((a + b*x)**3*sqrt(c + d*x)),
        variable=x,
        num_steps=5,
        integral=2*D*sqrt(c + d*x)/(b**3*d) - sqrt(c + d*x)*(-9*D*a**3*d + a**2*b*(5*C*d + 12*D*c) - a*b**2*(B*d + 8*C*c) + b**3*(-3*A*d + 4*B*c))/(4*b**3*(a + b*x)*(-a*d + b*c)**2) - sqrt(c + d*x)*(A*b**3 - a*(B*b**2 - C*a*b + D*a**2))/(2*b**3*(a + b*x)**2*(-a*d + b*c)) - (-15*D*a**3*d**2 + 3*a**2*b*d*(C*d + 12*D*c) - a*b**2*(-B*d**2 + 8*C*c*d + 24*D*c**2) + b**3*(3*A*d**2 - 4*B*c*d + 8*C*c**2))*atanh(sqrt(b)*sqrt(c + d*x)/sqrt(-a*d + b*c))/(4*b**(sympy.S(7)/2)*(-a*d + b*c)**(sympy.S(5)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2 + D*x**3)/((a + b*x)**4*sqrt(c + d*x)),
        variable=x,
        num_steps=5,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2 + D*x**3)/((a + b*x)**5*sqrt(c + d*x)),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*x)**3*(A + B*x + C*x**2 + D*x**3)/(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=2,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*x)**2*(A + B*x + C*x**2 + D*x**3)/(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=2,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*x)*(A + B*x + C*x**2 + D*x**3)/(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=2,
        integral=2*D*b*(c + d*x)**(sympy.S(7)/2)/(7*d**5) + (c + d*x)**(sympy.S(5)/2)*(2*C*b*d + 2*D*a*d - 8*D*b*c)/(5*d**5) + (c + d*x)**(sympy.S(3)/2)*(2*a*d*(C*d - 3*D*c) - 2*b*(-B*d**2 + 3*C*c*d - 6*D*c**2))/(3*d**5) - sqrt(c + d*x)*(2*a*d*(-B*d**2 + 2*C*c*d - 3*D*c**2) - 2*b*(A*d**3 - 2*B*c*d**2 + 3*C*c**2*d - 4*D*c**3))/d**5 + (-2*a*d + 2*b*c)*(A*d**3 - B*c*d**2 + C*c**2*d - D*c**3)/(d**5*sqrt(c + d*x)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2 + D*x**3)/(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=2,
        integral=2*D*(c + d*x)**(sympy.S(5)/2)/(5*d**4) + (c + d*x)**(sympy.S(3)/2)*(2*C*d - 6*D*c)/(3*d**4) - sqrt(c + d*x)*(-2*B*d**2 + 4*C*c*d - 6*D*c**2)/d**4 - (2*A*d**3 - 2*B*c*d**2 + 2*C*c**2*d - 2*D*c**3)/(d**4*sqrt(c + d*x)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2 + D*x**3)/((a + b*x)*(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=6,
        integral=-2*D*c*sqrt(c + d*x)/(b*d**3) + 2*D*(c + d*x)**(sympy.S(3)/2)/(3*b*d**3) + (2*A*d**3 - 2*B*c*d**2 + 2*C*c**2*d - 2*D*c**3)/(d**3*sqrt(c + d*x)*(-a*d + b*c)) + sqrt(c + d*x)*(2*C*b*d - 2*D*a*d - 2*D*b*c)/(b**2*d**3) - (2*A*b**3 - 2*a*(B*b**2 - C*a*b + D*a**2))*atanh(sqrt(b)*sqrt(c + d*x)/sqrt(-a*d + b*c))/(b**(sympy.S(5)/2)*(-a*d + b*c)**(sympy.S(3)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2 + D*x**3)/((a + b*x)**2*(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=5,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2 + D*x**3)/((a + b*x)**3*(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=5,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2 + D*x**3)/((a + b*x)**4*(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*x)**3*(A + B*x + C*x**2 + D*x**3)/(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=2,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*x)**2*(A + B*x + C*x**2 + D*x**3)/(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=2,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*x)*(A + B*x + C*x**2 + D*x**3)/(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=2,
        integral=2*D*b*(c + d*x)**(sympy.S(5)/2)/(5*d**5) + (c + d*x)**(sympy.S(3)/2)*(2*C*b*d + 2*D*a*d - 8*D*b*c)/(3*d**5) + sqrt(c + d*x)*(2*a*d*(C*d - 3*D*c) - 2*b*(-B*d**2 + 3*C*c*d - 6*D*c**2))/d**5 + (2*a*d*(-B*d**2 + 2*C*c*d - 3*D*c**2) - 2*b*(A*d**3 - 2*B*c*d**2 + 3*C*c**2*d - 4*D*c**3))/(d**5*sqrt(c + d*x)) + (-2*a*d + 2*b*c)*(A*d**3 - B*c*d**2 + C*c**2*d - D*c**3)/(3*d**5*(c + d*x)**(sympy.S(3)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2 + D*x**3)/(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=2,
        integral=2*D*(c + d*x)**(sympy.S(3)/2)/(3*d**4) + sqrt(c + d*x)*(2*C*d - 6*D*c)/d**4 + (-2*B*d**2 + 4*C*c*d - 6*D*c**2)/(d**4*sqrt(c + d*x)) - (2*A*d**3 - 2*B*c*d**2 + 2*C*c**2*d - 2*D*c**3)/(3*d**4*(c + d*x)**(sympy.S(3)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2 + D*x**3)/((a + b*x)*(c + d*x)**(sympy.S(5)/2)),
        variable=x,
        num_steps=4,
        integral=2*D*sqrt(c + d*x)/(b*d**3) + (2*a*d*(-B*d**2 + 2*C*c*d - 3*D*c**2) - 2*b*(-A*d**3 + C*c**2*d - 2*D*c**3))/(d**3*sqrt(c + d*x)*(-a*d + b*c)**2) + (2*A*d**3 - 2*B*c*d**2 + 2*C*c**2*d - 2*D*c**3)/(3*d**3*(c + d*x)**(sympy.S(3)/2)*(-a*d + b*c)) - (2*A*b**3 - 2*a*(B*b**2 - C*a*b + D*a**2))*atanh(sqrt(b)*sqrt(c + d*x)/sqrt(-a*d + b*c))/(b**(sympy.S(3)/2)*(-a*d + b*c)**(sympy.S(5)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2 + D*x**3)/((a + b*x)**2*(c + d*x)**(sympy.S(5)/2)),
        variable=x,
        num_steps=5,
        integral=-(A - a*(B*b**2 - C*a*b + D*a**2)/b**3)/((a + b*x)*(c + d*x)**(sympy.S(3)/2)*(-a*d + b*c)) - (C*a**2*b*d**3 - D*a**3*d**3 + a*b**2*d*(-3*B*d**2 + 4*C*c*d - 6*D*c**2) - b**3*(-5*A*d**3 + 2*B*c*d**2 - 2*D*c**3))/(b**2*d**2*sqrt(c + d*x)*(-a*d + b*c)**3) + (3*B*a*b**2*d**3 - 3*C*a**2*b*d**3 + 3*D*a**3*d**3 - b**3*(5*A*d**3 - 2*B*c*d**2 + 2*C*c**2*d - 2*D*c**3))/(3*b**3*d**2*(c + d*x)**(sympy.S(3)/2)*(-a*d + b*c)**2) - (-D*a**3*d - a**2*b*(C*d - 6*D*c) - a*b**2*(-3*B*d + 4*C*c) + b**3*(-5*A*d + 2*B*c))*atanh(sqrt(b)*sqrt(c + d*x)/sqrt(-a*d + b*c))/(b**(sympy.S(3)/2)*(-a*d + b*c)**(sympy.S(7)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x + C*x**2 + D*x**3)/((a + b*x)**3*(c + d*x)**(sympy.S(5)/2)),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*x)**3*(c + d*x)**n*(A + B*x + C*x**2 + D*x**3),
        variable=x,
        num_steps=2,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*x)**2*(c + d*x)**n*(A + B*x + C*x**2 + D*x**3),
        variable=x,
        num_steps=2,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*x)*(c + d*x)**n*(A + B*x + C*x**2 + D*x**3),
        variable=x,
        num_steps=2,
        integral=D*b*(c + d*x)**(n + 5)/(d**5*(n + 5)) - (c + d*x)**(n + 1)*(-a*d + b*c)*(A*d**3 - B*c*d**2 + C*c**2*d - D*c**3)/(d**5*(n + 1)) - (c + d*x)**(n + 2)*(a*d*(-B*d**2 + 2*C*c*d - 3*D*c**2) - b*(A*d**3 - 2*B*c*d**2 + 3*C*c**2*d - 4*D*c**3))/(d**5*(n + 2)) + (c + d*x)**(n + 3)*(a*d*(C*d - 3*D*c) - b*(-B*d**2 + 3*C*c*d - 6*D*c**2))/(d**5*(n + 3)) + (c + d*x)**(n + 4)*(C*b*d + D*a*d - 4*D*b*c)/(d**5*(n + 4)),
    ),
    RubiTestSuiteCase(
        integrand=(c + d*x)**n*(A + B*x + C*x**2 + D*x**3),
        variable=x,
        num_steps=2,
        integral=D*(c + d*x)**(n + 4)/(d**4*(n + 4)) + (c + d*x)**(n + 1)*(A*d**3 - B*c*d**2 + C*c**2*d - D*c**3)/(d**4*(n + 1)) - (c + d*x)**(n + 2)*(-B*d**2 + 2*C*c*d - 3*D*c**2)/(d**4*(n + 2)) + (c + d*x)**(n + 3)*(C*d - 3*D*c)/(d**4*(n + 3)),
    ),
    RubiTestSuiteCase(
        integrand=(c + d*x)**n*(A + B*x + C*x**2 + D*x**3)/(a + b*x),
        variable=x,
        num_steps=3,
        integral=D*(c + d*x)**(n + 3)/(b*d**3*(n + 3)) + (c + d*x)**(n + 2)*(C*b*d - D*a*d - 2*D*b*c)/(b**2*d**3*(n + 2)) - (c + d*x)**(n + 1)*(A*b**3 - a*(B*b**2 - C*a*b + D*a**2))*hyper((1, n + 1), (n + 2,), b*(c + d*x)/(-a*d + b*c))/(b**3*(n + 1)*(-a*d + b*c)) + (c + d*x)**(n + 1)*(D*a**2*d**2 - a*b*d*(C*d - D*c) - b**2*(-B*d**2 + C*c*d - D*c**2))/(b**3*d**3*(n + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(c + d*x)**n*(A + B*x + C*x**2 + D*x**3)/(a + b*x)**2,
        variable=x,
        num_steps=4,
        integral=D*(c + d*x)**(n + 2)/(b**2*d**2*(n + 2)) - (A - a*(B*b**2 - C*a*b + D*a**2)/b**3)*(c + d*x)**(n + 1)/((a + b*x)*(-a*d + b*c)) + (c + d*x)**(n + 1)*(D*a**3*d*(n + 3) - a**2*b*(C*d*(n + 2) + 3*D*c) + a*b**2*(B*d*(n + 1) + 2*C*c) - b**3*(A*d*n + B*c))*hyper((1, n + 1), (n + 2,), b*(c + d*x)/(-a*d + b*c))/(b**3*(n + 1)*(-a*d + b*c)**2) + (c + d*x)**(n + 1)*(C*b*d - 2*D*a*d - D*b*c)/(b**3*d**2*(n + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(c + d*x)**n*(A + B*x + C*x**2 + D*x**3)/(a + b*x)**3,
        variable=x,
        num_steps=4,
