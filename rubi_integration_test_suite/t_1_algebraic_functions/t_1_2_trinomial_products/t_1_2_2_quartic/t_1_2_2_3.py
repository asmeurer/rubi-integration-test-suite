...
SOURCE_FILE = '1 Algebraic functions/1.2 Trinomial products/1.2.2 Quartic/1.2.2.3 (d+e x^2)^m (a+b x^2+c x^4)^p.m'
...
TEST_CASES = [
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=3,
        integral=(-sqrt(a)*d + sqrt(b)*c)*atan(b**(sympy.S(1)/4)*x/a**(sympy.S(1)/4))/(2*a**(sympy.S(3)/4)*b**(sympy.S(3)/4)) + (sqrt(a)*d + sqrt(b)*c)*atanh(b**(sympy.S(1)/4)*x/a**(sympy.S(1)/4))/(2*a**(sympy.S(3)/4)*b**(sympy.S(3)/4)),
    ),
    RubiTestSuiteCase(
        integrand=(c - d*x**2)/(a - b*x**4),
        variable=x,
        num_steps=3,
        integral=(-sqrt(a)*d + sqrt(b)*c)*atanh(b**(sympy.S(1)/4)*x/a**(sympy.S(1)/4))/(2*a**(sympy.S(3)/4)*b**(sympy.S(3)/4)) + (sqrt(a)*d + sqrt(b)*c)*atan(b**(sympy.S(1)/4)*x/a**(sympy.S(1)/4))/(2*a**(sympy.S(3)/4)*b**(sympy.S(3)/4)),
    ),
    RubiTestSuiteCase(
        integrand=(3*x**2 + 2)/(9*x**4 + 4),
        variable=x,
        num_steps=5,
        integral=sqrt(3)*atan(sqrt(3)*x - 1)/6 + sqrt(3)*atan(sqrt(3)*x + 1)/6,
    ),
    RubiTestSuiteCase(
        integrand=(2 - 3*x**2)/(9*x**4 + 4),
        variable=x,
        num_steps=3,
        integral=-sqrt(3)*log(3*x**2 - 2*sqrt(3)*x + 2)/12 + sqrt(3)*log(3*x**2 + 2*sqrt(3)*x + 2)/12,
    ),
    RubiTestSuiteCase(
        integrand=(3*x**2 + 2)/(4 - 9*x**4),
        variable=x,
        num_steps=2,
        integral=sqrt(6)*atanh(sqrt(6)*x/2)/6,
    ),
    RubiTestSuiteCase(
        integrand=(2 - 3*x**2)/(4 - 9*x**4),
        variable=x,
        num_steps=2,
        integral=sqrt(6)*atan(sqrt(6)*x/2)/6,
    ),
    RubiTestSuiteCase(
        integrand=(sqrt(a)*sqrt(b) + b*x**2)/(a + b*x**4),
        variable=x,
        num_steps=5,
        integral=-sqrt(2)*b**(sympy.S(1)/4)*atan(1 - sqrt(2)*b**(sympy.S(1)/4)*x/a**(sympy.S(1)/4))/(2*a**(sympy.S(1)/4)) + sqrt(2)*b**(sympy.S(1)/4)*atan(1 + sqrt(2)*b**(sympy.S(1)/4)*x/a**(sympy.S(1)/4))/(2*a**(sympy.S(1)/4)),
    ),
    RubiTestSuiteCase(
        integrand=(sqrt(a)*sqrt(b) - b*x**2)/(a + b*x**4),
        variable=x,
        num_steps=3,
        integral=-sqrt(2)*b**(sympy.S(1)/4)*log(-sqrt(2)*a**(sympy.S(1)/4)*b**(sympy.S(1)/4)*x + sqrt(a) + sqrt(b)*x**2)/(4*a**(sympy.S(1)/4)) + sqrt(2)*b**(sympy.S(1)/4)*log(sqrt(2)*a**(sympy.S(1)/4)*b**(sympy.S(1)/4)*x + sqrt(a) + sqrt(b)*x**2)/(4*a**(sympy.S(1)/4)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)/(d**2 + e**2*x**4),
        variable=x,
        num_steps=5,
        integral=-sqrt(2)*atan(1 - sqrt(2)*sqrt(e)*x/sqrt(d))/(2*sqrt(d)*sqrt(e)) + sqrt(2)*atan(1 + sqrt(2)*sqrt(e)*x/sqrt(d))/(2*sqrt(d)*sqrt(e)),
    ),
    RubiTestSuiteCase(
        integrand=(d - e*x**2)/(d**2 + e**2*x**4),
        variable=x,
        num_steps=3,
        integral=-sqrt(2)*log(-sqrt(2)*sqrt(d)*sqrt(e)*x + d + e*x**2)/(4*sqrt(d)*sqrt(e)) + sqrt(2)*log(sqrt(2)*sqrt(d)*sqrt(e)*x + d + e*x**2)/(4*sqrt(d)*sqrt(e)),
    ),
    RubiTestSuiteCase(
        integrand=(2*x**2 + 5)/(x**4 - 1),
        variable=x,
        num_steps=3,
        integral=-3*atan(x)/2 - 7*atanh(x)/2,
    ),
    RubiTestSuiteCase(
        integrand=(b*x**2 + 1)/sqrt(-b**2*x**4 + 1),
        variable=x,
        num_steps=2,
        integral=elliptic_e(asin(sqrt(b)*x), -1)/sqrt(b),
    ),
    RubiTestSuiteCase(
        integrand=(-b*x**2 + 1)/sqrt(-b**2*x**4 + 1),
        variable=x,
        num_steps=5,
        integral=-elliptic_e(asin(sqrt(b)*x), -1)/sqrt(b) + 2*elliptic_f(asin(sqrt(b)*x), -1)/sqrt(b),
    ),
    RubiTestSuiteCase(
        integrand=(b*x**2 + 1)/sqrt(b**2*x**4 - 1),
        variable=x,
        num_steps=3,
        integral=sqrt(-b**2*x**4 + 1)*elliptic_e(asin(sqrt(b)*x), -1)/(sqrt(b)*sqrt(b**2*x**4 - 1)),
    ),
    RubiTestSuiteCase(
        integrand=(-b*x**2 + 1)/sqrt(b**2*x**4 - 1),
        variable=x,
        num_steps=6,
        integral=-sqrt(-b**2*x**4 + 1)*elliptic_e(asin(sqrt(b)*x), -1)/(sqrt(b)*sqrt(b**2*x**4 - 1)) + 2*sqrt(-b**2*x**4 + 1)*elliptic_f(asin(sqrt(b)*x), -1)/(sqrt(b)*sqrt(b**2*x**4 - 1)),
    ),
    RubiTestSuiteCase(
        integrand=(-b*x**2 + 1)/sqrt(b**2*x**4 + 1),
        variable=x,
        num_steps=1,
        integral=-x*sqrt(b**2*x**4 + 1)/(b*x**2 + 1) + sqrt((b**2*x**4 + 1)/(b*x**2 + 1)**2)*(b*x**2 + 1)*elliptic_e(2*atan(sqrt(b)*x), sympy.S.Half)/(sqrt(b)*sqrt(b**2*x**4 + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(b*x**2 + 1)/sqrt(b**2*x**4 + 1),
        variable=x,
        num_steps=3,
        integral=x*sqrt(b**2*x**4 + 1)/(b*x**2 + 1) - sqrt((b**2*x**4 + 1)/(b*x**2 + 1)**2)*(b*x**2 + 1)*elliptic_e(2*atan(sqrt(b)*x), sympy.S.Half)/(sqrt(b)*sqrt(b**2*x**4 + 1)) + sqrt((b**2*x**4 + 1)/(b*x**2 + 1)**2)*(b*x**2 + 1)*elliptic_f(2*atan(sqrt(b)*x), sympy.S.Half)/(sqrt(b)*sqrt(b**2*x**4 + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(-b*x**2 + 1)/sqrt(-b**2*x**4 - 1),
        variable=x,
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=1,
        integral=elliptic_e(asin(c*x), -1)/c,
    ),
    RubiTestSuiteCase(
        integrand=(c**2*x**2 + 1)/sqrt(-c**4*x**4 + 1),
        variable=x,
        num_steps=2,
        integral=elliptic_e(asin(c*x), -1)/c,
    ),
    ...
    RubiTestSuiteCase(
        integrand=(d + e*x**2)/(b*x**2 + d**2 + e**2*x**4),
        variable=x,
        num_steps=5,
        integral=-atan((-2*e*x + sqrt(-b + 2*d*e))/sqrt(b + 2*d*e))/sqrt(b + 2*d*e) + atan((2*e*x + sqrt(-b + 2*d*e))/sqrt(b + 2*d*e))/sqrt(b + 2*d*e),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)/(d**2 + e**2*x**4 + f*x**2),
        variable=x,
        num_steps=5,
        integral=-atan((-2*e*x + sqrt(2*d*e - f))/sqrt(2*d*e + f))/sqrt(2*d*e + f) + atan((2*e*x + sqrt(2*d*e - f))/sqrt(2*d*e + f))/sqrt(2*d*e + f),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)/(-b*x**2 + d**2 + e**2*x**4),
        variable=x,
        num_steps=5,
        integral=atanh((-2*e*x + sqrt(b + 2*d*e))/sqrt(b - 2*d*e))/sqrt(b - 2*d*e) - atanh((2*e*x + sqrt(b + 2*d*e))/sqrt(b - 2*d*e))/sqrt(b - 2*d*e),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)/(d**2 + e**2*x**4 - f*x**2),
        variable=x,
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=3,
        integral=-log(d + e*x**2 - x*sqrt(-b + 2*d*e))/(2*sqrt(-b + 2*d*e)) + log(d + e*x**2 + x*sqrt(-b + 2*d*e))/(2*sqrt(-b + 2*d*e)),
    ),
    RubiTestSuiteCase(
        integrand=(d - e*x**2)/(d**2 + e**2*x**4 + f*x**2),
        variable=x,
        num_steps=3,
        integral=-log(d + e*x**2 - x*sqrt(2*d*e - f))/(2*sqrt(2*d*e - f)) + log(d + e*x**2 + x*sqrt(2*d*e - f))/(2*sqrt(2*d*e - f)),
    ),
    RubiTestSuiteCase(
        integrand=(d - e*x**2)/(-b*x**2 + d**2 + e**2*x**4),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=(d - e*x**2)/(b*x**2 + c*d**2/e**2 + c*x**4),
        variable=x,
        num_steps=3,
        integral=-e**(sympy.S(3)/2)*log(sqrt(c)*d + sqrt(c)*e*x**2 - sqrt(e)*x*sqrt(-b*e + 2*c*d))/(2*sqrt(c)*sqrt(-b*e + 2*c*d)) + e**(sympy.S(3)/2)*log(sqrt(c)*d + sqrt(c)*e*x**2 + sqrt(e)*x*sqrt(-b*e + 2*c*d))/(2*sqrt(c)*sqrt(-b*e + 2*c*d)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)/(b*x**2 + c*d**2/e**2 + c*x**4),
        variable=x,
        num_steps=5,
        integral=-e**(sympy.S(3)/2)*atan((-2*sqrt(c)*sqrt(e)*x + sqrt(-b*e + 2*c*d))/sqrt(b*e + 2*c*d))/(sqrt(c)*sqrt(b*e + 2*c*d)) + e**(sympy.S(3)/2)*atan((2*sqrt(c)*sqrt(e)*x + sqrt(-b*e + 2*c*d))/sqrt(b*e + 2*c*d))/(sqrt(c)*sqrt(b*e + 2*c*d)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)/(b*x**2 + c*(d**2/e**2 + x**4)),
        variable=x,
        num_steps=6,
        integral=-e**(sympy.S(3)/2)*atan((-2*sqrt(c)*sqrt(e)*x + sqrt(-b*e + 2*c*d))/sqrt(b*e + 2*c*d))/(sqrt(c)*sqrt(b*e + 2*c*d)) + e**(sympy.S(3)/2)*atan((2*sqrt(c)*sqrt(e)*x + sqrt(-b*e + 2*c*d))/sqrt(b*e + 2*c*d))/(sqrt(c)*sqrt(b*e + 2*c*d)),
    ),
    RubiTestSuiteCase(
        integrand=(a - b*x**2)/(a**2 + b**2*x**4 + x**2*(2*a*b - 1)),
        variable=x,
        num_steps=3,
        integral=-log(a + b*x**2 - x)/2 + log(a + b*x**2 + x)/2,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**2)/(a**2 + b**2*x**4 + x**2*(2*a*b - 1)),
        variable=x,
        num_steps=5,
        integral=atanh((-2*b*x + 1)/sqrt(-4*a*b + 1))/sqrt(-4*a*b + 1) - atanh((2*b*x + 1)/sqrt(-4*a*b + 1))/sqrt(-4*a*b + 1),
    ),
    RubiTestSuiteCase(
        integrand=(2*x**2 + 1)/(b*x**2 + 4*x**4 + 1),
        variable=x,
        num_steps=5,
        integral=-atan((-4*x + sqrt(4 - b))/sqrt(b + 4))/sqrt(b + 4) + atan((4*x + sqrt(4 - b))/sqrt(b + 4))/sqrt(b + 4),
    ),
    RubiTestSuiteCase(
        integrand=(2*x**2 + 1)/(-b*x**2 + 4*x**4 + 1),
        variable=x,
        num_steps=5,
        integral=-atan((-4*x + sqrt(b + 4))/sqrt(4 - b))/sqrt(4 - b) + atan((4*x + sqrt(b + 4))/sqrt(4 - b))/sqrt(4 - b),
    ),
    RubiTestSuiteCase(
        integrand=(2*x**2 + 1)/(4*x**4 + 6*x**2 + 1),
        variable=x,
        num_steps=3,
        integral=sqrt(10)*atan(2*x/sqrt(3 - sqrt(5)))/10 + sqrt(10)*atan(2*x/sqrt(sqrt(5) + 3))/10,
    ),
    RubiTestSuiteCase(
        integrand=(2*x**2 + 1)/(4*x**4 + 5*x**2 + 1),
        variable=x,
        num_steps=3,
        integral=atan(x)/3 + atan(2*x)/3,
    ),
    RubiTestSuiteCase(
        integrand=(2*x**2 + 1)/(4*x**4 + 4*x**2 + 1),
        variable=x,
        num_steps=3,
        integral=sqrt(2)*atan(sqrt(2)*x)/2,
    ),
    RubiTestSuiteCase(
        integrand=(2*x**2 + 1)/(4*x**4 + 3*x**2 + 1),
        variable=x,
        num_steps=5,
        integral=-sqrt(7)*atan(sqrt(7)*(1 - 4*x)/7)/7 + sqrt(7)*atan(sqrt(7)*(4*x + 1)/7)/7,
    ),
    RubiTestSuiteCase(
        integrand=(2*x**2 + 1)/(4*x**4 + 2*x**2 + 1),
        variable=x,
        num_steps=5,
        integral=-sqrt(6)*atan(sqrt(3)*(-2*sqrt(2)*x + 1)/3)/6 + sqrt(6)*atan(sqrt(3)*(2*sqrt(2)*x + 1)/3)/6,
    ),
    RubiTestSuiteCase(
        integrand=(2*x**2 + 1)/(4*x**4 + x**2 + 1),
        variable=x,
        num_steps=5,
        integral=-sqrt(5)*atan(sqrt(5)*(-4*x + sqrt(3))/5)/5 + sqrt(5)*atan(sqrt(5)*(4*x + sqrt(3))/5)/5,
    ),
    RubiTestSuiteCase(
        integrand=(2*x**2 + 1)/(4*x**4 + 1),
        variable=x,
        num_steps=5,
        integral=atan(2*x - 1)/2 + atan(2*x + 1)/2,
    ),
    RubiTestSuiteCase(
        integrand=(2*x**2 + 1)/(4*x**4 - x**2 + 1),
        variable=x,
        num_steps=5,
        integral=-sqrt(3)*atan(sqrt(3)*(-4*x + sqrt(5))/3)/3 + sqrt(3)*atan(sqrt(3)*(4*x + sqrt(5))/3)/3,
    ),
    RubiTestSuiteCase(
        integrand=(2*x**2 + 1)/(4*x**4 - 2*x**2 + 1),
        variable=x,
        num_steps=5,
        integral=sqrt(2)*atan(2*sqrt(2)*x - sqrt(3))/2 + sqrt(2)*atan(2*sqrt(2)*x + sqrt(3))/2,
    ),
    RubiTestSuiteCase(
        integrand=(2*x**2 + 1)/(4*x**4 - 3*x**2 + 1),
        variable=x,
        num_steps=5,
        integral=atan(4*x - sqrt(7)) + atan(4*x + sqrt(7)),
    ),
    RubiTestSuiteCase(
        integrand=(2*x**2 + 1)/(4*x**4 - 4*x**2 + 1),
        variable=x,
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=7,
        integral=-log(1 - 2*x)/2 + log(1 - x)/2 - log(x + 1)/2 + log(2*x + 1)/2,
    ),
    RubiTestSuiteCase(
        integrand=(2*x**2 + 1)/(4*x**4 - 6*x**2 + 1),
        variable=x,
        num_steps=5,
        integral=-sqrt(2)*atanh(2*sqrt(2)*x - sqrt(5))/2 - sqrt(2)*atanh(2*sqrt(2)*x + sqrt(5))/2,
    ),
    RubiTestSuiteCase(
        integrand=(1 - 2*x**2)/(b*x**2 + 4*x**4 + 1),
        variable=x,
        num_steps=3,
        integral=-log(2*x**2 - x*sqrt(4 - b) + 1)/(2*sqrt(4 - b)) + log(2*x**2 + x*sqrt(4 - b) + 1)/(2*sqrt(4 - b)),
    ),
    RubiTestSuiteCase(
        integrand=(1 - 2*x**2)/(4*x**4 + 6*x**2 + 1),
        variable=x,
        num_steps=3,
        integral=sqrt(2)*atan(2*x/sqrt(3 - sqrt(5)))/2 - sqrt(2)*atan(2*x/sqrt(sqrt(5) + 3))/2,
    ),
    RubiTestSuiteCase(
        integrand=(1 - 2*x**2)/(4*x**4 + 5*x**2 + 1),
        variable=x,
        num_steps=3,
        integral=-atan(x) + atan(2*x),
    ),
    RubiTestSuiteCase(
        integrand=(1 - 2*x**2)/(4*x**4 + 4*x**2 + 1),
        variable=x,
        num_steps=2,
        integral=x/(2*x**2 + 1),
    ),
    RubiTestSuiteCase(
        integrand=(1 - 2*x**2)/(4*x**4 + 3*x**2 + 1),
        variable=x,
        num_steps=3,
        integral=-log(2*x**2 - x + 1)/2 + log(2*x**2 + x + 1)/2,
    ),
    RubiTestSuiteCase(
        integrand=(1 - 2*x**2)/(4*x**4 + 2*x**2 + 1),
        variable=x,
        num_steps=3,
        integral=-sqrt(2)*log(2*x**2 - sqrt(2)*x + 1)/4 + sqrt(2)*log(2*x**2 + sqrt(2)*x + 1)/4,
    ),
    RubiTestSuiteCase(
        integrand=(1 - 2*x**2)/(4*x**4 + x**2 + 1),
        variable=x,
        num_steps=3,
        integral=-sqrt(3)*log(2*x**2 - sqrt(3)*x + 1)/6 + sqrt(3)*log(2*x**2 + sqrt(3)*x + 1)/6,
    ),
    RubiTestSuiteCase(
        integrand=(1 - 2*x**2)/(4*x**4 + 1),
        variable=x,
        num_steps=3,
        integral=-log(2*x**2 - 2*x + 1)/4 + log(2*x**2 + 2*x + 1)/4,
    ),
    RubiTestSuiteCase(
        integrand=(1 - 2*x**2)/(4*x**4 - x**2 + 1),
        variable=x,
        num_steps=3,
        integral=-sqrt(5)*log(2*x**2 - sqrt(5)*x + 1)/10 + sqrt(5)*log(2*x**2 + sqrt(5)*x + 1)/10,
    ),
    RubiTestSuiteCase(
        integrand=(1 - 2*x**2)/(4*x**4 - 2*x**2 + 1),
        variable=x,
        num_steps=3,
        integral=-sqrt(6)*log(2*x**2 - sqrt(6)*x + 1)/12 + sqrt(6)*log(2*x**2 + sqrt(6)*x + 1)/12,
    ),
    RubiTestSuiteCase(
        integrand=(1 - 2*x**2)/(4*x**4 - 3*x**2 + 1),
        variable=x,
        num_steps=3,
        integral=-sqrt(7)*log(2*x**2 - sqrt(7)*x + 1)/14 + sqrt(7)*log(2*x**2 + sqrt(7)*x + 1)/14,
    ),
    RubiTestSuiteCase(
        integrand=(1 - 2*x**2)/(4*x**4 - 4*x**2 + 1),
        variable=x,
        num_steps=3,
        integral=sqrt(2)*atanh(sqrt(2)*x)/2,
    ),
    RubiTestSuiteCase(
        integrand=(1 - 2*x**2)/(4*x**4 - 5*x**2 + 1),
        variable=x,
        num_steps=7,
        integral=-log(1 - 2*x)/6 - log(1 - x)/6 + log(x + 1)/6 + log(2*x + 1)/6,
    ),
    RubiTestSuiteCase(
        integrand=(1 - 2*x**2)/(4*x**4 - 6*x**2 + 1),
        variable=x,
        num_steps=5,
        integral=-sqrt(10)*atanh(sqrt(5)*(-2*sqrt(2)*x + 1)/5)/10 + sqrt(10)*atanh(sqrt(5)*(2*sqrt(2)*x + 1)/5)/10,
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 1)/(b*x**2 + x**4 + 1),
        variable=x,
        num_steps=5,
        integral=-atan((-2*x + sqrt(2 - b))/sqrt(b + 2))/sqrt(b + 2) + atan((2*x + sqrt(2 - b))/sqrt(b + 2))/sqrt(b + 2),
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 1)/(x**4 + 5*x**2 + 1),
        variable=x,
        num_steps=3,
        integral=sqrt(7)*atan(x*sqrt(sqrt(21)/2 + sympy.S(5)/2))/7 + sqrt(7)*atan(sqrt(2)*x/sqrt(sqrt(21) + 5))/7,
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 1)/(x**4 + 4*x**2 + 1),
        variable=x,
        num_steps=3,
        integral=sqrt(6)*atan(x/sqrt(2 - sqrt(3)))/6 + sqrt(6)*atan(x/sqrt(sqrt(3) + 2))/6,
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 1)/(x**4 + 3*x**2 + 1),
        variable=x,
        num_steps=3,
        integral=sqrt(5)*atan(x*sqrt(sqrt(5)/2 + sympy.S(3)/2))/5 + sqrt(5)*atan(sqrt(2)*x/sqrt(sqrt(5) + 3))/5,
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 1)/(x**4 + 2*x**2 + 1),
        variable=x,
        num_steps=2,
        integral=atan(x),
    ),
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=5,
        integral=-sqrt(3)*atan(sqrt(3)*(1 - 2*x)/3)/3 + sqrt(3)*atan(sqrt(3)*(2*x + 1)/3)/3,
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 1)/(x**4 + 1),
        variable=x,
        num_steps=5,
        integral=sqrt(2)*atan(sqrt(2)*x - 1)/2 + sqrt(2)*atan(sqrt(2)*x + 1)/2,
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 1)/(x**4 - x**2 + 1),
        variable=x,
        num_steps=5,
        integral=atan(2*x - sqrt(3)) + atan(2*x + sqrt(3)),
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 1)/(x**4 - 2*x**2 + 1),
        variable=x,
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=7,
        integral=log(-2*x + 1 + sqrt(5))/2 + log(-2*x - sqrt(5) + 1)/2 - log(2*x + 1 + sqrt(5))/2 - log(2*x - sqrt(5) + 1)/2,
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 1)/(x**4 - 4*x**2 + 1),
        variable=x,
        num_steps=5,
        integral=-sqrt(2)*atanh(sqrt(2)*x - sqrt(3))/2 - sqrt(2)*atanh(sqrt(2)*x + sqrt(3))/2,
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 1)/(x**4 - 5*x**2 + 1),
        variable=x,
        num_steps=5,
        integral=sqrt(3)*atanh(sqrt(3)*(-2*x + sqrt(7))/3)/3 - sqrt(3)*atanh(sqrt(3)*(2*x + sqrt(7))/3)/3,
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**2)/(b*x**2 + x**4 + 1),
        variable=x,
        num_steps=3,
        integral=-log(x**2 - x*sqrt(2 - b) + 1)/(2*sqrt(2 - b)) + log(x**2 + x*sqrt(2 - b) + 1)/(2*sqrt(2 - b)),
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**2)/(x**4 + 5*x**2 + 1),
        variable=x,
        num_steps=3,
        integral=sqrt(3)*atan(x*sqrt(sqrt(21)/2 + sympy.S(5)/2))/3 - sqrt(3)*atan(sqrt(2)*x/sqrt(sqrt(21) + 5))/3,
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**2)/(x**4 + 4*x**2 + 1),
        variable=x,
        num_steps=3,
        integral=sqrt(2)*atan(x/sqrt(2 - sqrt(3)))/2 - sqrt(2)*atan(x/sqrt(sqrt(3) + 2))/2,
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**2)/(x**4 + 3*x**2 + 1),
        variable=x,
        num_steps=3,
        integral=atan(x*sqrt(sqrt(5)/2 + sympy.S(3)/2)) - atan(sqrt(2)*x/sqrt(sqrt(5) + 3)),
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**2)/(x**4 + 2*x**2 + 1),
        variable=x,
        num_steps=2,
        integral=x/(x**2 + 1),
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**2)/(x**4 + x**2 + 1),
        variable=x,
        num_steps=3,
        integral=-log(x**2 - x + 1)/2 + log(x**2 + x + 1)/2,
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**2)/(x**4 + 1),
        variable=x,
        num_steps=3,
        integral=-sqrt(2)*log(x**2 - sqrt(2)*x + 1)/4 + sqrt(2)*log(x**2 + sqrt(2)*x + 1)/4,
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**2)/(x**4 - x**2 + 1),
        variable=x,
        num_steps=3,
        integral=-sqrt(3)*log(x**2 - sqrt(3)*x + 1)/6 + sqrt(3)*log(x**2 + sqrt(3)*x + 1)/6,
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**2)/(x**4 - 2*x**2 + 1),
        variable=x,
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=5,
        integral=-sqrt(5)*atanh(sqrt(5)*(1 - 2*x)/5)/5 + sqrt(5)*atanh(sqrt(5)*(2*x + 1)/5)/5,
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**2)/(x**4 - 4*x**2 + 1),
        variable=x,
        num_steps=5,
        integral=-sqrt(6)*atanh(sqrt(3)*(-sqrt(2)*x + 1)/3)/6 + sqrt(6)*atanh(sqrt(3)*(sqrt(2)*x + 1)/3)/6,
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**2)/(x**4 - 5*x**2 + 1),
        variable=x,
        num_steps=5,
        integral=-sqrt(7)*atanh(sqrt(7)*(-2*x + sqrt(3))/7)/7 + sqrt(7)*atanh(sqrt(7)*(2*x + sqrt(3))/7)/7,
    ),
    RubiTestSuiteCase(
        integrand=(-3*x**2 - 1)/(9*x**4 + 2*x**2 + 1),
        variable=x,
        num_steps=5,
        integral=sqrt(2)*atan(sqrt(2)*(1 - 3*x)/2)/4 - sqrt(2)*atan(sqrt(2)*(3*x + 1)/2)/4,
    ),
    RubiTestSuiteCase(
        integrand=(3*x**2 + 1)/(-9*x**4 - 2*x**2 - 1),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=(2*x**2 + 3)/(x**4 - 2*x**2 + 1),
        variable=x,
        num_steps=3,
        integral=5*x/(2 - 2*x**2) + atanh(x)/2,
    ),
    RubiTestSuiteCase(
        integrand=(3*x**2 + 2)/(3*x**4 - 8*x**2 + 5),
        variable=x,
        num_steps=3,
        integral=5*atanh(x)/2 - 7*sqrt(15)*atanh(sqrt(15)*x/5)/10,
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)/(3*x**4 - 8*x**2 + 5),
        variable=x,
        num_steps=3,
        integral=(d/2 + e/2)*atanh(x) - sqrt(15)*(3*d + 5*e)*atanh(sqrt(15)*x/5)/30,
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 3)/(x**4 + 3*x**2 + 1),
        variable=x,
        num_steps=3,
        integral=sqrt(10)*(sqrt(5) + 3)**(sympy.S(3)/2)*atan(x*sqrt(sqrt(5)/2 + sympy.S(3)/2))/20 - sqrt(180 - 80*sqrt(5))*atan(sqrt(2)*x/sqrt(sqrt(5) + 3))/10,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**2)/(x**4 + x**2 + 1),
        variable=x,
        num_steps=9,
        integral=-(a/4 - b/4)*log(x**2 - x + 1) + (a/4 - b/4)*log(x**2 + x + 1) - sqrt(3)*(a + b)*atan(sqrt(3)*(1 - 2*x)/3)/6 + sqrt(3)*(a + b)*atan(sqrt(3)*(2*x + 1)/3)/6,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**2)/(x**4 + x**2 + 1)**2,
        variable=x,
        num_steps=10,
        integral=x*(a + b - x**2*(a - 2*b))/(6*x**4 + 6*x**2 + 6) - (a/4 - b/8)*log(x**2 - x + 1) + (a/4 - b/8)*log(x**2 + x + 1) - sqrt(3)*(4*a + b)*atan(sqrt(3)*(1 - 2*x)/3)/36 + sqrt(3)*(4*a + b)*atan(sqrt(3)*(2*x + 1)/3)/36,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**2)/(x**4 + x**2 + 2),
        variable=x,
        num_steps=9,
        integral=-(a - sqrt(2)*b)*log(x**2 - x*sqrt(-1 + 2*sqrt(2)) + sqrt(2))/(4*sqrt(-2 + 4*sqrt(2))) + (a - sqrt(2)*b)*log(x**2 + x*sqrt(-1 + 2*sqrt(2)) + sqrt(2))/(4*sqrt(-2 + 4*sqrt(2))) - sqrt(sympy.S(-1)/14 + sqrt(2)/7)*(a + sqrt(2)*b)*atan((-2*x + sqrt(-1 + 2*sqrt(2)))/sqrt(1 + 2*sqrt(2)))/2 + sqrt(sympy.S(-1)/14 + sqrt(2)/7)*(a + sqrt(2)*b)*atan((2*x + sqrt(-1 + 2*sqrt(2)))/sqrt(1 + 2*sqrt(2)))/2,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**2)/(x**4 + x**2 + 2)**2,
        variable=x,
        num_steps=10,
    ...
    RubiTestSuiteCase(
        integrand=(-x**2 + sqrt(2))/(x**4 - sqrt(2)*x**2 + 1),
        variable=x,
        num_steps=9,
        integral=-sqrt(sqrt(2)/2 + 1)*log(x**2 - x*sqrt(sqrt(2) + 2) + 1)/4 + sqrt(sqrt(2)/2 + 1)*log(x**2 + x*sqrt(sqrt(2) + 2) + 1)/4 - atan((-2*x + sqrt(sqrt(2) + 2))/sqrt(2 - sqrt(2)))/(2*sqrt(sqrt(2) + 2)) + atan((2*x + sqrt(sqrt(2) + 2))/sqrt(2 - sqrt(2)))/(2*sqrt(sqrt(2) + 2)),
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + sqrt(2))/(x**4 + sqrt(2)*x**2 + 1),
        variable=x,
        num_steps=9,
        integral=-sqrt(1 - sqrt(2)/2)*log(x**2 - x*sqrt(2 - sqrt(2)) + 1)/4 + sqrt(1 - sqrt(2)/2)*log(x**2 + x*sqrt(2 - sqrt(2)) + 1)/4 - atan((-2*x + sqrt(2 - sqrt(2)))/sqrt(sqrt(2) + 2))/(2*sqrt(2 - sqrt(2))) + atan((2*x + sqrt(2 - sqrt(2)))/sqrt(sqrt(2) + 2))/(2*sqrt(2 - sqrt(2))),
    ),
    RubiTestSuiteCase(
        integrand=(-x**2 + sqrt(2))/(b*x**2 + x**4 + 1),
        variable=x,
        num_steps=9,
        integral=(1 - sqrt(2))*atan((-2*x + sqrt(2 - b))/sqrt(b + 2))/(2*sqrt(b + 2)) - (1 - sqrt(2))*atan((2*x + sqrt(2 - b))/sqrt(b + 2))/(2*sqrt(b + 2)) - (1 + sqrt(2))*log(x**2 - x*sqrt(2 - b) + 1)/(4*sqrt(2 - b)) + (1 + sqrt(2))*log(x**2 + x*sqrt(2 - b) + 1)/(4*sqrt(2 - b)),
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + sqrt(2))/(b*x**2 + x**4 + 1),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=(2*a - x**2)/(a**2 - a*x**2 + x**4),
        variable=x,
        num_steps=9,
        integral=-sqrt(3)*log(-sqrt(3)*sqrt(a)*x + a + x**2)/(4*sqrt(a)) + sqrt(3)*log(sqrt(3)*sqrt(a)*x + a + x**2)/(4*sqrt(a)) - atan(sqrt(3) - 2*x/sqrt(a))/(2*sqrt(a)) + atan(sqrt(3) + 2*x/sqrt(a))/(2*sqrt(a)),
    ),
    RubiTestSuiteCase(
        integrand=(2*sqrt(a) - x**2)/(-sqrt(a)*x**2 + a + x**4),
        variable=x,
        num_steps=9,
        integral=-sqrt(3)*log(-sqrt(3)*a**(sympy.S(1)/4)*x + sqrt(a) + x**2)/(4*a**(sympy.S(1)/4)) + sqrt(3)*log(sqrt(3)*a**(sympy.S(1)/4)*x + sqrt(a) + x**2)/(4*a**(sympy.S(1)/4)) - atan(sqrt(3) - 2*x/a**(sympy.S(1)/4))/(2*a**(sympy.S(1)/4)) + atan(sqrt(3) + 2*x/a**(sympy.S(1)/4))/(2*a**(sympy.S(1)/4)),
    ),
    RubiTestSuiteCase(
        integrand=(2*b**(sympy.S(2)/3) + x**2)/(b**(sympy.S(4)/3) + b**(sympy.S(2)/3)*x**2 + x**4),
        variable=x,
        num_steps=9,
        integral=-log(b**(sympy.S(2)/3) - b**(sympy.S(1)/3)*x + x**2)/(4*b**(sympy.S(1)/3)) + log(b**(sympy.S(2)/3) + b**(sympy.S(1)/3)*x + x**2)/(4*b**(sympy.S(1)/3)) - sqrt(3)*atan(sqrt(3)*(b**(sympy.S(1)/3) - 2*x)/(3*b**(sympy.S(1)/3)))/(2*b**(sympy.S(1)/3)) + sqrt(3)*atan(sqrt(3)*(b**(sympy.S(1)/3) + 2*x)/(3*b**(sympy.S(1)/3)))/(2*b**(sympy.S(1)/3)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x**2)/(a**2 - a*x**2 + x**4),
        variable=x,
        num_steps=9,
        integral=-sqrt(3)*(A - B*a)*log(-sqrt(3)*sqrt(a)*x + a + x**2)/(12*a**(sympy.S(3)/2)) + sqrt(3)*(A - B*a)*log(sqrt(3)*sqrt(a)*x + a + x**2)/(12*a**(sympy.S(3)/2)) - (A + B*a)*atan(sqrt(3) - 2*x/sqrt(a))/(2*a**(sympy.S(3)/2)) + (A + B*a)*atan(sqrt(3) + 2*x/sqrt(a))/(2*a**(sympy.S(3)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x**2)/(-sqrt(a)*x**2 + a + x**4),
        variable=x,
        num_steps=9,
        integral=-sqrt(3)*(A - B*sqrt(a))*log(-sqrt(3)*a**(sympy.S(1)/4)*x + sqrt(a) + x**2)/(12*a**(sympy.S(3)/4)) + sqrt(3)*(A - B*sqrt(a))*log(sqrt(3)*a**(sympy.S(1)/4)*x + sqrt(a) + x**2)/(12*a**(sympy.S(3)/4)) - (A + B*sqrt(a))*atan(sqrt(3) - 2*x/a**(sympy.S(1)/4))/(2*a**(sympy.S(3)/4)) + (A + B*sqrt(a))*atan(sqrt(3) + 2*x/a**(sympy.S(1)/4))/(2*a**(sympy.S(3)/4)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x**2)/(a + c*x**4 - x**2*sqrt(a*c)),
        variable=x,
        num_steps=9,
        integral=-(A - B*sqrt(a)/sqrt(c))*log(sqrt(a) + sqrt(c)*x**2 - x*sqrt(2*sqrt(a)*sqrt(c) + sqrt(a*c)))/(4*sqrt(a)*sqrt(2*sqrt(a)*sqrt(c) + sqrt(a*c))) + (A - B*sqrt(a)/sqrt(c))*log(sqrt(a) + sqrt(c)*x**2 + x*sqrt(2*sqrt(a)*sqrt(c) + sqrt(a*c)))/(4*sqrt(a)*sqrt(2*sqrt(a)*sqrt(c) + sqrt(a*c))) - (A*sqrt(c) + B*sqrt(a))*atan((-2*sqrt(c)*x + sqrt(2*sqrt(a)*sqrt(c) + sqrt(a*c)))/sqrt(2*sqrt(a)*sqrt(c) - sqrt(a*c)))/(2*sqrt(a)*sqrt(c)*sqrt(2*sqrt(a)*sqrt(c) - sqrt(a*c))) + (A*sqrt(c) + B*sqrt(a))*atan((2*sqrt(c)*x + sqrt(2*sqrt(a)*sqrt(c) + sqrt(a*c)))/sqrt(2*sqrt(a)*sqrt(c) - sqrt(a*c)))/(2*sqrt(a)*sqrt(c)*sqrt(2*sqrt(a)*sqrt(c) - sqrt(a*c))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x**2)/(-sqrt(a)*sqrt(c)*x**2 + a + c*x**4),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(3 - x**2)/sqrt(-x**4 + x**2 + 3),
        variable=x,
        num_steps=4,
        integral=-sqrt(sympy.S(-1)/2 + sqrt(13)/2)*elliptic_e(asin(sqrt(2)*x/sqrt(1 + sqrt(13))), sympy.S(-7)/6 - sqrt(13)/6) + sqrt(7 + 2*sqrt(13))*elliptic_f(asin(sqrt(2)*x/sqrt(1 + sqrt(13))), sympy.S(-7)/6 - sqrt(13)/6),
    ),
    RubiTestSuiteCase(
        integrand=(3 - x**2)/sqrt(-x**4 + 2*x**2 + 3),
        variable=x,
        num_steps=5,
        integral=-elliptic_e(asin(sqrt(3)*x/3), -3) + 4*elliptic_f(asin(sqrt(3)*x/3), -3),
    ),
    RubiTestSuiteCase(
        integrand=(3 - x**2)/sqrt(-x**4 + 3*x**2 + 3),
        variable=x,
        num_steps=4,
        integral=-sqrt(sympy.S(-3)/2 + sqrt(21)/2)*elliptic_e(asin(sqrt(2)*x/sqrt(3 + sqrt(21))), sympy.S(-5)/2 - sqrt(21)/2) + sqrt(9 + 2*sqrt(21))*elliptic_f(asin(sqrt(2)*x/sqrt(3 + sqrt(21))), sympy.S(-5)/2 - sqrt(21)/2),
    ),
    RubiTestSuiteCase(
        integrand=(3 - x**2)/sqrt(-x**4 - x**2 + 3),
        variable=x,
        num_steps=4,
        integral=-sqrt(sympy.S.Half + sqrt(13)/2)*elliptic_e(asin(sqrt(2)*x/sqrt(-1 + sqrt(13))), sympy.S(-7)/6 + sqrt(13)/6) + sqrt(5 + 2*sqrt(13))*elliptic_f(asin(sqrt(2)*x/sqrt(-1 + sqrt(13))), sympy.S(-7)/6 + sqrt(13)/6),
    ),
    RubiTestSuiteCase(
        integrand=(3 - x**2)/sqrt(-x**4 - 2*x**2 + 3),
        variable=x,
        num_steps=4,
        integral=-sqrt(3)*elliptic_e(asin(x), sympy.S(-1)/3) + 2*sqrt(3)*elliptic_f(asin(x), sympy.S(-1)/3),
    ),
    RubiTestSuiteCase(
        integrand=(3 - x**2)/sqrt(-x**4 - 3*x**2 + 3),
        variable=x,
        num_steps=4,
        integral=-sqrt(sympy.S(3)/2 + sqrt(21)/2)*elliptic_e(asin(sqrt(2)*x/sqrt(-3 + sqrt(21))), sympy.S(-5)/2 + sqrt(21)/2) + sqrt(3 + 2*sqrt(21))*elliptic_f(asin(sqrt(2)*x/sqrt(-3 + sqrt(21))), sympy.S(-5)/2 + sqrt(21)/2),
    ),
    RubiTestSuiteCase(
        integrand=(b + 2*c*x**2 - sqrt(-4*a*c + b**2))/sqrt(a + b*x**2 + c*x**4),
        variable=x,
        num_steps=3,
    ...
    RubiTestSuiteCase(
        integrand=(a + c*x**4)*(d + e*x**2)**4,
        variable=x,
        num_steps=2,
        integral=a*d**4*x + 4*a*d**3*e*x**3/3 + 4*c*d*e**3*x**11/11 + c*e**4*x**13/13 + d**2*x**5*(6*a*e**2 + c*d**2)/5 + 4*d*e*x**7*(a*e**2 + c*d**2)/7 + e**2*x**9*(a*e**2 + 6*c*d**2)/9,
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**4)*(d + e*x**2)**3,
        variable=x,
        num_steps=2,
        integral=a*d**3*x + a*d**2*e*x**3 + c*d*e**2*x**9/3 + c*e**3*x**11/11 + d*x**5*(3*a*e**2 + c*d**2)/5 + e*x**7*(a*e**2 + 3*c*d**2)/7,
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**4)*(d + e*x**2)**2,
        variable=x,
        num_steps=2,
        integral=a*d**2*x + 2*a*d*e*x**3/3 + 2*c*d*e*x**7/7 + c*e**2*x**9/9 + x**5*(a*e**2 + c*d**2)/5,
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**4)*(d + e*x**2),
        variable=x,
        num_steps=2,
        integral=a*d*x + a*e*x**3/3 + c*d*x**5/5 + c*e*x**7/7,
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**4)/(d + e*x**2),
        variable=x,
        num_steps=3,
        integral=-c*d*x/e**2 + c*x**3/(3*e) + (a*e**2 + c*d**2)*atan(sqrt(e)*x/sqrt(d))/(sqrt(d)*e**(sympy.S(5)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**4)/(d + e*x**2)**2,
        variable=x,
        num_steps=3,
        integral=c*x/e**2 + x*(a + c*d**2/e**2)/(2*d*(d + e*x**2)) - (-a*e**2 + 3*c*d**2)*atan(sqrt(e)*x/sqrt(d))/(2*d**(sympy.S(3)/2)*e**(sympy.S(5)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**4)/(d + e*x**2)**3,
        variable=x,
        num_steps=3,
        integral=x*(3*a/d**2 - 5*c/e**2)/(8*d + 8*e*x**2) + x*(a + c*d**2/e**2)/(4*d*(d + e*x**2)**2) + (3*a*e**2 + 3*c*d**2)*atan(sqrt(e)*x/sqrt(d))/(8*d**(sympy.S(5)/2)*e**(sympy.S(5)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**4)/(d + e*x**2)**4,
        variable=x,
        num_steps=4,
        integral=x*(5*a/d**2 - 7*c/e**2)/(24*(d + e*x**2)**2) + x*(a + c*d**2/e**2)/(6*d*(d + e*x**2)**3) + x*(5*a/d**2 + c/e**2)/(16*d*(d + e*x**2)) + (5*a*e**2 + c*d**2)*atan(sqrt(e)*x/sqrt(d))/(16*d**(sympy.S(7)/2)*e**(sympy.S(5)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**4)**2*(d + e*x**2)**3,
        variable=x,
        num_steps=2,
        integral=a**2*d**3*x + a**2*d**2*e*x**3 + a*d*x**5*(3*a*e**2 + 2*c*d**2)/5 + a*e*x**7*(a*e**2 + 6*c*d**2)/7 + 3*c**2*d*e**2*x**13/13 + c**2*e**3*x**15/15 + c*d*x**9*(6*a*e**2 + c*d**2)/9 + c*e*x**11*(2*a*e**2 + 3*c*d**2)/11,
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**4)**2*(d + e*x**2)**2,
        variable=x,
        num_steps=2,
        integral=a**2*d**2*x + 2*a**2*d*e*x**3/3 + 4*a*c*d*e*x**7/7 + a*x**5*(a*e**2 + 2*c*d**2)/5 + 2*c**2*d*e*x**11/11 + c**2*e**2*x**13/13 + c*x**9*(2*a*e**2 + c*d**2)/9,
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**4)**2*(d + e*x**2),
        variable=x,
        num_steps=2,
        integral=a**2*d*x + a**2*e*x**3/3 + 2*a*c*d*x**5/5 + 2*a*c*e*x**7/7 + c**2*d*x**9/9 + c**2*e*x**11/11,
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**4)**2,
        variable=x,
        num_steps=2,
        integral=a**2*x + 2*a*c*x**5/5 + c**2*x**9/9,
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**4)**2/(d + e*x**2),
        variable=x,
        num_steps=3,
        integral=-c**2*d*x**5/(5*e**2) + c**2*x**7/(7*e) - c*d*x*(2*a*e**2 + c*d**2)/e**4 + c*x**3*(2*a*e**2 + c*d**2)/(3*e**3) + (a*e**2 + c*d**2)**2*atan(sqrt(e)*x/sqrt(d))/(sqrt(d)*e**(sympy.S(9)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**4)**2/(d + e*x**2)**2,
        variable=x,
        num_steps=4,
        integral=-2*c**2*d*x**3/(3*e**3) + c**2*x**5/(5*e**2) + c*x*(2*a*e**2 + 3*c*d**2)/e**4 + x*(a*e**2 + c*d**2)**2/(2*d*e**4*(d + e*x**2)) - (-a*e**2 + 7*c*d**2)*(a*e**2 + c*d**2)*atan(sqrt(e)*x/sqrt(d))/(2*d**(sympy.S(3)/2)*e**(sympy.S(9)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**4)**2/(d + e*x**2)**3,
        variable=x,
        num_steps=5,
        integral=-3*c**2*d*x/e**4 + c**2*x**3/(3*e**3) + x*(a*e**2 + c*d**2)**2/(4*d*e**4*(d + e*x**2)**2) + x*(3*a**2 - 10*a*c*d**2/e**2 - 13*c**2*d**4/e**4)/(8*d**2*(d + e*x**2)) + (3*a**2*e**4 + 6*a*c*d**2*e**2 + 35*c**2*d**4)*atan(sqrt(e)*x/sqrt(d))/(8*d**(sympy.S(5)/2)*e**(sympy.S(9)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**4)**2/(d + e*x**2)**4,
        variable=x,
        num_steps=5,
        integral=c**2*x/e**4 + x*(a*e**2 + c*d**2)**2/(6*d*e**4*(d + e*x**2)**3) + x*(5*a**2 - 14*a*c*d**2/e**2 - 19*c**2*d**4/e**4)/(24*d**2*(d + e*x**2)**2) + x*(5*a**2 + 2*a*c*d**2/e**2 + 29*c**2*d**4/e**4)/(16*d**3*(d + e*x**2)) - (-5*a**2*e**4 - 2*a*c*d**2*e**2 + 35*c**2*d**4)*atan(sqrt(e)*x/sqrt(d))/(16*d**(sympy.S(7)/2)*e**(sympy.S(9)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**4)**2/(d + e*x**2)**5,
        variable=x,
        num_steps=5,
        integral=x*(a*e**2 + c*d**2)**2/(8*d*e**4*(d + e*x**2)**4) + x*(7*a**2 - 18*a*c*d**2/e**2 - 25*c**2*d**4/e**4)/(48*d**2*(d + e*x**2)**3) + x*(35*a**2 + 6*a*c*d**2/e**2 + 163*c**2*d**4/e**4)/(192*d**3*(d + e*x**2)**2) - x*(-35*a**2*e**4 - 6*a*c*d**2*e**2 + 93*c**2*d**4)/(128*d**4*e**4*(d + e*x**2)) + (35*a**2*e**4 + 6*a*c*d**2*e**2 + 35*c**2*d**4)*atan(sqrt(e)*x/sqrt(d))/(128*d**(sympy.S(9)/2)*e**(sympy.S(9)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)**4/(a + c*x**4),
        variable=x,
        num_steps=11,
        integral=4*d*e**3*x**3/(3*c) + e**4*x**5/(5*c) + e**2*x*(-a*e**2 + 6*c*d**2)/c**2 - sqrt(2)*(-4*sqrt(a)*sqrt(c)*d*e*(-a*e**2 + c*d**2) + a**2*e**4 - 6*a*c*d**2*e**2 + c**2*d**4)*log(-sqrt(2)*a**(sympy.S(1)/4)*c**(sympy.S(1)/4)*x + sqrt(a) + sqrt(c)*x**2)/(8*a**(sympy.S(3)/4)*c**(sympy.S(9)/4)) + sqrt(2)*(-4*sqrt(a)*sqrt(c)*d*e*(-a*e**2 + c*d**2) + a**2*e**4 - 6*a*c*d**2*e**2 + c**2*d**4)*log(sqrt(2)*a**(sympy.S(1)/4)*c**(sympy.S(1)/4)*x + sqrt(a) + sqrt(c)*x**2)/(8*a**(sympy.S(3)/4)*c**(sympy.S(9)/4)) - sqrt(2)*(4*sqrt(a)*sqrt(c)*d*e*(-a*e**2 + c*d**2) + a**2*e**4 - 6*a*c*d**2*e**2 + c**2*d**4)*atan(1 - sqrt(2)*c**(sympy.S(1)/4)*x/a**(sympy.S(1)/4))/(4*a**(sympy.S(3)/4)*c**(sympy.S(9)/4)) + sqrt(2)*(4*sqrt(a)*sqrt(c)*d*e*(-a*e**2 + c*d**2) + a**2*e**4 - 6*a*c*d**2*e**2 + c**2*d**4)*atan(1 + sqrt(2)*c**(sympy.S(1)/4)*x/a**(sympy.S(1)/4))/(4*a**(sympy.S(3)/4)*c**(sympy.S(9)/4)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)**3/(a + c*x**4),
        variable=x,
        num_steps=11,
        integral=3*d*e**2*x/c + e**3*x**3/(3*c) - sqrt(2)*(-sqrt(a)*e*(-a*e**2 + 3*c*d**2) + sqrt(c)*d*(-3*a*e**2 + c*d**2))*log(-sqrt(2)*a**(sympy.S(1)/4)*c**(sympy.S(1)/4)*x + sqrt(a) + sqrt(c)*x**2)/(8*a**(sympy.S(3)/4)*c**(sympy.S(7)/4)) + sqrt(2)*(-sqrt(a)*e*(-a*e**2 + 3*c*d**2) + sqrt(c)*d*(-3*a*e**2 + c*d**2))*log(sqrt(2)*a**(sympy.S(1)/4)*c**(sympy.S(1)/4)*x + sqrt(a) + sqrt(c)*x**2)/(8*a**(sympy.S(3)/4)*c**(sympy.S(7)/4)) - sqrt(2)*(sqrt(a)*e*(-a*e**2 + 3*c*d**2) + sqrt(c)*d*(-3*a*e**2 + c*d**2))*atan(1 - sqrt(2)*c**(sympy.S(1)/4)*x/a**(sympy.S(1)/4))/(4*a**(sympy.S(3)/4)*c**(sympy.S(7)/4)) + sqrt(2)*(sqrt(a)*e*(-a*e**2 + 3*c*d**2) + sqrt(c)*d*(-3*a*e**2 + c*d**2))*atan(1 + sqrt(2)*c**(sympy.S(1)/4)*x/a**(sympy.S(1)/4))/(4*a**(sympy.S(3)/4)*c**(sympy.S(7)/4)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)**2/(a + c*x**4),
        variable=x,
        num_steps=11,
    ...
    RubiTestSuiteCase(
        integrand=1/(sqrt(a + c*x**4)*(d + e*x**2)**2),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=1/(sqrt(a + c*x**4)*(d + e*x**2)**3),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=7,
        integral=2*a**(sympy.S(3)/4)*d*e*sqrt(1 - c*x**4/a)*elliptic_e(asin(c**(sympy.S(1)/4)*x/a**(sympy.S(1)/4)), -1)/(c**(sympy.S(3)/4)*sqrt(a - c*x**4)) + a**(sympy.S(1)/4)*sqrt(1 - c*x**4/a)*(-6*sqrt(a)*sqrt(c)*d*e + a*e**2 + 3*c*d**2)*elliptic_f(asin(c**(sympy.S(1)/4)*x/a**(sympy.S(1)/4)), -1)/(3*c**(sympy.S(5)/4)*sqrt(a - c*x**4)) - e**2*x*sqrt(a - c*x**4)/(3*c),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)/sqrt(a - c*x**4),
        variable=x,
        num_steps=6,
        integral=a**(sympy.S(3)/4)*e*sqrt(1 - c*x**4/a)*elliptic_e(asin(c**(sympy.S(1)/4)*x/a**(sympy.S(1)/4)), -1)/(c**(sympy.S(3)/4)*sqrt(a - c*x**4)) + a**(sympy.S(3)/4)*sqrt(1 - c*x**4/a)*(-e + sqrt(c)*d/sqrt(a))*elliptic_f(asin(c**(sympy.S(1)/4)*x/a**(sympy.S(1)/4)), -1)/(c**(sympy.S(3)/4)*sqrt(a - c*x**4)),
    ),
    RubiTestSuiteCase(
        integrand=1/(sqrt(a - c*x**4)*(d + e*x**2)),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=1/(sqrt(a - c*x**4)*(d + e*x**2)**4),
        variable=x,
        num_steps=12,
    ...
    RubiTestSuiteCase(
        integrand=(sqrt(a) + sqrt(c)*x**2)/sqrt(-a + c*x**4),
        variable=x,
        num_steps=3,
        integral=a**(sympy.S(3)/4)*sqrt(1 - c*x**4/a)*elliptic_e(asin(c**(sympy.S(1)/4)*x/a**(sympy.S(1)/4)), -1)/(c**(sympy.S(1)/4)*sqrt(-a + c*x**4)),
    ),
    RubiTestSuiteCase(
        integrand=(x**2*sqrt(c/a) + 1)/sqrt(-a + c*x**4),
        variable=x,
        num_steps=3,
        integral=sqrt(1 - c*x**4/a)*elliptic_e(asin(x*(c/a)**(sympy.S(1)/4)), -1)/((c/a)**(sympy.S(1)/4)*sqrt(-a + c*x**4)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)/sqrt(-a - c*x**4),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=1/(sqrt(4 - 5*x**4)*(a + b*x**2)),
        variable=x,
        num_steps=2,
        integral=(sympy.Function('EllipticPi')((Integer(-1) * ((Integer(2) * Symbol('b')) * ((sympy.sqrt(Integer(5)) * Symbol('a')))**(Integer(-1)))), sympy.asin((((Integer(5))**((Integer(4))**(Integer(-1))) * x) * (sympy.sqrt(Integer(2)))**(Integer(-1)))), Integer(-1)) * ((sympy.sqrt(Integer(2)) * (Integer(5))**((Integer(4))**(Integer(-1))) * Symbol('a')))**(Integer(-1))),
    ),
    RubiTestSuiteCase(
        integrand=1/((a + b*x**2)*sqrt(5*x**4 + 4)),
        variable=x,
        num_steps=3,
    ...
    RubiTestSuiteCase(
        integrand=1/((a + b*x**2)*sqrt(-d*x**4 + 4)),
        variable=x,
        num_steps=1,
        integral=(sympy.Function('EllipticPi')((Integer(-1) * ((Integer(2) * Symbol('b')) * ((Symbol('a') * sympy.sqrt(Symbol('d'))))**(Integer(-1)))), sympy.asin((((Symbol('d'))**((Integer(4))**(Integer(-1))) * x) * (sympy.sqrt(Integer(2)))**(Integer(-1)))), Integer(-1)) * ((sympy.sqrt(Integer(2)) * Symbol('a') * (Symbol('d'))**((Integer(4))**(Integer(-1)))))**(Integer(-1))),
    ),
    RubiTestSuiteCase(
        integrand=1/((a + b*x**2)*sqrt(d*x**4 + 4)),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=sqrt(a + b*x**2)/sqrt(1 - x**4),
        variable=x,
        num_steps=-1,
        integral=((Symbol('a') * sympy.sqrt((Integer(1) + (Integer(-1) * (x)**(Integer(2))))) * sympy.sqrt(((Symbol('a') * (Integer(1) + (x)**(Integer(2)))) * ((Symbol('a') + (Symbol('b') * (x)**(Integer(2)))))**(Integer(-1)))) * sympy.Function('EllipticPi')((Symbol('b') * ((Symbol('a') + Symbol('b')))**(Integer(-1))), sympy.asin(((sympy.sqrt((Symbol('a') + Symbol('b'))) * x) * (sympy.sqrt((Symbol('a') + (Symbol('b') * (x)**(Integer(2))))))**(Integer(-1)))), (Integer(-1) * ((Symbol('a') + (Integer(-1) * Symbol('b'))) * ((Symbol('a') + Symbol('b')))**(Integer(-1)))))) * ((sympy.sqrt((Symbol('a') + Symbol('b'))) * sympy.sqrt((Integer(1) + (x)**(Integer(2)))) * sympy.sqrt(((Symbol('a') * (Integer(1) + (Integer(-1) * (x)**(Integer(2))))) * ((Symbol('a') + (Symbol('b') * (x)**(Integer(2)))))**(Integer(-1))))))**(Integer(-1))),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**4)**p*(c + e*x**2)**q,
        variable=x,
        num_steps=0,
        integral=sympy.Function('Unintegrable')((((Symbol('c') + (Symbol('e') * (x)**(Integer(2)))))**(Symbol('q')) * ((Symbol('a') + (Symbol('b') * (x)**(Integer(4)))))**(Symbol('p'))), x),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**4)**p*(c + e*x**2)**3,
        variable=x,
        num_steps=9,
        integral=c**3*x*(a + b*x**4)**p*hyper((sympy.S(1)/4, -p), (sympy.S(5)/4,), -b*x**4/a)/(1 + b*x**4/a)**p + 3*c*e**2*x**5*(a + b*x**4)**p*hyper((sympy.S(5)/4, -p), (sympy.S(9)/4,), -b*x**4/a)/(5*(1 + b*x**4/a)**p) + e**3*x**3*(a + b*x**4)**(p + 1)/(b*(4*p + 7)) - e*x**3*(a + b*x**4)**p*(a*e**2 - b*c**2*(4*p + 7))*hyper((sympy.S(3)/4, -p), (sympy.S(7)/4,), -b*x**4/a)/(b*(1 + b*x**4/a)**p*(4*p + 7)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**4)**p*(c + e*x**2)**2,
        variable=x,
        num_steps=7,
        integral=2*c*e*x**3*(a + b*x**4)**p*hyper((sympy.S(3)/4, -p), (sympy.S(7)/4,), -b*x**4/a)/(3*(1 + b*x**4/a)**p) + e**2*x*(a + b*x**4)**(p + 1)/(b*(4*p + 5)) - x*(a + b*x**4)**p*(a*e**2 - b*c**2*(4*p + 5))*hyper((sympy.S(1)/4, -p), (sympy.S(5)/4,), -b*x**4/a)/(b*(1 + b*x**4/a)**p*(4*p + 5)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**4)**p*(c + e*x**2),
        variable=x,
        num_steps=6,
        integral=c*x*(a + b*x**4)**p*hyper((sympy.S(1)/4, -p), (sympy.S(5)/4,), -b*x**4/a)/(1 + b*x**4/a)**p + e*x**3*(a + b*x**4)**p*hyper((sympy.S(3)/4, -p), (sympy.S(7)/4,), -b*x**4/a)/(3*(1 + b*x**4/a)**p),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**4)**p,
        variable=x,
        num_steps=2,
        integral=x*(a + b*x**4)**p*hyper((sympy.S(1)/4, -p), (sympy.S(5)/4,), -b*x**4/a)/(1 + b*x**4/a)**p,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**4)**p/(c + e*x**2),
        variable=x,
        num_steps=6,
        integral=x*(a + b*x**4)**p*appellf1(sympy.S(1)/4, 1, -p, sympy.S(5)/4, e**2*x**4/c**2, -b*x**4/a)/(c*(1 + b*x**4/a)**p) - e*x**3*(a + b*x**4)**p*appellf1(sympy.S(3)/4, 1, -p, sympy.S(7)/4, e**2*x**4/c**2, -b*x**4/a)/(3*c**2*(1 + b*x**4/a)**p),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**4)**p/(c + e*x**2)**2,
        variable=x,
        num_steps=8,
        integral=x*(a + b*x**4)**p*appellf1(sympy.S(1)/4, 2, -p, sympy.S(5)/4, e**2*x**4/c**2, -b*x**4/a)/(c**2*(1 + b*x**4/a)**p) - 2*e*x**3*(a + b*x**4)**p*appellf1(sympy.S(3)/4, 2, -p, sympy.S(7)/4, e**2*x**4/c**2, -b*x**4/a)/(3*c**3*(1 + b*x**4/a)**p) + e**2*x**5*(a + b*x**4)**p*appellf1(sympy.S(5)/4, 2, -p, sympy.S(9)/4, e**2*x**4/c**2, -b*x**4/a)/(5*c**4*(1 + b*x**4/a)**p),
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**2)**3*(b*x**4 + 1)**p,
        variable=x,
        num_steps=6,
        integral=3*x**5*hyper((sympy.S(5)/4, -p), (sympy.S(9)/4,), -b*x**4)/5 + x*hyper((sympy.S(1)/4, -p), (sympy.S(5)/4,), -b*x**4) - x**3*(b*x**4 + 1)**(p + 1)/(b*(4*p + 7)) + x**3*(-b*(4*p + 7) + 1)*hyper((sympy.S(3)/4, -p), (sympy.S(7)/4,), -b*x**4)/(b*(4*p + 7)),
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**2)**2*(b*x**4 + 1)**p,
        variable=x,
        num_steps=5,
        integral=-2*x**3*hyper((sympy.S(3)/4, -p), (sympy.S(7)/4,), -b*x**4)/3 + x*(b*x**4 + 1)**(p + 1)/(b*(4*p + 5)) - x*(-b*(4*p + 5) + 1)*hyper((sympy.S(1)/4, -p), (sympy.S(5)/4,), -b*x**4)/(b*(4*p + 5)),
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**2)*(b*x**4 + 1)**p,
        variable=x,
        num_steps=4,
        integral=-x**3*hyper((sympy.S(3)/4, -p), (sympy.S(7)/4,), -b*x**4)/3 + x*hyper((sympy.S(1)/4, -p), (sympy.S(5)/4,), -b*x**4),
    ),
    RubiTestSuiteCase(
        integrand=(b*x**4 + 1)**p,
        variable=x,
        num_steps=1,
        integral=x*hyper((sympy.S(1)/4, -p), (sympy.S(5)/4,), -b*x**4),
    ),
    RubiTestSuiteCase(
        integrand=(b*x**4 + 1)**p/(1 - x**2),
        variable=x,
        num_steps=4,
        integral=x**3*appellf1(sympy.S(3)/4, 1, -p, sympy.S(7)/4, x**4, -b*x**4)/3 + x*appellf1(sympy.S(1)/4, 1, -p, sympy.S(5)/4, x**4, -b*x**4),
    ),
    RubiTestSuiteCase(
        integrand=(b*x**4 + 1)**p/(1 - x**2)**2,
        variable=x,
        num_steps=5,
        integral=x**5*appellf1(sympy.S(5)/4, 2, -p, sympy.S(9)/4, x**4, -b*x**4)/5 + 2*x**3*appellf1(sympy.S(3)/4, 2, -p, sympy.S(7)/4, x**4, -b*x**4)/3 + x*appellf1(sympy.S(1)/4, 2, -p, sympy.S(5)/4, x**4, -b*x**4),
    ),
    RubiTestSuiteCase(
        integrand=(b*x**4 + 1)**p/(1 - x**2)**3,
        variable=x,
        num_steps=6,
        integral=x**7*appellf1(sympy.S(7)/4, 3, -p, sympy.S(11)/4, x**4, -b*x**4)/7 + 3*x**5*appellf1(sympy.S(5)/4, 3, -p, sympy.S(9)/4, x**4, -b*x**4)/5 + x**3*appellf1(sympy.S(3)/4, 3, -p, sympy.S(7)/4, x**4, -b*x**4) + x*appellf1(sympy.S(1)/4, 3, -p, sympy.S(5)/4, x**4, -b*x**4),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)**4/(d**2 - e**2*x**4),
        variable=x,
        num_steps=4,
        integral=8*d**(sympy.S(5)/2)*atanh(sqrt(e)*x/sqrt(d))/sqrt(e) - 7*d**2*x - 4*d*e*x**3/3 - e**2*x**5/5,
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)**3/(d**2 - e**2*x**4),
        variable=x,
        num_steps=4,
        integral=4*d**(sympy.S(3)/2)*atanh(sqrt(e)*x/sqrt(d))/sqrt(e) - 3*d*x - e*x**3/3,
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)**2/(d**2 - e**2*x**4),
        variable=x,
        num_steps=3,
        integral=2*sqrt(d)*atanh(sqrt(e)*x/sqrt(d))/sqrt(e) - x,
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)/(d**2 - e**2*x**4),
        variable=x,
        num_steps=2,
        integral=atanh(sqrt(e)*x/sqrt(d))/(sqrt(d)*sqrt(e)),
    ),
    RubiTestSuiteCase(
        integrand=1/((d + e*x**2)*(d**2 - e**2*x**4)),
        variable=x,
        num_steps=5,
        integral=x/(4*d**2*(d + e*x**2)) + atan(sqrt(e)*x/sqrt(d))/(2*d**(sympy.S(5)/2)*sqrt(e)) + atanh(sqrt(e)*x/sqrt(d))/(4*d**(sympy.S(5)/2)*sqrt(e)),
    ),
    RubiTestSuiteCase(
        integrand=1/((d + e*x**2)**2*(d**2 - e**2*x**4)),
        variable=x,
        num_steps=6,
        integral=x/(8*d**2*(d + e*x**2)**2) + 5*x/(16*d**3*(d + e*x**2)) + 7*atan(sqrt(e)*x/sqrt(d))/(16*d**(sympy.S(7)/2)*sqrt(e)) + atanh(sqrt(e)*x/sqrt(d))/(8*d**(sympy.S(7)/2)*sqrt(e)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)**(sympy.S(3)/2)/(d**2 - e**2*x**4),
        variable=x,
        num_steps=6,
        integral=-atanh(sqrt(e)*x/sqrt(d + e*x**2))/sqrt(e) + sqrt(2)*atanh(sqrt(2)*sqrt(e)*x/sqrt(d + e*x**2))/sqrt(e),
    ),
    RubiTestSuiteCase(
        integrand=sqrt(d + e*x**2)/(d**2 - e**2*x**4),
        variable=x,
        num_steps=3,
        integral=sqrt(2)*atanh(sqrt(2)*sqrt(e)*x/sqrt(d + e*x**2))/(2*d*sqrt(e)),
    ),
    RubiTestSuiteCase(
        integrand=1/(sqrt(d + e*x**2)*(d**2 - e**2*x**4)),
        variable=x,
        num_steps=4,
        integral=x/(2*d**2*sqrt(d + e*x**2)) + sqrt(2)*atanh(sqrt(2)*sqrt(e)*x/sqrt(d + e*x**2))/(4*d**2*sqrt(e)),
    ),
    RubiTestSuiteCase(
        integrand=1/((d + e*x**2)**(sympy.S(3)/2)*(d**2 - e**2*x**4)),
        variable=x,
        num_steps=6,
        integral=x/(6*d**2*(d + e*x**2)**(sympy.S(3)/2)) + 7*x/(12*d**3*sqrt(d + e*x**2)) + sqrt(2)*atanh(sqrt(2)*sqrt(e)*x/sqrt(d + e*x**2))/(8*d**3*sqrt(e)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**2)**(sympy.S(5)/2)/sqrt(a**2 - b**2*x**4),
        variable=x,
        num_steps=5,
        integral=19*a**2*sqrt(a - b*x**2)*sqrt(a + b*x**2)*atan(sqrt(b)*x/sqrt(a - b*x**2))/(8*sqrt(b)*sqrt(a**2 - b**2*x**4)) - 9*a*x*(a - b*x**2)*sqrt(a + b*x**2)/(8*sqrt(a**2 - b**2*x**4)) - x*(a - b*x**2)*(a + b*x**2)**(sympy.S(3)/2)/(4*sqrt(a**2 - b**2*x**4)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**2)**(sympy.S(3)/2)/sqrt(a**2 - b**2*x**4),
        variable=x,
        num_steps=4,
        integral=3*a*sqrt(a - b*x**2)*sqrt(a + b*x**2)*atan(sqrt(b)*x/sqrt(a - b*x**2))/(2*sqrt(b)*sqrt(a**2 - b**2*x**4)) - x*(a - b*x**2)*sqrt(a + b*x**2)/(2*sqrt(a**2 - b**2*x**4)),
    ),
    RubiTestSuiteCase(
        integrand=sqrt(a + b*x**2)/sqrt(a**2 - b**2*x**4),
        variable=x,
        num_steps=3,
        integral=sqrt(a - b*x**2)*sqrt(a + b*x**2)*atan(sqrt(b)*x/sqrt(a - b*x**2))/(sqrt(b)*sqrt(a**2 - b**2*x**4)),
    ),
    RubiTestSuiteCase(
        integrand=1/(sqrt(a + b*x**2)*sqrt(a**2 - b**2*x**4)),
        variable=x,
        num_steps=3,
        integral=sqrt(2)*sqrt(a - b*x**2)*sqrt(a + b*x**2)*atan(sqrt(2)*sqrt(b)*x/sqrt(a - b*x**2))/(2*a*sqrt(b)*sqrt(a**2 - b**2*x**4)),
    ),
    RubiTestSuiteCase(
        integrand=1/((a + b*x**2)**(sympy.S(3)/2)*sqrt(a**2 - b**2*x**4)),
        variable=x,
        num_steps=4,
        integral=x*(a - b*x**2)/(4*a**2*sqrt(a + b*x**2)*sqrt(a**2 - b**2*x**4)) + 3*sqrt(2)*sqrt(a - b*x**2)*sqrt(a + b*x**2)*atan(sqrt(2)*sqrt(b)*x/sqrt(a - b*x**2))/(8*a**2*sqrt(b)*sqrt(a**2 - b**2*x**4)),
    ),
    RubiTestSuiteCase(
        integrand=1/((a + b*x**2)**(sympy.S(5)/2)*sqrt(a**2 - b**2*x**4)),
        variable=x,
        num_steps=6,
        integral=x*(a - b*x**2)/(8*a**2*(a + b*x**2)**(sympy.S(3)/2)*sqrt(a**2 - b**2*x**4)) + 9*x*(a - b*x**2)/(32*a**3*sqrt(a + b*x**2)*sqrt(a**2 - b**2*x**4)) + 19*sqrt(2)*sqrt(a - b*x**2)*sqrt(a + b*x**2)*atan(sqrt(2)*sqrt(b)*x/sqrt(a - b*x**2))/(64*a**3*sqrt(b)*sqrt(a**2 - b**2*x**4)),
    ),
    RubiTestSuiteCase(
        integrand=(a - b*x**2)**(sympy.S(5)/2)/sqrt(a**2 - b**2*x**4),
        variable=x,
        num_steps=5,
        integral=19*a**2*sqrt(a - b*x**2)*sqrt(a + b*x**2)*atanh(sqrt(b)*x/sqrt(a + b*x**2))/(8*sqrt(b)*sqrt(a**2 - b**2*x**4)) - 9*a*x*sqrt(a - b*x**2)*(a + b*x**2)/(8*sqrt(a**2 - b**2*x**4)) - x*(a - b*x**2)**(sympy.S(3)/2)*(a + b*x**2)/(4*sqrt(a**2 - b**2*x**4)),
    ),
    RubiTestSuiteCase(
        integrand=(a - b*x**2)**(sympy.S(3)/2)/sqrt(a**2 - b**2*x**4),
        variable=x,
        num_steps=4,
        integral=3*a*sqrt(a - b*x**2)*sqrt(a + b*x**2)*atanh(sqrt(b)*x/sqrt(a + b*x**2))/(2*sqrt(b)*sqrt(a**2 - b**2*x**4)) - x*sqrt(a - b*x**2)*(a + b*x**2)/(2*sqrt(a**2 - b**2*x**4)),
    ),
    RubiTestSuiteCase(
        integrand=sqrt(a - b*x**2)/sqrt(a**2 - b**2*x**4),
        variable=x,
        num_steps=3,
        integral=sqrt(a - b*x**2)*sqrt(a + b*x**2)*atanh(sqrt(b)*x/sqrt(a + b*x**2))/(sqrt(b)*sqrt(a**2 - b**2*x**4)),
    ),
    RubiTestSuiteCase(
        integrand=1/(sqrt(a - b*x**2)*sqrt(a**2 - b**2*x**4)),
        variable=x,
        num_steps=3,
        integral=sqrt(2)*sqrt(a - b*x**2)*sqrt(a + b*x**2)*atanh(sqrt(2)*sqrt(b)*x/sqrt(a + b*x**2))/(2*a*sqrt(b)*sqrt(a**2 - b**2*x**4)),
    ),
    RubiTestSuiteCase(
        integrand=1/((a - b*x**2)**(sympy.S(3)/2)*sqrt(a**2 - b**2*x**4)),
        variable=x,
        num_steps=4,
        integral=x*(a + b*x**2)/(4*a**2*sqrt(a - b*x**2)*sqrt(a**2 - b**2*x**4)) + 3*sqrt(2)*sqrt(a - b*x**2)*sqrt(a + b*x**2)*atanh(sqrt(2)*sqrt(b)*x/sqrt(a + b*x**2))/(8*a**2*sqrt(b)*sqrt(a**2 - b**2*x**4)),
    ),
    RubiTestSuiteCase(
        integrand=1/((a - b*x**2)**(sympy.S(5)/2)*sqrt(a**2 - b**2*x**4)),
        variable=x,
        num_steps=6,
        integral=x*(a + b*x**2)/(8*a**2*(a - b*x**2)**(sympy.S(3)/2)*sqrt(a**2 - b**2*x**4)) + 9*x*(a + b*x**2)/(32*a**3*sqrt(a - b*x**2)*sqrt(a**2 - b**2*x**4)) + 19*sqrt(2)*sqrt(a - b*x**2)*sqrt(a + b*x**2)*atanh(sqrt(2)*sqrt(b)*x/sqrt(a + b*x**2))/(64*a**3*sqrt(b)*sqrt(a**2 - b**2*x**4)),
    ),
    RubiTestSuiteCase(
        integrand=sqrt(x**2 - 1)/sqrt(x**4 - 1),
        variable=x,
        num_steps=2,
        integral=sqrt(x**2 - 1)*sqrt(x**2 + 1)*asinh(x)/sqrt(x**4 - 1),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)**4/(b*d*e + b*e**2*x**2 - c*d**2 + c*e**2*x**4),
        variable=x,
        num_steps=4,
        integral=e**2*x**5/(5*c) + e*x**3*(-b*e + 4*c*d)/(3*c**2) + x*(b**2*e**2 - 5*b*c*d*e + 7*c**2*d**2)/c**3 - (-b*e + 2*c*d)**3*atanh(sqrt(c)*sqrt(e)*x/sqrt(-b*e + c*d))/(c**(sympy.S(7)/2)*sqrt(e)*sqrt(-b*e + c*d)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)**3/(b*d*e + b*e**2*x**2 - c*d**2 + c*e**2*x**4),
        variable=x,
        num_steps=4,
        integral=e*x**3/(3*c) + x*(-b*e + 3*c*d)/c**2 - (-b*e + 2*c*d)**2*atanh(sqrt(c)*sqrt(e)*x/sqrt(-b*e + c*d))/(c**(sympy.S(5)/2)*sqrt(e)*sqrt(-b*e + c*d)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)**2/(b*d*e + b*e**2*x**2 - c*d**2 + c*e**2*x**4),
        variable=x,
        num_steps=3,
        integral=x/c - (-b*e + 2*c*d)*atanh(sqrt(c)*sqrt(e)*x/sqrt(-b*e + c*d))/(c**(sympy.S(3)/2)*sqrt(e)*sqrt(-b*e + c*d)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)/(b*d*e + b*e**2*x**2 - c*d**2 + c*e**2*x**4),
        variable=x,
        num_steps=2,
        integral=-atanh(sqrt(c)*sqrt(e)*x/sqrt(-b*e + c*d))/(sqrt(c)*sqrt(e)*sqrt(-b*e + c*d)),
    ),
    RubiTestSuiteCase(
        integrand=1/((d + e*x**2)*(b*d*e + b*e**2*x**2 - c*d**2 + c*e**2*x**4)),
        variable=x,
        num_steps=5,
        integral=-c**(sympy.S(3)/2)*atanh(sqrt(c)*sqrt(e)*x/sqrt(-b*e + c*d))/(sqrt(e)*sqrt(-b*e + c*d)*(-b*e + 2*c*d)**2) - x/(2*d*(d + e*x**2)*(-b*e + 2*c*d)) - (-b*e + 4*c*d)*atan(sqrt(e)*x/sqrt(d))/(2*d**(sympy.S(3)/2)*sqrt(e)*(-b*e + 2*c*d)**2),
    ),
    RubiTestSuiteCase(
        integrand=1/((d + e*x**2)**2*(b*d*e + b*e**2*x**2 - c*d**2 + c*e**2*x**4)),
        variable=x,
        num_steps=6,
        integral=-c**(sympy.S(5)/2)*atanh(sqrt(c)*sqrt(e)*x/sqrt(-b*e + c*d))/(sqrt(e)*sqrt(-b*e + c*d)*(-b*e + 2*c*d)**3) - x/(4*d*(d + e*x**2)**2*(-b*e + 2*c*d)) - x*(-3*b*e + 10*c*d)/(8*d**2*(d + e*x**2)*(-b*e + 2*c*d)**2) - (3*b**2*e**2 - 16*b*c*d*e + 28*c**2*d**2)*atan(sqrt(e)*x/sqrt(d))/(8*d**(sympy.S(5)/2)*sqrt(e)*(-b*e + 2*c*d)**3),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)**(sympy.S(5)/2)/(b*d*e + b*e**2*x**2 - c*d**2 + c*e**2*x**4),
        variable=x,
        num_steps=7,
        integral=x*sqrt(d + e*x**2)/(2*c) + (-2*b*e + 5*c*d)*atanh(sqrt(e)*x/sqrt(d + e*x**2))/(2*c**2*sqrt(e)) - (-b*e + 2*c*d)**(sympy.S(3)/2)*atanh(sqrt(e)*x*sqrt(-b*e + 2*c*d)/(sqrt(d + e*x**2)*sqrt(-b*e + c*d)))/(c**2*sqrt(e)*sqrt(-b*e + c*d)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)**(sympy.S(3)/2)/(b*d*e + b*e**2*x**2 - c*d**2 + c*e**2*x**4),
        variable=x,
        num_steps=6,
        integral=atanh(sqrt(e)*x/sqrt(d + e*x**2))/(c*sqrt(e)) - sqrt(-b*e + 2*c*d)*atanh(sqrt(e)*x*sqrt(-b*e + 2*c*d)/(sqrt(d + e*x**2)*sqrt(-b*e + c*d)))/(c*sqrt(e)*sqrt(-b*e + c*d)),
    ),
    RubiTestSuiteCase(
        integrand=sqrt(d + e*x**2)/(b*d*e + b*e**2*x**2 - c*d**2 + c*e**2*x**4),
        variable=x,
        num_steps=3,
        integral=-atanh(sqrt(e)*x*sqrt(-b*e + 2*c*d)/(sqrt(d + e*x**2)*sqrt(-b*e + c*d)))/(sqrt(e)*sqrt(-b*e + c*d)*sqrt(-b*e + 2*c*d)),
    ),
    RubiTestSuiteCase(
        integrand=1/(sqrt(d + e*x**2)*(b*d*e + b*e**2*x**2 - c*d**2 + c*e**2*x**4)),
        variable=x,
        num_steps=4,
        integral=-c*atanh(sqrt(e)*x*sqrt(-b*e + 2*c*d)/(sqrt(d + e*x**2)*sqrt(-b*e + c*d)))/(sqrt(e)*sqrt(-b*e + c*d)*(-b*e + 2*c*d)**(sympy.S(3)/2)) - x/(d*sqrt(d + e*x**2)*(-b*e + 2*c*d)),
    ),
    RubiTestSuiteCase(
        integrand=1/((d + e*x**2)**(sympy.S(3)/2)*(b*d*e + b*e**2*x**2 - c*d**2 + c*e**2*x**4)),
        variable=x,
        num_steps=6,
        integral=-c**2*atanh(sqrt(e)*x*sqrt(-b*e + 2*c*d)/(sqrt(d + e*x**2)*sqrt(-b*e + c*d)))/(sqrt(e)*sqrt(-b*e + c*d)*(-b*e + 2*c*d)**(sympy.S(5)/2)) - x/(3*d*(d + e*x**2)**(sympy.S(3)/2)*(-b*e + 2*c*d)) - x*(-2*b*e + 7*c*d)/(3*d**2*sqrt(d + e*x**2)*(-b*e + 2*c*d)**2),
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 1)**3*sqrt(x**4 + x**2 + 1),
        variable=x,
        num_steps=6,
        integral=x**3*(x**4 + x**2 + 1)**(sympy.S(3)/2)/9 + 2*x*(6*x**2 + 7)*sqrt(x**4 + x**2 + 1)/45 + x*(x**4 + x**2 + 1)**(sympy.S(3)/2)/3 + 26*x*sqrt(x**4 + x**2 + 1)/(45*x**2 + 45) + sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(7*x**2 + 7)*elliptic_f(2*atan(x), sympy.S(1)/4)/(15*sqrt(x**4 + x**2 + 1)) - sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(26*x**2 + 26)*elliptic_e(2*atan(x), sympy.S(1)/4)/(45*sqrt(x**4 + x**2 + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 1)**2*sqrt(x**4 + x**2 + 1),
        variable=x,
        num_steps=5,
        integral=2*x*(3*x**2 + 4)*sqrt(x**4 + x**2 + 1)/21 + x*(x**4 + x**2 + 1)**(sympy.S(3)/2)/7 + 2*x*sqrt(x**4 + x**2 + 1)/(3*x**2 + 3) - sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(2*x**2 + 2)*elliptic_e(2*atan(x), sympy.S(1)/4)/(3*sqrt(x**4 + x**2 + 1)) + sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(4*x**2 + 4)*elliptic_f(2*atan(x), sympy.S(1)/4)/(7*sqrt(x**4 + x**2 + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 1)*sqrt(x**4 + x**2 + 1),
        variable=x,
        num_steps=4,
        integral=x*(x**2 + 2)*sqrt(x**4 + x**2 + 1)/5 + 3*x*sqrt(x**4 + x**2 + 1)/(5*x**2 + 5) - sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(3*x**2 + 3)*elliptic_e(2*atan(x), sympy.S(1)/4)/(5*sqrt(x**4 + x**2 + 1)) + sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(3*x**2 + 3)*elliptic_f(2*atan(x), sympy.S(1)/4)/(5*sqrt(x**4 + x**2 + 1)),
    ),
    RubiTestSuiteCase(
        integrand=sqrt(x**4 + x**2 + 1)/(x**2 + 1),
        variable=x,
        num_steps=8,
        integral=x*sqrt(x**4 + x**2 + 1)/(x**2 + 1) - sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(x**2 + 1)*elliptic_e(2*atan(x), sympy.S(1)/4)/sqrt(x**4 + x**2 + 1) + sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(3*x**2 + 3)*elliptic_f(2*atan(x), sympy.S(1)/4)/(4*sqrt(x**4 + x**2 + 1)) + atan(x/sqrt(x**4 + x**2 + 1))/2,
    ),
    RubiTestSuiteCase(
        integrand=sqrt(x**4 + x**2 + 1)/(x**2 + 1)**2,
        variable=x,
        num_steps=1,
        integral=sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(x**2 + 1)*elliptic_e(2*atan(x), sympy.S(1)/4)/(2*sqrt(x**4 + x**2 + 1)),
    ),
    RubiTestSuiteCase(
        integrand=sqrt(x**4 + x**2 + 1)/(x**2 + 1)**3,
        variable=x,
        num_steps=23,
        integral=x*sqrt(x**4 + x**2 + 1)/(4*(x**2 + 1)**2) + sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(x**2 + 1)*elliptic_e(2*atan(x), sympy.S(1)/4)/(4*sqrt(x**4 + x**2 + 1)) + atan(x/sqrt(x**4 + x**2 + 1))/4,
    ),
    RubiTestSuiteCase(
        integrand=sqrt(x**4 + x**2 + 1)/(x**2 + 1)**4,
        variable=x,
        num_steps=26,
        integral=x*sqrt(x**4 + x**2 + 1)/(6*(x**2 + 1)**2) + x*sqrt(x**4 + x**2 + 1)/(6*(x**2 + 1)**3) + sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(x**2 + 1)*elliptic_e(2*atan(x), sympy.S(1)/4)/(3*sqrt(x**4 + x**2 + 1)) - sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(x**2 + 1)*elliptic_f(2*atan(x), sympy.S(1)/4)/(8*sqrt(x**4 + x**2 + 1)) + atan(x/sqrt(x**4 + x**2 + 1))/4,
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 1)**3/sqrt(x**4 + x**2 + 1),
        variable=x,
        num_steps=5,
        integral=x**3*sqrt(x**4 + x**2 + 1)/5 + 11*x*sqrt(x**4 + x**2 + 1)/15 + 14*x*sqrt(x**4 + x**2 + 1)/(15*x**2 + 15) + sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(3*x**2 + 3)*elliptic_f(2*atan(x), sympy.S(1)/4)/(5*sqrt(x**4 + x**2 + 1)) - sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(14*x**2 + 14)*elliptic_e(2*atan(x), sympy.S(1)/4)/(15*sqrt(x**4 + x**2 + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 1)**2/sqrt(x**4 + x**2 + 1),
        variable=x,
        num_steps=4,
        integral=x*sqrt(x**4 + x**2 + 1)/3 + 4*x*sqrt(x**4 + x**2 + 1)/(3*x**2 + 3) + sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(x**2 + 1)*elliptic_f(2*atan(x), sympy.S(1)/4)/sqrt(x**4 + x**2 + 1) - sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(4*x**2 + 4)*elliptic_e(2*atan(x), sympy.S(1)/4)/(3*sqrt(x**4 + x**2 + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 1)/sqrt(x**4 + x**2 + 1),
        variable=x,
        num_steps=3,
        integral=x*sqrt(x**4 + x**2 + 1)/(x**2 + 1) - sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(x**2 + 1)*elliptic_e(2*atan(x), sympy.S(1)/4)/sqrt(x**4 + x**2 + 1) + sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(x**2 + 1)*elliptic_f(2*atan(x), sympy.S(1)/4)/sqrt(x**4 + x**2 + 1),
    ),
    RubiTestSuiteCase(
        integrand=1/((x**2 + 1)*sqrt(x**4 + x**2 + 1)),
        variable=x,
        num_steps=4,
        integral=sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(x**2 + 1)*elliptic_f(2*atan(x), sympy.S(1)/4)/(4*sqrt(x**4 + x**2 + 1)) + atan(x/sqrt(x**4 + x**2 + 1))/2,
    ),
    RubiTestSuiteCase(
        integrand=1/((x**2 + 1)**2*sqrt(x**4 + x**2 + 1)),
        variable=x,
        num_steps=8,
        integral=sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(x**2 + 1)*elliptic_e(2*atan(x), sympy.S(1)/4)/(2*sqrt(x**4 + x**2 + 1)) - sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(x**2 + 1)*elliptic_f(2*atan(x), sympy.S(1)/4)/(4*sqrt(x**4 + x**2 + 1)) + atan(x/sqrt(x**4 + x**2 + 1))/2,
    ),
    RubiTestSuiteCase(
        integrand=1/((x**2 + 1)**3*sqrt(x**4 + x**2 + 1)),
        variable=x,
        num_steps=9,
        integral=x*sqrt(x**4 + x**2 + 1)/(4*(x**2 + 1)**2) - sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(x**2 + 1)*elliptic_f(2*atan(x), sympy.S(1)/4)/(2*sqrt(x**4 + x**2 + 1)) + sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(3*x**2 + 3)*elliptic_e(2*atan(x), sympy.S(1)/4)/(4*sqrt(x**4 + x**2 + 1)) + atan(x/sqrt(x**4 + x**2 + 1))/4,
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 1)**3/(x**4 + x**2 + 1)**(sympy.S(3)/2),
        variable=x,
        num_steps=4,
        integral=-x*(1 - x**2)/(3*sqrt(x**4 + x**2 + 1)) + 2*x*sqrt(x**4 + x**2 + 1)/(3*x**2 + 3) + sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(x**2 + 1)*elliptic_f(2*atan(x), sympy.S(1)/4)/sqrt(x**4 + x**2 + 1) - sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(2*x**2 + 2)*elliptic_e(2*atan(x), sympy.S(1)/4)/(3*sqrt(x**4 + x**2 + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 1)**2/(x**4 + x**2 + 1)**(sympy.S(3)/2),
        variable=x,
        num_steps=2,
        integral=x*(2*x**2 + 1)/(3*sqrt(x**4 + x**2 + 1)) - 2*x*sqrt(x**4 + x**2 + 1)/(3*x**2 + 3) + sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(2*x**2 + 2)*elliptic_e(2*atan(x), sympy.S(1)/4)/(3*sqrt(x**4 + x**2 + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(x**2 + 1)/(x**4 + x**2 + 1)**(sympy.S(3)/2),
        variable=x,
        num_steps=2,
        integral=x*(x**2 + 2)/(3*sqrt(x**4 + x**2 + 1)) - x*sqrt(x**4 + x**2 + 1)/(3*x**2 + 3) + sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(x**2 + 1)*elliptic_e(2*atan(x), sympy.S(1)/4)/(3*sqrt(x**4 + x**2 + 1)),
    ),
    RubiTestSuiteCase(
        integrand=1/((x**2 + 1)*(x**4 + x**2 + 1)**(sympy.S(3)/2)),
        variable=x,
        num_steps=9,
        integral=-x*(2*x**2 + 1)/(3*sqrt(x**4 + x**2 + 1)) + 2*x*sqrt(x**4 + x**2 + 1)/(3*x**2 + 3) - sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(2*x**2 + 2)*elliptic_e(2*atan(x), sympy.S(1)/4)/(3*sqrt(x**4 + x**2 + 1)) + sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(3*x**2 + 3)*elliptic_f(2*atan(x), sympy.S(1)/4)/(4*sqrt(x**4 + x**2 + 1)) + atan(x/sqrt(x**4 + x**2 + 1))/2,
    ),
    RubiTestSuiteCase(
        integrand=1/((x**2 + 1)**2*(x**4 + x**2 + 1)**(sympy.S(3)/2)),
        variable=x,
        num_steps=16,
        integral=-x*(x**2 + 2)/(3*sqrt(x**4 + x**2 + 1)) + x*sqrt(x**4 + x**2 + 1)/(3*x**2 + 3) + sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(x**2 + 1)*elliptic_e(2*atan(x), sympy.S(1)/4)/(6*sqrt(x**4 + x**2 + 1)) + atan(x/sqrt(x**4 + x**2 + 1)),
    ),
    RubiTestSuiteCase(
        integrand=1/((x**2 + 1)**3*(x**4 + x**2 + 1)**(sympy.S(3)/2)),
        variable=x,
        num_steps=23,
        integral=-x*(1 - x**2)/(3*sqrt(x**4 + x**2 + 1)) - x*sqrt(x**4 + x**2 + 1)/(3*x**2 + 3) + x*sqrt(x**4 + x**2 + 1)/(4*(x**2 + 1)**2) - sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(5*x**2 + 5)*elliptic_f(2*atan(x), sympy.S(1)/4)/(4*sqrt(x**4 + x**2 + 1)) + sqrt((x**4 + x**2 + 1)/(x**2 + 1)**2)*(19*x**2 + 19)*elliptic_e(2*atan(x), sympy.S(1)/4)/(12*sqrt(x**4 + x**2 + 1)) + 3*atan(x/sqrt(x**4 + x**2 + 1))/4,
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)**4*(a + b*x**2 + c*x**4),
        variable=x,
        num_steps=2,
        integral=a*d**4*x + c*e**4*x**13/13 + d**3*x**3*(4*a*e + b*d)/3 + d**2*x**5*(6*a*e**2 + 4*b*d*e + c*d**2)/5 + 2*d*e*x**7*(2*c*d**2 + e*(2*a*e + 3*b*d))/7 + e**3*x**11*(b*e + 4*c*d)/11 + e**2*x**9*(6*c*d**2 + e*(a*e + 4*b*d))/9,
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)**3*(a + b*x**2 + c*x**4),
        variable=x,
        num_steps=2,
        integral=a*d**3*x + c*e**3*x**11/11 + d**2*x**3*(3*a*e + b*d)/3 + d*x**5*(c*d**2 + 3*e*(a*e + b*d))/5 + e**2*x**9*(b*e + 3*c*d)/9 + e*x**7*(3*c*d**2 + e*(a*e + 3*b*d))/7,
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)**2*(a + b*x**2 + c*x**4),
        variable=x,
        num_steps=2,
        integral=a*d**2*x + c*e**2*x**9/9 + d*x**3*(2*a*e + b*d)/3 + e*x**7*(b*e + 2*c*d)/7 + x**5*(c*d**2 + e*(a*e + 2*b*d))/5,
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)*(a + b*x**2 + c*x**4),
        variable=x,
        num_steps=2,
        integral=a*d*x + c*e*x**7/7 + x**5*(b*e + c*d)/5 + x**3*(a*e + b*d)/3,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**2 + c*x**4)/(d + e*x**2),
        variable=x,
        num_steps=3,
        integral=c*x**3/(3*e) - x*(-b*e + c*d)/e**2 + (a*e**2 - b*d*e + c*d**2)*atan(sqrt(e)*x/sqrt(d))/(sqrt(d)*e**(sympy.S(5)/2)),
    ),
    RubiTestSuiteCase(
    ...
    RubiTestSuiteCase(
        integrand=(a + b*x**2 + c*x**4)/(d + e*x**2)**4,
        variable=x,
        num_steps=4,
        integral=x*(a + d*(-b*e + c*d)/e**2)/(6*d*(d + e*x**2)**3) - x*(7*c*d**2 - e*(5*a*e + b*d))/(24*d**2*e**2*(d + e*x**2)**2) + x*(c*d**2 + e*(5*a*e + b*d))/(16*d**3*e**2*(d + e*x**2)) + (c*d**2 + e*(5*a*e + b*d))*atan(sqrt(e)*x/sqrt(d))/(16*d**(sympy.S(7)/2)*e**(sympy.S(5)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)**3*(a + b*x**2 + c*x**4)**2,
        variable=x,
        num_steps=2,
        integral=a**2*d**3*x + a*d**2*x**3*(3*a*e + 2*b*d)/3 + c**2*e**3*x**15/15 + c*e**2*x**13*(2*b*e + 3*c*d)/13 + d*x**5*(6*a*b*d*e + a*(3*a*e**2 + 2*c*d**2) + b**2*d**2)/5 + e*x**11*(b**2*e**2 + 3*c**2*d**2 + 2*c*e*(a*e + 3*b*d))/11 + x**9*(b*e**2*(2*a*e + 3*b*d)/9 + c**2*d**3/9 + 2*c*d*e*(a*e + b*d)/3) + x**7*(a**2*e**3/7 + 6*a*b*d*e**2/7 + 6*a*c*d**2*e/7 + 3*b**2*d**2*e/7 + 2*b*c*d**3/7),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)**2*(a + b*x**2 + c*x**4)**2,
        variable=x,
        num_steps=2,
        integral=a**2*d**2*x + 2*a*d*x**3*(a*e + b*d)/3 + c**2*e**2*x**13/13 + 2*c*e*x**11*(b*e + c*d)/11 + x**9*(b**2*e**2/9 + c**2*d**2/9 + 2*c*e*(a*e + 2*b*d)/9) + x**7*(2*a*b*e**2/7 + 4*a*c*d*e/7 + 2*b**2*d*e/7 + 2*b*c*d**2/7) + x**5*(4*a*b*d*e/5 + a*(a*e**2 + 2*c*d**2)/5 + b**2*d**2/5),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)*(a + b*x**2 + c*x**4)**2,
        variable=x,
        num_steps=2,
        integral=a**2*d*x + a*x**3*(a*e + 2*b*d)/3 + c**2*e*x**11/11 + c*x**9*(2*b*e + c*d)/9 + x**7*(2*a*c*e/7 + b**2*e/7 + 2*b*c*d/7) + x**5*(2*a*b*e/5 + 2*a*c*d/5 + b**2*d/5),
    ),
    RubiTestSuiteCase(
    ...
    RubiTestSuiteCase(
        integrand=(a + b*x**2 + c*x**4)**2/(d + e*x**2),
        variable=x,
        num_steps=3,
        integral=c**2*x**7/(7*e) - c*x**5*(-2*b*e + c*d)/(5*e**2) + x**3*(b**2*e**2 + c**2*d**2 - 2*c*e*(-a*e + b*d))/(3*e**3) - x*(-b*e + c*d)*(c*d**2 - e*(-2*a*e + b*d))/e**4 + (a*e**2 - b*d*e + c*d**2)**2*atan(sqrt(e)*x/sqrt(d))/(sqrt(d)*e**(sympy.S(9)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**2 + c*x**4)**2/(d + e*x**2)**2,
        variable=x,
        num_steps=4,
        integral=c**2*x**5/(5*e**2) - 2*c*x**3*(-b*e + c*d)/(3*e**3) + x*(b**2*e**2 + 3*c**2*d**2 - 2*c*e*(-a*e + 2*b*d))/e**4 + x*(a*e**2 - b*d*e + c*d**2)**2/(2*d*e**4*(d + e*x**2)) - (7*c*d**2 - e*(a*e + 3*b*d))*(a*e**2 - b*d*e + c*d**2)*atan(sqrt(e)*x/sqrt(d))/(2*d**(sympy.S(3)/2)*e**(sympy.S(9)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**2 + c*x**4)**2/(d + e*x**2)**3,
        variable=x,
        num_steps=5,
        integral=c**2*x**3/(3*e**3) - c*x*(-2*b*e + 3*c*d)/e**4 + x*(a*e**2 - b*d*e + c*d**2)**2/(4*d*e**4*(d + e*x**2)**2) - x*(-3*a*e**2 - 5*b*d*e + 13*c*d**2)*(a*e**2 - b*d*e + c*d**2)/(8*d**2*e**4*(d + e*x**2)) + (35*c**2*d**4 - 6*c*d**2*e*(-a*e + 5*b*d) + e**2*(3*a**2*e**2 + 2*a*b*d*e + 3*b**2*d**2))*atan(sqrt(e)*x/sqrt(d))/(8*d**(sympy.S(5)/2)*e**(sympy.S(9)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**2 + c*x**4)**2/(d + e*x**2)**4,
        variable=x,
        num_steps=5,
        integral=c**2*x/e**4 + x*(a*e**2 - b*d*e + c*d**2)**2/(6*d*e**4*(d + e*x**2)**3) - x*(-5*a*e**2 - 7*b*d*e + 19*c*d**2)*(a*e**2 - b*d*e + c*d**2)/(24*d**2*e**4*(d + e*x**2)**2) + x*(29*c**2*d**4 - 2*c*d**2*e*(-a*e + 11*b*d) + e**2*(5*a**2*e**2 + 2*a*b*d*e + b**2*d**2))/(16*d**3*e**4*(d + e*x**2)) - (35*c**2*d**4 - 2*c*d**2*e*(a*e + 5*b*d) - e**2*(5*a**2*e**2 + 2*a*b*d*e + b**2*d**2))*atan(sqrt(e)*x/sqrt(d))/(16*d**(sympy.S(7)/2)*e**(sympy.S(9)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**2 + c*x**4)**2/(d + e*x**2)**5,
        variable=x,
        num_steps=5,
    ...
    RubiTestSuiteCase(
        integrand=(a + x**2*(b + c*x**2))/(d + e*x**2)**2,
        variable=x,
        num_steps=3,
        integral=c*x/e**2 + x*(a + d*(-b*e + c*d)/e**2)/(2*d*(d + e*x**2)) - (3*c*d**2 - e*(a*e + b*d))*atan(sqrt(e)*x/sqrt(d))/(2*d**(sympy.S(3)/2)*e**(sympy.S(5)/2)),
    ),
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=5,
        integral=e**2*x/c + sqrt(2)*(e*(-b*e + 2*c*d) - (b**2*e**2 + 2*c**2*d**2 - 2*c*e*(a*e + b*d))/sqrt(-4*a*c + b**2))*atan(sqrt(2)*sqrt(c)*x/sqrt(b + sqrt(-4*a*c + b**2)))/(2*c**(sympy.S(3)/2)*sqrt(b + sqrt(-4*a*c + b**2))) + sqrt(2)*(e*(-b*e + 2*c*d) + (b**2*e**2 + 2*c**2*d**2 - 2*c*e*(a*e + b*d))/sqrt(-4*a*c + b**2))*atan(sqrt(2)*sqrt(c)*x/sqrt(b - sqrt(-4*a*c + b**2)))/(2*c**(sympy.S(3)/2)*sqrt(b - sqrt(-4*a*c + b**2))),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)/(a + b*x**2 + c*x**4),
        variable=x,
        num_steps=3,
        integral=sqrt(2)*(e - (-b*e + 2*c*d)/sqrt(-4*a*c + b**2))*atan(sqrt(2)*sqrt(c)*x/sqrt(b + sqrt(-4*a*c + b**2)))/(2*sqrt(c)*sqrt(b + sqrt(-4*a*c + b**2))) + sqrt(2)*(e + (-b*e + 2*c*d)/sqrt(-4*a*c + b**2))*atan(sqrt(2)*sqrt(c)*x/sqrt(b - sqrt(-4*a*c + b**2)))/(2*sqrt(c)*sqrt(b - sqrt(-4*a*c + b**2))),
    ),
    RubiTestSuiteCase(
    ...
    RubiTestSuiteCase(
        integrand=1/((d + e*x**2)**2*(a + b*x**2 + c*x**4)),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=1/((d + e*x**2)*(a + b*x**2 + c*x**4)**2),
        variable=x,
        num_steps=10,
    ...
    RubiTestSuiteCase(
        integrand=1/((d + e*x**2)**2*(a + b*x**2 + c*x**4)**2),
        variable=x,
        num_steps=12,
    ...
    RubiTestSuiteCase(
        integrand=(5*x**2 + 7)**4*(-x**4 + x**2 + 2)**(sympy.S(3)/2),
        variable=x,
        num_steps=9,
        integral=-125*x**5*(-x**4 + x**2 + 2)**(sympy.S(5)/2)/3 - 11750*x**3*(-x**4 + x**2 + 2)**(sympy.S(5)/2)/39 - x*(69817 - 1581440*x**2)*(-x**4 + x**2 + 2)**(sympy.S(3)/2)/1001 + 3*x*(7837383*x**2 + 2193559)*sqrt(-x**4 + x**2 + 2)/5005 - 132300*x*(-x**4 + x**2 + 2)**(sympy.S(5)/2)/143 + 124141422*elliptic_e(asin(sqrt(2)*x/2), -2)/5005 - 50794416*elliptic_f(asin(sqrt(2)*x/2), -2)/5005,
    ),
    RubiTestSuiteCase(
        integrand=(5*x**2 + 7)**3*(-x**4 + x**2 + 2)**(sympy.S(3)/2),
        variable=x,
        num_steps=8,
        integral=-125*x**3*(-x**4 + x**2 + 2)**(sympy.S(5)/2)/13 + x*(374045*x**2 + 33792)*(-x**4 + x**2 + 2)**(sympy.S(3)/2)/3003 + x*(5712051*x**2 + 2512273)*sqrt(-x**4 + x**2 + 2)/15015 - 7825*x*(-x**4 + x**2 + 2)**(sympy.S(5)/2)/143 + 31072528*elliptic_e(asin(sqrt(2)*x/2), -2)/15015 - 3199778*elliptic_f(asin(sqrt(2)*x/2), -2)/5005,
    ),
    RubiTestSuiteCase(
        integrand=(5*x**2 + 7)**2*(-x**4 + x**2 + 2)**(sympy.S(3)/2),
        variable=x,
        num_steps=7,
        integral=x*(920*x**2 + 363)*(-x**4 + x**2 + 2)**(sympy.S(3)/2)/99 + x*(14889*x**2 + 11497)*sqrt(-x**4 + x**2 + 2)/495 - 25*x*(-x**4 + x**2 + 2)**(sympy.S(5)/2)/11 + 85942*elliptic_e(asin(sqrt(2)*x/2), -2)/495 - 3392*elliptic_f(asin(sqrt(2)*x/2), -2)/165,
    ),
    RubiTestSuiteCase(
        integrand=(5*x**2 + 7)*(-x**4 + x**2 + 2)**(sympy.S(3)/2),
        variable=x,
        num_steps=6,
        integral=x*(35*x**2 + 48)*(-x**4 + x**2 + 2)**(sympy.S(3)/2)/63 + x*(669*x**2 + 1087)*sqrt(-x**4 + x**2 + 2)/315 + 4432*elliptic_e(asin(sqrt(2)*x/2), -2)/315 + 418*elliptic_f(asin(sqrt(2)*x/2), -2)/105,
    ),
    RubiTestSuiteCase(
        integrand=(-x**4 + x**2 + 2)**(sympy.S(3)/2),
        variable=x,
        num_steps=6,
        integral=x*(3*x**2 + 19)*sqrt(-x**4 + x**2 + 2)/35 + x*(-x**4 + x**2 + 2)**(sympy.S(3)/2)/7 + 34*elliptic_e(asin(sqrt(2)*x/2), -2)/35 + 48*elliptic_f(asin(sqrt(2)*x/2), -2)/35,
    ),
    RubiTestSuiteCase(
        integrand=(-x**4 + x**2 + 2)**(sympy.S(3)/2)/(5*x**2 + 7),
        variable=x,
        num_steps=13,
        integral=(((Integer(75))**(Integer(-1)) * x * (Integer(13) + (Integer(-1) * (Integer(3) * (x)**(Integer(2))))) * sympy.sqrt((Integer(2) + (x)**(Integer(2)) + (Integer(-1) * (x)**(Integer(4)))))) + ((Integer(92) * (Integer(375))**(Integer(-1))) * sympy.elliptic_e(sympy.asin((x * (sympy.sqrt(Integer(2)))**(Integer(-1)))), Integer(-2))) + (Integer(-1) * ((Integer(178) * (Integer(625))**(Integer(-1))) * sympy.elliptic_f(sympy.asin((x * (sympy.sqrt(Integer(2)))**(Integer(-1)))), Integer(-2)))) + ((Integer(1156) * sympy.Function('EllipticPi')((Integer(-1) * (Integer(10) * (Integer(7))**(Integer(-1)))), sympy.asin((x * (sympy.sqrt(Integer(2)))**(Integer(-1)))), Integer(-2))) * (Integer(4375))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(-x**4 + x**2 + 2)**(sympy.S(3)/2)/(5*x**2 + 7)**2,
        variable=x,
        num_steps=21,
        integral=(((Integer(-1) * (Integer(75))**(Integer(-1))) * x * sympy.sqrt((Integer(2) + (x)**(Integer(2)) + (Integer(-1) * (x)**(Integer(4)))))) + (Integer(-1) * ((Integer(17) * x * sympy.sqrt((Integer(2) + (x)**(Integer(2)) + (Integer(-1) * (x)**(Integer(4)))))) * ((Integer(175) * (Integer(7) + (Integer(5) * (x)**(Integer(2))))))**(Integer(-1)))) + (Integer(-1) * ((Integer(97) * (Integer(525))**(Integer(-1))) * sympy.elliptic_e(sympy.asin((x * (sympy.sqrt(Integer(2)))**(Integer(-1)))), Integer(-2)))) + ((Integer(458) * (Integer(875))**(Integer(-1))) * sympy.elliptic_f(sympy.asin((x * (sympy.sqrt(Integer(2)))**(Integer(-1)))), Integer(-2))) + (Integer(-1) * ((Integer(1241) * sympy.Function('EllipticPi')((Integer(-1) * (Integer(10) * (Integer(7))**(Integer(-1)))), sympy.asin((x * (sympy.sqrt(Integer(2)))**(Integer(-1)))), Integer(-2))) * (Integer(6125))**(Integer(-1))))),
    ),
    RubiTestSuiteCase(
        integrand=(-x**4 + x**2 + 2)**(sympy.S(3)/2)/(5*x**2 + 7)**3,
        variable=x,
        num_steps=27,
        integral=((Integer(-1) * ((Integer(17) * x * sympy.sqrt((Integer(2) + (x)**(Integer(2)) + (Integer(-1) * (x)**(Integer(4)))))) * ((Integer(350) * ((Integer(7) + (Integer(5) * (x)**(Integer(2)))))**(Integer(2))))**(Integer(-1)))) + ((Integer(563) * x * sympy.sqrt((Integer(2) + (x)**(Integer(2)) + (Integer(-1) * (x)**(Integer(4)))))) * ((Integer(9800) * (Integer(7) + (Integer(5) * (x)**(Integer(2))))))**(Integer(-1))) + ((Integer(191) * sympy.elliptic_e(sympy.asin((x * (sympy.sqrt(Integer(2)))**(Integer(-1)))), Integer(-2))) * (Integer(9800))**(Integer(-1))) + (Integer(-1) * ((Integer(1251) * sympy.elliptic_f(sympy.asin((x * (sympy.sqrt(Integer(2)))**(Integer(-1)))), Integer(-2))) * (Integer(24500))**(Integer(-1)))) + ((Integer(9879) * sympy.Function('EllipticPi')((Integer(-1) * (Integer(10) * (Integer(7))**(Integer(-1)))), sympy.asin((x * (sympy.sqrt(Integer(2)))**(Integer(-1)))), Integer(-2))) * (Integer(343000))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(5*x**2 + 7)**3/sqrt(-x**4 + x**2 + 2),
        variable=x,
        num_steps=6,
        integral=-25*x**3*sqrt(-x**4 + x**2 + 2) - 625*x*sqrt(-x**4 + x**2 + 2)/3 + 3905*elliptic_e(asin(sqrt(2)*x/2), -2)/3 - 542*elliptic_f(asin(sqrt(2)*x/2), -2),
    ),
    RubiTestSuiteCase(
        integrand=(5*x**2 + 7)**2/sqrt(-x**4 + x**2 + 2),
        variable=x,
        num_steps=5,
        integral=-25*x*sqrt(-x**4 + x**2 + 2)/3 + 260*elliptic_e(asin(sqrt(2)*x/2), -2)/3 - 21*elliptic_f(asin(sqrt(2)*x/2), -2),
    ),
    RubiTestSuiteCase(
        integrand=(5*x**2 + 7)/sqrt(-x**4 + x**2 + 2),
        variable=x,
        num_steps=4,
        integral=5*elliptic_e(asin(sqrt(2)*x/2), -2) + 2*elliptic_f(asin(sqrt(2)*x/2), -2),
    ),
    RubiTestSuiteCase(
        integrand=1/sqrt(-x**4 + x**2 + 2),
        variable=x,
        num_steps=2,
        integral=elliptic_f(asin(sqrt(2)*x/2), -2),
    ),
    RubiTestSuiteCase(
        integrand=1/((5*x**2 + 7)*sqrt(-x**4 + x**2 + 2)),
        variable=x,
        num_steps=2,
        integral=((Integer(7))**(Integer(-1)) * sympy.Function('EllipticPi')((Integer(-1) * (Integer(10) * (Integer(7))**(Integer(-1)))), sympy.asin((x * (sympy.sqrt(Integer(2)))**(Integer(-1)))), Integer(-2))),
    ),
    RubiTestSuiteCase(
        integrand=1/((5*x**2 + 7)**2*sqrt(-x**4 + x**2 + 2)),
        variable=x,
        num_steps=8,
        integral=((Integer(-1) * ((Integer(25) * x * sympy.sqrt((Integer(2) + (x)**(Integer(2)) + (Integer(-1) * (x)**(Integer(4)))))) * ((Integer(476) * (Integer(7) + (Integer(5) * (x)**(Integer(2))))))**(Integer(-1)))) + (Integer(-1) * ((Integer(5) * (Integer(476))**(Integer(-1))) * sympy.elliptic_e(sympy.asin((x * (sympy.sqrt(Integer(2)))**(Integer(-1)))), Integer(-2)))) + (Integer(-1) * ((Integer(238))**(Integer(-1)) * sympy.elliptic_f(sympy.asin((x * (sympy.sqrt(Integer(2)))**(Integer(-1)))), Integer(-2)))) + ((Integer(167) * sympy.Function('EllipticPi')((Integer(-1) * (Integer(10) * (Integer(7))**(Integer(-1)))), sympy.asin((x * (sympy.sqrt(Integer(2)))**(Integer(-1)))), Integer(-2))) * (Integer(3332))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=1/((5*x**2 + 7)**3*sqrt(-x**4 + x**2 + 2)),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=1/((d + e*x**2)*sqrt(a + b*x**2 + c*x**4)),
        variable=x,
        num_steps=3,
    ...
    RubiTestSuiteCase(
        integrand=1/((d + e*x**2)**2*sqrt(a + b*x**2 + c*x**4)),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(d + e*x**2)**3/sqrt(x**4 + 3*x**2 + 2),
        variable=x,
        num_steps=5,
        integral=e**3*x**3*sqrt(x**4 + 3*x**2 + 2)/5 + e**2*x*(d - 4*e/5)*sqrt(x**4 + 3*x**2 + 2) + 3*e*x*(x**2 + 2)*(5*d**2 - 10*d*e + 6*e**2)/(5*sqrt(x**4 + 3*x**2 + 2)) - 3*sqrt(2)*e*sqrt((x**2 + 2)/(x**2 + 1))*(x**2 + 1)*(5*d**2 - 10*d*e + 6*e**2)*elliptic_e(atan(x), sympy.S.Half)/(5*sqrt(x**4 + 3*x**2 + 2)) + sqrt(2)*sqrt((x**2 + 2)/(x**2 + 1))*(x**2 + 1)*(5*d**3 - 10*d*e**2 + 8*e**3)*elliptic_f(atan(x), sympy.S.Half)/(10*sqrt(x**4 + 3*x**2 + 2)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)**2/sqrt(x**4 + 3*x**2 + 2),
        variable=x,
        num_steps=4,
        integral=e**2*x*sqrt(x**4 + 3*x**2 + 2)/3 + e*x*(2*d - 2*e)*(x**2 + 2)/sqrt(x**4 + 3*x**2 + 2) - 2*sqrt(2)*e*sqrt((x**2 + 2)/(x**2 + 1))*(d - e)*(x**2 + 1)*elliptic_e(atan(x), sympy.S.Half)/sqrt(x**4 + 3*x**2 + 2) + sqrt(2)*sqrt((x**2 + 2)/(x**2 + 1))*(3*d**2 - 2*e**2)*(x**2 + 1)*elliptic_f(atan(x), sympy.S.Half)/(6*sqrt(x**4 + 3*x**2 + 2)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**2)/sqrt(x**4 + 3*x**2 + 2),
        variable=x,
        num_steps=3,
        integral=sqrt(2)*d*sqrt((x**2 + 2)/(x**2 + 1))*(x**2 + 1)*elliptic_f(atan(x), sympy.S.Half)/(2*sqrt(x**4 + 3*x**2 + 2)) + e*x*(x**2 + 2)/sqrt(x**4 + 3*x**2 + 2) - sqrt(2)*e*sqrt((x**2 + 2)/(x**2 + 1))*(x**2 + 1)*elliptic_e(atan(x), sympy.S.Half)/sqrt(x**4 + 3*x**2 + 2),
    ),
    RubiTestSuiteCase(
        integrand=(c + e*x**2)**q*(a + b*x**4 + c*x**2)**p,
        variable=x,
        num_steps=0,
        integral=sympy.Function('Unintegrable')((((Symbol('c') + (Symbol('e') * (x)**(Integer(2)))))**(Symbol('q')) * ((Symbol('a') + (Symbol('c') * (x)**(Integer(2))) + (Symbol('b') * (x)**(Integer(4)))))**(Symbol('p'))), x),
    ),
    RubiTestSuiteCase(
        integrand=(c + e*x**2)**3*(a + b*x**4 + c*x**2)**p,
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(c + e*x**2)**2*(a + b*x**4 + c*x**2)**p,
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(2*x - sqrt(3) + 1)/((2*x + 1 + sqrt(3))*sqrt(4*x**4 + 4*sqrt(3)*x**2 - 1)),
        variable=x,
        num_steps=2,
        integral=sqrt(-3 + 2*sqrt(3))*atanh((2*x - sqrt(3) + 1)**2/(2*sqrt(-9 + 6*sqrt(3))*sqrt(4*x**4 + 4*sqrt(3)*x**2 - 1)))/3,
    ),
    RubiTestSuiteCase(
        integrand=(2*x + 1 + sqrt(3))/((2*x - sqrt(3) + 1)*sqrt(4*x**4 - 4*sqrt(3)*x**2 - 1)),
        variable=x,
        num_steps=2,
        integral=-sqrt(3 + 2*sqrt(3))*atan((2*x + 1 + sqrt(3))**2/(2*sqrt(9 + 6*sqrt(3))*sqrt(4*x**4 - 4*sqrt(3)*x**2 - 1)))/3,
    ),
    RubiTestSuiteCase(
        integrand=(f + g*x)/((d + e*x)*sqrt(a + b*x**2 + c*x**4)),
        variable=x,
        num_steps=8,
