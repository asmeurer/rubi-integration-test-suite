...
SOURCE_FILE = '1 Algebraic functions/1.2 Trinomial products/1.2.3 General/1.2.3.5 P(x) (d x)^m (a+b x^n+c x^(2 n))^p.m'
...
TEST_CASES = [
    ...
    RubiTestSuiteCase(
        integrand=(d + e*x)/(a + b*x**n + c*x**(2*n)),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(d + e*x + f*x**2)/(a + b*x**n + c*x**(2*n)),
        variable=x,
        num_steps=11,
    ...
    RubiTestSuiteCase(
        integrand=(d + e*x + f*x**2 + g*x**3)/(a + b*x**n + c*x**(2*n)),
        variable=x,
        num_steps=13,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*x**n + c*x**(2*n))**(-2),
        variable=x,
        num_steps=4,
        integral=-c*x*(4*a*c*(1 - 2*n) - b**2*(1 - n) + b*(1 - n)*sqrt(-4*a*c + b**2))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(a*n*(-4*a*c + b**2)*(-4*a*c + b**2 + b*sqrt(-4*a*c + b**2))) - c*x*(4*a*c*(1 - 2*n) - b**2*(1 - n) - b*(1 - n)*sqrt(-4*a*c + b**2))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(a*n*(-4*a*c + b**2)*(-4*a*c + b**2 - b*sqrt(-4*a*c + b**2))) + x*(-2*a*c + b**2 + b*c*x**n)/(a*n*(-4*a*c + b**2)*(a + b*x**n + c*x**(2*n))),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x)/(a + b*x**n + c*x**(2*n))**2,
        variable=x,
        num_steps=15,
        integral=2*b*c**2*e*x**(n + 2)*(2 - n)*hyper((1, (n + 2)/n), (2 + 2/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(a*n*(b + sqrt(-4*a*c + b**2))*(n + 2)*(-4*a*c + b**2)**(sympy.S(3)/2)) - 2*b*c**2*e*x**(n + 2)*(2 - n)*hyper((1, (n + 2)/n), (2 + 2/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(a*n*(b - sqrt(-4*a*c + b**2))*(n + 2)*(-4*a*c + b**2)**(sympy.S(3)/2)) - c*d*x*(4*a*c*(1 - 2*n) - b**2*(1 - n) + b*(1 - n)*sqrt(-4*a*c + b**2))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(a*n*(-4*a*c + b**2)*(-4*a*c + b**2 + b*sqrt(-4*a*c + b**2))) - c*d*x*(4*a*c*(1 - 2*n) - b**2*(1 - n) - b*(1 - n)*sqrt(-4*a*c + b**2))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(a*n*(-4*a*c + b**2)*(-4*a*c + b**2 - b*sqrt(-4*a*c + b**2))) - c*e*x**2*(4*a*c*(1 - n) - b**2*(2 - n))*hyper((1, 2/n), ((n + 2)/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(a*n*(-4*a*c + b**2)*(-4*a*c + b**2 + b*sqrt(-4*a*c + b**2))) - c*e*x**2*(4*a*c*(1 - n) - b**2*(2 - n))*hyper((1, 2/n), ((n + 2)/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(a*n*(-4*a*c + b**2)*(-4*a*c + b**2 - b*sqrt(-4*a*c + b**2))) + d*x*(-2*a*c + b**2 + b*c*x**n)/(a*n*(-4*a*c + b**2)*(a + b*x**n + c*x**(2*n))) + e*x**2*(-2*a*c + b**2 + b*c*x**n)/(a*n*(-4*a*c + b**2)*(a + b*x**n + c*x**(2*n))),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x + f*x**2)/(a + b*x**n + c*x**(2*n))**2,
        variable=x,
        num_steps=24,
        integral=2*b*c**2*e*x**(n + 2)*(2 - n)*hyper((1, (n + 2)/n), (2 + 2/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(a*n*(b + sqrt(-4*a*c + b**2))*(n + 2)*(-4*a*c + b**2)**(sympy.S(3)/2)) - 2*b*c**2*e*x**(n + 2)*(2 - n)*hyper((1, (n + 2)/n), (2 + 2/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(a*n*(b - sqrt(-4*a*c + b**2))*(n + 2)*(-4*a*c + b**2)**(sympy.S(3)/2)) + 2*b*c**2*f*x**(n + 3)*(3 - n)*hyper((1, (n + 3)/n), (2 + 3/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(a*n*(b + sqrt(-4*a*c + b**2))*(n + 3)*(-4*a*c + b**2)**(sympy.S(3)/2)) - 2*b*c**2*f*x**(n + 3)*(3 - n)*hyper((1, (n + 3)/n), (2 + 3/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(a*n*(b - sqrt(-4*a*c + b**2))*(n + 3)*(-4*a*c + b**2)**(sympy.S(3)/2)) - c*d*x*(4*a*c*(1 - 2*n) - b**2*(1 - n) + b*(1 - n)*sqrt(-4*a*c + b**2))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(a*n*(-4*a*c + b**2)*(-4*a*c + b**2 + b*sqrt(-4*a*c + b**2))) - c*d*x*(4*a*c*(1 - 2*n) - b**2*(1 - n) - b*(1 - n)*sqrt(-4*a*c + b**2))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(a*n*(-4*a*c + b**2)*(-4*a*c + b**2 - b*sqrt(-4*a*c + b**2))) - c*e*x**2*(4*a*c*(1 - n) - b**2*(2 - n))*hyper((1, 2/n), ((n + 2)/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(a*n*(-4*a*c + b**2)*(-4*a*c + b**2 + b*sqrt(-4*a*c + b**2))) - c*e*x**2*(4*a*c*(1 - n) - b**2*(2 - n))*hyper((1, 2/n), ((n + 2)/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(a*n*(-4*a*c + b**2)*(-4*a*c + b**2 - b*sqrt(-4*a*c + b**2))) - 2*c*f*x**3*(2*a*c*(3 - 2*n) - b**2*(3 - n))*hyper((1, 3/n), ((n + 3)/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(3*a*n*(-4*a*c + b**2)*(-4*a*c + b**2 + b*sqrt(-4*a*c + b**2))) - 2*c*f*x**3*(2*a*c*(3 - 2*n) - b**2*(3 - n))*hyper((1, 3/n), ((n + 3)/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(3*a*n*(-4*a*c + b**2)*(-4*a*c + b**2 - b*sqrt(-4*a*c + b**2))) + d*x*(-2*a*c + b**2 + b*c*x**n)/(a*n*(-4*a*c + b**2)*(a + b*x**n + c*x**(2*n))) + e*x**2*(-2*a*c + b**2 + b*c*x**n)/(a*n*(-4*a*c + b**2)*(a + b*x**n + c*x**(2*n))) + f*x**3*(-2*a*c + b**2 + b*c*x**n)/(a*n*(-4*a*c + b**2)*(a + b*x**n + c*x**(2*n))),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x + f*x**2 + g*x**3)/(a + b*x**n + c*x**(2*n))**2,
        variable=x,
        num_steps=33,
        integral=2*b*c**2*e*x**(n + 2)*(2 - n)*hyper((1, (n + 2)/n), (2 + 2/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(a*n*(b + sqrt(-4*a*c + b**2))*(n + 2)*(-4*a*c + b**2)**(sympy.S(3)/2)) - 2*b*c**2*e*x**(n + 2)*(2 - n)*hyper((1, (n + 2)/n), (2 + 2/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(a*n*(b - sqrt(-4*a*c + b**2))*(n + 2)*(-4*a*c + b**2)**(sympy.S(3)/2)) + 2*b*c**2*f*x**(n + 3)*(3 - n)*hyper((1, (n + 3)/n), (2 + 3/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(a*n*(b + sqrt(-4*a*c + b**2))*(n + 3)*(-4*a*c + b**2)**(sympy.S(3)/2)) - 2*b*c**2*f*x**(n + 3)*(3 - n)*hyper((1, (n + 3)/n), (2 + 3/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(a*n*(b - sqrt(-4*a*c + b**2))*(n + 3)*(-4*a*c + b**2)**(sympy.S(3)/2)) + 2*b*c**2*g*x**(n + 4)*(4 - n)*hyper((1, (n + 4)/n), (2 + 4/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(a*n*(b + sqrt(-4*a*c + b**2))*(n + 4)*(-4*a*c + b**2)**(sympy.S(3)/2)) - 2*b*c**2*g*x**(n + 4)*(4 - n)*hyper((1, (n + 4)/n), (2 + 4/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(a*n*(b - sqrt(-4*a*c + b**2))*(n + 4)*(-4*a*c + b**2)**(sympy.S(3)/2)) - c*d*x*(4*a*c*(1 - 2*n) - b**2*(1 - n) + b*(1 - n)*sqrt(-4*a*c + b**2))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(a*n*(-4*a*c + b**2)*(-4*a*c + b**2 + b*sqrt(-4*a*c + b**2))) - c*d*x*(4*a*c*(1 - 2*n) - b**2*(1 - n) - b*(1 - n)*sqrt(-4*a*c + b**2))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(a*n*(-4*a*c + b**2)*(-4*a*c + b**2 - b*sqrt(-4*a*c + b**2))) - c*e*x**2*(4*a*c*(1 - n) - b**2*(2 - n))*hyper((1, 2/n), ((n + 2)/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(a*n*(-4*a*c + b**2)*(-4*a*c + b**2 + b*sqrt(-4*a*c + b**2))) - c*e*x**2*(4*a*c*(1 - n) - b**2*(2 - n))*hyper((1, 2/n), ((n + 2)/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(a*n*(-4*a*c + b**2)*(-4*a*c + b**2 - b*sqrt(-4*a*c + b**2))) - 2*c*f*x**3*(2*a*c*(3 - 2*n) - b**2*(3 - n))*hyper((1, 3/n), ((n + 3)/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(3*a*n*(-4*a*c + b**2)*(-4*a*c + b**2 + b*sqrt(-4*a*c + b**2))) - 2*c*f*x**3*(2*a*c*(3 - 2*n) - b**2*(3 - n))*hyper((1, 3/n), ((n + 3)/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(3*a*n*(-4*a*c + b**2)*(-4*a*c + b**2 - b*sqrt(-4*a*c + b**2))) - c*g*x**4*(4*a*c*(2 - n) - b**2*(4 - n))*hyper((1, 4/n), ((n + 4)/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(2*a*n*(-4*a*c + b**2)*(-4*a*c + b**2 + b*sqrt(-4*a*c + b**2))) - c*g*x**4*(4*a*c*(2 - n) - b**2*(4 - n))*hyper((1, 4/n), ((n + 4)/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(2*a*n*(-4*a*c + b**2)*(-4*a*c + b**2 - b*sqrt(-4*a*c + b**2))) + d*x*(-2*a*c + b**2 + b*c*x**n)/(a*n*(-4*a*c + b**2)*(a + b*x**n + c*x**(2*n))) + e*x**2*(-2*a*c + b**2 + b*c*x**n)/(a*n*(-4*a*c + b**2)*(a + b*x**n + c*x**(2*n))) + f*x**3*(-2*a*c + b**2 + b*c*x**n)/(a*n*(-4*a*c + b**2)*(a + b*x**n + c*x**(2*n))) + g*x**4*(-2*a*c + b**2 + b*c*x**n)/(a*n*(-4*a*c + b**2)*(a + b*x**n + c*x**(2*n))),
    ),
    RubiTestSuiteCase(
        integrand=(-a*h*x**(n/2 - 1) + c*f*x**(n - 1) + c*g*x**(2*n - 1) + c*h*x**(5*n/2 - 1))/(a + b*x**n + c*x**(2*n))**(sympy.S(3)/2),
        variable=x,
        num_steps=2,
        integral=-(2*c*x**n*(-b*g + 2*c*f) + 2*c*(-2*a*g + b*f) + 2*h*x**(n/2)*(-4*a*c + b**2))/(n*(-4*a*c + b**2)*sqrt(a + b*x**n + c*x**(2*n))),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**n + c*x**(2*n))**p*(a + b*x**n*(n*p + n + 1) + c*x**(2*n)*(2*n*(p + 1) + 1)),
        variable=x,
        num_steps=1,
        integral=x*(a + b*x**n + c*x**(2*n))**(p + 1),
    ),
    RubiTestSuiteCase(
        integrand=x**(n/4 - 1)*(-a*h + c*f*x**(n/4) + c*g*x**(3*n/4) + c*h*x**n)/(a + c*x**n)**(sympy.S(3)/2),
        variable=x,
        num_steps=1,
        integral=-(2*a*g + 4*a*h*x**(n/4) - 2*c*f*x**(n/2))/(a*n*sqrt(a + c*x**n)),
    ),
    RubiTestSuiteCase(
        integrand=(d*x)**(n/4 - 1)*(-a*h + c*f*x**(n/4) + c*g*x**(3*n/4) + c*h*x**n)/(a + c*x**n)**(sympy.S(3)/2),
        variable=x,
        num_steps=2,
        integral=-2*x**(1 - n/4)*(d*x)**(n/4 - 1)*(a*g + 2*a*h*x**(n/4) - c*f*x**(n/2))/(a*n*sqrt(a + c*x**n)),
    ),
    RubiTestSuiteCase(
        integrand=x**(n/2 - 1)*(-a*h + c*f*x**(n/2) + c*g*x**(3*n/2) + c*h*x**(2*n))/(a + b*x**n + c*x**(2*n))**(sympy.S(3)/2),
        variable=x,
        num_steps=1,
        integral=-(2*c*x**n*(-b*g + 2*c*f) + 2*c*(-2*a*g + b*f) + 2*h*x**(n/2)*(-4*a*c + b**2))/(n*(-4*a*c + b**2)*sqrt(a + b*x**n + c*x**(2*n))),
    ),
    RubiTestSuiteCase(
        integrand=(d*x)**(n/2 - 1)*(-a*h + c*f*x**(n/2) + c*g*x**(3*n/2) + c*h*x**(2*n))/(a + b*x**n + c*x**(2*n))**(sympy.S(3)/2),
        variable=x,
        num_steps=2,
        integral=-2*x**(1 - n/2)*(d*x)**(n/2 - 1)*(c*x**n*(-b*g + 2*c*f) + c*(-2*a*g + b*f) + h*x**(n/2)*(-4*a*c + b**2))/(n*(-4*a*c + b**2)*sqrt(a + b*x**n + c*x**(2*n))),
    ),
    RubiTestSuiteCase(
        integrand=(g*x)**m*(a + b*x**n + c*x**(2*n))**p*(a*(m + 1) + b*x**n*(m + n*p + n + 1) + c*x**(2*n)*(m + 2*n*(p + 1) + 1)),
        variable=x,
        num_steps=1,
        integral=(g*x)**(m + 1)*(a + b*x**n + c*x**(2*n))**(p + 1)/g,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*x**n + C*x**(2*n) + D*x**(3*n))/(a + b*x**n + c*x**(2*n))**2,
        variable=x,
        num_steps=4,
        integral=x*(A*c*(-2*a*c + b**2) - a*(B*b*c - 2*C*a*c + D*a*b) + x**n*(-D*a*b**2 - 2*a*c*(B*c - D*a) + b*c*(A*c + C*a)))/(a*c*n*(-4*a*c + b**2)*(a + b*x**n + c*x**(2*n))) + x*(D*a*b**2 + 2*a*c*(B*c*(1 - n) - D*a*(n + 1)) - b*c*(1 - n)*(A*c + C*a) - (A*c**2*(4*a*c*(1 - 2*n) - b**2*(1 - n)) - a*(4*C*a*c**2 - C*b**2*c*(1 - n) + D*b**3 - 2*b*c*(B*c*n + D*a*(n + 2))))/sqrt(-4*a*c + b**2))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(a*c*n*(b + sqrt(-4*a*c + b**2))*(-4*a*c + b**2)) + x*(D*a*b**2 + 2*a*c*(B*c*(1 - n) - D*a*(n + 1)) - b*c*(1 - n)*(A*c + C*a) + (A*c**2*(4*a*c*(1 - 2*n) - b**2*(1 - n)) - a*(4*C*a*c**2 - C*b**2*c*(1 - n) + D*b**3 - 2*b*c*(B*c*n + D*a*(n + 2))))/sqrt(-4*a*c + b**2))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(a*c*n*(b - sqrt(-4*a*c + b**2))*(-4*a*c + b**2)),
    ),
]
