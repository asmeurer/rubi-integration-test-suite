...
SOURCE_FILE = '1 Algebraic functions/1.2 Trinomial products/1.2.3 General/1.2.3.3 (d+e x^n)^q (a+b x^n+c x^(2 n))^p.m'
...
TEST_CASES = [
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=5,
        integral=x/(2 - 2*x**4) + atan(x)/4 + atanh(x)/4,
    ),
    RubiTestSuiteCase(
        integrand=(x**4 + 1)/(x**8 - 3*x**4 + 1),
        variable=x,
        num_steps=7,
        integral=atan(sqrt(2)*x/sqrt(-1 + sqrt(5)))/sqrt(-2 + 2*sqrt(5)) - atan(sqrt(2)*x/sqrt(1 + sqrt(5)))/sqrt(2 + 2*sqrt(5)) + atanh(sqrt(2)*x/sqrt(-1 + sqrt(5)))/sqrt(-2 + 2*sqrt(5)) - atanh(sqrt(2)*x/sqrt(1 + sqrt(5)))/sqrt(2 + 2*sqrt(5)),
    ),
    RubiTestSuiteCase(
        integrand=(x**4 + 1)/(x**8 - 4*x**4 + 1),
        variable=x,
        num_steps=7,
        integral=2**(sympy.S(3)/4)*atan(2**(sympy.S(1)/4)*x/sqrt(-1 + sqrt(3)))/(4*sqrt(-1 + sqrt(3))) - 2**(sympy.S(3)/4)*atan(2**(sympy.S(1)/4)*x/sqrt(1 + sqrt(3)))/(4*sqrt(1 + sqrt(3))) + 2**(sympy.S(3)/4)*atanh(2**(sympy.S(1)/4)*x/sqrt(-1 + sqrt(3)))/(4*sqrt(-1 + sqrt(3))) - 2**(sympy.S(3)/4)*atanh(2**(sympy.S(1)/4)*x/sqrt(1 + sqrt(3)))/(4*sqrt(1 + sqrt(3))),
    ),
    RubiTestSuiteCase(
        integrand=(x**4 + 1)/(x**8 - 5*x**4 + 1),
        variable=x,
        num_steps=7,
        integral=atan(sqrt(2)*x/sqrt(-sqrt(3) + sqrt(7)))/sqrt(-6*sqrt(3) + 6*sqrt(7)) - atan(sqrt(2)*x/sqrt(sqrt(3) + sqrt(7)))/sqrt(6*sqrt(3) + 6*sqrt(7)) + atanh(sqrt(2)*x/sqrt(-sqrt(3) + sqrt(7)))/sqrt(-6*sqrt(3) + 6*sqrt(7)) - atanh(sqrt(2)*x/sqrt(sqrt(3) + sqrt(7)))/sqrt(6*sqrt(3) + 6*sqrt(7)),
    ),
    RubiTestSuiteCase(
        integrand=(x**4 + 1)/(x**8 - 6*x**4 + 1),
        variable=x,
        num_steps=7,
        integral=atan(x/sqrt(-1 + sqrt(2)))/(4*sqrt(-1 + sqrt(2))) - atan(x/sqrt(1 + sqrt(2)))/(4*sqrt(1 + sqrt(2))) + atanh(x/sqrt(-1 + sqrt(2)))/(4*sqrt(-1 + sqrt(2))) - atanh(x/sqrt(1 + sqrt(2)))/(4*sqrt(1 + sqrt(2))),
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**4)/(b*x**4 + x**8 + 1),
        variable=x,
        num_steps=19,
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=7,
        integral=atan(sqrt(2)*x/sqrt(-1 + sqrt(5)))/sqrt(-10 + 10*sqrt(5)) + atan(sqrt(2)*x/sqrt(1 + sqrt(5)))/sqrt(10 + 10*sqrt(5)) + atanh(sqrt(2)*x/sqrt(-1 + sqrt(5)))/sqrt(-10 + 10*sqrt(5)) + atanh(sqrt(2)*x/sqrt(1 + sqrt(5)))/sqrt(10 + 10*sqrt(5)),
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**4)/(x**8 - 4*x**4 + 1),
        variable=x,
        num_steps=7,
        integral=2**(sympy.S(3)/4)*atan(2**(sympy.S(1)/4)*x/sqrt(-1 + sqrt(3)))/(4*sqrt(-3 + 3*sqrt(3))) + 2**(sympy.S(3)/4)*atan(2**(sympy.S(1)/4)*x/sqrt(1 + sqrt(3)))/(4*sqrt(3 + 3*sqrt(3))) + 2**(sympy.S(3)/4)*atanh(2**(sympy.S(1)/4)*x/sqrt(-1 + sqrt(3)))/(4*sqrt(-3 + 3*sqrt(3))) + 2**(sympy.S(3)/4)*atanh(2**(sympy.S(1)/4)*x/sqrt(1 + sqrt(3)))/(4*sqrt(3 + 3*sqrt(3))),
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**4)/(x**8 - 5*x**4 + 1),
        variable=x,
        num_steps=7,
        integral=atan(sqrt(2)*x/sqrt(-sqrt(3) + sqrt(7)))/sqrt(-14*sqrt(3) + 14*sqrt(7)) + atan(sqrt(2)*x/sqrt(sqrt(3) + sqrt(7)))/sqrt(14*sqrt(3) + 14*sqrt(7)) + atanh(sqrt(2)*x/sqrt(-sqrt(3) + sqrt(7)))/sqrt(-14*sqrt(3) + 14*sqrt(7)) + atanh(sqrt(2)*x/sqrt(sqrt(3) + sqrt(7)))/sqrt(14*sqrt(3) + 14*sqrt(7)),
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**4)/(x**8 - 6*x**4 + 1),
        variable=x,
        num_steps=7,
        integral=atan(x/sqrt(-1 + sqrt(2)))/(4*sqrt(-2 + 2*sqrt(2))) + atan(x/sqrt(1 + sqrt(2)))/(4*sqrt(2 + 2*sqrt(2))) + atanh(x/sqrt(-1 + sqrt(2)))/(4*sqrt(-2 + 2*sqrt(2))) + atanh(x/sqrt(1 + sqrt(2)))/(4*sqrt(2 + 2*sqrt(2))),
    ),
    RubiTestSuiteCase(
        integrand=(2*x**4 - 1 + sqrt(3))/(x**8 - x**4 + 1),
        variable=x,
        num_steps=9,
        integral=-sqrt(2)*log(x**2 - x*sqrt(2 - sqrt(3)) + 1)/4 + sqrt(2)*log(x**2 + x*sqrt(2 - sqrt(3)) + 1)/4 - sqrt(2)*atan((-2*x + sqrt(sqrt(3) + 2))/sqrt(2 - sqrt(3)))/2 + sqrt(2)*atan((2*x + sqrt(sqrt(3) + 2))/sqrt(2 - sqrt(3)))/2,
    ),
    RubiTestSuiteCase(
        integrand=(x**4*(1 + sqrt(3)) + 1)/(x**8 - x**4 + 1),
        variable=x,
        num_steps=9,
        integral=-sqrt(sqrt(3) + 2)*log(x**2 - x*sqrt(2 - sqrt(3)) + 1)/4 + sqrt(sqrt(3) + 2)*log(x**2 + x*sqrt(2 - sqrt(3)) + 1)/4 - sqrt(sqrt(3) + 2)*atan((-2*x + sqrt(sqrt(3) + 2))/sqrt(2 - sqrt(3)))/2 + sqrt(sqrt(3) + 2)*atan((2*x + sqrt(sqrt(3) + 2))/sqrt(2 - sqrt(3)))/2,
    ),
    RubiTestSuiteCase(
        integrand=(x**4*(-3 + sqrt(3)) - 2*sqrt(3) + 3)/(x**8 - x**4 + 1),
        variable=x,
        num_steps=9,
        integral=sqrt(6 - 3*sqrt(3))*log(x**2 - x*sqrt(2 - sqrt(3)) + 1)/4 - sqrt(6 - 3*sqrt(3))*log(x**2 + x*sqrt(2 - sqrt(3)) + 1)/4 + sqrt(6 - 3*sqrt(3))*atan((-2*x + sqrt(sqrt(3) + 2))/sqrt(2 - sqrt(3)))/2 - sqrt(6 - 3*sqrt(3))*atan((2*x + sqrt(sqrt(3) + 2))/sqrt(2 - sqrt(3)))/2,
    ),
    RubiTestSuiteCase(
        integrand=(d + e/x)/(a/x**2 + c),
        variable=x,
        num_steps=5,
        integral=-sqrt(a)*d*atan(sqrt(c)*x/sqrt(a))/c**(sympy.S(3)/2) + d*x/c + e*log(a + c*x**2)/(2*c),
    ),
    RubiTestSuiteCase(
        integrand=(d + e/x)/(a/x**2 + b/x + c),
        variable=x,
        num_steps=6,
        integral=d*x/c - (b*d - c*e)*log(a + b*x + c*x**2)/(2*c**2) - (-2*a*c*d + b**2*d - b*c*e)*atanh((b + 2*c*x)/sqrt(-4*a*c + b**2))/(c**2*sqrt(-4*a*c + b**2)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e/x**2)/(a/x**4 + c),
        variable=x,
        num_steps=11,
        integral=d*x/c + sqrt(2)*(sqrt(a)*d - sqrt(c)*e)*atan(1 - sqrt(2)*c**(sympy.S(1)/4)*x/a**(sympy.S(1)/4))/(4*a**(sympy.S(1)/4)*c**(sympy.S(5)/4)) - sqrt(2)*(sqrt(a)*d - sqrt(c)*e)*atan(1 + sqrt(2)*c**(sympy.S(1)/4)*x/a**(sympy.S(1)/4))/(4*a**(sympy.S(1)/4)*c**(sympy.S(5)/4)) + sqrt(2)*(sqrt(a)*d + sqrt(c)*e)*log(-sqrt(2)*a**(sympy.S(1)/4)*c**(sympy.S(1)/4)*x + sqrt(a) + sqrt(c)*x**2)/(8*a**(sympy.S(1)/4)*c**(sympy.S(5)/4)) - sqrt(2)*(sqrt(a)*d + sqrt(c)*e)*log(sqrt(2)*a**(sympy.S(1)/4)*c**(sympy.S(1)/4)*x + sqrt(a) + sqrt(c)*x**2)/(8*a**(sympy.S(1)/4)*c**(sympy.S(5)/4)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e/x**2)/(a/x**4 + b/x**2 + c),
        variable=x,
        num_steps=5,
        integral=d*x/c - sqrt(2)*(b*d - c*e + (-2*a*c*d + b**2*d - b*c*e)/sqrt(-4*a*c + b**2))*atan(sqrt(2)*sqrt(c)*x/sqrt(b + sqrt(-4*a*c + b**2)))/(2*c**(sympy.S(3)/2)*sqrt(b + sqrt(-4*a*c + b**2))) - sqrt(2)*(b*d - c*e - (-2*a*c*d + b**2*d - b*c*e)/sqrt(-4*a*c + b**2))*atan(sqrt(2)*sqrt(c)*x/sqrt(b - sqrt(-4*a*c + b**2)))/(2*c**(sympy.S(3)/2)*sqrt(b - sqrt(-4*a*c + b**2))),
    ),
    RubiTestSuiteCase(
        integrand=(d + e/x**3)/(a/x**6 + c),
        variable=x,
        num_steps=14,
        integral=-a**(sympy.S(1)/6)*d*atan(c**(sympy.S(1)/6)*x/a**(sympy.S(1)/6))/(3*c**(sympy.S(7)/6)) + d*x/c - e*log(a**(sympy.S(1)/3) + c**(sympy.S(1)/3)*x**2)/(6*a**(sympy.S(1)/3)*c**(sympy.S(2)/3)) + (sqrt(a)*d - sqrt(3)*sqrt(c)*e)*atan(sqrt(3) - 2*c**(sympy.S(1)/6)*x/a**(sympy.S(1)/6))/(6*a**(sympy.S(1)/3)*c**(sympy.S(7)/6)) - (sqrt(a)*d + sqrt(3)*sqrt(c)*e)*atan(sqrt(3) + 2*c**(sympy.S(1)/6)*x/a**(sympy.S(1)/6))/(6*a**(sympy.S(1)/3)*c**(sympy.S(7)/6)) - (sqrt(3)*sqrt(a)*d - sqrt(c)*e)*log(sqrt(3)*a**(sympy.S(1)/6)*c**(sympy.S(1)/6)*x + a**(sympy.S(1)/3) + c**(sympy.S(1)/3)*x**2)/(12*a**(sympy.S(1)/3)*c**(sympy.S(7)/6)) + (sqrt(3)*sqrt(a)*d + sqrt(c)*e)*log(-sqrt(3)*a**(sympy.S(1)/6)*c**(sympy.S(1)/6)*x + a**(sympy.S(1)/3) + c**(sympy.S(1)/3)*x**2)/(12*a**(sympy.S(1)/3)*c**(sympy.S(7)/6)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e/x**3)/(a/x**6 + b/x**3 + c),
        variable=x,
        num_steps=15,
        integral=d*x/c - 2**(sympy.S(2)/3)*(b*d - c*e + (-2*a*c*d + b**2*d - b*c*e)/sqrt(-4*a*c + b**2))*log(2**(sympy.S(1)/3)*c**(sympy.S(1)/3)*x + (b + sqrt(-4*a*c + b**2))**(sympy.S(1)/3))/(6*c**(sympy.S(4)/3)*(b + sqrt(-4*a*c + b**2))**(sympy.S(2)/3)) + 2**(sympy.S(2)/3)*(b*d - c*e + (-2*a*c*d + b**2*d - b*c*e)/sqrt(-4*a*c + b**2))*log(2**(sympy.S(2)/3)*c**(sympy.S(2)/3)*x**2 - 2**(sympy.S(1)/3)*c**(sympy.S(1)/3)*x*(b + sqrt(-4*a*c + b**2))**(sympy.S(1)/3) + (b + sqrt(-4*a*c + b**2))**(sympy.S(2)/3))/(12*c**(sympy.S(4)/3)*(b + sqrt(-4*a*c + b**2))**(sympy.S(2)/3)) + 2**(sympy.S(2)/3)*sqrt(3)*(b*d - c*e + (-2*a*c*d + b**2*d - b*c*e)/sqrt(-4*a*c + b**2))*atan(sqrt(3)*(-2*2**(sympy.S(1)/3)*c**(sympy.S(1)/3)*x/(b + sqrt(-4*a*c + b**2))**(sympy.S(1)/3) + 1)/3)/(6*c**(sympy.S(4)/3)*(b + sqrt(-4*a*c + b**2))**(sympy.S(2)/3)) - 2**(sympy.S(2)/3)*(b*d - c*e - (-2*a*c*d + b**2*d - b*c*e)/sqrt(-4*a*c + b**2))*log(2**(sympy.S(1)/3)*c**(sympy.S(1)/3)*x + (b - sqrt(-4*a*c + b**2))**(sympy.S(1)/3))/(6*c**(sympy.S(4)/3)*(b - sqrt(-4*a*c + b**2))**(sympy.S(2)/3)) + 2**(sympy.S(2)/3)*(b*d - c*e - (-2*a*c*d + b**2*d - b*c*e)/sqrt(-4*a*c + b**2))*log(2**(sympy.S(2)/3)*c**(sympy.S(2)/3)*x**2 - 2**(sympy.S(1)/3)*c**(sympy.S(1)/3)*x*(b - sqrt(-4*a*c + b**2))**(sympy.S(1)/3) + (b - sqrt(-4*a*c + b**2))**(sympy.S(2)/3))/(12*c**(sympy.S(4)/3)*(b - sqrt(-4*a*c + b**2))**(sympy.S(2)/3)) + 2**(sympy.S(2)/3)*sqrt(3)*(b*d - c*e - (-2*a*c*d + b**2*d - b*c*e)/sqrt(-4*a*c + b**2))*atan(sqrt(3)*(-2*2**(sympy.S(1)/3)*c**(sympy.S(1)/3)*x/(b - sqrt(-4*a*c + b**2))**(sympy.S(1)/3) + 1)/3)/(6*c**(sympy.S(4)/3)*(b - sqrt(-4*a*c + b**2))**(sympy.S(2)/3)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e/x**4)/(a/x**8 + c),
        variable=x,
        num_steps=21,
        integral=d*x/c - (sqrt(a)*(-sqrt(2)*d + d) + sqrt(c)*e)*log(-a**(sympy.S(1)/8)*c**(sympy.S(1)/8)*x*sqrt(2 - sqrt(2)) + a**(sympy.S(1)/4) + c**(sympy.S(1)/4)*x**2)/(8*a**(sympy.S(3)/8)*c**(sympy.S(9)/8)*sqrt(4 - 2*sqrt(2))) + (sqrt(a)*(-sqrt(2)*d + d) + sqrt(c)*e)*log(a**(sympy.S(1)/8)*c**(sympy.S(1)/8)*x*sqrt(2 - sqrt(2)) + a**(sympy.S(1)/4) + c**(sympy.S(1)/4)*x**2)/(8*a**(sympy.S(3)/8)*c**(sympy.S(9)/8)*sqrt(4 - 2*sqrt(2))) - sqrt(sqrt(2) + 2)*(sqrt(a)*(-sqrt(2)*d + d) + sqrt(c)*e)*atan((a**(sympy.S(1)/8)*sqrt(sqrt(2) + 2) - 2*c**(sympy.S(1)/8)*x)/(a**(sympy.S(1)/8)*sqrt(2 - sqrt(2))))/(8*a**(sympy.S(3)/8)*c**(sympy.S(9)/8)) + sqrt(sqrt(2) + 2)*(sqrt(a)*(-sqrt(2)*d + d) + sqrt(c)*e)*atan((a**(sympy.S(1)/8)*sqrt(sqrt(2) + 2) + 2*c**(sympy.S(1)/8)*x)/(a**(sympy.S(1)/8)*sqrt(2 - sqrt(2))))/(8*a**(sympy.S(3)/8)*c**(sympy.S(9)/8)) + (sqrt(a)*d*(1 + sqrt(2)) + sqrt(c)*e)*log(-a**(sympy.S(1)/8)*c**(sympy.S(1)/8)*x*sqrt(sqrt(2) + 2) + a**(sympy.S(1)/4) + c**(sympy.S(1)/4)*x**2)/(8*a**(sympy.S(3)/8)*c**(sympy.S(9)/8)*sqrt(2*sqrt(2) + 4)) - (sqrt(a)*d*(1 + sqrt(2)) + sqrt(c)*e)*log(a**(sympy.S(1)/8)*c**(sympy.S(1)/8)*x*sqrt(sqrt(2) + 2) + a**(sympy.S(1)/4) + c**(sympy.S(1)/4)*x**2)/(8*a**(sympy.S(3)/8)*c**(sympy.S(9)/8)*sqrt(2*sqrt(2) + 4)) + sqrt(2 - sqrt(2))*(sqrt(a)*d*(1 + sqrt(2)) + sqrt(c)*e)*atan((a**(sympy.S(1)/8)*sqrt(2 - sqrt(2)) - 2*c**(sympy.S(1)/8)*x)/(a**(sympy.S(1)/8)*sqrt(sqrt(2) + 2)))/(8*a**(sympy.S(3)/8)*c**(sympy.S(9)/8)) - sqrt(2 - sqrt(2))*(sqrt(a)*d*(1 + sqrt(2)) + sqrt(c)*e)*atan((a**(sympy.S(1)/8)*sqrt(2 - sqrt(2)) + 2*c**(sympy.S(1)/8)*x)/(a**(sympy.S(1)/8)*sqrt(sqrt(2) + 2)))/(8*a**(sympy.S(3)/8)*c**(sympy.S(9)/8)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e/x**4)/(a/x**8 + b/x**4 + c),
        variable=x,
        num_steps=9,
        integral=d*x/c + 2**(sympy.S(3)/4)*(b*d - c*e - (-2*a*c*d + b**2*d - b*c*e)/sqrt(-4*a*c + b**2))*atan(2**(sympy.S(1)/4)*c**(sympy.S(1)/4)*x/(-b + sqrt(-4*a*c + b**2))**(sympy.S(1)/4))/(4*c**(sympy.S(5)/4)*(-b + sqrt(-4*a*c + b**2))**(sympy.S(3)/4)) + 2**(sympy.S(3)/4)*(b*d - c*e - (-2*a*c*d + b**2*d - b*c*e)/sqrt(-4*a*c + b**2))*atanh(2**(sympy.S(1)/4)*c**(sympy.S(1)/4)*x/(-b + sqrt(-4*a*c + b**2))**(sympy.S(1)/4))/(4*c**(sympy.S(5)/4)*(-b + sqrt(-4*a*c + b**2))**(sympy.S(3)/4)) + 2**(sympy.S(3)/4)*(b*d - c*e + (-2*a*c*d + b**2*d - b*c*e)/sqrt(-4*a*c + b**2))*atan(2**(sympy.S(1)/4)*c**(sympy.S(1)/4)*x/(-b - sqrt(-4*a*c + b**2))**(sympy.S(1)/4))/(4*c**(sympy.S(5)/4)*(-b - sqrt(-4*a*c + b**2))**(sympy.S(3)/4)) + 2**(sympy.S(3)/4)*(b*d - c*e + (-2*a*c*d + b**2*d - b*c*e)/sqrt(-4*a*c + b**2))*atanh(2**(sympy.S(1)/4)*c**(sympy.S(1)/4)*x/(-b - sqrt(-4*a*c + b**2))**(sympy.S(1)/4))/(4*c**(sympy.S(5)/4)*(-b - sqrt(-4*a*c + b**2))**(sympy.S(3)/4)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)**3/(a + c*x**(2*n)),
        variable=x,
        num_steps=5,
        integral=3*d*e**2*x/c + e**3*x**(n + 1)/(c*(n + 1)) + d*x*(-3*a*e**2 + c*d**2)*hyper((1, 1/(2*n)), (1 + 1/(2*n),), -c*x**(2*n)/a)/(a*c) + e*x**(n + 1)*(-a*e**2 + 3*c*d**2)*hyper((1, (n + 1)/(2*n)), (sympy.S(3)/2 + 1/(2*n),), -c*x**(2*n)/a)/(a*c*(n + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)**2/(a + c*x**(2*n)),
        variable=x,
        num_steps=5,
        integral=e**2*x/c + 2*d*e*x**(n + 1)*hyper((1, (n + 1)/(2*n)), (sympy.S(3)/2 + 1/(2*n),), -c*x**(2*n)/a)/(a*(n + 1)) + x*(-a*e**2 + c*d**2)*hyper((1, 1/(2*n)), (1 + 1/(2*n),), -c*x**(2*n)/a)/(a*c),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)/(a + c*x**(2*n)),
        variable=x,
        num_steps=3,
        integral=d*x*hyper((1, 1/(2*n)), (1 + 1/(2*n),), -c*x**(2*n)/a)/a + e*x**(n + 1)*hyper((1, (n + 1)/(2*n)), (sympy.S(3)/2 + 1/(2*n),), -c*x**(2*n)/a)/(a*(n + 1)),
    ),
    RubiTestSuiteCase(
        integrand=1/((a + c*x**(2*n))*(d + e*x**n)),
        variable=x,
        num_steps=6,
        integral=e**2*x*hyper((1, 1/n), (1 + 1/n,), -e*x**n/d)/(d*(a*e**2 + c*d**2)) + c*d*x*hyper((1, 1/(2*n)), (1 + 1/(2*n),), -c*x**(2*n)/a)/(a*(a*e**2 + c*d**2)) - c*e*x**(n + 1)*hyper((1, (n + 1)/(2*n)), (sympy.S(3)/2 + 1/(2*n),), -c*x**(2*n)/a)/(a*(n + 1)*(a*e**2 + c*d**2)),
    ),
    RubiTestSuiteCase(
        integrand=1/((a + c*x**(2*n))*(d + e*x**n)**2),
        variable=x,
        num_steps=7,
        integral=2*c*e**2*x*hyper((1, 1/n), (1 + 1/n,), -e*x**n/d)/(a*e**2 + c*d**2)**2 + e**2*x*hyper((2, 1/n), (1 + 1/n,), -e*x**n/d)/(d**2*(a*e**2 + c*d**2)) - 2*c**2*d*e*x**(n + 1)*hyper((1, (n + 1)/(2*n)), (sympy.S(3)/2 + 1/(2*n),), -c*x**(2*n)/a)/(a*(n + 1)*(a*e**2 + c*d**2)**2) + c*x*(-a*e**2 + c*d**2)*hyper((1, 1/(2*n)), (1 + 1/(2*n),), -c*x**(2*n)/a)/(a*(a*e**2 + c*d**2)**2),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)/(a - c*x**(2*n)),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=(d + e*x**n)**3/(a + c*x**(2*n))**2,
        variable=x,
        num_steps=9,
        integral=3*d*e**2*x*hyper((1, 1/(2*n)), (1 + 1/(2*n),), -c*x**(2*n)/a)/(a*c) + e**3*x**(n + 1)*hyper((1, (n + 1)/(2*n)), (sympy.S(3)/2 + 1/(2*n),), -c*x**(2*n)/a)/(a*c*(n + 1)) + x*(d*(-3*a*e**2 + c*d**2) + e*x**n*(-a*e**2 + 3*c*d**2))/(2*a*c*n*(a + c*x**(2*n))) - d*x*(1 - 2*n)*(-3*a*e**2 + c*d**2)*hyper((1, 1/(2*n)), (1 + 1/(2*n),), -c*x**(2*n)/a)/(2*a**2*c*n) - e*x**(n + 1)*(1 - n)*(-a*e**2 + 3*c*d**2)*hyper((1, (n + 1)/(2*n)), (sympy.S(3)/2 + 1/(2*n),), -c*x**(2*n)/a)/(2*a**2*c*n*(n + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)**2/(a + c*x**(2*n))**2,
        variable=x,
        num_steps=7,
        integral=e**2*x*hyper((1, 1/(2*n)), (1 + 1/(2*n),), -c*x**(2*n)/a)/(a*c) + x*(-a*e**2 + c*d**2 + 2*c*d*e*x**n)/(2*a*c*n*(a + c*x**(2*n))) - d*e*x**(n + 1)*(1 - n)*hyper((1, (n + 1)/(2*n)), (sympy.S(3)/2 + 1/(2*n),), -c*x**(2*n)/a)/(a**2*n*(n + 1)) - x*(1 - 2*n)*(-a*e**2 + c*d**2)*hyper((1, 1/(2*n)), (1 + 1/(2*n),), -c*x**(2*n)/a)/(2*a**2*c*n),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)/(a + c*x**(2*n))**2,
        variable=x,
        num_steps=4,
        integral=x*(d + e*x**n)/(2*a*n*(a + c*x**(2*n))) - d*x*(1 - 2*n)*hyper((1, 1/(2*n)), (1 + 1/(2*n),), -c*x**(2*n)/a)/(2*a**2*n) - e*x**(n + 1)*(1 - n)*hyper((1, (n + 1)/(2*n)), (sympy.S(3)/2 + 1/(2*n),), -c*x**(2*n)/a)/(2*a**2*n*(n + 1)),
    ),
    RubiTestSuiteCase(
        integrand=1/((a + c*x**(2*n))**2*(d + e*x**n)),
        variable=x,
        num_steps=10,
        integral=e**4*x*hyper((1, 1/n), (1 + 1/n,), -e*x**n/d)/(d*(a*e**2 + c*d**2)**2) + c*d*e**2*x*hyper((1, 1/(2*n)), (1 + 1/(2*n),), -c*x**(2*n)/a)/(a*(a*e**2 + c*d**2)**2) - c*e**3*x**(n + 1)*hyper((1, (n + 1)/(2*n)), (sympy.S(3)/2 + 1/(2*n),), -c*x**(2*n)/a)/(a*(n + 1)*(a*e**2 + c*d**2)**2) + c*x*(d - e*x**n)/(2*a*n*(a + c*x**(2*n))*(a*e**2 + c*d**2)) - c*d*x*(1 - 2*n)*hyper((1, 1/(2*n)), (1 + 1/(2*n),), -c*x**(2*n)/a)/(2*a**2*n*(a*e**2 + c*d**2)) + c*e*x**(n + 1)*(1 - n)*hyper((1, (n + 1)/(2*n)), (sympy.S(3)/2 + 1/(2*n),), -c*x**(2*n)/a)/(2*a**2*n*(n + 1)*(a*e**2 + c*d**2)),
    ),
    RubiTestSuiteCase(
        integrand=1/((a + c*x**(2*n))**2*(d + e*x**n)**2),
        variable=x,
        num_steps=11,
    ...
    RubiTestSuiteCase(
        integrand=1/(sqrt(a + c*x**(2*n))*(d + e*x**n)),
        variable=x,
        num_steps=6,
        integral=x*sqrt(1 + c*x**(2*n)/a)*appellf1(1/(2*n), sympy.S.Half, 1, 1 + 1/(2*n), -c*x**(2*n)/a, e**2*x**(2*n)/d**2)/(d*sqrt(a + c*x**(2*n))) - e*x**(n + 1)*sqrt(1 + c*x**(2*n)/a)*appellf1((n + 1)/(2*n), sympy.S.Half, 1, sympy.S(3)/2 + 1/(2*n), -c*x**(2*n)/a, e**2*x**(2*n)/d**2)/(d**2*sqrt(a + c*x**(2*n))*(n + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**(2*n))**p*(d + e*x**n)**q,
        variable=x,
        num_steps=0,
        integral=sympy.Function('Unintegrable')((((Symbol('d') + (Symbol('e') * (x)**(Symbol('n')))))**(Symbol('q')) * ((Symbol('a') + (Symbol('c') * (x)**((Integer(2) * Symbol('n'))))))**(Symbol('p'))), x),
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**(2*n))**p*(d + e*x**n)**3,
        variable=x,
        num_steps=10,
        integral=d**3*x*(a + c*x**(2*n))**p*hyper((-p, 1/(2*n)), (1 + 1/(2*n),), -c*x**(2*n)/a)/(1 + c*x**(2*n)/a)**p + 3*d**2*e*x**(n + 1)*(a + c*x**(2*n))**p*hyper((-p, (n + 1)/(2*n)), (sympy.S(3)/2 + 1/(2*n),), -c*x**(2*n)/a)/((1 + c*x**(2*n)/a)**p*(n + 1)) + 3*d*e**2*x**(2*n + 1)*(a + c*x**(2*n))**p*hyper((-p, 1 + 1/(2*n)), (2 + 1/(2*n),), -c*x**(2*n)/a)/((1 + c*x**(2*n)/a)**p*(2*n + 1)) + e**3*x**(3*n + 1)*(a + c*x**(2*n))**p*hyper((-p, sympy.S(3)/2 + 1/(2*n)), (sympy.S(5)/2 + 1/(2*n),), -c*x**(2*n)/a)/((1 + c*x**(2*n)/a)**p*(3*n + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**(2*n))**p*(d + e*x**n)**2,
        variable=x,
        num_steps=8,
        integral=d**2*x*(a + c*x**(2*n))**p*hyper((-p, 1/(2*n)), (1 + 1/(2*n),), -c*x**(2*n)/a)/(1 + c*x**(2*n)/a)**p + 2*d*e*x**(n + 1)*(a + c*x**(2*n))**p*hyper((-p, (n + 1)/(2*n)), (sympy.S(3)/2 + 1/(2*n),), -c*x**(2*n)/a)/((1 + c*x**(2*n)/a)**p*(n + 1)) + e**2*x**(2*n + 1)*(a + c*x**(2*n))**p*hyper((-p, 1 + 1/(2*n)), (2 + 1/(2*n),), -c*x**(2*n)/a)/((1 + c*x**(2*n)/a)**p*(2*n + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**(2*n))**p*(d + e*x**n),
        variable=x,
        num_steps=6,
        integral=d*x*(a + c*x**(2*n))**p*hyper((-p, 1/(2*n)), (1 + 1/(2*n),), -c*x**(2*n)/a)/(1 + c*x**(2*n)/a)**p + e*x**(n + 1)*(a + c*x**(2*n))**p*hyper((-p, (n + 1)/(2*n)), (sympy.S(3)/2 + 1/(2*n),), -c*x**(2*n)/a)/((1 + c*x**(2*n)/a)**p*(n + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**(2*n))**p/(d + e*x**n),
        variable=x,
        num_steps=6,
        integral=x*(a + c*x**(2*n))**p*appellf1(1/(2*n), 1, -p, 1 + 1/(2*n), e**2*x**(2*n)/d**2, -c*x**(2*n)/a)/(d*(1 + c*x**(2*n)/a)**p) - e*x**(n + 1)*(a + c*x**(2*n))**p*appellf1((n + 1)/(2*n), 1, -p, sympy.S(3)/2 + 1/(2*n), e**2*x**(2*n)/d**2, -c*x**(2*n)/a)/(d**2*(1 + c*x**(2*n)/a)**p*(n + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**(2*n))**p/(d + e*x**n)**2,
        variable=x,
        num_steps=8,
        integral=x*(a + c*x**(2*n))**p*appellf1(1/(2*n), 2, -p, 1 + 1/(2*n), e**2*x**(2*n)/d**2, -c*x**(2*n)/a)/(d**2*(1 + c*x**(2*n)/a)**p) - 2*e*x**(n + 1)*(a + c*x**(2*n))**p*appellf1((n + 1)/(2*n), 2, -p, sympy.S(3)/2 + 1/(2*n), e**2*x**(2*n)/d**2, -c*x**(2*n)/a)/(d**3*(1 + c*x**(2*n)/a)**p*(n + 1)) + e**2*x**(2*n + 1)*(a + c*x**(2*n))**p*appellf1(1 + 1/(2*n), 2, -p, 2 + 1/(2*n), e**2*x**(2*n)/d**2, -c*x**(2*n)/a)/(d**4*(1 + c*x**(2*n)/a)**p*(2*n + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(a + c*x**(2*n))**p/(d + e*x**n)**3,
        variable=x,
        num_steps=10,
        integral=x*(a + c*x**(2*n))**p*appellf1(1/(2*n), 3, -p, 1 + 1/(2*n), e**2*x**(2*n)/d**2, -c*x**(2*n)/a)/(d**3*(1 + c*x**(2*n)/a)**p) - 3*e*x**(n + 1)*(a + c*x**(2*n))**p*appellf1((n + 1)/(2*n), 3, -p, sympy.S(3)/2 + 1/(2*n), e**2*x**(2*n)/d**2, -c*x**(2*n)/a)/(d**4*(1 + c*x**(2*n)/a)**p*(n + 1)) + 3*e**2*x**(2*n + 1)*(a + c*x**(2*n))**p*appellf1(1 + 1/(2*n), 3, -p, 2 + 1/(2*n), e**2*x**(2*n)/d**2, -c*x**(2*n)/a)/(d**5*(1 + c*x**(2*n)/a)**p*(2*n + 1)) - e**3*x**(3*n + 1)*(a + c*x**(2*n))**p*appellf1(sympy.S(3)/2 + 1/(2*n), 3, -p, sympy.S(5)/2 + 1/(2*n), e**2*x**(2*n)/d**2, -c*x**(2*n)/a)/(d**6*(1 + c*x**(2*n)/a)**p*(3*n + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)*(a + b*x**n + c*x**(2*n)),
        variable=x,
        num_steps=2,
        integral=a*d*x + c*e*x**(3*n + 1)/(3*n + 1) + x**(n + 1)*(a*e + b*d)/(n + 1) + x**(2*n + 1)*(b*e + c*d)/(2*n + 1),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)*(a + b*x**n + c*x**(2*n))**2,
        variable=x,
        num_steps=2,
        integral=a**2*d*x + a*x**(n + 1)*(a*e + 2*b*d)/(n + 1) + c**2*e*x**(5*n + 1)/(5*n + 1) + c*x**(4*n + 1)*(2*b*e + c*d)/(4*n + 1) + x**(2*n + 1)*(2*a*b*e + 2*a*c*d + b**2*d)/(2*n + 1) + x**(3*n + 1)*(2*a*c*e + b**2*e + 2*b*c*d)/(3*n + 1),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)*(a + b*x**n + c*x**(2*n))**3,
        variable=x,
        num_steps=2,
        integral=a**3*d*x + a**2*x**(n + 1)*(a*e + 3*b*d)/(n + 1) + 3*a*x**(2*n + 1)*(a*b*e + a*c*d + b**2*d)/(2*n + 1) + c**3*e*x**(7*n + 1)/(7*n + 1) + c**2*x**(6*n + 1)*(3*b*e + c*d)/(6*n + 1) + 3*c*x**(5*n + 1)*(a*c*e + b**2*e + b*c*d)/(5*n + 1) + x**(3*n + 1)*(3*a**2*c*e + 3*a*b**2*e + 6*a*b*c*d + b**3*d)/(3*n + 1) + x**(4*n + 1)*(6*a*b*c*e + 3*a*c**2*d + b**3*e + 3*b**2*c*d)/(4*n + 1),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)**3/(a + b*x**n + c*x**(2*n)),
        variable=x,
        num_steps=5,
        integral=e**3*x**(n + 1)/(c*(n + 1)) + e**2*x*(-b*e + 3*c*d)/c**2 + x*(-a*c*e**3 + b**2*e**3 - 3*b*c*d*e**2 + 3*c**2*d**2*e - (-b*e + 2*c*d)*(b**2*e**2 + c**2*d**2 - c*e*(3*a*e + b*d))/sqrt(-4*a*c + b**2))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(c**2*(b + sqrt(-4*a*c + b**2))) + x*(-a*c*e**3 + b**2*e**3 - 3*b*c*d*e**2 + 3*c**2*d**2*e + (-b*e + 2*c*d)*(b**2*e**2 + c**2*d**2 - c*e*(3*a*e + b*d))/sqrt(-4*a*c + b**2))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(c**2*(b - sqrt(-4*a*c + b**2))),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)**2/(a + b*x**n + c*x**(2*n)),
        variable=x,
        num_steps=5,
        integral=e**2*x/c + x*(-b*e**2 + 2*c*d*e - (b**2*e**2 + 2*c**2*d**2 - 2*c*e*(a*e + b*d))/sqrt(-4*a*c + b**2))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(c*(b + sqrt(-4*a*c + b**2))) + x*(-b*e**2 + 2*c*d*e + (b**2*e**2 + 2*c**2*d**2 - 2*c*e*(a*e + b*d))/sqrt(-4*a*c + b**2))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(c*(b - sqrt(-4*a*c + b**2))),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)/(a + b*x**n + c*x**(2*n)),
        variable=x,
        num_steps=3,
        integral=x*(e - (-b*e + 2*c*d)/sqrt(-4*a*c + b**2))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(b + sqrt(-4*a*c + b**2)) + x*(e + (-b*e + 2*c*d)/sqrt(-4*a*c + b**2))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/(b - sqrt(-4*a*c + b**2)),
    ),
    RubiTestSuiteCase(
        integrand=1/((d + e*x**n)*(a + b*x**n + c*x**(2*n))),
        variable=x,
        num_steps=6,
        integral=-c*x*(2*c*d - e*(b + sqrt(-4*a*c + b**2)))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/((-4*a*c + b**2 - b*sqrt(-4*a*c + b**2))*(a*e**2 - b*d*e + c*d**2)) - c*x*(e + (-b*e + 2*c*d)/sqrt(-4*a*c + b**2))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/((b + sqrt(-4*a*c + b**2))*(a*e**2 - b*d*e + c*d**2)) + e**2*x*hyper((1, 1/n), (1 + 1/n,), -e*x**n/d)/(d*(a*e**2 - b*d*e + c*d**2)),
    ),
    RubiTestSuiteCase(
        integrand=1/((d + e*x**n)**2*(a + b*x**n + c*x**(2*n))),
        variable=x,
        num_steps=7,
        integral=-c*x*(b*e**2*(b - sqrt(-4*a*c + b**2)) + 2*c**2*d**2 - 2*c*e*(a*e + b*d - d*sqrt(-4*a*c + b**2)))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/((-4*a*c + b**2 + b*sqrt(-4*a*c + b**2))*(a*e**2 - b*d*e + c*d**2)**2) - c*x*(b*e**2*(b + sqrt(-4*a*c + b**2)) + 2*c**2*d**2 - 2*c*e*(a*e + b*d + d*sqrt(-4*a*c + b**2)))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/((-4*a*c + b**2 - b*sqrt(-4*a*c + b**2))*(a*e**2 - b*d*e + c*d**2)**2) + e**2*x*(-b*e + 2*c*d)*hyper((1, 1/n), (1 + 1/n,), -e*x**n/d)/(d*(a*e**2 - b*d*e + c*d**2)**2) + e**2*x*hyper((2, 1/n), (1 + 1/n,), -e*x**n/d)/(d**2*(a*e**2 - b*d*e + c*d**2)),
    ),
    RubiTestSuiteCase(
        integrand=1/((d + e*x**n)**3*(a + b*x**n + c*x**(2*n))),
        variable=x,
        num_steps=8,
        integral=-c*x*(-b**2*e**3*(b - sqrt(-4*a*c + b**2)) + 2*c**3*d**3 - 3*c**2*d*e*(2*a*e + b*d - d*sqrt(-4*a*c + b**2)) + c*e**2*(3*a*b*e - a*e*sqrt(-4*a*c + b**2) + 3*b**2*d - 3*b*d*sqrt(-4*a*c + b**2)))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/((-4*a*c + b**2 + b*sqrt(-4*a*c + b**2))*(a*e**2 - b*d*e + c*d**2)**3) - c*x*(-b**2*e**3*(b + sqrt(-4*a*c + b**2)) + 2*c**3*d**3 - 3*c**2*d*e*(2*a*e + b*d + d*sqrt(-4*a*c + b**2)) + c*e**2*(a*e*sqrt(-4*a*c + b**2) + 3*b**2*d + 3*b*(a*e + d*sqrt(-4*a*c + b**2))))*hyper((1, 1/n), (1 + 1/n,), -2*c*x**n/(b - sqrt(-4*a*c + b**2)))/((-4*a*c + b**2 - b*sqrt(-4*a*c + b**2))*(a*e**2 - b*d*e + c*d**2)**3) + e**2*x*(b**2*e**2 + 3*c**2*d**2 - c*e*(a*e + 3*b*d))*hyper((1, 1/n), (1 + 1/n,), -e*x**n/d)/(d*(a*e**2 - b*d*e + c*d**2)**3) + e**2*x*(-b*e + 2*c*d)*hyper((2, 1/n), (1 + 1/n,), -e*x**n/d)/(d**2*(a*e**2 - b*d*e + c*d**2)**2) + e**2*x*hyper((3, 1/n), (1 + 1/n,), -e*x**n/d)/(d**3*(a*e**2 - b*d*e + c*d**2)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)**3/(a + b*x**n + c*x**(2*n))**2,
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=1/((d + e*x**n)**2*(a + b*x**n + c*x**(2*n))**2),
        variable=x,
        num_steps=11,
    ...
    RubiTestSuiteCase(
        integrand=(d + e*x**n)**3/(a + b*x**n + c*x**(2*n))**3,
        variable=x,
        num_steps=11,
    ...
    RubiTestSuiteCase(
        integrand=1/((d + e*x**n)**2*(a + b*x**n + c*x**(2*n))**3),
        variable=x,
        num_steps=16,
    ...
    RubiTestSuiteCase(
        integrand=(d + e*x**n)*sqrt(a + b*x**n + c*x**(2*n)),
        variable=x,
        num_steps=6,
        integral=d*x*sqrt(a + b*x**n + c*x**(2*n))*appellf1(1/n, sympy.S(-1)/2, sympy.S(-1)/2, 1 + 1/n, -2*c*x**n/(b - sqrt(-4*a*c + b**2)), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(sqrt(2*c*x**n/(b - sqrt(-4*a*c + b**2)) + 1)*sqrt(2*c*x**n/(b + sqrt(-4*a*c + b**2)) + 1)) + e*x**(n + 1)*sqrt(a + b*x**n + c*x**(2*n))*appellf1(1 + 1/n, sympy.S(-1)/2, sympy.S(-1)/2, 2 + 1/n, -2*c*x**n/(b - sqrt(-4*a*c + b**2)), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/((n + 1)*sqrt(2*c*x**n/(b - sqrt(-4*a*c + b**2)) + 1)*sqrt(2*c*x**n/(b + sqrt(-4*a*c + b**2)) + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)*(a + b*x**n + c*x**(2*n))**(sympy.S(3)/2),
        variable=x,
        num_steps=6,
        integral=a*d*x*sqrt(a + b*x**n + c*x**(2*n))*appellf1(1/n, sympy.S(-3)/2, sympy.S(-3)/2, 1 + 1/n, -2*c*x**n/(b - sqrt(-4*a*c + b**2)), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(sqrt(2*c*x**n/(b - sqrt(-4*a*c + b**2)) + 1)*sqrt(2*c*x**n/(b + sqrt(-4*a*c + b**2)) + 1)) + a*e*x**(n + 1)*sqrt(a + b*x**n + c*x**(2*n))*appellf1(1 + 1/n, sympy.S(-3)/2, sympy.S(-3)/2, 2 + 1/n, -2*c*x**n/(b - sqrt(-4*a*c + b**2)), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/((n + 1)*sqrt(2*c*x**n/(b - sqrt(-4*a*c + b**2)) + 1)*sqrt(2*c*x**n/(b + sqrt(-4*a*c + b**2)) + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)/sqrt(a + b*x**n + c*x**(2*n)),
        variable=x,
        num_steps=6,
        integral=d*x*sqrt(2*c*x**n/(b - sqrt(-4*a*c + b**2)) + 1)*sqrt(2*c*x**n/(b + sqrt(-4*a*c + b**2)) + 1)*appellf1(1/n, sympy.S.Half, sympy.S.Half, 1 + 1/n, -2*c*x**n/(b - sqrt(-4*a*c + b**2)), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/sqrt(a + b*x**n + c*x**(2*n)) + e*x**(n + 1)*sqrt(2*c*x**n/(b - sqrt(-4*a*c + b**2)) + 1)*sqrt(2*c*x**n/(b + sqrt(-4*a*c + b**2)) + 1)*appellf1(1 + 1/n, sympy.S.Half, sympy.S.Half, 2 + 1/n, -2*c*x**n/(b - sqrt(-4*a*c + b**2)), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/((n + 1)*sqrt(a + b*x**n + c*x**(2*n))),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)/(a + b*x**n + c*x**(2*n))**(sympy.S(3)/2),
        variable=x,
        num_steps=6,
        integral=d*x*sqrt(2*c*x**n/(b - sqrt(-4*a*c + b**2)) + 1)*sqrt(2*c*x**n/(b + sqrt(-4*a*c + b**2)) + 1)*appellf1(1/n, sympy.S(3)/2, sympy.S(3)/2, 1 + 1/n, -2*c*x**n/(b - sqrt(-4*a*c + b**2)), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(a*sqrt(a + b*x**n + c*x**(2*n))) + e*x**(n + 1)*sqrt(2*c*x**n/(b - sqrt(-4*a*c + b**2)) + 1)*sqrt(2*c*x**n/(b + sqrt(-4*a*c + b**2)) + 1)*appellf1(1 + 1/n, sympy.S(3)/2, sympy.S(3)/2, 2 + 1/n, -2*c*x**n/(b - sqrt(-4*a*c + b**2)), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(a*(n + 1)*sqrt(a + b*x**n + c*x**(2*n))),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)/(a + b*x**n + c*x**(2*n))**(sympy.S(5)/2),
        variable=x,
        num_steps=6,
        integral=d*x*sqrt(2*c*x**n/(b - sqrt(-4*a*c + b**2)) + 1)*sqrt(2*c*x**n/(b + sqrt(-4*a*c + b**2)) + 1)*appellf1(1/n, sympy.S(5)/2, sympy.S(5)/2, 1 + 1/n, -2*c*x**n/(b - sqrt(-4*a*c + b**2)), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(a**2*sqrt(a + b*x**n + c*x**(2*n))) + e*x**(n + 1)*sqrt(2*c*x**n/(b - sqrt(-4*a*c + b**2)) + 1)*sqrt(2*c*x**n/(b + sqrt(-4*a*c + b**2)) + 1)*appellf1(1 + 1/n, sympy.S(5)/2, sympy.S(5)/2, 2 + 1/n, -2*c*x**n/(b - sqrt(-4*a*c + b**2)), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/(a**2*(n + 1)*sqrt(a + b*x**n + c*x**(2*n))),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)**q*(a + b*x**n + c*x**(2*n))**p,
        variable=x,
        num_steps=0,
        integral=sympy.Function('Unintegrable')((((Symbol('d') + (Symbol('e') * (x)**(Symbol('n')))))**(Symbol('q')) * ((Symbol('a') + (Symbol('b') * (x)**(Symbol('n'))) + (Symbol('c') * (x)**((Integer(2) * Symbol('n'))))))**(Symbol('p'))), x),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)**3*(a + b*x**n + c*x**(2*n))**p,
        variable=x,
        num_steps=10,
        integral=d**3*x*(a + b*x**n + c*x**(2*n))**p*appellf1(1/n, -p, -p, 1 + 1/n, -2*c*x**n/(b - sqrt(-4*a*c + b**2)), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/((2*c*x**n/(b - sqrt(-4*a*c + b**2)) + 1)**p*(2*c*x**n/(b + sqrt(-4*a*c + b**2)) + 1)**p) + 3*d**2*e*x**(n + 1)*(a + b*x**n + c*x**(2*n))**p*appellf1(1 + 1/n, -p, -p, 2 + 1/n, -2*c*x**n/(b - sqrt(-4*a*c + b**2)), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/((n + 1)*(2*c*x**n/(b - sqrt(-4*a*c + b**2)) + 1)**p*(2*c*x**n/(b + sqrt(-4*a*c + b**2)) + 1)**p) + 3*d*e**2*x**(2*n + 1)*(a + b*x**n + c*x**(2*n))**p*appellf1(2 + 1/n, -p, -p, 3 + 1/n, -2*c*x**n/(b - sqrt(-4*a*c + b**2)), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/((2*n + 1)*(2*c*x**n/(b - sqrt(-4*a*c + b**2)) + 1)**p*(2*c*x**n/(b + sqrt(-4*a*c + b**2)) + 1)**p) + e**3*x**(3*n + 1)*(a + b*x**n + c*x**(2*n))**p*appellf1(3 + 1/n, -p, -p, 4 + 1/n, -2*c*x**n/(b - sqrt(-4*a*c + b**2)), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/((3*n + 1)*(2*c*x**n/(b - sqrt(-4*a*c + b**2)) + 1)**p*(2*c*x**n/(b + sqrt(-4*a*c + b**2)) + 1)**p),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)**2*(a + b*x**n + c*x**(2*n))**p,
        variable=x,
        num_steps=8,
        integral=d**2*x*(a + b*x**n + c*x**(2*n))**p*appellf1(1/n, -p, -p, 1 + 1/n, -2*c*x**n/(b - sqrt(-4*a*c + b**2)), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/((2*c*x**n/(b - sqrt(-4*a*c + b**2)) + 1)**p*(2*c*x**n/(b + sqrt(-4*a*c + b**2)) + 1)**p) + 2*d*e*x**(n + 1)*(a + b*x**n + c*x**(2*n))**p*appellf1(1 + 1/n, -p, -p, 2 + 1/n, -2*c*x**n/(b - sqrt(-4*a*c + b**2)), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/((n + 1)*(2*c*x**n/(b - sqrt(-4*a*c + b**2)) + 1)**p*(2*c*x**n/(b + sqrt(-4*a*c + b**2)) + 1)**p) + e**2*x**(2*n + 1)*(a + b*x**n + c*x**(2*n))**p*appellf1(2 + 1/n, -p, -p, 3 + 1/n, -2*c*x**n/(b - sqrt(-4*a*c + b**2)), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/((2*n + 1)*(2*c*x**n/(b - sqrt(-4*a*c + b**2)) + 1)**p*(2*c*x**n/(b + sqrt(-4*a*c + b**2)) + 1)**p),
    ),
    RubiTestSuiteCase(
        integrand=(d + e*x**n)*(a + b*x**n + c*x**(2*n))**p,
        variable=x,
        num_steps=6,
        integral=d*x*(a + b*x**n + c*x**(2*n))**p*appellf1(1/n, -p, -p, 1 + 1/n, -2*c*x**n/(b - sqrt(-4*a*c + b**2)), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/((2*c*x**n/(b - sqrt(-4*a*c + b**2)) + 1)**p*(2*c*x**n/(b + sqrt(-4*a*c + b**2)) + 1)**p) + e*x**(n + 1)*(a + b*x**n + c*x**(2*n))**p*appellf1(1 + 1/n, -p, -p, 2 + 1/n, -2*c*x**n/(b - sqrt(-4*a*c + b**2)), -2*c*x**n/(b + sqrt(-4*a*c + b**2)))/((n + 1)*(2*c*x**n/(b - sqrt(-4*a*c + b**2)) + 1)**p*(2*c*x**n/(b + sqrt(-4*a*c + b**2)) + 1)**p),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**n + c*x**(2*n))**p/(d + e*x**n),
        variable=x,
        num_steps=0,
        integral=sympy.Function('Unintegrable')((((Symbol('a') + (Symbol('b') * (x)**(Symbol('n'))) + (Symbol('c') * (x)**((Integer(2) * Symbol('n'))))))**(Symbol('p')) * ((Symbol('d') + (Symbol('e') * (x)**(Symbol('n')))))**(Integer(-1))), x),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**n + c*x**(2*n))**p/(d + e*x**n)**2,
        variable=x,
        num_steps=0,
        integral=sympy.Function('Unintegrable')((((Symbol('a') + (Symbol('b') * (x)**(Symbol('n'))) + (Symbol('c') * (x)**((Integer(2) * Symbol('n'))))))**(Symbol('p')) * (((Symbol('d') + (Symbol('e') * (x)**(Symbol('n')))))**(Integer(2)))**(Integer(-1))), x),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x**n + c*x**(2*n))**p/(d + e*x**n)**3,
        variable=x,
        num_steps=0,
        integral=sympy.Function('Unintegrable')((((Symbol('a') + (Symbol('b') * (x)**(Symbol('n'))) + (Symbol('c') * (x)**((Integer(2) * Symbol('n'))))))**(Symbol('p')) * (((Symbol('d') + (Symbol('e') * (x)**(Symbol('n')))))**(Integer(3)))**(Integer(-1))), x),
    ),
]
