...
SOURCE_FILE = '5 Inverse trig functions/5.2 Inverse cosine/5.2.5 Inverse cosine functions.m'
...
TEST_CASES = [
    RubiTestSuiteCase(
        integrand=x**3*(a + b*acos(c*x))/(-c**2*d*x**2 + d),
        variable=x,
        num_steps=8,
        integral=(((Symbol('b') * x * sympy.sqrt((Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2))))))) * ((Integer(4) * (Symbol('c'))**(Integer(3)) * Symbol('d')))**(Integer(-1))) + (Integer(-1) * (((x)**(Integer(2)) * (Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x))))) * ((Integer(2) * (Symbol('c'))**(Integer(2)) * Symbol('d')))**(Integer(-1)))) + ((sympy.I * ((Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))))**(Integer(2))) * ((Integer(2) * Symbol('b') * (Symbol('c'))**(Integer(4)) * Symbol('d')))**(Integer(-1))) + (Integer(-1) * ((Symbol('b') * sympy.asin((Symbol('c') * x))) * ((Integer(4) * (Symbol('c'))**(Integer(4)) * Symbol('d')))**(Integer(-1)))) + (Integer(-1) * (((Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))) * sympy.log((Integer(1) + (Integer(-1) * (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * x)))))))) * (((Symbol('c'))**(Integer(4)) * Symbol('d')))**(Integer(-1)))) + ((sympy.I * Symbol('b') * sympy.Function('PolyLog')(Integer(2), (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * x)))))) * ((Integer(2) * (Symbol('c'))**(Integer(4)) * Symbol('d')))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=x**2*(a + b*acos(c*x))/(-c**2*d*x**2 + d),
        variable=x,
        num_steps=8,
        integral=(((Symbol('b') * sympy.sqrt((Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2))))))) * (((Symbol('c'))**(Integer(3)) * Symbol('d')))**(Integer(-1))) + (Integer(-1) * ((x * (Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x))))) * (((Symbol('c'))**(Integer(2)) * Symbol('d')))**(Integer(-1)))) + ((Integer(2) * (Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))) * sympy.atanh((sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x)))))) * (((Symbol('c'))**(Integer(3)) * Symbol('d')))**(Integer(-1))) + (Integer(-1) * ((sympy.I * Symbol('b') * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x))))))) * (((Symbol('c'))**(Integer(3)) * Symbol('d')))**(Integer(-1)))) + ((sympy.I * Symbol('b') * sympy.Function('PolyLog')(Integer(2), (sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x)))))) * (((Symbol('c'))**(Integer(3)) * Symbol('d')))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=x*(a + b*acos(c*x))/(-c**2*d*x**2 + d),
        variable=x,
        num_steps=5,
        integral=(((sympy.I * ((Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))))**(Integer(2))) * ((Integer(2) * Symbol('b') * (Symbol('c'))**(Integer(2)) * Symbol('d')))**(Integer(-1))) + (Integer(-1) * (((Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))) * sympy.log((Integer(1) + (Integer(-1) * (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * x)))))))) * (((Symbol('c'))**(Integer(2)) * Symbol('d')))**(Integer(-1)))) + ((sympy.I * Symbol('b') * sympy.Function('PolyLog')(Integer(2), (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * x)))))) * ((Integer(2) * (Symbol('c'))**(Integer(2)) * Symbol('d')))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(c*x))/(-c**2*d*x**2 + d),
        variable=x,
        num_steps=6,
        integral=(((Integer(2) * (Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))) * sympy.atanh((sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x)))))) * ((Symbol('c') * Symbol('d')))**(Integer(-1))) + (Integer(-1) * ((sympy.I * Symbol('b') * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x))))))) * ((Symbol('c') * Symbol('d')))**(Integer(-1)))) + ((sympy.I * Symbol('b') * sympy.Function('PolyLog')(Integer(2), (sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x)))))) * ((Symbol('c') * Symbol('d')))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(c*x))/(x*(-c**2*d*x**2 + d)),
        variable=x,
        num_steps=7,
        integral=(((Integer(2) * (Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))) * sympy.atanh((sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * x)))))) * (Symbol('d'))**(Integer(-1))) + (Integer(-1) * ((sympy.I * Symbol('b') * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * x))))))) * ((Integer(2) * Symbol('d')))**(Integer(-1)))) + ((sympy.I * Symbol('b') * sympy.Function('PolyLog')(Integer(2), (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * x)))))) * ((Integer(2) * Symbol('d')))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(c*x))/(x**2*(-c**2*d*x**2 + d)),
        variable=x,
        num_steps=10,
        integral=((Integer(-1) * ((Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))) * ((Symbol('d') * x))**(Integer(-1)))) + ((Integer(2) * Symbol('c') * (Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))) * sympy.atanh((sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x)))))) * (Symbol('d'))**(Integer(-1))) + ((Symbol('b') * Symbol('c') * sympy.atanh(sympy.sqrt((Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2)))))))) * (Symbol('d'))**(Integer(-1))) + (Integer(-1) * ((sympy.I * Symbol('b') * Symbol('c') * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x))))))) * (Symbol('d'))**(Integer(-1)))) + ((sympy.I * Symbol('b') * Symbol('c') * sympy.Function('PolyLog')(Integer(2), (sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x)))))) * (Symbol('d'))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(c*x))/(x**3*(-c**2*d*x**2 + d)),
        variable=x,
        num_steps=9,
        integral=(((Symbol('b') * Symbol('c') * sympy.sqrt((Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2))))))) * ((Integer(2) * Symbol('d') * x))**(Integer(-1))) + (Integer(-1) * ((Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))) * ((Integer(2) * Symbol('d') * (x)**(Integer(2))))**(Integer(-1)))) + ((Integer(2) * (Symbol('c'))**(Integer(2)) * (Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))) * sympy.atanh((sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * x)))))) * (Symbol('d'))**(Integer(-1))) + (Integer(-1) * ((sympy.I * Symbol('b') * (Symbol('c'))**(Integer(2)) * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * x))))))) * ((Integer(2) * Symbol('d')))**(Integer(-1)))) + ((sympy.I * Symbol('b') * (Symbol('c'))**(Integer(2)) * sympy.Function('PolyLog')(Integer(2), (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * x)))))) * ((Integer(2) * Symbol('d')))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=x**4*(a + b*acos(c*x))/(-c**2*d*x**2 + d)**2,
        variable=x,
        num_steps=12,
        integral=((Symbol('b') * ((Integer(2) * (Symbol('c'))**(Integer(5)) * (Symbol('d'))**(Integer(2)) * sympy.sqrt((Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2))))))))**(Integer(-1))) + (Integer(-1) * ((Symbol('b') * sympy.sqrt((Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2))))))) * (((Symbol('c'))**(Integer(5)) * (Symbol('d'))**(Integer(2))))**(Integer(-1)))) + ((Integer(3) * x * (Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x))))) * ((Integer(2) * (Symbol('c'))**(Integer(4)) * (Symbol('d'))**(Integer(2))))**(Integer(-1))) + (((x)**(Integer(3)) * (Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x))))) * ((Integer(2) * (Symbol('c'))**(Integer(2)) * (Symbol('d'))**(Integer(2)) * (Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2)))))))**(Integer(-1))) + (Integer(-1) * ((Integer(3) * (Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))) * sympy.atanh((sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x)))))) * (((Symbol('c'))**(Integer(5)) * (Symbol('d'))**(Integer(2))))**(Integer(-1)))) + ((Integer(3) * sympy.I * Symbol('b') * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x))))))) * ((Integer(2) * (Symbol('c'))**(Integer(5)) * (Symbol('d'))**(Integer(2))))**(Integer(-1))) + (Integer(-1) * ((Integer(3) * sympy.I * Symbol('b') * sympy.Function('PolyLog')(Integer(2), (sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x)))))) * ((Integer(2) * (Symbol('c'))**(Integer(5)) * (Symbol('d'))**(Integer(2))))**(Integer(-1))))),
    ),
    RubiTestSuiteCase(
        integrand=x**3*(a + b*acos(c*x))/(-c**2*d*x**2 + d)**2,
        variable=x,
        num_steps=8,
        integral=(((Symbol('b') * x) * ((Integer(2) * (Symbol('c'))**(Integer(3)) * (Symbol('d'))**(Integer(2)) * sympy.sqrt((Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2))))))))**(Integer(-1))) + (((x)**(Integer(2)) * (Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x))))) * ((Integer(2) * (Symbol('c'))**(Integer(2)) * (Symbol('d'))**(Integer(2)) * (Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2)))))))**(Integer(-1))) + (Integer(-1) * ((sympy.I * ((Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))))**(Integer(2))) * ((Integer(2) * Symbol('b') * (Symbol('c'))**(Integer(4)) * (Symbol('d'))**(Integer(2))))**(Integer(-1)))) + (Integer(-1) * ((Symbol('b') * sympy.asin((Symbol('c') * x))) * ((Integer(2) * (Symbol('c'))**(Integer(4)) * (Symbol('d'))**(Integer(2))))**(Integer(-1)))) + (((Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))) * sympy.log((Integer(1) + (Integer(-1) * (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * x)))))))) * (((Symbol('c'))**(Integer(4)) * (Symbol('d'))**(Integer(2))))**(Integer(-1))) + (Integer(-1) * ((sympy.I * Symbol('b') * sympy.Function('PolyLog')(Integer(2), (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * x)))))) * ((Integer(2) * (Symbol('c'))**(Integer(4)) * (Symbol('d'))**(Integer(2))))**(Integer(-1))))),
    ),
    RubiTestSuiteCase(
        integrand=x**2*(a + b*acos(c*x))/(-c**2*d*x**2 + d)**2,
        variable=x,
        num_steps=8,
        integral=((Symbol('b') * ((Integer(2) * (Symbol('c'))**(Integer(3)) * (Symbol('d'))**(Integer(2)) * sympy.sqrt((Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2))))))))**(Integer(-1))) + ((x * (Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x))))) * ((Integer(2) * (Symbol('c'))**(Integer(2)) * (Symbol('d'))**(Integer(2)) * (Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2)))))))**(Integer(-1))) + (Integer(-1) * (((Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))) * sympy.atanh((sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x)))))) * (((Symbol('c'))**(Integer(3)) * (Symbol('d'))**(Integer(2))))**(Integer(-1)))) + ((sympy.I * Symbol('b') * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x))))))) * ((Integer(2) * (Symbol('c'))**(Integer(3)) * (Symbol('d'))**(Integer(2))))**(Integer(-1))) + (Integer(-1) * ((sympy.I * Symbol('b') * sympy.Function('PolyLog')(Integer(2), (sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x)))))) * ((Integer(2) * (Symbol('c'))**(Integer(3)) * (Symbol('d'))**(Integer(2))))**(Integer(-1))))),
    ),
    RubiTestSuiteCase(
        integrand=x*(a + b*acos(c*x))/(-c**2*d*x**2 + d)**2,
        variable=x,
        num_steps=2,
        integral=b*x/(2*c*d**2*sqrt(-c**2*x**2 + 1)) + (a + b*acos(c*x))/(2*c**2*d**2*(-c**2*x**2 + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(c*x))/(-c**2*d*x**2 + d)**2,
        variable=x,
        num_steps=8,
        integral=((Symbol('b') * ((Integer(2) * Symbol('c') * (Symbol('d'))**(Integer(2)) * sympy.sqrt((Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2))))))))**(Integer(-1))) + ((x * (Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x))))) * ((Integer(2) * (Symbol('d'))**(Integer(2)) * (Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2)))))))**(Integer(-1))) + (((Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))) * sympy.atanh((sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x)))))) * ((Symbol('c') * (Symbol('d'))**(Integer(2))))**(Integer(-1))) + (Integer(-1) * ((sympy.I * Symbol('b') * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x))))))) * ((Integer(2) * Symbol('c') * (Symbol('d'))**(Integer(2))))**(Integer(-1)))) + ((sympy.I * Symbol('b') * sympy.Function('PolyLog')(Integer(2), (sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x)))))) * ((Integer(2) * Symbol('c') * (Symbol('d'))**(Integer(2))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(c*x))/(x*(-c**2*d*x**2 + d)**2),
        variable=x,
        num_steps=9,
        integral=(((Symbol('b') * Symbol('c') * x) * ((Integer(2) * (Symbol('d'))**(Integer(2)) * sympy.sqrt((Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2))))))))**(Integer(-1))) + ((Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))) * ((Integer(2) * (Symbol('d'))**(Integer(2)) * (Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2)))))))**(Integer(-1))) + ((Integer(2) * (Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))) * sympy.atanh((sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * x)))))) * ((Symbol('d'))**(Integer(2)))**(Integer(-1))) + (Integer(-1) * ((sympy.I * Symbol('b') * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * x))))))) * ((Integer(2) * (Symbol('d'))**(Integer(2))))**(Integer(-1)))) + ((sympy.I * Symbol('b') * sympy.Function('PolyLog')(Integer(2), (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * x)))))) * ((Integer(2) * (Symbol('d'))**(Integer(2))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(c*x))/(x**2*(-c**2*d*x**2 + d)**2),
        variable=x,
        num_steps=13,
        integral=(((Symbol('b') * Symbol('c')) * ((Integer(2) * (Symbol('d'))**(Integer(2)) * sympy.sqrt((Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2))))))))**(Integer(-1))) + (Integer(-1) * ((Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))) * (((Symbol('d'))**(Integer(2)) * x * (Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2)))))))**(Integer(-1)))) + ((Integer(3) * (Symbol('c'))**(Integer(2)) * x * (Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x))))) * ((Integer(2) * (Symbol('d'))**(Integer(2)) * (Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2)))))))**(Integer(-1))) + ((Integer(3) * Symbol('c') * (Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))) * sympy.atanh((sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x)))))) * ((Symbol('d'))**(Integer(2)))**(Integer(-1))) + ((Symbol('b') * Symbol('c') * sympy.atanh(sympy.sqrt((Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2)))))))) * ((Symbol('d'))**(Integer(2)))**(Integer(-1))) + (Integer(-1) * ((Integer(3) * sympy.I * Symbol('b') * Symbol('c') * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x))))))) * ((Integer(2) * (Symbol('d'))**(Integer(2))))**(Integer(-1)))) + ((Integer(3) * sympy.I * Symbol('b') * Symbol('c') * sympy.Function('PolyLog')(Integer(2), (sympy.E)**((sympy.I * sympy.acos((Symbol('c') * x)))))) * ((Integer(2) * (Symbol('d'))**(Integer(2))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(c*x))/(x**3*(-c**2*d*x**2 + d)**2),
        variable=x,
        num_steps=12,
        integral=(((Symbol('b') * Symbol('c')) * ((Integer(2) * (Symbol('d'))**(Integer(2)) * x * sympy.sqrt((Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2))))))))**(Integer(-1))) + (((Symbol('c'))**(Integer(2)) * (Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x))))) * (((Symbol('d'))**(Integer(2)) * (Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2)))))))**(Integer(-1))) + (Integer(-1) * ((Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))) * ((Integer(2) * (Symbol('d'))**(Integer(2)) * (x)**(Integer(2)) * (Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2)))))))**(Integer(-1)))) + ((Integer(4) * (Symbol('c'))**(Integer(2)) * (Symbol('a') + (Symbol('b') * sympy.acos((Symbol('c') * x)))) * sympy.atanh((sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * x)))))) * ((Symbol('d'))**(Integer(2)))**(Integer(-1))) + (Integer(-1) * ((sympy.I * Symbol('b') * (Symbol('c'))**(Integer(2)) * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * x))))))) * ((Symbol('d'))**(Integer(2)))**(Integer(-1)))) + ((sympy.I * Symbol('b') * (Symbol('c'))**(Integer(2)) * sympy.Function('PolyLog')(Integer(2), (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * x)))))) * ((Symbol('d'))**(Integer(2)))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(c*x))*(f + g*x)**3*sqrt(-c**2*d*x**2 + d),
        variable=x,
        num_steps=16,
        integral=b*c*f**3*x**2*sqrt(-c**2*d*x**2 + d)/(4*sqrt(-c**2*x**2 + 1)) + b*c*f**2*g*x**3*sqrt(-c**2*d*x**2 + d)/(3*sqrt(-c**2*x**2 + 1)) + 3*b*c*f*g**2*x**4*sqrt(-c**2*d*x**2 + d)/(16*sqrt(-c**2*x**2 + 1)) + b*c*g**3*x**5*sqrt(-c**2*d*x**2 + d)/(25*sqrt(-c**2*x**2 + 1)) - b*f**2*g*x*sqrt(-c**2*d*x**2 + d)/(c*sqrt(-c**2*x**2 + 1)) - 3*b*f*g**2*x**2*sqrt(-c**2*d*x**2 + d)/(16*c*sqrt(-c**2*x**2 + 1)) - b*g**3*x**3*sqrt(-c**2*d*x**2 + d)/(45*c*sqrt(-c**2*x**2 + 1)) - 2*b*g**3*x*sqrt(-c**2*d*x**2 + d)/(15*c**3*sqrt(-c**2*x**2 + 1)) + f**3*x*(a + b*acos(c*x))*sqrt(-c**2*d*x**2 + d)/2 + 3*f*g**2*x**3*(a + b*acos(c*x))*sqrt(-c**2*d*x**2 + d)/4 - f**2*g*(a + b*acos(c*x))*(-c**2*x**2 + 1)*sqrt(-c**2*d*x**2 + d)/c**2 - 3*f*g**2*x*(a + b*acos(c*x))*sqrt(-c**2*d*x**2 + d)/(8*c**2) + g**3*(a + b*acos(c*x))*(-c**2*x**2 + 1)**2*sqrt(-c**2*d*x**2 + d)/(5*c**4) - g**3*(a + b*acos(c*x))*(-c**2*x**2 + 1)*sqrt(-c**2*d*x**2 + d)/(3*c**4) - f**3*(a + b*acos(c*x))**2*sqrt(-c**2*d*x**2 + d)/(4*b*c*sqrt(-c**2*x**2 + 1)) - 3*f*g**2*(a + b*acos(c*x))**2*sqrt(-c**2*d*x**2 + d)/(16*b*c**3*sqrt(-c**2*x**2 + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(c*x))*(f + g*x)**2*sqrt(-c**2*d*x**2 + d),
        variable=x,
        num_steps=13,
        integral=b*c*f**2*x**2*sqrt(-c**2*d*x**2 + d)/(4*sqrt(-c**2*x**2 + 1)) + 2*b*c*f*g*x**3*sqrt(-c**2*d*x**2 + d)/(9*sqrt(-c**2*x**2 + 1)) + b*c*g**2*x**4*sqrt(-c**2*d*x**2 + d)/(16*sqrt(-c**2*x**2 + 1)) - 2*b*f*g*x*sqrt(-c**2*d*x**2 + d)/(3*c*sqrt(-c**2*x**2 + 1)) - b*g**2*x**2*sqrt(-c**2*d*x**2 + d)/(16*c*sqrt(-c**2*x**2 + 1)) + f**2*x*(a + b*acos(c*x))*sqrt(-c**2*d*x**2 + d)/2 + g**2*x**3*(a + b*acos(c*x))*sqrt(-c**2*d*x**2 + d)/4 - 2*f*g*(a + b*acos(c*x))*(-c**2*x**2 + 1)*sqrt(-c**2*d*x**2 + d)/(3*c**2) - g**2*x*(a + b*acos(c*x))*sqrt(-c**2*d*x**2 + d)/(8*c**2) - f**2*(a + b*acos(c*x))**2*sqrt(-c**2*d*x**2 + d)/(4*b*c*sqrt(-c**2*x**2 + 1)) - g**2*(a + b*acos(c*x))**2*sqrt(-c**2*d*x**2 + d)/(16*b*c**3*sqrt(-c**2*x**2 + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(c*x))*(f + g*x)*sqrt(-c**2*d*x**2 + d),
        variable=x,
        num_steps=8,
        integral=b*c*f*x**2*sqrt(-c**2*d*x**2 + d)/(4*sqrt(-c**2*x**2 + 1)) + b*c*g*x**3*sqrt(-c**2*d*x**2 + d)/(9*sqrt(-c**2*x**2 + 1)) - b*g*x*sqrt(-c**2*d*x**2 + d)/(3*c*sqrt(-c**2*x**2 + 1)) + f*x*(a + b*acos(c*x))*sqrt(-c**2*d*x**2 + d)/2 - g*(a + b*acos(c*x))*(-c**2*x**2 + 1)*sqrt(-c**2*d*x**2 + d)/(3*c**2) - f*(a + b*acos(c*x))**2*sqrt(-c**2*d*x**2 + d)/(4*b*c*sqrt(-c**2*x**2 + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(c*x))*sqrt(-c**2*d*x**2 + d)/(f + g*x),
        variable=x,
        num_steps=22,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*acos(c*x))*sqrt(-c**2*d*x**2 + d)/(f + g*x)**2,
        variable=x,
        num_steps=35,
    ...
    RubiTestSuiteCase(
        integrand=acos(a + b*x)/(a*d/b + d*x),
        variable=x,
        num_steps=7,
        integral=((Integer(-1) * ((sympy.I * (sympy.acos((Symbol('a') + (Symbol('b') * x))))**(Integer(2))) * ((Integer(2) * Symbol('d')))**(Integer(-1)))) + ((sympy.acos((Symbol('a') + (Symbol('b') * x))) * sympy.log((Integer(1) + (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('a') + (Symbol('b') * x)))))))) * (Symbol('d'))**(Integer(-1))) + (Integer(-1) * ((sympy.I * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('a') + (Symbol('b') * x)))))))) * ((Integer(2) * Symbol('d')))**(Integer(-1))))),
    ),
    RubiTestSuiteCase(
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=5,
        integral=x**4*acos(a*x**2)/4 - x**2*sqrt(-a**2*x**4 + 1)/(8*a) + asin(a*x**2)/(8*a**2),
    ),
    RubiTestSuiteCase(
        integrand=x**2*acos(a*x**2),
        variable=x,
        num_steps=4,
        integral=x**3*acos(a*x**2)/3 - 2*x*sqrt(-a**2*x**4 + 1)/(9*a) + 2*elliptic_f(asin(sqrt(a)*x), -1)/(9*a**(sympy.S(3)/2)),
    ),
    RubiTestSuiteCase(
        integrand=x*acos(a*x**2),
        variable=x,
        num_steps=3,
        integral=x**2*acos(a*x**2)/2 - sqrt(-a**2*x**4 + 1)/(2*a),
    ),
    RubiTestSuiteCase(
        integrand=acos(a*x**2),
        variable=x,
        num_steps=6,
        integral=x*acos(a*x**2) + 2*elliptic_e(asin(sqrt(a)*x), -1)/sqrt(a) - 2*elliptic_f(asin(sqrt(a)*x), -1)/sqrt(a),
    ),
    RubiTestSuiteCase(
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=3,
        integral=-2*sqrt(a)*elliptic_f(asin(sqrt(a)*x), -1) - acos(a*x**2)/x,
    ),
    RubiTestSuiteCase(
        integrand=x**2*acos(a/x),
        variable=x,
        num_steps=6,
        integral=-a**3*atanh(sqrt(-a**2/x**2 + 1))/6 - a*x**2*sqrt(-a**2/x**2 + 1)/6 + x**3*asec(x/a)/3,
    ),
    RubiTestSuiteCase(
        integrand=x*acos(a/x),
        variable=x,
        num_steps=3,
        integral=-a*x*sqrt(-a**2/x**2 + 1)/2 + x**2*asec(x/a)/2,
    ),
    RubiTestSuiteCase(
        integrand=acos(a/x),
        variable=x,
        num_steps=5,
        integral=-a*atanh(sqrt(-a**2/x**2 + 1)) + x*asec(x/a),
    ),
    RubiTestSuiteCase(
        integrand=acos(a/x)/x,
        variable=x,
        num_steps=5,
        integral=(((Integer(2))**(Integer(-1)) * sympy.I * (sympy.acos((Symbol('a') * (x)**(Integer(-1)))))**(Integer(2))) + (Integer(-1) * (sympy.acos((Symbol('a') * (x)**(Integer(-1)))) * sympy.log((Integer(1) + (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('a') * (x)**(Integer(-1)))))))))) + ((Integer(2))**(Integer(-1)) * sympy.I * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('a') * (x)**(Integer(-1)))))))))),
    ),
    RubiTestSuiteCase(
        integrand=acos(a/x)/x**2,
        variable=x,
        num_steps=3,
        integral=-asec(x/a)/x + sqrt(-a**2/x**2 + 1)/a,
    ),
    RubiTestSuiteCase(
        integrand=acos(a/x)/x**3,
        variable=x,
        num_steps=5,
        integral=-asec(x/a)/(2*x**2) + sqrt(-a**2/x**2 + 1)/(4*a*x) - acsc(x/a)/(4*a**2),
    ),
    RubiTestSuiteCase(
        integrand=acos(a/x)/x**4,
        variable=x,
        num_steps=5,
        integral=-asec(x/a)/(3*x**3) - (-a**2/x**2 + 1)**(sympy.S(3)/2)/(9*a**3) + sqrt(-a**2/x**2 + 1)/(3*a**3),
    ),
    RubiTestSuiteCase(
        integrand=x**2*acos(sqrt(x)),
        variable=x,
        num_steps=8,
        integral=-x**(sympy.S(5)/2)*sqrt(1 - x)/18 - 5*x**(sympy.S(3)/2)*sqrt(1 - x)/72 - 5*sqrt(x)*sqrt(1 - x)/48 + x**3*acos(sqrt(x))/3 + 5*asin(2*x - 1)/96,
    ),
    RubiTestSuiteCase(
        integrand=x*acos(sqrt(x)),
        variable=x,
        num_steps=7,
        integral=-x**(sympy.S(3)/2)*sqrt(1 - x)/8 - 3*sqrt(x)*sqrt(1 - x)/16 + x**2*acos(sqrt(x))/2 + 3*asin(2*x - 1)/32,
    ),
    RubiTestSuiteCase(
        integrand=acos(sqrt(x)),
        variable=x,
        num_steps=6,
        integral=-sqrt(x)*sqrt(1 - x)/2 + x*acos(sqrt(x)) + asin(2*x - 1)/4,
    ),
    RubiTestSuiteCase(
        integrand=acos(sqrt(x))/x,
        variable=x,
        num_steps=5,
        integral=(((Integer(-1) * sympy.I) * (sympy.acos(sympy.sqrt(x)))**(Integer(2))) + (Integer(2) * sympy.acos(sympy.sqrt(x)) * sympy.log((Integer(1) + (sympy.E)**((Integer(2) * sympy.I * sympy.acos(sympy.sqrt(x))))))) + (Integer(-1) * (sympy.I * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((Integer(2) * sympy.I * sympy.acos(sympy.sqrt(x))))))))),
    ),
    RubiTestSuiteCase(
        integrand=acos(sqrt(x))/x**2,
        variable=x,
        num_steps=3,
        integral=-acos(sqrt(x))/x + sqrt(1 - x)/sqrt(x),
    ),
    RubiTestSuiteCase(
        integrand=acos(sqrt(x))/x**3,
        variable=x,
        num_steps=4,
        integral=-acos(sqrt(x))/(2*x**2) + sqrt(1 - x)/(3*sqrt(x)) + sqrt(1 - x)/(6*x**(sympy.S(3)/2)),
    ),
    RubiTestSuiteCase(
        integrand=acos(sqrt(x))/x**4,
        variable=x,
        num_steps=5,
        integral=-acos(sqrt(x))/(3*x**3) + 8*sqrt(1 - x)/(45*sqrt(x)) + 4*sqrt(1 - x)/(45*x**(sympy.S(3)/2)) + sqrt(1 - x)/(15*x**(sympy.S(5)/2)),
    ),
    RubiTestSuiteCase(
        integrand=acos(sqrt(x))/x**5,
        variable=x,
        num_steps=6,
        integral=-acos(sqrt(x))/(4*x**4) + 4*sqrt(1 - x)/(35*sqrt(x)) + 2*sqrt(1 - x)/(35*x**(sympy.S(3)/2)) + 3*sqrt(1 - x)/(70*x**(sympy.S(5)/2)) + sqrt(1 - x)/(28*x**(sympy.S(7)/2)),
    ),
    RubiTestSuiteCase(
        integrand=acos(sqrt(x))/sqrt(x),
        variable=x,
        num_steps=3,
        integral=2*sqrt(x)*acos(sqrt(x)) - 2*sqrt(1 - x),
    ),
    RubiTestSuiteCase(
        integrand=acos(a*x**n)/x,
        variable=x,
        num_steps=5,
        integral=((Integer(-1) * ((sympy.I * (sympy.acos((Symbol('a') * (x)**(Symbol('n')))))**(Integer(2))) * ((Integer(2) * Symbol('n')))**(Integer(-1)))) + ((sympy.acos((Symbol('a') * (x)**(Symbol('n')))) * sympy.log((Integer(1) + (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('a') * (x)**(Symbol('n'))))))))) * (Symbol('n'))**(Integer(-1))) + (Integer(-1) * ((sympy.I * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('a') * (x)**(Symbol('n'))))))))) * ((Integer(2) * Symbol('n')))**(Integer(-1))))),
    ),
    RubiTestSuiteCase(
        integrand=acos(a*x**5)/x,
        variable=x,
        num_steps=5,
        integral=(((Integer(-1) * (Integer(10))**(Integer(-1))) * sympy.I * (sympy.acos((Symbol('a') * (x)**(Integer(5)))))**(Integer(2))) + ((Integer(5))**(Integer(-1)) * sympy.acos((Symbol('a') * (x)**(Integer(5)))) * sympy.log((Integer(1) + (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('a') * (x)**(Integer(5))))))))) + (Integer(-1) * ((Integer(10))**(Integer(-1)) * sympy.I * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('a') * (x)**(Integer(5))))))))))),
    ),
    RubiTestSuiteCase(
        integrand=x**3*acos(a + b*x**4),
        variable=x,
        num_steps=4,
        integral=-sqrt(1 - (a + b*x**4)**2)/(4*b) + (a + b*x**4)*acos(a + b*x**4)/(4*b),
    ),
    RubiTestSuiteCase(
        integrand=x**(n - 1)*acos(a + b*x**n),
        variable=x,
        num_steps=4,
        integral=-sqrt(1 - (a + b*x**n)**2)/(b*n) + (a + b*x**n)*acos(a + b*x**n)/(b*n),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(d*x**2 + 1))**4,
        variable=x,
        num_steps=3,
        integral=384*b**4*x + 192*b**3*(a + b*acos(d*x**2 + 1))*sqrt(-d**2*x**4 - 2*d*x**2)/(d*x) - 48*b**2*x*(a + b*acos(d*x**2 + 1))**2 - 8*b*(a + b*acos(d*x**2 + 1))**3*sqrt(-d**2*x**4 - 2*d*x**2)/(d*x) + x*(a + b*acos(d*x**2 + 1))**4,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(d*x**2 + 1))**3,
        variable=x,
        num_steps=5,
        integral=-24*a*b**2*x - 24*b**3*x*acos(d*x**2 + 1) + 48*b**3*sqrt(-d**2*x**4 - 2*d*x**2)/(d*x) - 6*b*(a + b*acos(d*x**2 + 1))**2*sqrt(-d**2*x**4 - 2*d*x**2)/(d*x) + x*(a + b*acos(d*x**2 + 1))**3,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(d*x**2 + 1))**2,
        variable=x,
        num_steps=2,
        integral=-8*b**2*x - 4*b*(a + b*acos(d*x**2 + 1))*sqrt(-d**2*x**4 - 2*d*x**2)/(d*x) + x*(a + b*acos(d*x**2 + 1))**2,
    ),
    RubiTestSuiteCase(
        integrand=a + b*acos(d*x**2 + 1),
        variable=x,
        num_steps=4,
        integral=a*x + b*x*acos(d*x**2 + 1) - 2*b*sqrt(-d**2*x**4 - 2*d*x**2)/(d*x),
    ),
    RubiTestSuiteCase(
        integrand=1/(a + b*acos(d*x**2 + 1)),
        variable=x,
        num_steps=1,
        integral=(((x * sympy.cos((Symbol('a') * ((Integer(2) * Symbol('b')))**(Integer(-1)))) * sympy.Function('CosIntegral')(((Symbol('a') + (Symbol('b') * sympy.acos((Integer(1) + (Symbol('d') * (x)**(Integer(2))))))) * ((Integer(2) * Symbol('b')))**(Integer(-1))))) * ((sympy.sqrt(Integer(2)) * Symbol('b') * sympy.sqrt(((Integer(-1) * Symbol('d')) * (x)**(Integer(2))))))**(Integer(-1))) + ((x * sympy.sin((Symbol('a') * ((Integer(2) * Symbol('b')))**(Integer(-1)))) * sympy.Function('SinIntegral')(((Symbol('a') + (Symbol('b') * sympy.acos((Integer(1) + (Symbol('d') * (x)**(Integer(2))))))) * ((Integer(2) * Symbol('b')))**(Integer(-1))))) * ((sympy.sqrt(Integer(2)) * Symbol('b') * sympy.sqrt(((Integer(-1) * Symbol('d')) * (x)**(Integer(2))))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(d*x**2 + 1))**(-2),
        variable=x,
        num_steps=1,
        integral=((sympy.sqrt(((Integer(-2) * Symbol('d') * (x)**(Integer(2))) + (Integer(-1) * ((Symbol('d'))**(Integer(2)) * (x)**(Integer(4)))))) * ((Integer(2) * Symbol('b') * Symbol('d') * x * (Symbol('a') + (Symbol('b') * sympy.acos((Integer(1) + (Symbol('d') * (x)**(Integer(2)))))))))**(Integer(-1))) + ((x * sympy.Function('CosIntegral')(((Symbol('a') + (Symbol('b') * sympy.acos((Integer(1) + (Symbol('d') * (x)**(Integer(2))))))) * ((Integer(2) * Symbol('b')))**(Integer(-1)))) * sympy.sin((Symbol('a') * ((Integer(2) * Symbol('b')))**(Integer(-1))))) * ((Integer(2) * sympy.sqrt(Integer(2)) * (Symbol('b'))**(Integer(2)) * sympy.sqrt(((Integer(-1) * Symbol('d')) * (x)**(Integer(2))))))**(Integer(-1))) + (Integer(-1) * ((x * sympy.cos((Symbol('a') * ((Integer(2) * Symbol('b')))**(Integer(-1)))) * sympy.Function('SinIntegral')(((Symbol('a') + (Symbol('b') * sympy.acos((Integer(1) + (Symbol('d') * (x)**(Integer(2))))))) * ((Integer(2) * Symbol('b')))**(Integer(-1))))) * ((Integer(2) * sympy.sqrt(Integer(2)) * (Symbol('b'))**(Integer(2)) * sympy.sqrt(((Integer(-1) * Symbol('d')) * (x)**(Integer(2))))))**(Integer(-1))))),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(d*x**2 + 1))**(-3),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*acos(d*x**2 + 1))**(sympy.S(-7)/2),
        variable=x,
        num_steps=2,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*acos(sqrt(-c*x + 1)/sqrt(c*x + 1)))**n/(-c**2*x**2 + 1),
        variable=x,
        num_steps=0,
        integral=sympy.Function('Unintegrable')((((Symbol('a') + (Symbol('b') * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1)))))))**(Symbol('n')) * ((Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2))))))**(Integer(-1))), x),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(sqrt(-c*x + 1)/sqrt(c*x + 1)))**3/(-c**2*x**2 + 1),
        variable=x,
        num_steps=8,
        integral=(((sympy.I * ((Symbol('a') + (Symbol('b') * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1)))))))**(Integer(4))) * ((Integer(4) * Symbol('b') * Symbol('c')))**(Integer(-1))) + (Integer(-1) * ((((Symbol('a') + (Symbol('b') * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1)))))))**(Integer(3)) * sympy.log((Integer(1) + (sympy.E)**((Integer(2) * sympy.I * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1))))))))) * (Symbol('c'))**(Integer(-1)))) + ((Integer(3) * sympy.I * Symbol('b') * ((Symbol('a') + (Symbol('b') * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1)))))))**(Integer(2)) * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((Integer(2) * sympy.I * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1))))))))) * ((Integer(2) * Symbol('c')))**(Integer(-1))) + (Integer(-1) * ((Integer(3) * (Symbol('b'))**(Integer(2)) * (Symbol('a') + (Symbol('b') * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1)))))) * sympy.Function('PolyLog')(Integer(3), (Integer(-1) * (sympy.E)**((Integer(2) * sympy.I * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1))))))))) * ((Integer(2) * Symbol('c')))**(Integer(-1)))) + (Integer(-1) * ((Integer(3) * sympy.I * (Symbol('b'))**(Integer(3)) * sympy.Function('PolyLog')(Integer(4), (Integer(-1) * (sympy.E)**((Integer(2) * sympy.I * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1))))))))) * ((Integer(4) * Symbol('c')))**(Integer(-1))))),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(sqrt(-c*x + 1)/sqrt(c*x + 1)))**2/(-c**2*x**2 + 1),
        variable=x,
        num_steps=7,
        integral=(((sympy.I * ((Symbol('a') + (Symbol('b') * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1)))))))**(Integer(3))) * ((Integer(3) * Symbol('b') * Symbol('c')))**(Integer(-1))) + (Integer(-1) * ((((Symbol('a') + (Symbol('b') * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1)))))))**(Integer(2)) * sympy.log((Integer(1) + (sympy.E)**((Integer(2) * sympy.I * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1))))))))) * (Symbol('c'))**(Integer(-1)))) + ((sympy.I * Symbol('b') * (Symbol('a') + (Symbol('b') * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1)))))) * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((Integer(2) * sympy.I * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1))))))))) * (Symbol('c'))**(Integer(-1))) + (Integer(-1) * (((Symbol('b'))**(Integer(2)) * sympy.Function('PolyLog')(Integer(3), (Integer(-1) * (sympy.E)**((Integer(2) * sympy.I * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1))))))))) * ((Integer(2) * Symbol('c')))**(Integer(-1))))),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*acos(sqrt(-c*x + 1)/sqrt(c*x + 1)))/(-c**2*x**2 + 1),
        variable=x,
        num_steps=6,
        integral=(((sympy.I * ((Symbol('a') + (Symbol('b') * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1)))))))**(Integer(2))) * ((Integer(2) * Symbol('b') * Symbol('c')))**(Integer(-1))) + (Integer(-1) * (((Symbol('a') + (Symbol('b') * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1)))))) * sympy.log((Integer(1) + (sympy.E)**((Integer(2) * sympy.I * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1))))))))) * (Symbol('c'))**(Integer(-1)))) + ((sympy.I * Symbol('b') * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((Integer(2) * sympy.I * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1))))))))) * ((Integer(2) * Symbol('c')))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=1/((a + b*acos(sqrt(-c*x + 1)/sqrt(c*x + 1)))*(-c**2*x**2 + 1)),
        variable=x,
        num_steps=0,
        integral=sympy.Function('Unintegrable')((((Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2))))) * (Symbol('a') + (Symbol('b') * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1))))))))**(Integer(-1)), x),
    ),
    RubiTestSuiteCase(
        integrand=1/((a + b*acos(sqrt(-c*x + 1)/sqrt(c*x + 1)))**2*(-c**2*x**2 + 1)),
        variable=x,
        num_steps=0,
        integral=sympy.Function('Unintegrable')((((Integer(1) + (Integer(-1) * ((Symbol('c'))**(Integer(2)) * (x)**(Integer(2))))) * ((Symbol('a') + (Symbol('b') * sympy.acos((sympy.sqrt((Integer(1) + (Integer(-1) * (Symbol('c') * x)))) * (sympy.sqrt((Integer(1) + (Symbol('c') * x))))**(Integer(-1)))))))**(Integer(2))))**(Integer(-1)), x),
    ),
    RubiTestSuiteCase(
        integrand=acos(c*exp(a + b*x)),
        variable=x,
        num_steps=6,
        integral=((Integer(-1) * ((sympy.I * (sympy.acos((Symbol('c') * (sympy.E)**((Symbol('a') + (Symbol('b') * x))))))**(Integer(2))) * ((Integer(2) * Symbol('b')))**(Integer(-1)))) + ((sympy.acos((Symbol('c') * (sympy.E)**((Symbol('a') + (Symbol('b') * x))))) * sympy.log((Integer(1) + (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * (sympy.E)**((Symbol('a') + (Symbol('b') * x)))))))))) * (Symbol('b'))**(Integer(-1))) + (Integer(-1) * ((sympy.I * sympy.Function('PolyLog')(Integer(2), (Integer(-1) * (sympy.E)**((Integer(2) * sympy.I * sympy.acos((Symbol('c') * (sympy.E)**((Symbol('a') + (Symbol('b') * x)))))))))) * ((Integer(2) * Symbol('b')))**(Integer(-1))))),
    ),
    RubiTestSuiteCase(
        integrand=x**3*exp(acos(a*x)),
        variable=x,
        num_steps=6,
        integral=-exp(acos(a*x))*sin(2*acos(a*x))/(20*a**4) - exp(acos(a*x))*sin(4*acos(a*x))/(136*a**4) + exp(acos(a*x))*cos(2*acos(a*x))/(10*a**4) + exp(acos(a*x))*cos(4*acos(a*x))/(34*a**4),
    ),
    RubiTestSuiteCase(
        integrand=x**2*exp(acos(a*x)),
        variable=x,
        num_steps=6,
        integral=x*exp(acos(a*x))/(8*a**2) - sqrt(-a**2*x**2 + 1)*exp(acos(a*x))/(8*a**3) - exp(acos(a*x))*sin(3*acos(a*x))/(40*a**3) + 3*exp(acos(a*x))*cos(3*acos(a*x))/(40*a**3),
    ),
    RubiTestSuiteCase(
        integrand=x*exp(acos(a*x)),
        variable=x,
        num_steps=5,
        integral=-exp(acos(a*x))*sin(2*acos(a*x))/(10*a**2) + exp(acos(a*x))*cos(2*acos(a*x))/(5*a**2),
    ),
    RubiTestSuiteCase(
        integrand=exp(acos(a*x)),
        variable=x,
        num_steps=2,
        integral=x*exp(acos(a*x))/2 - sqrt(-a**2*x**2 + 1)*exp(acos(a*x))/(2*a),
    ),
    RubiTestSuiteCase(
        integrand=exp(acos(a*x))/x,
        variable=x,
        num_steps=6,
        integral=-2*I*exp(acos(a*x))*hyper((1, -I/2), (1 - I/2,), -exp(2*I*acos(a*x))) + I*exp(acos(a*x)),
    ),
    RubiTestSuiteCase(
        integrand=exp(acos(a*x))/x**2,
        variable=x,
        num_steps=6,
        integral=a*(1 + I)*exp((1 + I)*acos(a*x))*hyper((1, sympy.S.Half - I/2), (sympy.S(3)/2 - I/2,), -exp(2*I*acos(a*x))) - a*(2 + 2*I)*exp((1 + I)*acos(a*x))*hyper((2, sympy.S.Half - I/2), (sympy.S(3)/2 - I/2,), -exp(2*I*acos(a*x))),
    ),
    RubiTestSuiteCase(
        integrand=acos(c/(a + b*x)),
        variable=x,
        num_steps=6,
        integral=-c*atanh(sqrt(-c**2/(a + b*x)**2 + 1))/b + (a + b*x)*asec(a/c + b*x/c)/b,
    ),
    RubiTestSuiteCase(
        integrand=x/(sqrt(1 - x**2)*sqrt(acos(x))),
        variable=x,
        num_steps=3,
        integral=((Integer(-1) * sympy.sqrt((Integer(2) * sympy.pi))) * sympy.Function('FresnelC')((sympy.sqrt((Integer(2) * (sympy.pi)**(Integer(-1)))) * sympy.sqrt(sympy.acos(x))))),
    ),
    RubiTestSuiteCase(
        integrand=x/(sqrt(1 - x**2)*acos(x)),
        variable=x,
        num_steps=2,
        integral=(Integer(-1) * sympy.Function('CosIntegral')(sympy.acos(x))),
    ),
    RubiTestSuiteCase(
        integrand=acos(sqrt(b*x**2 + 1))**n/sqrt(b*x**2 + 1),
        variable=x,
        num_steps=2,
        integral=-sqrt(-b*x**2)*acos(sqrt(b*x**2 + 1))**(n + 1)/(b*x*(n + 1)),
    ),
    RubiTestSuiteCase(
        integrand=1/(sqrt(b*x**2 + 1)*acos(sqrt(b*x**2 + 1))),
        variable=x,
        num_steps=2,
        integral=-sqrt(-b*x**2)*log(acos(sqrt(b*x**2 + 1)))/(b*x),
    ),
]
