...
SOURCE_FILE = '2 Exponentials/2.1 u (F^(c (a+b x)))^n.m'
...
TEST_CASES = [
    ...
    RubiTestSuiteCase(
        integrand=((Symbol('F'))**((Symbol('c') * (Symbol('a') + (Symbol('b') * x)))) * (sympy.Function('Expand')(((Symbol('d') + (Symbol('e') * x)))**(Integer(4))))**(Symbol('m'))),
        variable=x,
        num_steps=2,
    ...
    RubiTestSuiteCase(
        integrand=((Symbol('F'))**((Symbol('c') * (Symbol('a') + (Symbol('b') * x)))) * (sympy.Function('Expand')(((Symbol('d') + (Symbol('e') * x)))**(Integer(3))))**(Symbol('m'))),
        variable=x,
        num_steps=2,
    ...
    RubiTestSuiteCase(
        integrand=((Symbol('F'))**((Symbol('c') * (Symbol('a') + (Symbol('b') * x)))) * (sympy.Function('Expand')(((Symbol('d') + (Symbol('e') * x)))**(Integer(2))))**(Symbol('m'))),
        variable=x,
        num_steps=2,
    ...
    RubiTestSuiteCase(
        integrand=((Symbol('F'))**((Symbol('c') * (Symbol('a') + (Symbol('b') * x)))) * (sympy.Function('Expand')(((Symbol('d') + (Symbol('e') * x)))**(Integer(1))))**(Symbol('m'))),
        variable=x,
        num_steps=1,
        integral=(((Symbol('F'))**((Symbol('c') * (Symbol('a') + (Integer(-1) * ((Symbol('b') * Symbol('d')) * (Symbol('e'))**(Integer(-1))))))) * ((Symbol('d') + (Symbol('e') * x)))**(Symbol('m')) * sympy.Function('Gamma')((Integer(1) + Symbol('m')), (Integer(-1) * ((Symbol('b') * Symbol('c') * (Symbol('d') + (Symbol('e') * x)) * sympy.log(Symbol('F'))) * (Symbol('e'))**(Integer(-1)))))) * ((((Integer(-1) * ((Symbol('b') * Symbol('c') * (Symbol('d') + (Symbol('e') * x)) * sympy.log(Symbol('F'))) * (Symbol('e'))**(Integer(-1)))))**(Symbol('m')) * (Symbol('b') * Symbol('c') * sympy.log(Symbol('F')))))**(Integer(-1))),
    ),
    RubiTestSuiteCase(
        integrand=((Symbol('F'))**((Symbol('c') * (Symbol('a') + (Symbol('b') * x)))) * ((sympy.Function('Expand')(((Symbol('d') + (Symbol('e') * x)))**(Integer(1))))**(Symbol('m')))**(Integer(-1))),
        variable=x,
        num_steps=1,
    ...
    RubiTestSuiteCase(
        integrand=((Symbol('F'))**((Symbol('c') * (Symbol('a') + (Symbol('b') * x)))) * ((sympy.Function('Expand')(((Symbol('d') + (Symbol('e') * x)))**(Integer(2))))**(Symbol('m')))**(Integer(-1))),
        variable=x,
        num_steps=2,
    ...
    RubiTestSuiteCase(
        integrand=((Symbol('F'))**((Symbol('c') * (Symbol('a') + (Symbol('b') * x)))) * ((sympy.Function('Expand')(((Symbol('d') + (Symbol('e') * x)))**(Integer(3))))**(Symbol('m')))**(Integer(-1))),
        variable=x,
        num_steps=2,
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=1,
        integral=2**(5*x + 2)*5**(5*x + 1)/log(10),
    ),
    RubiTestSuiteCase(
        integrand=F**(a + b*x)*x**(sympy.S(7)/2),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=F**(a + b*x)*x**(sympy.S(5)/2),
        variable=x,
        num_steps=5,
    ...
    RubiTestSuiteCase(
        integrand=F**(a + b*x)*x**(sympy.S(3)/2),
        variable=x,
        num_steps=4,
    ...
    RubiTestSuiteCase(
        integrand=F**(c*(a + b*x))*(d + e*x + f*x**2),
        variable=x,
        num_steps=8,
        integral=F**(c*(a + b*x))*d/(b*c*log(F)) + F**(c*(a + b*x))*e*x/(b*c*log(F)) + F**(c*(a + b*x))*f*x**2/(b*c*log(F)) - F**(c*(a + b*x))*e/(b**2*c**2*log(F)**2) - 2*F**(c*(a + b*x))*f*x/(b**2*c**2*log(F)**2) + 2*F**(c*(a + b*x))*f/(b**3*c**3*log(F)**3),
    ),
    RubiTestSuiteCase(
        integrand=F**(c*(a + b*x))*(d + e*x + f*x**2 + g*x**3),
        variable=x,
        num_steps=12,
        integral=F**(c*(a + b*x))*d/(b*c*log(F)) + F**(c*(a + b*x))*e*x/(b*c*log(F)) + F**(c*(a + b*x))*f*x**2/(b*c*log(F)) + F**(c*(a + b*x))*g*x**3/(b*c*log(F)) - F**(c*(a + b*x))*e/(b**2*c**2*log(F)**2) - 2*F**(c*(a + b*x))*f*x/(b**2*c**2*log(F)**2) - 3*F**(c*(a + b*x))*g*x**2/(b**2*c**2*log(F)**2) + 2*F**(c*(a + b*x))*f/(b**3*c**3*log(F)**3) + 6*F**(c*(a + b*x))*g*x/(b**3*c**3*log(F)**3) - 6*F**(c*(a + b*x))*g/(b**4*c**4*log(F)**4),
    ),
    RubiTestSuiteCase(
        integrand=F**(c*(a + b*x))*(d + e*x + f*x**2 + g*x**3 + h*x**4),
        variable=x,
        num_steps=17,
    ...
    RubiTestSuiteCase(
        integrand=x**m*(a + b*x)**3*exp(-a - b*x),
        variable=x,
        num_steps=6,
        integral=((Integer(-1) * (((Symbol('a'))**(Integer(3)) * (x)**(Symbol('m')) * sympy.Function('Gamma')((Integer(1) + Symbol('m')), (Symbol('b') * x))) * (((sympy.E)**(Symbol('a')) * ((Symbol('b') * x))**(Symbol('m')) * Symbol('b')))**(Integer(-1)))) + (Integer(-1) * ((Integer(3) * (Symbol('a'))**(Integer(2)) * (x)**(Symbol('m')) * sympy.Function('Gamma')((Integer(2) + Symbol('m')), (Symbol('b') * x))) * (((sympy.E)**(Symbol('a')) * ((Symbol('b') * x))**(Symbol('m')) * Symbol('b')))**(Integer(-1)))) + (Integer(-1) * ((Integer(3) * Symbol('a') * (x)**(Symbol('m')) * sympy.Function('Gamma')((Integer(3) + Symbol('m')), (Symbol('b') * x))) * (((sympy.E)**(Symbol('a')) * ((Symbol('b') * x))**(Symbol('m')) * Symbol('b')))**(Integer(-1)))) + (Integer(-1) * (((x)**(Symbol('m')) * sympy.Function('Gamma')((Integer(4) + Symbol('m')), (Symbol('b') * x))) * (((sympy.E)**(Symbol('a')) * ((Symbol('b') * x))**(Symbol('m')) * Symbol('b')))**(Integer(-1))))),
    ),
    RubiTestSuiteCase(
        integrand=x**3*(a + b*x)**3*exp(-a - b*x),
        variable=x,
        num_steps=24,
        integral=-a**3*x**3*exp(-a - b*x)/b - 3*a**3*x**2*exp(-a - b*x)/b**2 - 6*a**3*x*exp(-a - b*x)/b**3 - 6*a**3*exp(-a - b*x)/b**4 - 3*a**2*x**4*exp(-a - b*x) - 12*a**2*x**3*exp(-a - b*x)/b - 36*a**2*x**2*exp(-a - b*x)/b**2 - 72*a**2*x*exp(-a - b*x)/b**3 - 72*a**2*exp(-a - b*x)/b**4 - 3*a*b*x**5*exp(-a - b*x) - 15*a*x**4*exp(-a - b*x) - 60*a*x**3*exp(-a - b*x)/b - 180*a*x**2*exp(-a - b*x)/b**2 - 360*a*x*exp(-a - b*x)/b**3 - 360*a*exp(-a - b*x)/b**4 - b**2*x**6*exp(-a - b*x) - 6*b*x**5*exp(-a - b*x) - 30*x**4*exp(-a - b*x) - 120*x**3*exp(-a - b*x)/b - 360*x**2*exp(-a - b*x)/b**2 - 720*x*exp(-a - b*x)/b**3 - 720*exp(-a - b*x)/b**4,
    ),
    RubiTestSuiteCase(
        integrand=x**2*(a + b*x)**3*exp(-a - b*x),
        variable=x,
        num_steps=20,
        integral=-a**3*x**2*exp(-a - b*x)/b - 2*a**3*x*exp(-a - b*x)/b**2 - 2*a**3*exp(-a - b*x)/b**3 - 3*a**2*x**3*exp(-a - b*x) - 9*a**2*x**2*exp(-a - b*x)/b - 18*a**2*x*exp(-a - b*x)/b**2 - 18*a**2*exp(-a - b*x)/b**3 - 3*a*b*x**4*exp(-a - b*x) - 12*a*x**3*exp(-a - b*x) - 36*a*x**2*exp(-a - b*x)/b - 72*a*x*exp(-a - b*x)/b**2 - 72*a*exp(-a - b*x)/b**3 - b**2*x**5*exp(-a - b*x) - 5*b*x**4*exp(-a - b*x) - 20*x**3*exp(-a - b*x) - 60*x**2*exp(-a - b*x)/b - 120*x*exp(-a - b*x)/b**2 - 120*exp(-a - b*x)/b**3,
    ),
    RubiTestSuiteCase(
        integrand=x*(a + b*x)**3*exp(-a - b*x),
        variable=x,
        num_steps=11,
        integral=a*(a + b*x)**3*exp(-a - b*x)/b**2 + 3*a*(a + b*x)**2*exp(-a - b*x)/b**2 + 6*a*(a + b*x)*exp(-a - b*x)/b**2 + 6*a*exp(-a - b*x)/b**2 - (a + b*x)**4*exp(-a - b*x)/b**2 - 4*(a + b*x)**3*exp(-a - b*x)/b**2 - 12*(a + b*x)**2*exp(-a - b*x)/b**2 - 24*(a + b*x)*exp(-a - b*x)/b**2 - 24*exp(-a - b*x)/b**2,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x)**3*exp(-a - b*x),
        variable=x,
        num_steps=4,
        integral=-(a + b*x)**3*exp(-a - b*x)/b - 3*(a + b*x)**2*exp(-a - b*x)/b - 6*(a + b*x)*exp(-a - b*x)/b - 6*exp(-a - b*x)/b,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x)**3*exp(-a - b*x)/x,
        variable=x,
        num_steps=9,
        integral=((Integer(-2) * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x))))) + (Integer(-1) * (Integer(3) * Symbol('a') * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x)))))) + (Integer(-1) * (Integer(3) * (Symbol('a'))**(Integer(2)) * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x)))))) + (Integer(-1) * (Integer(2) * Symbol('b') * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x)))) * x)) + (Integer(-1) * (Integer(3) * Symbol('a') * Symbol('b') * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x)))) * x)) + (Integer(-1) * ((Symbol('b'))**(Integer(2)) * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x)))) * (x)**(Integer(2)))) + (((Symbol('a'))**(Integer(3)) * sympy.Function('ExpIntegralEi')(((Integer(-1) * Symbol('b')) * x))) * ((sympy.E)**(Symbol('a')))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x)**3*exp(-a - b*x)/x**2,
        variable=x,
        num_steps=8,
        integral=(((Integer(-1) * Symbol('b')) * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x))))) + (Integer(-1) * (Integer(3) * Symbol('a') * Symbol('b') * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x)))))) + (Integer(-1) * (((Symbol('a'))**(Integer(3)) * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x))))) * (x)**(Integer(-1)))) + (Integer(-1) * ((Symbol('b'))**(Integer(2)) * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x)))) * x)) + ((Integer(3) * (Symbol('a'))**(Integer(2)) * Symbol('b') * sympy.Function('ExpIntegralEi')(((Integer(-1) * Symbol('b')) * x))) * ((sympy.E)**(Symbol('a')))**(Integer(-1))) + (Integer(-1) * (((Symbol('a'))**(Integer(3)) * Symbol('b') * sympy.Function('ExpIntegralEi')(((Integer(-1) * Symbol('b')) * x))) * ((sympy.E)**(Symbol('a')))**(Integer(-1))))),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x)**3*exp(-a - b*x)/x**3,
        variable=x,
        num_steps=9,
        integral=(((Integer(-1) * (Symbol('b'))**(Integer(2))) * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x))))) + (Integer(-1) * (((Symbol('a'))**(Integer(3)) * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x))))) * ((Integer(2) * (x)**(Integer(2))))**(Integer(-1)))) + (Integer(-1) * ((Integer(3) * (Symbol('a'))**(Integer(2)) * Symbol('b') * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x))))) * (x)**(Integer(-1)))) + (((Symbol('a'))**(Integer(3)) * Symbol('b') * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x))))) * ((Integer(2) * x))**(Integer(-1))) + ((Integer(3) * Symbol('a') * (Symbol('b'))**(Integer(2)) * sympy.Function('ExpIntegralEi')(((Integer(-1) * Symbol('b')) * x))) * ((sympy.E)**(Symbol('a')))**(Integer(-1))) + (Integer(-1) * ((Integer(3) * (Symbol('a'))**(Integer(2)) * (Symbol('b'))**(Integer(2)) * sympy.Function('ExpIntegralEi')(((Integer(-1) * Symbol('b')) * x))) * ((sympy.E)**(Symbol('a')))**(Integer(-1)))) + (((Integer(2))**(Integer(-1)) * (Symbol('a'))**(Integer(3)) * (Symbol('b'))**(Integer(2)) * sympy.Function('ExpIntegralEi')(((Integer(-1) * Symbol('b')) * x))) * ((sympy.E)**(Symbol('a')))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x)**3*exp(-a - b*x)/x**4,
        variable=x,
        num_steps=12,
        integral=((Integer(-1) * (((Symbol('a'))**(Integer(3)) * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x))))) * ((Integer(3) * (x)**(Integer(3))))**(Integer(-1)))) + (Integer(-1) * ((Integer(3) * (Symbol('a'))**(Integer(2)) * Symbol('b') * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x))))) * ((Integer(2) * (x)**(Integer(2))))**(Integer(-1)))) + (((Symbol('a'))**(Integer(3)) * Symbol('b') * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x))))) * ((Integer(6) * (x)**(Integer(2))))**(Integer(-1))) + (Integer(-1) * ((Integer(3) * Symbol('a') * (Symbol('b'))**(Integer(2)) * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x))))) * (x)**(Integer(-1)))) + ((Integer(3) * (Symbol('a'))**(Integer(2)) * (Symbol('b'))**(Integer(2)) * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x))))) * ((Integer(2) * x))**(Integer(-1))) + (Integer(-1) * (((Symbol('a'))**(Integer(3)) * (Symbol('b'))**(Integer(2)) * (sympy.E)**(((Integer(-1) * Symbol('a')) + (Integer(-1) * (Symbol('b') * x))))) * ((Integer(6) * x))**(Integer(-1)))) + (((Symbol('b'))**(Integer(3)) * sympy.Function('ExpIntegralEi')(((Integer(-1) * Symbol('b')) * x))) * ((sympy.E)**(Symbol('a')))**(Integer(-1))) + (Integer(-1) * ((Integer(3) * Symbol('a') * (Symbol('b'))**(Integer(3)) * sympy.Function('ExpIntegralEi')(((Integer(-1) * Symbol('b')) * x))) * ((sympy.E)**(Symbol('a')))**(Integer(-1)))) + (((Integer(3) * (Integer(2))**(Integer(-1))) * (Symbol('a'))**(Integer(2)) * (Symbol('b'))**(Integer(3)) * sympy.Function('ExpIntegralEi')(((Integer(-1) * Symbol('b')) * x))) * ((sympy.E)**(Symbol('a')))**(Integer(-1))) + (Integer(-1) * (((Integer(6))**(Integer(-1)) * (Symbol('a'))**(Integer(3)) * (Symbol('b'))**(Integer(3)) * sympy.Function('ExpIntegralEi')(((Integer(-1) * Symbol('b')) * x))) * ((sympy.E)**(Symbol('a')))**(Integer(-1))))),
    ),
    RubiTestSuiteCase(
        integrand=F**(a + b*(c + d*x))*x**m*(e + f*x)**2,
        variable=x,
        num_steps=5,
        integral=((((Symbol('f'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')))) * (x)**(Symbol('m')) * sympy.Function('Gamma')((Integer(3) + Symbol('m')), ((Integer(-1) * Symbol('b')) * Symbol('d') * x * sympy.log(Symbol('F'))))) * (((((Integer(-1) * Symbol('b')) * Symbol('d') * x * sympy.log(Symbol('F'))))**(Symbol('m')) * ((Symbol('b'))**(Integer(3)) * (Symbol('d'))**(Integer(3)) * (sympy.log(Symbol('F')))**(Integer(3)))))**(Integer(-1))) + (Integer(-1) * ((Integer(2) * Symbol('e') * Symbol('f') * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')))) * (x)**(Symbol('m')) * sympy.Function('Gamma')((Integer(2) + Symbol('m')), ((Integer(-1) * Symbol('b')) * Symbol('d') * x * sympy.log(Symbol('F'))))) * (((((Integer(-1) * Symbol('b')) * Symbol('d') * x * sympy.log(Symbol('F'))))**(Symbol('m')) * ((Symbol('b'))**(Integer(2)) * (Symbol('d'))**(Integer(2)) * (sympy.log(Symbol('F')))**(Integer(2)))))**(Integer(-1)))) + (((Symbol('e'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')))) * (x)**(Symbol('m')) * sympy.Function('Gamma')((Integer(1) + Symbol('m')), ((Integer(-1) * Symbol('b')) * Symbol('d') * x * sympy.log(Symbol('F'))))) * (((((Integer(-1) * Symbol('b')) * Symbol('d') * x * sympy.log(Symbol('F'))))**(Symbol('m')) * (Symbol('b') * Symbol('d') * sympy.log(Symbol('F')))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=F**(a + b*(c + d*x))*x**3*(e + f*x)**2,
        variable=x,
        num_steps=17,
        integral=F**(a + b*c + b*d*x)*e**2*x**3/(b*d*log(F)) + 2*F**(a + b*c + b*d*x)*e*f*x**4/(b*d*log(F)) + F**(a + b*c + b*d*x)*f**2*x**5/(b*d*log(F)) - 3*F**(a + b*c + b*d*x)*e**2*x**2/(b**2*d**2*log(F)**2) - 8*F**(a + b*c + b*d*x)*e*f*x**3/(b**2*d**2*log(F)**2) - 5*F**(a + b*c + b*d*x)*f**2*x**4/(b**2*d**2*log(F)**2) + 6*F**(a + b*c + b*d*x)*e**2*x/(b**3*d**3*log(F)**3) + 24*F**(a + b*c + b*d*x)*e*f*x**2/(b**3*d**3*log(F)**3) + 20*F**(a + b*c + b*d*x)*f**2*x**3/(b**3*d**3*log(F)**3) - 6*F**(a + b*c + b*d*x)*e**2/(b**4*d**4*log(F)**4) - 48*F**(a + b*c + b*d*x)*e*f*x/(b**4*d**4*log(F)**4) - 60*F**(a + b*c + b*d*x)*f**2*x**2/(b**4*d**4*log(F)**4) + 48*F**(a + b*c + b*d*x)*e*f/(b**5*d**5*log(F)**5) + 120*F**(a + b*c + b*d*x)*f**2*x/(b**5*d**5*log(F)**5) - 120*F**(a + b*c + b*d*x)*f**2/(b**6*d**6*log(F)**6),
    ),
    RubiTestSuiteCase(
        integrand=F**(a + b*(c + d*x))*x**2*(e + f*x)**2,
        variable=x,
        num_steps=14,
        integral=F**(a + b*c + b*d*x)*e**2*x**2/(b*d*log(F)) + 2*F**(a + b*c + b*d*x)*e*f*x**3/(b*d*log(F)) + F**(a + b*c + b*d*x)*f**2*x**4/(b*d*log(F)) - 2*F**(a + b*c + b*d*x)*e**2*x/(b**2*d**2*log(F)**2) - 6*F**(a + b*c + b*d*x)*e*f*x**2/(b**2*d**2*log(F)**2) - 4*F**(a + b*c + b*d*x)*f**2*x**3/(b**2*d**2*log(F)**2) + 2*F**(a + b*c + b*d*x)*e**2/(b**3*d**3*log(F)**3) + 12*F**(a + b*c + b*d*x)*e*f*x/(b**3*d**3*log(F)**3) + 12*F**(a + b*c + b*d*x)*f**2*x**2/(b**3*d**3*log(F)**3) - 12*F**(a + b*c + b*d*x)*e*f/(b**4*d**4*log(F)**4) - 24*F**(a + b*c + b*d*x)*f**2*x/(b**4*d**4*log(F)**4) + 24*F**(a + b*c + b*d*x)*f**2/(b**5*d**5*log(F)**5),
    ),
    RubiTestSuiteCase(
        integrand=F**(a + b*(c + d*x))*x*(e + f*x)**2,
        variable=x,
        num_steps=11,
        integral=F**(a + b*c + b*d*x)*e**2*x/(b*d*log(F)) + 2*F**(a + b*c + b*d*x)*e*f*x**2/(b*d*log(F)) + F**(a + b*c + b*d*x)*f**2*x**3/(b*d*log(F)) - F**(a + b*c + b*d*x)*e**2/(b**2*d**2*log(F)**2) - 4*F**(a + b*c + b*d*x)*e*f*x/(b**2*d**2*log(F)**2) - 3*F**(a + b*c + b*d*x)*f**2*x**2/(b**2*d**2*log(F)**2) + 4*F**(a + b*c + b*d*x)*e*f/(b**3*d**3*log(F)**3) + 6*F**(a + b*c + b*d*x)*f**2*x/(b**3*d**3*log(F)**3) - 6*F**(a + b*c + b*d*x)*f**2/(b**4*d**4*log(F)**4),
    ),
    RubiTestSuiteCase(
        integrand=F**(a + b*(c + d*x))*(e + f*x)**2,
        variable=x,
        num_steps=4,
        integral=F**(a + b*c + b*d*x)*(e + f*x)**2/(b*d*log(F)) - 2*F**(a + b*c + b*d*x)*f*(e + f*x)/(b**2*d**2*log(F)**2) + 2*F**(a + b*c + b*d*x)*f**2/(b**3*d**3*log(F)**3),
    ),
    RubiTestSuiteCase(
        integrand=F**(a + b*(c + d*x))*(e + f*x)**2/x,
        variable=x,
        num_steps=6,
        integral=(((Symbol('e'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')))) * sympy.Function('ExpIntegralEi')((Symbol('b') * Symbol('d') * x * sympy.log(Symbol('F'))))) + (Integer(-1) * (((Symbol('f'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x)))) * (((Symbol('b'))**(Integer(2)) * (Symbol('d'))**(Integer(2)) * (sympy.log(Symbol('F')))**(Integer(2))))**(Integer(-1)))) + ((Integer(2) * Symbol('e') * Symbol('f') * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x)))) * ((Symbol('b') * Symbol('d') * sympy.log(Symbol('F'))))**(Integer(-1))) + (((Symbol('f'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x))) * x) * ((Symbol('b') * Symbol('d') * sympy.log(Symbol('F'))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=F**(a + b*(c + d*x))*(e + f*x)**2/x**2,
        variable=x,
        num_steps=6,
        integral=((Integer(-1) * (((Symbol('e'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x)))) * (x)**(Integer(-1)))) + (Integer(2) * Symbol('e') * Symbol('f') * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')))) * sympy.Function('ExpIntegralEi')((Symbol('b') * Symbol('d') * x * sympy.log(Symbol('F'))))) + (((Symbol('f'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x)))) * ((Symbol('b') * Symbol('d') * sympy.log(Symbol('F'))))**(Integer(-1))) + (Symbol('b') * Symbol('d') * (Symbol('e'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')))) * sympy.Function('ExpIntegralEi')((Symbol('b') * Symbol('d') * x * sympy.log(Symbol('F')))) * sympy.log(Symbol('F')))),
    ),
    RubiTestSuiteCase(
        integrand=F**(a + b*(c + d*x))*(e + f*x)**2/x**3,
        variable=x,
        num_steps=8,
        integral=((Integer(-1) * (((Symbol('e'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x)))) * ((Integer(2) * (x)**(Integer(2))))**(Integer(-1)))) + (Integer(-1) * ((Integer(2) * Symbol('e') * Symbol('f') * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x)))) * (x)**(Integer(-1)))) + ((Symbol('f'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')))) * sympy.Function('ExpIntegralEi')((Symbol('b') * Symbol('d') * x * sympy.log(Symbol('F'))))) + (Integer(-1) * ((Symbol('b') * Symbol('d') * (Symbol('e'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x))) * sympy.log(Symbol('F'))) * ((Integer(2) * x))**(Integer(-1)))) + (Integer(2) * Symbol('b') * Symbol('d') * Symbol('e') * Symbol('f') * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')))) * sympy.Function('ExpIntegralEi')((Symbol('b') * Symbol('d') * x * sympy.log(Symbol('F')))) * sympy.log(Symbol('F'))) + ((Integer(2))**(Integer(-1)) * (Symbol('b'))**(Integer(2)) * (Symbol('d'))**(Integer(2)) * (Symbol('e'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')))) * sympy.Function('ExpIntegralEi')((Symbol('b') * Symbol('d') * x * sympy.log(Symbol('F')))) * (sympy.log(Symbol('F')))**(Integer(2)))),
    ),
    RubiTestSuiteCase(
        integrand=F**(a + b*(c + d*x))*(e + f*x)**2/x**4,
        variable=x,
        num_steps=11,
        integral=((Integer(-1) * (((Symbol('e'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x)))) * ((Integer(3) * (x)**(Integer(3))))**(Integer(-1)))) + (Integer(-1) * ((Symbol('e') * Symbol('f') * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x)))) * ((x)**(Integer(2)))**(Integer(-1)))) + (Integer(-1) * (((Symbol('f'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x)))) * (x)**(Integer(-1)))) + (Integer(-1) * ((Symbol('b') * Symbol('d') * (Symbol('e'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x))) * sympy.log(Symbol('F'))) * ((Integer(6) * (x)**(Integer(2))))**(Integer(-1)))) + (Integer(-1) * ((Symbol('b') * Symbol('d') * Symbol('e') * Symbol('f') * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x))) * sympy.log(Symbol('F'))) * (x)**(Integer(-1)))) + (Symbol('b') * Symbol('d') * (Symbol('f'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')))) * sympy.Function('ExpIntegralEi')((Symbol('b') * Symbol('d') * x * sympy.log(Symbol('F')))) * sympy.log(Symbol('F'))) + (Integer(-1) * (((Symbol('b'))**(Integer(2)) * (Symbol('d'))**(Integer(2)) * (Symbol('e'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x))) * (sympy.log(Symbol('F')))**(Integer(2))) * ((Integer(6) * x))**(Integer(-1)))) + ((Symbol('b'))**(Integer(2)) * (Symbol('d'))**(Integer(2)) * Symbol('e') * Symbol('f') * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')))) * sympy.Function('ExpIntegralEi')((Symbol('b') * Symbol('d') * x * sympy.log(Symbol('F')))) * (sympy.log(Symbol('F')))**(Integer(2))) + ((Integer(6))**(Integer(-1)) * (Symbol('b'))**(Integer(3)) * (Symbol('d'))**(Integer(3)) * (Symbol('e'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')))) * sympy.Function('ExpIntegralEi')((Symbol('b') * Symbol('d') * x * sympy.log(Symbol('F')))) * (sympy.log(Symbol('F')))**(Integer(3)))),
    ),
    RubiTestSuiteCase(
        integrand=F**(a + b*(c + d*x))*(e + f*x)**2/x**5,
        variable=x,
        num_steps=14,
        integral=((Integer(-1) * (((Symbol('e'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x)))) * ((Integer(4) * (x)**(Integer(4))))**(Integer(-1)))) + (Integer(-1) * ((Integer(2) * Symbol('e') * Symbol('f') * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x)))) * ((Integer(3) * (x)**(Integer(3))))**(Integer(-1)))) + (Integer(-1) * (((Symbol('f'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x)))) * ((Integer(2) * (x)**(Integer(2))))**(Integer(-1)))) + (Integer(-1) * ((Symbol('b') * Symbol('d') * (Symbol('e'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x))) * sympy.log(Symbol('F'))) * ((Integer(12) * (x)**(Integer(3))))**(Integer(-1)))) + (Integer(-1) * ((Symbol('b') * Symbol('d') * Symbol('e') * Symbol('f') * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x))) * sympy.log(Symbol('F'))) * ((Integer(3) * (x)**(Integer(2))))**(Integer(-1)))) + (Integer(-1) * ((Symbol('b') * Symbol('d') * (Symbol('f'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x))) * sympy.log(Symbol('F'))) * ((Integer(2) * x))**(Integer(-1)))) + (Integer(-1) * (((Symbol('b'))**(Integer(2)) * (Symbol('d'))**(Integer(2)) * (Symbol('e'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x))) * (sympy.log(Symbol('F')))**(Integer(2))) * ((Integer(24) * (x)**(Integer(2))))**(Integer(-1)))) + (Integer(-1) * (((Symbol('b'))**(Integer(2)) * (Symbol('d'))**(Integer(2)) * Symbol('e') * Symbol('f') * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x))) * (sympy.log(Symbol('F')))**(Integer(2))) * ((Integer(3) * x))**(Integer(-1)))) + ((Integer(2))**(Integer(-1)) * (Symbol('b'))**(Integer(2)) * (Symbol('d'))**(Integer(2)) * (Symbol('f'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')))) * sympy.Function('ExpIntegralEi')((Symbol('b') * Symbol('d') * x * sympy.log(Symbol('F')))) * (sympy.log(Symbol('F')))**(Integer(2))) + (Integer(-1) * (((Symbol('b'))**(Integer(3)) * (Symbol('d'))**(Integer(3)) * (Symbol('e'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')) + (Symbol('b') * Symbol('d') * x))) * (sympy.log(Symbol('F')))**(Integer(3))) * ((Integer(24) * x))**(Integer(-1)))) + ((Integer(3))**(Integer(-1)) * (Symbol('b'))**(Integer(3)) * (Symbol('d'))**(Integer(3)) * Symbol('e') * Symbol('f') * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')))) * sympy.Function('ExpIntegralEi')((Symbol('b') * Symbol('d') * x * sympy.log(Symbol('F')))) * (sympy.log(Symbol('F')))**(Integer(3))) + ((Integer(24))**(Integer(-1)) * (Symbol('b'))**(Integer(4)) * (Symbol('d'))**(Integer(4)) * (Symbol('e'))**(Integer(2)) * (Symbol('F'))**((Symbol('a') + (Symbol('b') * Symbol('c')))) * sympy.Function('ExpIntegralEi')((Symbol('b') * Symbol('d') * x * sympy.log(Symbol('F')))) * (sympy.log(Symbol('F')))**(Integer(4)))),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x)**4*(c + d*x)**3*exp(-a - b*x),
        variable=x,
        num_steps=28,
