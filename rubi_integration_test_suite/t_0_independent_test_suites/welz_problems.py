...
SOURCE_FILE = '0 Independent test suites/Welz Problems.m'
...
TEST_CASES = [
    RubiTestSuiteCase(
        integrand=1/sqrt(-a*x + 1),
        variable=x,
        num_steps=1,
        integral=-2*sqrt(-a*x + 1)/a,
    ),
    RubiTestSuiteCase(
        integrand=(2*x + sqrt(x**2 + 1))**(-2),
        variable=x,
        num_steps=9,
        integral=4*x/(3 - 9*x**2) - sqrt(3)*atanh(sqrt(3)*x)/9 + sqrt(3)*atanh(sqrt(3)*sqrt(x**2 + 1)/2)/9 - 2*sqrt(x**2 + 1)/(3 - 9*x**2),
    ),
    RubiTestSuiteCase(
        integrand=1/(sqrt(x**2 - 1)*(3*x**2 - 4)**2),
        variable=x,
        num_steps=3,
        integral=3*x*sqrt(x**2 - 1)/(32 - 24*x**2) + 5*atanh(x/(2*sqrt(x**2 - 1)))/16,
    ),
    RubiTestSuiteCase(
        integrand=(2*sqrt(x) + sqrt(x + 1))**(-2),
        variable=x,
        num_steps=8,
        integral=-4*sqrt(x)*sqrt(x + 1)/(3 - 9*x) + 5*log(1 - 3*x)/9 - 8*asinh(sqrt(x))/9 + 10*atanh(2*sqrt(x)/sqrt(x + 1))/9 + 8/(9 - 27*x),
    ),
    RubiTestSuiteCase(
        integrand=sqrt(x**2 - 1)/(x - I)**2,
        variable=x,
        num_steps=6,
        integral=-sqrt(2)*I*atan(sqrt(2)*(-I*x + 1)/(2*sqrt(x**2 - 1)))/2 + atanh(x/sqrt(x**2 - 1)) + sqrt(x**2 - 1)/(-x + I),
    ),
    RubiTestSuiteCase(
        integrand=1/(sqrt(x**2 - 1)*(x**2 + 1)**2),
        variable=x,
        num_steps=3,
        integral=-x*sqrt(x**2 - 1)/(4*x**2 + 4) + 3*sqrt(2)*atanh(sqrt(2)*x/sqrt(x**2 - 1))/8,
    ),
    RubiTestSuiteCase(
        integrand=1/((sqrt(x) + sqrt(x - 1))**2*sqrt(x - 1)),
        variable=x,
        num_steps=4,
        integral=-4*x**(sympy.S(3)/2)/3 + 4*(x - 1)**(sympy.S(3)/2)/3 + 2*sqrt(x - 1),
    ),
    RubiTestSuiteCase(
        integrand=1/((sqrt(x) + sqrt(x**2 - 1))**2*sqrt(x**2 - 1)),
        variable=x,
        num_steps=-18,
        integral=(2 - 4*x)/(5*sqrt(x) + 5*sqrt(x**2 - 1)) + sqrt(-110 + 50*sqrt(5))*atan(sqrt(x)*sqrt(2 + 2*sqrt(5))/2)/25 - sqrt(-110 + 50*sqrt(5))*atan(sqrt(-2 + 2*sqrt(5))*sqrt(x**2 - 1)/(-x*(1 - sqrt(5)) + 2))/50 - sqrt(110 + 50*sqrt(5))*atanh(sqrt(x)*sqrt(-2 + 2*sqrt(5))/2)/25 - sqrt(110 + 50*sqrt(5))*atanh(sqrt(2 + 2*sqrt(5))*sqrt(x**2 - 1)/(-sqrt(5)*x - x + 2))/50,
    ),
    RubiTestSuiteCase(
        integrand=(sqrt(x) - sqrt(x**2 - 1))**2/(sqrt(x**2 - 1)*(-x**2 + x + 1)**2),
        variable=x,
        num_steps=-25,
        integral=(2 - 4*x)/(5*sqrt(x) + 5*sqrt(x**2 - 1)) + sqrt(-110 + 50*sqrt(5))*atan(sqrt(x)*sqrt(2 + 2*sqrt(5))/2)/25 - sqrt(-110 + 50*sqrt(5))*atan(sqrt(-2 + 2*sqrt(5))*sqrt(x**2 - 1)/(-x*(1 - sqrt(5)) + 2))/50 - sqrt(110 + 50*sqrt(5))*atanh(sqrt(x)*sqrt(-2 + 2*sqrt(5))/2)/25 - sqrt(110 + 50*sqrt(5))*atanh(sqrt(2 + 2*sqrt(5))*sqrt(x**2 - 1)/(-sqrt(5)*x - x + 2))/50,
    ),
    RubiTestSuiteCase(
        integrand=sqrt(2)/(2*(x + 1)**2*sqrt(x**2 + I)) + sqrt(2)/(2*(x + 1)**2*sqrt(x**2 - I)),
        variable=x,
        num_steps=7,
        integral=sqrt(2)*atanh((x + I)/(sqrt(1 - I)*sqrt(x**2 - I)))/(2*(1 - I)**(sympy.S(3)/2)) - sqrt(2)*atanh((-x + I)/(sqrt(1 + I)*sqrt(x**2 + I)))/(2*(1 + I)**(sympy.S(3)/2)) - sqrt(2)*(sympy.S.Half + I/2)*sqrt(x**2 - I)/(2*(x + 1)) - sqrt(2)*(sympy.S.Half - I/2)*sqrt(x**2 + I)/(2*(x + 1)),
    ),
    RubiTestSuiteCase(
        integrand=sqrt(x**2 + sqrt(x**4 + 1))/((x + 1)**2*sqrt(x**4 + 1)),
        variable=x,
        num_steps=7,
        integral=-(1 - I)**(sympy.S(3)/2)*atanh((I*x + 1)/(sqrt(1 - I)*sqrt(-I*x**2 + 1)))/4 - (1 + I)**(sympy.S(3)/2)*atanh((-I*x + 1)/(sqrt(1 + I)*sqrt(I*x**2 + 1)))/4 - sqrt(-I*x**2 + 1)/(2*x + 2) - sqrt(I*x**2 + 1)/(2*x + 2),
    ),
    RubiTestSuiteCase(
        integrand=sqrt(x**2 + sqrt(x**4 + 1))/((x + 1)*sqrt(x**4 + 1)),
        variable=x,
        num_steps=5,
        integral=-sqrt(1 - I)*atanh((I*x + 1)/(sqrt(1 - I)*sqrt(-I*x**2 + 1)))/2 - sqrt(1 + I)*atanh((-I*x + 1)/(sqrt(1 + I)*sqrt(I*x**2 + 1)))/2,
    ),
    RubiTestSuiteCase(
        integrand=sqrt(x**2 + sqrt(x**4 + 1))/sqrt(x**4 + 1),
        variable=x,
        num_steps=2,
        integral=sqrt(2)*atanh(sqrt(2)*x/sqrt(x**2 + sqrt(x**4 + 1)))/2,
    ),
    RubiTestSuiteCase(
        integrand=sqrt(-x**2 + sqrt(x**4 + 1))/sqrt(x**4 + 1),
        variable=x,
        num_steps=2,
        integral=sqrt(2)*atan(sqrt(2)*x/sqrt(-x**2 + sqrt(x**4 + 1)))/2,
    ),
    RubiTestSuiteCase(
        integrand=((x - 1)**(sympy.S(3)/2) + (x + 1)**(sympy.S(3)/2))/((x - 1)**(sympy.S(3)/2)*(x + 1)**(sympy.S(3)/2)),
        variable=x,
        num_steps=2,
        integral=-2/sqrt(x + 1) - 2/sqrt(x - 1),
    ),
    RubiTestSuiteCase(
        integrand=(x + sqrt(a + x**2))**b,
        variable=x,
        num_steps=3,
        integral=-a*(x + sqrt(a + x**2))**(b - 1)/(2 - 2*b) + (x + sqrt(a + x**2))**(b + 1)/(2*b + 2),
    ),
    RubiTestSuiteCase(
        integrand=(x - sqrt(a + x**2))**b,
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=(x + sqrt(a + x**2))**b/sqrt(a + x**2),
        variable=x,
        num_steps=2,
        integral=(x + sqrt(a + x**2))**b/b,
    ),
    RubiTestSuiteCase(
        integrand=(x - sqrt(a + x**2))**b/sqrt(a + x**2),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*exp(p*x))**(-2),
        variable=x,
        num_steps=3,
        integral=1/(a*p*(a + b*exp(p*x))) + x/a**2 - log(a + b*exp(p*x))/(a**2*p),
    ),
    RubiTestSuiteCase(
        integrand=(a*exp(p*x) + b*exp(-p*x))**(-2),
        variable=x,
        num_steps=2,
        integral=-1/(2*a*p*(a*exp(2*p*x) + b)),
    ),
    RubiTestSuiteCase(
        integrand=x/(a*exp(p*x) + b*exp(-p*x))**2,
        variable=x,
        num_steps=6,
        integral=-x/(2*a*p*(a*exp(2*p*x) + b)) + x/(2*a*b*p) - log(a*exp(2*p*x) + b)/(4*a*b*p**2),
    ),
    RubiTestSuiteCase(
        integrand=(3*x**2 - x + 1)/(sqrt(x**2 - x + 1)*(x**2 + x + 1)**2),
        variable=x,
        num_steps=6,
        integral=(x + 1)*sqrt(x**2 - x + 1)/(x**2 + x + 1) + sqrt(2)*atan(sqrt(2)*(x + 1)/sqrt(x**2 - x + 1)) - sqrt(6)*atanh(sqrt(6)*(1 - x)/(3*sqrt(x**2 - x + 1)))/6,
    ),
    RubiTestSuiteCase(
        integrand=sqrt(x + sqrt(a**2 + x**2))/sqrt(a**2 + x**2),
        variable=x,
        num_steps=2,
        integral=2*sqrt(x + sqrt(a**2 + x**2)),
    ),
    RubiTestSuiteCase(
        integrand=sqrt(b*x + sqrt(a + b**2*x**2))/sqrt(a + b**2*x**2),
        variable=x,
        num_steps=2,
        integral=2*sqrt(b*x + sqrt(a + b**2*x**2))/b,
    ),
    RubiTestSuiteCase(
        integrand=1/(x*sqrt(a**2 + x**2)*sqrt(x + sqrt(a**2 + x**2))),
        variable=x,
        num_steps=5,
        integral=-2*atan(sqrt(x + sqrt(a**2 + x**2))/sqrt(a))/a**(sympy.S(3)/2) - 2*atanh(sqrt(x + sqrt(a**2 + x**2))/sqrt(a))/a**(sympy.S(3)/2),
    ),
    RubiTestSuiteCase(
    ...
    RubiTestSuiteCase(
        integrand=(a + b*x)/((3 - x**2)*(x**2 + 1)**(sympy.S(1)/3)),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=1/(x*(3*x**2 - 6*x + 4)**(sympy.S(1)/3)),
        variable=x,
        num_steps=1,
        integral=-2**(sympy.S(1)/3)*log(x)/4 + 2**(sympy.S(1)/3)*log(-3*x - 3*2**(sympy.S(1)/3)*(3*x**2 - 6*x + 4)**(sympy.S(1)/3) + 6)/4 - 2**(sympy.S(1)/3)*sqrt(3)*atan(2**(sympy.S(2)/3)*sqrt(3)*(2 - x)/(3*(3*x**2 - 6*x + 4)**(sympy.S(1)/3)) + sqrt(3)/3)/6,
    ),
    RubiTestSuiteCase(
        integrand=x*(1 - x**3)**(sympy.S(1)/3),
        variable=x,
        num_steps=8,
        integral=x**2*(1 - x**3)**(sympy.S(1)/3)/3 - log(x/(1 - x**3)**(sympy.S(1)/3) + 1)/9 + log(x**2/(1 - x**3)**(sympy.S(2)/3) - x/(1 - x**3)**(sympy.S(1)/3) + 1)/18 - sqrt(3)*atan(sqrt(3)*(-2*x/(1 - x**3)**(sympy.S(1)/3) + 1)/3)/9,
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**3)**(sympy.S(1)/3)/x,
        variable=x,
        num_steps=6,
        integral=(1 - x**3)**(sympy.S(1)/3) - log(x)/2 + log(1 - (1 - x**3)**(sympy.S(1)/3))/2 - sqrt(3)*atan(sqrt(3)*(2*(1 - x**3)**(sympy.S(1)/3) + 1)/3)/3,
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**3)**(sympy.S(1)/3)/(x + 1),
        variable=x,
        num_steps=-1,
        integral=Integer(0),
    ),
    RubiTestSuiteCase(
        integrand=(1 - x**3)**(sympy.S(1)/3)/(x**2 - x + 1),
        variable=x,
        num_steps=-2,
        integral=-2**(sympy.S(1)/3)*log((3 - 3*x)*(x**2 - x + 1))/4 + log(x + (1 - x**3)**(sympy.S(1)/3))/2 - 2**(sympy.S(1)/3)*log(2**(sympy.S(1)/3)*x + (1 - x**3)**(sympy.S(1)/3))/4 + 2**(sympy.S(1)/3)*log(-(1 - x**3)**(sympy.S(1)/3) + 2**(sympy.S(1)/3))/4 + 3*2**(sympy.S(1)/3)*log((1 - x**3)**(sympy.S(1)/3) - 2**(sympy.S(1)/3)*(x - 1))/4 + 2**(sympy.S(1)/3)*sqrt(3)*atan(sqrt(3)*(1 + 2*2**(sympy.S(1)/3)*(x - 1)/(1 - x**3)**(sympy.S(1)/3))/3)/2 - 2**(sympy.S(1)/3)*sqrt(3)*atan(sqrt(3)*(2**(sympy.S(2)/3)*(1 - x**3)**(sympy.S(1)/3) + 1)/3)/6 + sqrt(3)*atan(sqrt(3)*(-2*x/(1 - x**3)**(sympy.S(1)/3) + 1)/3)/3 - 2**(sympy.S(1)/3)*sqrt(3)*atan(sqrt(3)*(-2*2**(sympy.S(1)/3)*x/(1 - x**3)**(sympy.S(1)/3) + 1)/3)/6,
    ),
    RubiTestSuiteCase(
        integrand=(160*x**3 + 30*x**2 - 3*x + 3)/(320*x**4 + 80*x**3 - 12*x**2 + 24*x + 9),
        variable=x,
        num_steps=1,
        integral=log(320*x**4 + 80*x**3 - 12*x**2 + 24*x + 9)/8,
    ),
    RubiTestSuiteCase(
        integrand=(20*x**2 + 12*x + 3)/(320*x**4 + 80*x**3 - 12*x**2 + 24*x + 9),
        variable=x,
        num_steps=1,
        integral=-sqrt(11)*atan(sqrt(11)*(7 - 40*x)/55)/22 + sqrt(11)*atan(sqrt(11)*(800*x**3 - 40*x**2 + 30*x + 57)/66)/22,
    ),
    RubiTestSuiteCase(
        integrand=-(-2560*x**3 + 400*x**2 + 576*x + 84)/(320*x**4 + 80*x**3 - 12*x**2 + 24*x + 9),
        variable=x,
        num_steps=2,
        integral=2*log(320*x**4 + 80*x**3 - 12*x**2 + 24*x + 9) + 2*sqrt(11)*atan(sqrt(11)*(7 - 40*x)/55) - 2*sqrt(11)*atan(sqrt(11)*(800*x**3 - 40*x**2 + 30*x + 57)/66),
    ),
    RubiTestSuiteCase(
        integrand=sqrt(1 - x**4)/(x**4 + 1),
        variable=x,
        num_steps=1,
        integral=atan(x*(x**2 + 1)/sqrt(1 - x**4))/2 + atanh(x*(1 - x**2)/sqrt(1 - x**4))/2,
    ),
    RubiTestSuiteCase(
        integrand=sqrt(x**4 + 1)/(1 - x**4),
        variable=x,
        num_steps=4,
        integral=sqrt(2)*atan(sqrt(2)*x/sqrt(x**4 + 1))/4 + sqrt(2)*atanh(sqrt(2)*x/sqrt(x**4 + 1))/4,
    ),
    RubiTestSuiteCase(
        integrand=sqrt(p*x**2 + x**4 + 1)/(1 - x**4),
        variable=x,
        num_steps=4,
        integral=sqrt(2 - p)*atan(x*sqrt(2 - p)/sqrt(p*x**2 + x**4 + 1))/4 + sqrt(p + 2)*atanh(x*sqrt(p + 2)/sqrt(p*x**2 + x**4 + 1))/4,
    ),
    RubiTestSuiteCase(
        integrand=sqrt(p*x**2 - x**4 + 1)/(x**4 + 1),
        variable=x,
        num_steps=1,
        integral=sqrt(2)*sqrt(-p + sqrt(p**2 + 4))*atanh(sqrt(2)*x*sqrt(-p + sqrt(p**2 + 4))*(p - 2*x**2 + sqrt(p**2 + 4))/(4*sqrt(p*x**2 - x**4 + 1)))/4 - sqrt(2)*sqrt(p + sqrt(p**2 + 4))*atan(sqrt(2)*x*sqrt(p + sqrt(p**2 + 4))*(p - 2*x**2 - sqrt(p**2 + 4))/(4*sqrt(p*x**2 - x**4 + 1)))/4,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x)/((2 - x**2)*(x**2 - 1)**(sympy.S(1)/4)),
        variable=x,
        num_steps=7,
        integral=sqrt(2)*a*atan(sqrt(2)*x/(2*(x**2 - 1)**(sympy.S(1)/4)))/4 + sqrt(2)*a*atanh(sqrt(2)*x/(2*(x**2 - 1)**(sympy.S(1)/4)))/4 - b*atan((x**2 - 1)**(sympy.S(1)/4)) + b*atanh((x**2 - 1)**(sympy.S(1)/4)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x)/((-x**2 - 1)**(sympy.S(1)/4)*(x**2 + 2)),
        variable=x,
        num_steps=7,
        integral=sqrt(2)*a*atan(sqrt(2)*x/(2*(-x**2 - 1)**(sympy.S(1)/4)))/4 + sqrt(2)*a*atanh(sqrt(2)*x/(2*(-x**2 - 1)**(sympy.S(1)/4)))/4 + b*atan((-x**2 - 1)**(sympy.S(1)/4)) - b*atanh((-x**2 - 1)**(sympy.S(1)/4)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x)/((1 - x**2)**(sympy.S(1)/4)*(2 - x**2)),
        variable=x,
        num_steps=3,
        integral=a*atan((1 - sqrt(1 - x**2))/(x*(1 - x**2)**(sympy.S(1)/4)))/2 + a*atanh((sqrt(1 - x**2) + 1)/(x*(1 - x**2)**(sympy.S(1)/4)))/2 + sqrt(2)*b*atan(sqrt(2)*(1 - sqrt(1 - x**2))/(2*(1 - x**2)**(sympy.S(1)/4)))/2 + sqrt(2)*b*atanh(sqrt(2)*(sqrt(1 - x**2) + 1)/(2*(1 - x**2)**(sympy.S(1)/4)))/2,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*x)/((x**2 + 1)**(sympy.S(1)/4)*(x**2 + 2)),
        variable=x,
        num_steps=3,
        integral=-a*atan((sqrt(x**2 + 1) + 1)/(x*(x**2 + 1)**(sympy.S(1)/4)))/2 - a*atanh((1 - sqrt(x**2 + 1))/(x*(x**2 + 1)**(sympy.S(1)/4)))/2 - sqrt(2)*b*atan(sqrt(2)*(1 - sqrt(x**2 + 1))/(2*(x**2 + 1)**(sympy.S(1)/4)))/2 - sqrt(2)*b*atanh(sqrt(2)*(sqrt(x**2 + 1) + 1)/(2*(x**2 + 1)**(sympy.S(1)/4)))/2,
    ),
    RubiTestSuiteCase(
    ...
    RubiTestSuiteCase(
        integrand=x/((-d*x**3 + 4)*sqrt(d*x**3 - 1)),
        variable=x,
        num_steps=1,
        integral=-2**(sympy.S(1)/3)*atan((2**(sympy.S(1)/3)*d**(sympy.S(1)/3)*x + 1)/sqrt(d*x**3 - 1))/(6*d**(sympy.S(2)/3)) - 2**(sympy.S(1)/3)*atan(sqrt(d*x**3 - 1))/(18*d**(sympy.S(2)/3)) - 2**(sympy.S(1)/3)*sqrt(3)*atanh(sqrt(3)*sqrt(d*x**3 - 1)/3)/(18*d**(sympy.S(2)/3)) - 2**(sympy.S(1)/3)*sqrt(3)*atanh(sqrt(3)*(-2**(sympy.S(1)/3)*d**(sympy.S(1)/3)*x + 1)/sqrt(d*x**3 - 1))/(18*d**(sympy.S(2)/3)),
    ),
    RubiTestSuiteCase(
        integrand=x/(sqrt(x**3 - 1)*(x**3 + 8)),
        variable=x,
        num_steps=8,
        integral=atan((1 - x)**2/(3*sqrt(x**3 - 1)))/18 + atan(sqrt(x**3 - 1)/3)/18 - sqrt(3)*atanh(sqrt(3)*(1 - x)/sqrt(x**3 - 1))/18,
    ),
    RubiTestSuiteCase(
        integrand=x/((-d*x**3 + 8)*sqrt(d*x**3 + 1)),
        variable=x,
        num_steps=8,
        integral=-sqrt(3)*atan(sqrt(3)*(d**(sympy.S(1)/3)*x + 1)/sqrt(d*x**3 + 1))/(18*d**(sympy.S(2)/3)) + atanh((d**(sympy.S(1)/3)*x + 1)**2/(3*sqrt(d*x**3 + 1)))/(18*d**(sympy.S(2)/3)) - atanh(sqrt(d*x**3 + 1)/3)/(18*d**(sympy.S(2)/3)),
    ),
    RubiTestSuiteCase(
        integrand=1/((1 - 3*x**2)**(sympy.S(1)/3)*(3 - x**2)),
        variable=x,
        num_steps=1,
        integral=atan((1 - (1 - 3*x**2)**(sympy.S(1)/3))/x)/4 + sqrt(3)*atanh(sqrt(3)*x/3)/12 - sqrt(3)*atanh(sqrt(3)*(1 - (1 - 3*x**2)**(sympy.S(1)/3))**2/(9*x))/12,
    ),
    RubiTestSuiteCase(
        integrand=1/((x**2 + 3)*(3*x**2 + 1)**(sympy.S(1)/3)),
        variable=x,
        num_steps=1,
        integral=sqrt(3)*atan(sqrt(3)*x/3)/12 + sqrt(3)*atan(sqrt(3)*(1 - (3*x**2 + 1)**(sympy.S(1)/3))**2/(9*x))/12 - atanh((1 - (3*x**2 + 1)**(sympy.S(1)/3))/x)/4,
    ),
    RubiTestSuiteCase(
    ...
    RubiTestSuiteCase(
        integrand=(a + x)/((-a + x)*sqrt(a**2*x + x**3 - x**2*(a**2 + 1))),
        variable=x,
        num_steps=4,
        integral=-2*sqrt(x)*sqrt(a**2 + x**2 - x*(a**2 + 1))*atan(sqrt(x)*(1 - a)/sqrt(a**2 + x**2 - x*(a**2 + 1)))/((1 - a)*sqrt(a**2*x + x**3 - x**2*(a**2 + 1))),
    ),
    RubiTestSuiteCase(
        integrand=(a + x - 2)/((-a + x)*sqrt(a*x*(2 - a) + x**3 + x**2*(a**2 - 2*a - 1))),
        variable=x,
        num_steps=-5,
        integral=Integer(0),
    ),
    RubiTestSuiteCase(
        integrand=(-a + x*(2*a - 1))/((-a + x)*sqrt(a**2*x + x**3*(2*a - 1) - x**2*(a**2 + 2*a - 1))),
        variable=x,
        num_steps=-7,
        integral=log((-a**2 + 2*a*x + x**2 - 2*x - 2*sqrt(x*(1 - x)*(a**2 - 2*a*x + x)))/(a - x)**2),
    ),
    RubiTestSuiteCase(
        integrand=(-2**(sympy.S(1)/3)*x + 1)/((x + 2**(sympy.S(2)/3))*sqrt(x**3 + 1)),
        variable=x,
        num_steps=2,
        integral=2*sqrt(3)*atan(sqrt(3)*(2**(sympy.S(1)/3)*x + 1)/sqrt(x**3 + 1))/3,
    ),
    RubiTestSuiteCase(
        integrand=(x + 1)/((x - 2)*sqrt(x**3 + 1)),
        variable=x,
        num_steps=2,
        integral=-2*atanh((x + 1)**2/(3*sqrt(x**3 + 1)))/3,
    ),
    RubiTestSuiteCase(
        integrand=x/(sqrt(x**3 + 1)*(x**3 + 10 + 6*sqrt(3))),
        variable=x,
        num_steps=1,
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=1,
        integral=sqrt(2)*3**(sympy.S(1)/4)*(sqrt(3) + 2)*atan(sqrt(2)*3**(sympy.S(1)/4)*(1 + sqrt(3))*sqrt(x**3 - 1)/6)/18 - sqrt(2)*3**(sympy.S(1)/4)*(sqrt(3) + 2)*atan(sqrt(2)*3**(sympy.S(1)/4)*(1 - sqrt(3))*(1 - x)/(2*sqrt(x**3 - 1)))/12 + sqrt(2)*3**(sympy.S(3)/4)*(sqrt(3) + 2)*atanh(sqrt(2)*3**(sympy.S(1)/4)*(2*x - sqrt(3) + 1)/(2*sqrt(x**3 - 1)))/18 + sqrt(2)*3**(sympy.S(3)/4)*(sqrt(3) + 2)*atanh(sqrt(2)*3**(sympy.S(1)/4)*(1 + sqrt(3))*(1 - x)/(2*sqrt(x**3 - 1)))/36,
    ),
    RubiTestSuiteCase(
        integrand=(x - sqrt(3) + 1)/((x + 1 + sqrt(3))*sqrt(x**4 + 4*sqrt(3)*x**2 - 4)),
        variable=x,
        num_steps=2,
        integral=sqrt(-3 + 2*sqrt(3))*atanh((x - sqrt(3) + 1)**2/(sqrt(-9 + 6*sqrt(3))*sqrt(x**4 + 4*sqrt(3)*x**2 - 4)))/3,
    ),
    RubiTestSuiteCase(
        integrand=(x + 1 + sqrt(3))/((x - sqrt(3) + 1)*sqrt(x**4 - 4*sqrt(3)*x**2 - 4)),
        variable=x,
        num_steps=2,
        integral=-sqrt(3 + 2*sqrt(3))*atan((x + 1 + sqrt(3))**2/(sqrt(9 + 6*sqrt(3))*sqrt(x**4 - 4*sqrt(3)*x**2 - 4)))/3,
    ),
    RubiTestSuiteCase(
        integrand=(x - 1)/((x + 1)*(x**3 + 2)**(sympy.S(1)/3)),
        variable=x,
        num_steps=1,
        integral=log(x + 1) - 3*log(x - (x**3 + 2)**(sympy.S(1)/3) + 2)/2 + sqrt(3)*atan(sqrt(3)*((2*x + 4)/(x**3 + 2)**(sympy.S(1)/3) + 1)/3),
    ),
    RubiTestSuiteCase(
        integrand=1/((x + 1)*(x**3 + 2)**(sympy.S(1)/3)),
        variable=x,
        num_steps=3,
        integral=-log(-x + (x**3 + 2)**(sympy.S(1)/3))/4 - log(x + 1)/2 + 3*log(x - (x**3 + 2)**(sympy.S(1)/3) + 2)/4 + sqrt(3)*atan(sqrt(3)*(2*x/(x**3 + 2)**(sympy.S(1)/3) + 1)/3)/6 - sqrt(3)*atan(sqrt(3)*((2*x + 4)/(x**3 + 2)**(sympy.S(1)/3) + 1)/3)/2,
    ),
    RubiTestSuiteCase(
        integrand=(x + 1)/((1 - x**3)**(sympy.S(1)/3)*(x**2 - x + 1)),
        variable=x,
        num_steps=-4,
        integral=-2**(sympy.S(2)/3)*log(2**(sympy.S(1)/3)*(1 - x)/(1 - x**3)**(sympy.S(1)/3) + 1)/2 + 2**(sympy.S(2)/3)*log(2**(sympy.S(2)/3)*(1 - x)**2/(1 - x**3)**(sympy.S(2)/3) - 2**(sympy.S(1)/3)*(1 - x)/(1 - x**3)**(sympy.S(1)/3) + 1)/4 + 2**(sympy.S(2)/3)*sqrt(3)*atan(sqrt(3)*(-2*2**(sympy.S(1)/3)*(1 - x)/(1 - x**3)**(sympy.S(1)/3) + 1)/3)/2,
    ),
    RubiTestSuiteCase(
        integrand=(x + 1)**2/((1 - x**3)**(sympy.S(1)/3)*(x**3 + 1)),
        variable=x,
        num_steps=-5,
        integral=-2**(sympy.S(2)/3)*log(2**(sympy.S(1)/3)*(1 - x)/(1 - x**3)**(sympy.S(1)/3) + 1)/2 + 2**(sympy.S(2)/3)*log(2**(sympy.S(2)/3)*(1 - x)**2/(1 - x**3)**(sympy.S(2)/3) - 2**(sympy.S(1)/3)*(1 - x)/(1 - x**3)**(sympy.S(1)/3) + 1)/4 + 2**(sympy.S(2)/3)*sqrt(3)*atan(sqrt(3)*(-2*2**(sympy.S(1)/3)*(1 - x)/(1 - x**3)**(sympy.S(1)/3) + 1)/3)/2,
    ),
