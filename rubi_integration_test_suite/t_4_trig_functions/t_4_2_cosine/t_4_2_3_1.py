...
SOURCE_FILE = '4 Trig functions/4.2 Cosine/4.2.3.1 (a+b cos)^m (c+d cos)^n (A+B cos).m'
...
TEST_CASES = [
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)*cos(c + d*x)**3,
        variable=x,
        num_steps=8,
        integral=B*a*sin(c + d*x)*cos(c + d*x)**4/(5*d) + 3*a*x*(A + B)/8 + a*(A + B)*sin(c + d*x)*cos(c + d*x)**3/(4*d) + 3*a*(A + B)*sin(c + d*x)*cos(c + d*x)/(8*d) - a*(5*A + 4*B)*sin(c + d*x)**3/(15*d) + a*(5*A + 4*B)*sin(c + d*x)/(5*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)*cos(c + d*x)**2,
        variable=x,
        num_steps=7,
        integral=B*a*sin(c + d*x)*cos(c + d*x)**3/(4*d) + a*x*(4*A + 3*B)/8 - a*(A + B)*sin(c + d*x)**3/(3*d) + a*(A + B)*sin(c + d*x)/d + a*(4*A + 3*B)*sin(c + d*x)*cos(c + d*x)/(8*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)*cos(c + d*x),
        variable=x,
        num_steps=3,
        integral=B*a*sin(c + d*x)*cos(c + d*x)**2/(3*d) + a*x*(A + B)/2 + a*(A + B)*sin(c + d*x)*cos(c + d*x)/(2*d) + a*(3*A + 2*B)*sin(c + d*x)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a),
        variable=x,
        num_steps=1,
        integral=B*a*sin(c + d*x)*cos(c + d*x)/(2*d) + a*x*(2*A + B)/2 + a*(A + B)*sin(c + d*x)/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)*sec(c + d*x),
        variable=x,
        num_steps=4,
        integral=A*a*atanh(sin(c + d*x))/d + B*a*sin(c + d*x)/d + a*x*(A + B),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)*sec(c + d*x)**2,
        variable=x,
        num_steps=4,
        integral=A*a*tan(c + d*x)/d + B*a*x + a*(A + B)*atanh(sin(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)*sec(c + d*x)**3,
        variable=x,
        num_steps=6,
        integral=A*a*tan(c + d*x)*sec(c + d*x)/(2*d) + a*(A + B)*tan(c + d*x)/d + a*(A + 2*B)*atanh(sin(c + d*x))/(2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)*sec(c + d*x)**4,
        variable=x,
        num_steps=7,
        integral=A*a*tan(c + d*x)*sec(c + d*x)**2/(3*d) + a*(A + B)*tan(c + d*x)*sec(c + d*x)/(2*d) + a*(A + B)*atanh(sin(c + d*x))/(2*d) + a*(2*A + 3*B)*tan(c + d*x)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)*sec(c + d*x)**5,
        variable=x,
        num_steps=7,
        integral=A*a*tan(c + d*x)*sec(c + d*x)**3/(4*d) + a*(A + B)*tan(c + d*x)**3/(3*d) + a*(A + B)*tan(c + d*x)/d + a*(3*A + 4*B)*tan(c + d*x)*sec(c + d*x)/(8*d) + a*(3*A + 4*B)*atanh(sin(c + d*x))/(8*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2*cos(c + d*x)**3,
        variable=x,
        num_steps=9,
        integral=B*(a**2*cos(c + d*x) + a**2)*sin(c + d*x)*cos(c + d*x)**4/(6*d) + a**2*x*(12*A + 11*B)/16 + a**2*(6*A + 7*B)*sin(c + d*x)*cos(c + d*x)**4/(30*d) - a**2*(9*A + 8*B)*sin(c + d*x)**3/(15*d) + a**2*(9*A + 8*B)*sin(c + d*x)/(5*d) + a**2*(12*A + 11*B)*sin(c + d*x)*cos(c + d*x)**3/(24*d) + a**2*(12*A + 11*B)*sin(c + d*x)*cos(c + d*x)/(16*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2*cos(c + d*x)**2,
        variable=x,
        num_steps=8,
        integral=B*(a**2*cos(c + d*x) + a**2)*sin(c + d*x)*cos(c + d*x)**3/(5*d) + a**2*x*(7*A + 6*B)/8 + a**2*(5*A + 6*B)*sin(c + d*x)*cos(c + d*x)**3/(20*d) + a**2*(7*A + 6*B)*sin(c + d*x)*cos(c + d*x)/(8*d) - a**2*(10*A + 9*B)*sin(c + d*x)**3/(15*d) + a**2*(10*A + 9*B)*sin(c + d*x)/(5*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2*cos(c + d*x),
        variable=x,
        num_steps=4,
        integral=B*(a*cos(c + d*x) + a)**3*sin(c + d*x)/(4*a*d) + a**2*x*(8*A + 7*B)/8 + a**2*(8*A + 7*B)*sin(c + d*x)*cos(c + d*x)/(24*d) + a**2*(8*A + 7*B)*sin(c + d*x)/(6*d) + (4*A - B)*(a*cos(c + d*x) + a)**2*sin(c + d*x)/(12*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2,
        variable=x,
        num_steps=2,
        integral=B*(a*cos(c + d*x) + a)**2*sin(c + d*x)/(3*d) + a**2*x*(3*A + 2*B)/2 + a**2*(3*A + 2*B)*sin(c + d*x)*cos(c + d*x)/(6*d) + 2*a**2*(3*A + 2*B)*sin(c + d*x)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2*sec(c + d*x),
        variable=x,
        num_steps=5,
        integral=A*a**2*atanh(sin(c + d*x))/d + B*(a**2*cos(c + d*x) + a**2)*sin(c + d*x)/(2*d) + a**2*x*(4*A + 3*B)/2 + a**2*(2*A + 3*B)*sin(c + d*x)/(2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2*sec(c + d*x)**2,
        variable=x,
        num_steps=5,
        integral=A*(a**2*cos(c + d*x) + a**2)*tan(c + d*x)/d + a**2*x*(A + 2*B) - a**2*(A - B)*sin(c + d*x)/d + a**2*(2*A + B)*atanh(sin(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2*sec(c + d*x)**3,
        variable=x,
        num_steps=5,
        integral=A*(a**2*cos(c + d*x) + a**2)*tan(c + d*x)*sec(c + d*x)/(2*d) + B*a**2*x + a**2*(3*A + 2*B)*tan(c + d*x)/(2*d) + a**2*(3*A + 4*B)*atanh(sin(c + d*x))/(2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2*sec(c + d*x)**4,
        variable=x,
        num_steps=7,
        integral=A*(a**2*cos(c + d*x) + a**2)*tan(c + d*x)*sec(c + d*x)**2/(3*d) + a**2*(2*A + 3*B)*atanh(sin(c + d*x))/(2*d) + a**2*(4*A + 3*B)*tan(c + d*x)*sec(c + d*x)/(6*d) + a**2*(5*A + 6*B)*tan(c + d*x)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2*sec(c + d*x)**5,
        variable=x,
        num_steps=8,
        integral=A*(a**2*cos(c + d*x) + a**2)*tan(c + d*x)*sec(c + d*x)**3/(4*d) + a**2*(4*A + 5*B)*tan(c + d*x)/(3*d) + a**2*(5*A + 4*B)*tan(c + d*x)*sec(c + d*x)**2/(12*d) + a**2*(7*A + 8*B)*tan(c + d*x)*sec(c + d*x)/(8*d) + a**2*(7*A + 8*B)*atanh(sin(c + d*x))/(8*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3*cos(c + d*x)**2,
        variable=x,
        num_steps=9,
        integral=B*a*(a*cos(c + d*x) + a)**2*sin(c + d*x)*cos(c + d*x)**3/(6*d) + a**3*x*(26*A + 23*B)/16 - a**3*(19*A + 17*B)*sin(c + d*x)**3/(15*d) + a**3*(19*A + 17*B)*sin(c + d*x)/(5*d) + a**3*(22*A + 21*B)*sin(c + d*x)*cos(c + d*x)**3/(40*d) + a**3*(26*A + 23*B)*sin(c + d*x)*cos(c + d*x)/(16*d) + (3*A + 4*B)*(a**3*cos(c + d*x) + a**3)*sin(c + d*x)*cos(c + d*x)**3/(15*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3*cos(c + d*x),
        variable=x,
        num_steps=10,
        integral=B*(a*cos(c + d*x) + a)**4*sin(c + d*x)/(5*a*d) + a**3*x*(15*A + 13*B)/8 - a**3*(15*A + 13*B)*sin(c + d*x)**3/(60*d) + 3*a**3*(15*A + 13*B)*sin(c + d*x)*cos(c + d*x)/(40*d) + a**3*(15*A + 13*B)*sin(c + d*x)/(5*d) + (5*A - B)*(a*cos(c + d*x) + a)**3*sin(c + d*x)/(20*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3,
        variable=x,
        num_steps=8,
        integral=B*(a*cos(c + d*x) + a)**3*sin(c + d*x)/(4*d) + 5*a**3*x*(4*A + 3*B)/8 - a**3*(4*A + 3*B)*sin(c + d*x)**3/(12*d) + 3*a**3*(4*A + 3*B)*sin(c + d*x)*cos(c + d*x)/(8*d) + a**3*(4*A + 3*B)*sin(c + d*x)/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3*sec(c + d*x),
        variable=x,
        num_steps=6,
        integral=A*a**3*atanh(sin(c + d*x))/d + B*a*(a*cos(c + d*x) + a)**2*sin(c + d*x)/(3*d) + a**3*x*(7*A + 5*B)/2 + 5*a**3*(A + B)*sin(c + d*x)/(2*d) + (3*A + 5*B)*(a**3*cos(c + d*x) + a**3)*sin(c + d*x)/(6*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3*sec(c + d*x)**2,
        variable=x,
        num_steps=6,
        integral=A*a*(a*cos(c + d*x) + a)**2*tan(c + d*x)/d + 5*B*a**3*sin(c + d*x)/(2*d) + a**3*x*(6*A + 7*B)/2 + a**3*(3*A + B)*atanh(sin(c + d*x))/d - (2*A - B)*(a**3*cos(c + d*x) + a**3)*sin(c + d*x)/(2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3*sec(c + d*x)**3,
        variable=x,
        num_steps=6,
        integral=-5*A*a**3*sin(c + d*x)/(2*d) + A*a*(a*cos(c + d*x) + a)**2*tan(c + d*x)*sec(c + d*x)/(2*d) + a**3*x*(A + 3*B) + a**3*(7*A + 6*B)*atanh(sin(c + d*x))/(2*d) + (2*A + B)*(a**3*cos(c + d*x) + a**3)*tan(c + d*x)/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3*sec(c + d*x)**4,
        variable=x,
        num_steps=6,
        integral=A*a*(a*cos(c + d*x) + a)**2*tan(c + d*x)*sec(c + d*x)**2/(3*d) + B*a**3*x + 5*a**3*(A + B)*tan(c + d*x)/(2*d) + a**3*(5*A + 7*B)*atanh(sin(c + d*x))/(2*d) + (5*A + 3*B)*(a**3*cos(c + d*x) + a**3)*tan(c + d*x)*sec(c + d*x)/(6*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3*sec(c + d*x)**5,
        variable=x,
        num_steps=8,
        integral=A*a*(a*cos(c + d*x) + a)**2*tan(c + d*x)*sec(c + d*x)**3/(4*d) + 5*a**3*(3*A + 4*B)*atanh(sin(c + d*x))/(8*d) + a**3*(9*A + 11*B)*tan(c + d*x)/(3*d) + a**3*(27*A + 28*B)*tan(c + d*x)*sec(c + d*x)/(24*d) + (3*A + 2*B)*(a**3*cos(c + d*x) + a**3)*tan(c + d*x)*sec(c + d*x)**2/(6*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3*sec(c + d*x)**6,
        variable=x,
        num_steps=9,
        integral=A*a*(a*cos(c + d*x) + a)**2*tan(c + d*x)*sec(c + d*x)**4/(5*d) + a**3*(13*A + 15*B)*tan(c + d*x)*sec(c + d*x)/(8*d) + a**3*(13*A + 15*B)*atanh(sin(c + d*x))/(8*d) + a**3*(38*A + 45*B)*tan(c + d*x)/(15*d) + a**3*(43*A + 45*B)*tan(c + d*x)*sec(c + d*x)**2/(60*d) + (7*A + 5*B)*(a**3*cos(c + d*x) + a**3)*tan(c + d*x)*sec(c + d*x)**3/(20*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**4*cos(c + d*x)**2,
        variable=x,
        num_steps=10,
        integral=B*a*(a*cos(c + d*x) + a)**3*sin(c + d*x)*cos(c + d*x)**3/(7*d) + a**4*x*(49*A + 44*B)/16 + a**4*(49*A + 44*B)*sin(c + d*x)*cos(c + d*x)/(16*d) - a**4*(252*A + 227*B)*sin(c + d*x)**3/(105*d) + a**4*(252*A + 227*B)*sin(c + d*x)/(35*d) + a**4*(301*A + 276*B)*sin(c + d*x)*cos(c + d*x)**3/(280*d) + (7*A + 7*B)*(a**4*cos(c + d*x) + a**4)*sin(c + d*x)*cos(c + d*x)**3/(15*d) + (7*A + 10*B)*(a**2*cos(c + d*x) + a**2)**2*sin(c + d*x)*cos(c + d*x)**3/(42*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**4*cos(c + d*x),
        variable=x,
        num_steps=13,
        integral=B*(a*cos(c + d*x) + a)**5*sin(c + d*x)/(6*a*d) + 7*a**4*x*(8*A + 7*B)/16 - 2*a**4*(8*A + 7*B)*sin(c + d*x)**3/(15*d) + a**4*(8*A + 7*B)*sin(c + d*x)*cos(c + d*x)**3/(40*d) + 27*a**4*(8*A + 7*B)*sin(c + d*x)*cos(c + d*x)/(80*d) + 4*a**4*(8*A + 7*B)*sin(c + d*x)/(5*d) + (6*A - B)*(a*cos(c + d*x) + a)**4*sin(c + d*x)/(30*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**4,
        variable=x,
        num_steps=11,
        integral=B*(a*cos(c + d*x) + a)**4*sin(c + d*x)/(5*d) + 7*a**4*x*(5*A + 4*B)/8 - 4*a**4*(5*A + 4*B)*sin(c + d*x)**3/(15*d) + a**4*(5*A + 4*B)*sin(c + d*x)*cos(c + d*x)**3/(20*d) + 27*a**4*(5*A + 4*B)*sin(c + d*x)*cos(c + d*x)/(40*d) + 8*a**4*(5*A + 4*B)*sin(c + d*x)/(5*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**4*sec(c + d*x),
        variable=x,
        num_steps=7,
        integral=A*a**4*atanh(sin(c + d*x))/d + B*a*(a*cos(c + d*x) + a)**3*sin(c + d*x)/(4*d) + a**4*x*(48*A + 35*B)/8 + 5*a**4*(8*A + 7*B)*sin(c + d*x)/(8*d) + (4*A + 7*B)*(a**2*cos(c + d*x) + a**2)**2*sin(c + d*x)/(12*d) + (32*A + 35*B)*(a**4*cos(c + d*x) + a**4)*sin(c + d*x)/(24*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**4*sec(c + d*x)**2,
        variable=x,
        num_steps=7,
        integral=A*a*(a*cos(c + d*x) + a)**3*tan(c + d*x)/d + a**4*x*(13*A + 12*B)/2 + 5*a**4*(A + 2*B)*sin(c + d*x)/(2*d) + a**4*(4*A + B)*atanh(sin(c + d*x))/d - (3*A - 8*B)*(a**4*cos(c + d*x) + a**4)*sin(c + d*x)/(6*d) - (3*A - B)*(a**2*cos(c + d*x) + a**2)**2*sin(c + d*x)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**4*sec(c + d*x)**3,
        variable=x,
        num_steps=7,
        integral=A*a*(a*cos(c + d*x) + a)**3*tan(c + d*x)*sec(c + d*x)/(2*d) + a**4*x*(8*A + 13*B)/2 - 5*a**4*(A - B)*sin(c + d*x)/(2*d) + a**4*(13*A + 8*B)*atanh(sin(c + d*x))/(2*d) + (5*A + 2*B)*(a**2*cos(c + d*x) + a**2)**2*tan(c + d*x)/(2*d) - (6*A + B)*(a**4*cos(c + d*x) + a**4)*sin(c + d*x)/(2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**4*sec(c + d*x)**4,
        variable=x,
        num_steps=7,
        integral=A*a*(a*cos(c + d*x) + a)**3*tan(c + d*x)*sec(c + d*x)**2/(3*d) + a**4*x*(A + 4*B) - 5*a**4*(2*A + B)*sin(c + d*x)/(2*d) + a**4*(12*A + 13*B)*atanh(sin(c + d*x))/(2*d) + (2*A + B)*(a**2*cos(c + d*x) + a**2)**2*tan(c + d*x)*sec(c + d*x)/(2*d) + (11*A + 9*B)*(a**4*cos(c + d*x) + a**4)*tan(c + d*x)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**4*sec(c + d*x)**5,
        variable=x,
        num_steps=7,
        integral=A*a*(a*cos(c + d*x) + a)**3*tan(c + d*x)*sec(c + d*x)**3/(4*d) + B*a**4*x + 5*a**4*(7*A + 8*B)*tan(c + d*x)/(8*d) + a**4*(35*A + 48*B)*atanh(sin(c + d*x))/(8*d) + (7*A + 4*B)*(a**2*cos(c + d*x) + a**2)**2*tan(c + d*x)*sec(c + d*x)**2/(12*d) + (35*A + 32*B)*(a**4*cos(c + d*x) + a**4)*tan(c + d*x)*sec(c + d*x)/(24*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**4*sec(c + d*x)**6,
        variable=x,
        num_steps=9,
        integral=A*a*(a*cos(c + d*x) + a)**3*tan(c + d*x)*sec(c + d*x)**4/(5*d) + 7*a**4*(4*A + 5*B)*atanh(sin(c + d*x))/(8*d) + a**4*(83*A + 100*B)*tan(c + d*x)/(15*d) + a**4*(244*A + 275*B)*tan(c + d*x)*sec(c + d*x)/(120*d) + (8*A + 5*B)*(a**2*cos(c + d*x) + a**2)**2*tan(c + d*x)*sec(c + d*x)**3/(20*d) + (26*A + 25*B)*(a**4*cos(c + d*x) + a**4)*tan(c + d*x)*sec(c + d*x)**2/(30*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**4*sec(c + d*x)**7,
        variable=x,
        num_steps=10,
        integral=A*a*(a*cos(c + d*x) + a)**3*tan(c + d*x)*sec(c + d*x)**5/(6*d) + 7*a**4*(7*A + 8*B)*tan(c + d*x)*sec(c + d*x)/(16*d) + 7*a**4*(7*A + 8*B)*atanh(sin(c + d*x))/(16*d) + a**4*(72*A + 83*B)*tan(c + d*x)/(15*d) + a**4*(159*A + 176*B)*tan(c + d*x)*sec(c + d*x)**2/(120*d) + (3*A + 2*B)*(a**2*cos(c + d*x) + a**2)**2*tan(c + d*x)*sec(c + d*x)**4/(10*d) + (73*A + 72*B)*(a**4*cos(c + d*x) + a**4)*tan(c + d*x)*sec(c + d*x)**3/(120*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**4/(a*cos(c + d*x) + a),
        variable=x,
        num_steps=7,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**4/(d*(a*cos(c + d*x) + a)) - x*(12*A - 15*B)/(8*a) - (4*A - 5*B)*sin(c + d*x)*cos(c + d*x)**3/(4*a*d) - (4*A - 4*B)*sin(c + d*x)**3/(3*a*d) + (4*A - 4*B)*sin(c + d*x)/(a*d) - (12*A - 15*B)*sin(c + d*x)*cos(c + d*x)/(8*a*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**3/(a*cos(c + d*x) + a),
        variable=x,
        num_steps=6,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**3/(d*(a*cos(c + d*x) + a)) + x*(3*A - 3*B)/(2*a) + (3*A - 4*B)*sin(c + d*x)**3/(3*a*d) - (3*A - 4*B)*sin(c + d*x)/(a*d) + (3*A - 3*B)*sin(c + d*x)*cos(c + d*x)/(2*a*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)/(a*cos(c + d*x) + a),
        variable=x,
        num_steps=5,
        integral=B*sin(c + d*x)/(a*d) + x*(A - B)/a - (A - B)*sin(c + d*x)/(a*d*(cos(c + d*x) + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/(a*cos(c + d*x) + a),
        variable=x,
        num_steps=2,
        integral=B*x/a + (A - B)*sin(c + d*x)/(d*(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)/(a*cos(c + d*x) + a),
        variable=x,
        num_steps=3,
        integral=A*atanh(sin(c + d*x))/(a*d) - (A - B)*sin(c + d*x)/(d*(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**2/(a*cos(c + d*x) + a),
        variable=x,
        num_steps=5,
        integral=-(A - B)*tan(c + d*x)/(d*(a*cos(c + d*x) + a)) - (A - B)*atanh(sin(c + d*x))/(a*d) + (2*A - B)*tan(c + d*x)/(a*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**3/(a*cos(c + d*x) + a),
        variable=x,
        num_steps=6,
        integral=-(A - B)*tan(c + d*x)*sec(c + d*x)/(d*(a*cos(c + d*x) + a)) - (2*A - 2*B)*tan(c + d*x)/(a*d) + (3*A - 2*B)*tan(c + d*x)*sec(c + d*x)/(2*a*d) + (3*A - 2*B)*atanh(sin(c + d*x))/(2*a*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**4/(a*cos(c + d*x) + a),
        variable=x,
        num_steps=6,
        integral=-(A - B)*tan(c + d*x)*sec(c + d*x)**2/(d*(a*cos(c + d*x) + a)) - (3*A - 3*B)*tan(c + d*x)*sec(c + d*x)/(2*a*d) - (3*A - 3*B)*atanh(sin(c + d*x))/(2*a*d) + (4*A - 3*B)*tan(c + d*x)**3/(3*a*d) + (4*A - 3*B)*tan(c + d*x)/(a*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**4/(a*cos(c + d*x) + a)**2,
        variable=x,
        num_steps=7,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**4/(3*d*(a*cos(c + d*x) + a)**2) + x*(7*A - 10*B)/(2*a**2) + (7*A - 10*B)*sin(c + d*x)*cos(c + d*x)/(2*a**2*d) + (7*A - 10*B)*sin(c + d*x)*cos(c + d*x)**3/(3*a**2*d*(cos(c + d*x) + 1)) + (8*A - 12*B)*sin(c + d*x)**3/(3*a**2*d) - (8*A - 12*B)*sin(c + d*x)/(a**2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**3/(a*cos(c + d*x) + a)**2,
        variable=x,
        num_steps=3,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**3/(3*d*(a*cos(c + d*x) + a)**2) - x*(4*A - 7*B)/(2*a**2) - (4*A - 7*B)*sin(c + d*x)*cos(c + d*x)/(2*a**2*d) + (5*A - 8*B)*sin(c + d*x)*cos(c + d*x)**2/(3*a**2*d*(cos(c + d*x) + 1)) + (10*A - 16*B)*sin(c + d*x)/(3*a**2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**2/(a*cos(c + d*x) + a)**2,
        variable=x,
        num_steps=6,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**2/(3*d*(a*cos(c + d*x) + a)**2) + x*(A - 2*B)/a**2 - (A - 4*B)*sin(c + d*x)/(3*a**2*d) - (A - 2*B)*sin(c + d*x)/(a**2*d*(cos(c + d*x) + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)/(a*cos(c + d*x) + a)**2,
        variable=x,
        num_steps=4,
        integral=B*x/a**2 - (A - B)*sin(c + d*x)/(3*d*(a*cos(c + d*x) + a)**2) + (2*A - 5*B)*sin(c + d*x)/(3*a**2*d*(cos(c + d*x) + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/(a*cos(c + d*x) + a)**2,
        variable=x,
        num_steps=2,
        integral=(A - B)*sin(c + d*x)/(3*d*(a*cos(c + d*x) + a)**2) + (A + 2*B)*sin(c + d*x)/(3*d*(a**2*cos(c + d*x) + a**2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)/(a*cos(c + d*x) + a)**2,
        variable=x,
        num_steps=4,
        integral=A*atanh(sin(c + d*x))/(a**2*d) - (A - B)*sin(c + d*x)/(3*d*(a*cos(c + d*x) + a)**2) - (4*A - B)*sin(c + d*x)/(3*a**2*d*(cos(c + d*x) + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**2/(a*cos(c + d*x) + a)**2,
        variable=x,
        num_steps=6,
        integral=-(A - B)*tan(c + d*x)/(3*d*(a*cos(c + d*x) + a)**2) - (2*A - B)*atanh(sin(c + d*x))/(a**2*d) - (2*A - B)*tan(c + d*x)/(a**2*d*(cos(c + d*x) + 1)) + (10*A - 4*B)*tan(c + d*x)/(3*a**2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**3/(a*cos(c + d*x) + a)**2,
        variable=x,
        num_steps=7,
        integral=-(A - B)*tan(c + d*x)*sec(c + d*x)/(3*d*(a*cos(c + d*x) + a)**2) + (7*A - 4*B)*tan(c + d*x)*sec(c + d*x)/(2*a**2*d) + (7*A - 4*B)*atanh(sin(c + d*x))/(2*a**2*d) - (8*A - 5*B)*tan(c + d*x)*sec(c + d*x)/(3*a**2*d*(cos(c + d*x) + 1)) - (16*A - 10*B)*tan(c + d*x)/(3*a**2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**4/(a*cos(c + d*x) + a)**2,
        variable=x,
        num_steps=7,
        integral=-(A - B)*tan(c + d*x)*sec(c + d*x)**2/(3*d*(a*cos(c + d*x) + a)**2) - (10*A - 7*B)*tan(c + d*x)*sec(c + d*x)/(2*a**2*d) - (10*A - 7*B)*atanh(sin(c + d*x))/(2*a**2*d) - (10*A - 7*B)*tan(c + d*x)*sec(c + d*x)**2/(3*a**2*d*(cos(c + d*x) + 1)) + (12*A - 8*B)*tan(c + d*x)**3/(3*a**2*d) + (12*A - 8*B)*tan(c + d*x)/(a**2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**5/(a*cos(c + d*x) + a)**3,
        variable=x,
        num_steps=8,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**5/(5*d*(a*cos(c + d*x) + a)**3) + (13*A - 23*B)*sin(c + d*x)*cos(c + d*x)**3/(3*d*(a**3*cos(c + d*x) + a**3)) + (8*A - 13*B)*sin(c + d*x)*cos(c + d*x)**4/(15*a*d*(a*cos(c + d*x) + a)**2) + x*(13*A - 23*B)/(2*a**3) + (13*A - 23*B)*sin(c + d*x)*cos(c + d*x)/(2*a**3*d) + (76*A - 136*B)*sin(c + d*x)**3/(15*a**3*d) - (76*A - 136*B)*sin(c + d*x)/(5*a**3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**4/(a*cos(c + d*x) + a)**3,
        variable=x,
        num_steps=4,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**4/(5*d*(a*cos(c + d*x) + a)**3) + (36*A - 76*B)*sin(c + d*x)*cos(c + d*x)**2/(15*d*(a**3*cos(c + d*x) + a**3)) + (6*A - 11*B)*sin(c + d*x)*cos(c + d*x)**3/(15*a*d*(a*cos(c + d*x) + a)**2) - x*(6*A - 13*B)/(2*a**3) - (6*A - 13*B)*sin(c + d*x)*cos(c + d*x)/(2*a**3*d) + (72*A - 152*B)*sin(c + d*x)/(15*a**3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**3/(a*cos(c + d*x) + a)**3,
        variable=x,
        num_steps=7,
        integral=-(A - 3*B)*sin(c + d*x)/(d*(a**3*cos(c + d*x) + a**3)) + (A - B)*sin(c + d*x)*cos(c + d*x)**3/(5*d*(a*cos(c + d*x) + a)**3) + (4*A - 9*B)*sin(c + d*x)*cos(c + d*x)**2/(15*a*d*(a*cos(c + d*x) + a)**2) + x*(A - 3*B)/a**3 - (7*A - 27*B)*sin(c + d*x)/(15*a**3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**2/(a*cos(c + d*x) + a)**3,
        variable=x,
        num_steps=5,
        integral=B*x/a**3 + (A - B)*sin(c + d*x)*cos(c + d*x)**2/(5*d*(a*cos(c + d*x) + a)**3) + (4*A - 29*B)*sin(c + d*x)/(15*d*(a**3*cos(c + d*x) + a**3)) - (2*A - 7*B)*sin(c + d*x)/(15*a*d*(a*cos(c + d*x) + a)**2),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)/(a*cos(c + d*x) + a)**3,
        variable=x,
        num_steps=4,
        integral=-(A - B)*sin(c + d*x)/(5*d*(a*cos(c + d*x) + a)**3) + (3*A + 7*B)*sin(c + d*x)/(15*d*(a**3*cos(c + d*x) + a**3)) + (3*A - 8*B)*sin(c + d*x)/(15*a*d*(a*cos(c + d*x) + a)**2),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/(a*cos(c + d*x) + a)**3,
        variable=x,
        num_steps=3,
        integral=(A - B)*sin(c + d*x)/(5*d*(a*cos(c + d*x) + a)**3) + (2*A + 3*B)*sin(c + d*x)/(15*d*(a**3*cos(c + d*x) + a**3)) + (2*A + 3*B)*sin(c + d*x)/(15*a*d*(a*cos(c + d*x) + a)**2),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)/(a*cos(c + d*x) + a)**3,
        variable=x,
        num_steps=5,
        integral=A*atanh(sin(c + d*x))/(a**3*d) - (A - B)*sin(c + d*x)/(5*d*(a*cos(c + d*x) + a)**3) - (22*A - 2*B)*sin(c + d*x)/(15*d*(a**3*cos(c + d*x) + a**3)) - (7*A - 2*B)*sin(c + d*x)/(15*a*d*(a*cos(c + d*x) + a)**2),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**2/(a*cos(c + d*x) + a)**3,
        variable=x,
        num_steps=7,
        integral=-(A - B)*tan(c + d*x)/(5*d*(a*cos(c + d*x) + a)**3) - (3*A - B)*tan(c + d*x)/(d*(a**3*cos(c + d*x) + a**3)) - (9*A - 4*B)*tan(c + d*x)/(15*a*d*(a*cos(c + d*x) + a)**2) - (3*A - B)*atanh(sin(c + d*x))/(a**3*d) + (72*A - 22*B)*tan(c + d*x)/(15*a**3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**3/(a*cos(c + d*x) + a)**3,
        variable=x,
        num_steps=8,
        integral=-(A - B)*tan(c + d*x)*sec(c + d*x)/(5*d*(a*cos(c + d*x) + a)**3) - (76*A - 36*B)*tan(c + d*x)*sec(c + d*x)/(15*d*(a**3*cos(c + d*x) + a**3)) - (11*A - 6*B)*tan(c + d*x)*sec(c + d*x)/(15*a*d*(a*cos(c + d*x) + a)**2) + (13*A - 6*B)*tan(c + d*x)*sec(c + d*x)/(2*a**3*d) + (13*A - 6*B)*atanh(sin(c + d*x))/(2*a**3*d) - (152*A - 72*B)*tan(c + d*x)/(15*a**3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**5/(a*cos(c + d*x) + a)**4,
        variable=x,
        num_steps=5,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**5/(7*d*(a*cos(c + d*x) + a)**4) + (A - 2*B)*sin(c + d*x)*cos(c + d*x)**4/(5*a*d*(a*cos(c + d*x) + a)**3) - x*(8*A - 21*B)/(2*a**4) - (8*A - 21*B)*sin(c + d*x)*cos(c + d*x)/(2*a**4*d) + (52*A - 129*B)*sin(c + d*x)*cos(c + d*x)**3/(105*a**4*d*(cos(c + d*x) + 1)**2) + (332*A - 864*B)*sin(c + d*x)*cos(c + d*x)**2/(105*a**4*d*(cos(c + d*x) + 1)) + (664*A - 1728*B)*sin(c + d*x)/(105*a**4*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**4/(a*cos(c + d*x) + a)**4,
        variable=x,
        num_steps=8,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**4/(7*d*(a*cos(c + d*x) + a)**4) + (5*A - 12*B)*sin(c + d*x)*cos(c + d*x)**3/(35*a*d*(a*cos(c + d*x) + a)**3) + x*(A - 4*B)/a**4 - (A - 4*B)*sin(c + d*x)/(a**4*d*(cos(c + d*x) + 1)) + (25*A - 88*B)*sin(c + d*x)*cos(c + d*x)**2/(105*a**4*d*(cos(c + d*x) + 1)**2) - (55*A - 244*B)*sin(c + d*x)/(105*a**4*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**3/(a*cos(c + d*x) + a)**4,
        variable=x,
        num_steps=6,
        integral=B*x/a**4 + (A - B)*sin(c + d*x)*cos(c + d*x)**3/(7*d*(a*cos(c + d*x) + a)**4) + (3*A - 10*B)*sin(c + d*x)*cos(c + d*x)**2/(35*a*d*(a*cos(c + d*x) + a)**3) - (6*A - 55*B)*sin(c + d*x)/(105*a**4*d*(cos(c + d*x) + 1)**2) + (12*A - 215*B)*sin(c + d*x)/(105*a**4*d*(cos(c + d*x) + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**2/(a*cos(c + d*x) + a)**4,
        variable=x,
        num_steps=5,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**2/(7*d*(a*cos(c + d*x) + a)**4) - (A - 8*B)*sin(c + d*x)/(35*a*d*(a*cos(c + d*x) + a)**3) - (2*A + 54*B)*sin(c + d*x)/(105*a**4*d*(cos(c + d*x) + 1)**2) + (13*A + 36*B)*sin(c + d*x)/(105*a**4*d*(cos(c + d*x) + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)/(a*cos(c + d*x) + a)**4,
        variable=x,
        num_steps=5,
        integral=-(A - B)*sin(c + d*x)/(7*d*(a*cos(c + d*x) + a)**4) + (8*A + 13*B)*sin(c + d*x)/(105*d*(a**4*cos(c + d*x) + a**4)) + (8*A + 13*B)*sin(c + d*x)/(105*d*(a**2*cos(c + d*x) + a**2)**2) + (4*A - 11*B)*sin(c + d*x)/(35*a*d*(a*cos(c + d*x) + a)**3),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/(a*cos(c + d*x) + a)**4,
        variable=x,
        num_steps=4,
        integral=(A - B)*sin(c + d*x)/(7*d*(a*cos(c + d*x) + a)**4) + (6*A + 8*B)*sin(c + d*x)/(105*d*(a**4*cos(c + d*x) + a**4)) + (6*A + 8*B)*sin(c + d*x)/(105*d*(a**2*cos(c + d*x) + a**2)**2) + (3*A + 4*B)*sin(c + d*x)/(35*a*d*(a*cos(c + d*x) + a)**3),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)/(a*cos(c + d*x) + a)**4,
        variable=x,
        num_steps=6,
        integral=A*atanh(sin(c + d*x))/(a**4*d) - (A - B)*sin(c + d*x)/(7*d*(a*cos(c + d*x) + a)**4) - (10*A - 3*B)*sin(c + d*x)/(35*a*d*(a*cos(c + d*x) + a)**3) - (55*A - 6*B)*sin(c + d*x)/(105*a**4*d*(cos(c + d*x) + 1)**2) - (160*A - 6*B)*sin(c + d*x)/(105*a**4*d*(cos(c + d*x) + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**2/(a*cos(c + d*x) + a)**4,
        variable=x,
        num_steps=8,
        integral=-(A - B)*tan(c + d*x)/(7*d*(a*cos(c + d*x) + a)**4) - (12*A - 5*B)*tan(c + d*x)/(35*a*d*(a*cos(c + d*x) + a)**3) - (4*A - B)*atanh(sin(c + d*x))/(a**4*d) - (4*A - B)*tan(c + d*x)/(a**4*d*(cos(c + d*x) + 1)) - (88*A - 25*B)*tan(c + d*x)/(105*a**4*d*(cos(c + d*x) + 1)**2) + (664*A - 160*B)*tan(c + d*x)/(105*a**4*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**3/(a*cos(c + d*x) + a)**4,
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**3,
        variable=x,
        num_steps=5,
        integral=2*B*a*sin(c + d*x)*cos(c + d*x)**4/(9*d*sqrt(a*cos(c + d*x) + a)) + 2*a*(9*A + 8*B)*sin(c + d*x)*cos(c + d*x)**3/(63*d*sqrt(a*cos(c + d*x) + a)) + 4*a*(9*A + 8*B)*sin(c + d*x)/(45*d*sqrt(a*cos(c + d*x) + a)) - (72*A + 64*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(315*d) + (36*A + 32*B)*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)/(105*a*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**2,
        variable=x,
        num_steps=4,
        integral=2*B*a*sin(c + d*x)*cos(c + d*x)**3/(7*d*sqrt(a*cos(c + d*x) + a)) + 2*a*(7*A + 6*B)*sin(c + d*x)/(15*d*sqrt(a*cos(c + d*x) + a)) - (28*A + 24*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(105*d) + (14*A + 12*B)*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)/(35*a*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)*cos(c + d*x),
        variable=x,
        num_steps=4,
        integral=2*B*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)/(5*a*d) + 2*a*(5*A + 7*B)*sin(c + d*x)/(15*d*sqrt(a*cos(c + d*x) + a)) + (10*A - 4*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(15*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a),
        variable=x,
        num_steps=2,
        integral=2*B*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(3*d) + 2*a*(3*A + B)*sin(c + d*x)/(3*d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)*sec(c + d*x),
        variable=x,
        num_steps=3,
        integral=2*A*sqrt(a)*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/d + 2*B*a*sin(c + d*x)/(d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)*sec(c + d*x)**2,
        variable=x,
        num_steps=3,
        integral=A*a*tan(c + d*x)/(d*sqrt(a*cos(c + d*x) + a)) + sqrt(a)*(A + 2*B)*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)*sec(c + d*x)**3,
        variable=x,
        num_steps=4,
        integral=A*a*tan(c + d*x)*sec(c + d*x)/(2*d*sqrt(a*cos(c + d*x) + a)) + sqrt(a)*(3*A + 4*B)*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(4*d) + a*(3*A + 4*B)*tan(c + d*x)/(4*d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)*sec(c + d*x)**4,
        variable=x,
        num_steps=5,
        integral=A*a*tan(c + d*x)*sec(c + d*x)**2/(3*d*sqrt(a*cos(c + d*x) + a)) + sqrt(a)*(5*A + 6*B)*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(8*d) + a*(5*A + 6*B)*tan(c + d*x)*sec(c + d*x)/(12*d*sqrt(a*cos(c + d*x) + a)) + a*(5*A + 6*B)*tan(c + d*x)/(8*d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*cos(c + d*x)**3,
        variable=x,
        num_steps=6,
        integral=2*B*a*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)*cos(c + d*x)**4/(11*d) + 2*a**2*(11*A + 12*B)*sin(c + d*x)*cos(c + d*x)**4/(99*d*sqrt(a*cos(c + d*x) + a)) + 2*a**2*(187*A + 168*B)*sin(c + d*x)*cos(c + d*x)**3/(693*d*sqrt(a*cos(c + d*x) + a)) + 4*a**2*(187*A + 168*B)*sin(c + d*x)/(495*d*sqrt(a*cos(c + d*x) + a)) - 8*a*(187*A + 168*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(3465*d) + (748*A + 672*B)*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)/(1155*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*cos(c + d*x)**2,
        variable=x,
        num_steps=5,
        integral=2*B*a*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)*cos(c + d*x)**3/(9*d) + 2*a**2*(9*A + 10*B)*sin(c + d*x)*cos(c + d*x)**3/(63*d*sqrt(a*cos(c + d*x) + a)) + 2*a**2*(39*A + 34*B)*sin(c + d*x)/(45*d*sqrt(a*cos(c + d*x) + a)) - 4*a*(39*A + 34*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(315*d) + (78*A + 68*B)*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)/(105*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*cos(c + d*x),
        variable=x,
        num_steps=5,
        integral=2*B*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sin(c + d*x)/(7*a*d) + 8*a**2*(21*A + 19*B)*sin(c + d*x)/(105*d*sqrt(a*cos(c + d*x) + a)) + 2*a*(21*A + 19*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(105*d) + (14*A - 4*B)*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)/(35*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2),
        variable=x,
        num_steps=3,
        integral=2*B*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)/(5*d) + 8*a**2*(5*A + 3*B)*sin(c + d*x)/(15*d*sqrt(a*cos(c + d*x) + a)) + 2*a*(5*A + 3*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(15*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sec(c + d*x),
        variable=x,
        num_steps=4,
        integral=2*A*a**(sympy.S(3)/2)*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/d + 2*B*a*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(3*d) + 2*a**2*(3*A + 4*B)*sin(c + d*x)/(3*d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sec(c + d*x)**2,
        variable=x,
        num_steps=4,
        integral=A*a*sqrt(a*cos(c + d*x) + a)*tan(c + d*x)/d + a**(sympy.S(3)/2)*(3*A + 2*B)*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/d - a**2*(A - 2*B)*sin(c + d*x)/(d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sec(c + d*x)**3,
        variable=x,
        num_steps=4,
        integral=A*a*sqrt(a*cos(c + d*x) + a)*tan(c + d*x)*sec(c + d*x)/(2*d) + a**(sympy.S(3)/2)*(7*A + 12*B)*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(4*d) + a**2*(5*A + 4*B)*tan(c + d*x)/(4*d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sec(c + d*x)**4,
        variable=x,
        num_steps=5,
        integral=A*a*sqrt(a*cos(c + d*x) + a)*tan(c + d*x)*sec(c + d*x)**2/(3*d) + a**(sympy.S(3)/2)*(11*A + 14*B)*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(8*d) + a**2*(7*A + 6*B)*tan(c + d*x)*sec(c + d*x)/(12*d*sqrt(a*cos(c + d*x) + a)) + a**2*(11*A + 14*B)*tan(c + d*x)/(8*d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sec(c + d*x)**5,
        variable=x,
        num_steps=6,
        integral=A*a*sqrt(a*cos(c + d*x) + a)*tan(c + d*x)*sec(c + d*x)**3/(4*d) + a**(sympy.S(3)/2)*(75*A + 88*B)*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(64*d) + a**2*(9*A + 8*B)*tan(c + d*x)*sec(c + d*x)**2/(24*d*sqrt(a*cos(c + d*x) + a)) + a**2*(75*A + 88*B)*tan(c + d*x)*sec(c + d*x)/(96*d*sqrt(a*cos(c + d*x) + a)) + a**2*(75*A + 88*B)*tan(c + d*x)/(64*d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*cos(c + d*x)**2,
        variable=x,
        num_steps=6,
        integral=2*B*a*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)*cos(c + d*x)**3/(11*d) + 2*a**3*(209*A + 194*B)*sin(c + d*x)*cos(c + d*x)**3/(693*d*sqrt(a*cos(c + d*x) + a)) + 2*a**3*(803*A + 710*B)*sin(c + d*x)/(495*d*sqrt(a*cos(c + d*x) + a)) + 2*a**2*(11*A + 14*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)*cos(c + d*x)**3/(99*d) - 4*a**2*(803*A + 710*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(3465*d) + 2*a*(803*A + 710*B)*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)/(1155*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*cos(c + d*x),
        variable=x,
        num_steps=6,
        integral=2*B*(a*cos(c + d*x) + a)**(sympy.S(7)/2)*sin(c + d*x)/(9*a*d) + 64*a**3*(15*A + 13*B)*sin(c + d*x)/(315*d*sqrt(a*cos(c + d*x) + a)) + 16*a**2*(15*A + 13*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(315*d) + 2*a*(15*A + 13*B)*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)/(105*d) + (18*A - 4*B)*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sin(c + d*x)/(63*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2),
        variable=x,
        num_steps=4,
        integral=2*B*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sin(c + d*x)/(7*d) + 64*a**3*(7*A + 5*B)*sin(c + d*x)/(105*d*sqrt(a*cos(c + d*x) + a)) + 16*a**2*(7*A + 5*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(105*d) + 2*a*(7*A + 5*B)*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)/(35*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sec(c + d*x),
        variable=x,
        num_steps=5,
        integral=2*A*a**(sympy.S(5)/2)*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/d + 2*B*a*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)/(5*d) + 2*a**3*(35*A + 32*B)*sin(c + d*x)/(15*d*sqrt(a*cos(c + d*x) + a)) + 2*a**2*(5*A + 8*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(15*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sec(c + d*x)**2,
        variable=x,
        num_steps=5,
        integral=A*a*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*tan(c + d*x)/d + a**(sympy.S(5)/2)*(5*A + 2*B)*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/d + a**3*(3*A + 14*B)*sin(c + d*x)/(3*d*sqrt(a*cos(c + d*x) + a)) - a**2*(3*A - 2*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sec(c + d*x)**3,
        variable=x,
        num_steps=5,
        integral=A*a*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*tan(c + d*x)*sec(c + d*x)/(2*d) + a**(sympy.S(5)/2)*(19*A + 20*B)*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(4*d) - a**3*(9*A - 4*B)*sin(c + d*x)/(4*d*sqrt(a*cos(c + d*x) + a)) + a**2*(7*A + 4*B)*sqrt(a*cos(c + d*x) + a)*tan(c + d*x)/(4*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sec(c + d*x)**4,
        variable=x,
        num_steps=5,
        integral=A*a*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*tan(c + d*x)*sec(c + d*x)**2/(3*d) + a**(sympy.S(5)/2)*(25*A + 38*B)*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(8*d) + a**3*(49*A + 54*B)*tan(c + d*x)/(24*d*sqrt(a*cos(c + d*x) + a)) + a**2*(3*A + 2*B)*sqrt(a*cos(c + d*x) + a)*tan(c + d*x)*sec(c + d*x)/(4*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sec(c + d*x)**5,
        variable=x,
        num_steps=6,
        integral=A*a*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*tan(c + d*x)*sec(c + d*x)**3/(4*d) + a**(sympy.S(5)/2)*(163*A + 200*B)*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(64*d) + a**3*(95*A + 104*B)*tan(c + d*x)*sec(c + d*x)/(96*d*sqrt(a*cos(c + d*x) + a)) + a**3*(163*A + 200*B)*tan(c + d*x)/(64*d*sqrt(a*cos(c + d*x) + a)) + a**2*(11*A + 8*B)*sqrt(a*cos(c + d*x) + a)*tan(c + d*x)*sec(c + d*x)**2/(24*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sec(c + d*x)**6,
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**3/sqrt(a*cos(c + d*x) + a),
        variable=x,
        num_steps=7,
        integral=2*B*sin(c + d*x)*cos(c + d*x)**3/(7*d*sqrt(a*cos(c + d*x) + a)) + (14*A - 2*B)*sin(c + d*x)*cos(c + d*x)**2/(35*d*sqrt(a*cos(c + d*x) + a)) + (196*A - 148*B)*sin(c + d*x)/(105*d*sqrt(a*cos(c + d*x) + a)) - (14*A - 62*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(105*a*d) - sqrt(2)*(A - B)*atanh(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)))/(sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**2/sqrt(a*cos(c + d*x) + a),
        variable=x,
        num_steps=6,
        integral=2*B*sin(c + d*x)*cos(c + d*x)**2/(5*d*sqrt(a*cos(c + d*x) + a)) - (20*A - 28*B)*sin(c + d*x)/(15*d*sqrt(a*cos(c + d*x) + a)) + (10*A - 2*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(15*a*d) + sqrt(2)*(A - B)*atanh(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)))/(sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)/sqrt(a*cos(c + d*x) + a),
        variable=x,
        num_steps=5,
        integral=2*B*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(3*a*d) + (6*A - 4*B)*sin(c + d*x)/(3*d*sqrt(a*cos(c + d*x) + a)) - sqrt(2)*(A - B)*atanh(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)))/(sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/sqrt(a*cos(c + d*x) + a),
        variable=x,
        num_steps=3,
        integral=2*B*sin(c + d*x)/(d*sqrt(a*cos(c + d*x) + a)) + sqrt(2)*(A - B)*atanh(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)))/(sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)/sqrt(a*cos(c + d*x) + a),
        variable=x,
        num_steps=5,
        integral=2*A*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(sqrt(a)*d) - sqrt(2)*(A - B)*atanh(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)))/(sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**2/sqrt(a*cos(c + d*x) + a),
        variable=x,
        num_steps=6,
        integral=A*tan(c + d*x)/(d*sqrt(a*cos(c + d*x) + a)) - (A - 2*B)*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(sqrt(a)*d) + sqrt(2)*(A - B)*atanh(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)))/(sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**3/sqrt(a*cos(c + d*x) + a),
        variable=x,
        num_steps=7,
        integral=A*tan(c + d*x)*sec(c + d*x)/(2*d*sqrt(a*cos(c + d*x) + a)) - (A - 4*B)*tan(c + d*x)/(4*d*sqrt(a*cos(c + d*x) + a)) - sqrt(2)*(A - B)*atanh(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)))/(sqrt(a)*d) + (7*A - 4*B)*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(4*sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**4/(a*cos(c + d*x) + a)**(sympy.S(3)/2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**3/(a*cos(c + d*x) + a)**(sympy.S(3)/2),
        variable=x,
        num_steps=7,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**3/(2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) - (5*A - 9*B)*sin(c + d*x)*cos(c + d*x)**2/(10*a*d*sqrt(a*cos(c + d*x) + a)) - (65*A - 93*B)*sin(c + d*x)/(15*a*d*sqrt(a*cos(c + d*x) + a)) + (35*A - 39*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(30*a**2*d) + sqrt(2)*(11*A - 15*B)*atanh(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)))/(4*a**(sympy.S(3)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**2/(a*cos(c + d*x) + a)**(sympy.S(3)/2),
        variable=x,
        num_steps=6,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**2/(2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) + (9*A - 13*B)*sin(c + d*x)/(3*a*d*sqrt(a*cos(c + d*x) + a)) - (3*A - 7*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(6*a**2*d) - sqrt(2)*(7*A - 11*B)*atanh(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)))/(4*a**(sympy.S(3)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)/(a*cos(c + d*x) + a)**(sympy.S(3)/2),
        variable=x,
        num_steps=5,
        integral=2*B*sin(c + d*x)/(a*d*sqrt(a*cos(c + d*x) + a)) - (A - B)*sin(c + d*x)/(2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) + sqrt(2)*(3*A - 7*B)*atanh(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)))/(4*a**(sympy.S(3)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/(a*cos(c + d*x) + a)**(sympy.S(3)/2),
        variable=x,
        num_steps=3,
        integral=(A - B)*sin(c + d*x)/(2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) + sqrt(2)*(A + 3*B)*atanh(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)))/(4*a**(sympy.S(3)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)/(a*cos(c + d*x) + a)**(sympy.S(3)/2),
        variable=x,
        num_steps=6,
        integral=2*A*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(a**(sympy.S(3)/2)*d) - (A - B)*sin(c + d*x)/(2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) - sqrt(2)*(5*A - B)*atanh(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)))/(4*a**(sympy.S(3)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**2/(a*cos(c + d*x) + a)**(sympy.S(3)/2),
        variable=x,
        num_steps=7,
        integral=-(A - B)*tan(c + d*x)/(2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) + (3*A - B)*tan(c + d*x)/(2*a*d*sqrt(a*cos(c + d*x) + a)) - (3*A - 2*B)*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(a**(sympy.S(3)/2)*d) + sqrt(2)*(9*A - 5*B)*atanh(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)))/(4*a**(sympy.S(3)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**3/(a*cos(c + d*x) + a)**(sympy.S(3)/2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**4/(a*cos(c + d*x) + a)**(sympy.S(5)/2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**3/(a*cos(c + d*x) + a)**(sympy.S(5)/2),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**2/(a*cos(c + d*x) + a)**(sympy.S(5)/2),
        variable=x,
        num_steps=6,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**2/(4*d*(a*cos(c + d*x) + a)**(sympy.S(5)/2)) - (5*A - 13*B)*sin(c + d*x)/(16*a*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) - (A - 9*B)*sin(c + d*x)/(4*a**2*d*sqrt(a*cos(c + d*x) + a)) + sqrt(2)*(19*A - 75*B)*atanh(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)))/(32*a**(sympy.S(5)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)/(a*cos(c + d*x) + a)**(sympy.S(5)/2),
        variable=x,
        num_steps=5,
        integral=-(A - B)*sin(c + d*x)/(4*d*(a*cos(c + d*x) + a)**(sympy.S(5)/2)) + (5*A - 13*B)*sin(c + d*x)/(16*a*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) + sqrt(2)*(5*A + 19*B)*atanh(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)))/(32*a**(sympy.S(5)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/(a*cos(c + d*x) + a)**(sympy.S(5)/2),
        variable=x,
        num_steps=4,
        integral=(A - B)*sin(c + d*x)/(4*d*(a*cos(c + d*x) + a)**(sympy.S(5)/2)) + (3*A + 5*B)*sin(c + d*x)/(16*a*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) + sqrt(2)*(3*A + 5*B)*atanh(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)))/(32*a**(sympy.S(5)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)/(a*cos(c + d*x) + a)**(sympy.S(5)/2),
        variable=x,
        num_steps=7,
        integral=2*A*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(a**(sympy.S(5)/2)*d) - (A - B)*sin(c + d*x)/(4*d*(a*cos(c + d*x) + a)**(sympy.S(5)/2)) - (11*A - 3*B)*sin(c + d*x)/(16*a*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) - sqrt(2)*(43*A - 3*B)*atanh(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)))/(32*a**(sympy.S(5)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**2/(a*cos(c + d*x) + a)**(sympy.S(5)/2),
        variable=x,
        num_steps=8,
        integral=-(A - B)*tan(c + d*x)/(4*d*(a*cos(c + d*x) + a)**(sympy.S(5)/2)) - (15*A - 7*B)*tan(c + d*x)/(16*a*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) + (35*A - 11*B)*tan(c + d*x)/(16*a**2*d*sqrt(a*cos(c + d*x) + a)) - (5*A - 2*B)*atanh(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(a**(sympy.S(5)/2)*d) + sqrt(2)*(115*A - 43*B)*atanh(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)))/(32*a**(sympy.S(5)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**3/(a*cos(c + d*x) + a)**(sympy.S(5)/2),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=8,
        integral=2*B*a*sin(c + d*x)*cos(c + d*x)**(sympy.S(7)/2)/(9*d) + 2*a*(A + B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(5)/2)/(7*d) + 10*a*(A + B)*sin(c + d*x)*sqrt(cos(c + d*x))/(21*d) + 10*a*(A + B)*elliptic_f(c/2 + d*x/2, 2)/(21*d) + 2*a*(9*A + 7*B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(45*d) + 2*a*(9*A + 7*B)*elliptic_e(c/2 + d*x/2, 2)/(15*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=7,
        integral=2*B*a*sin(c + d*x)*cos(c + d*x)**(sympy.S(5)/2)/(7*d) + 2*a*(A + B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(5*d) + 6*a*(A + B)*elliptic_e(c/2 + d*x/2, 2)/(5*d) + 2*a*(7*A + 5*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(21*d) + 2*a*(7*A + 5*B)*elliptic_f(c/2 + d*x/2, 2)/(21*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)*sqrt(cos(c + d*x)),
        variable=x,
        num_steps=6,
        integral=2*B*a*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(5*d) + 2*a*(A + B)*sin(c + d*x)*sqrt(cos(c + d*x))/(3*d) + 2*a*(A + B)*elliptic_f(c/2 + d*x/2, 2)/(3*d) + 2*a*(5*A + 3*B)*elliptic_e(c/2 + d*x/2, 2)/(5*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)/sqrt(cos(c + d*x)),
        variable=x,
        num_steps=5,
        integral=2*B*a*sin(c + d*x)*sqrt(cos(c + d*x))/(3*d) + 2*a*(A + B)*elliptic_e(c/2 + d*x/2, 2)/d + 2*a*(3*A + B)*elliptic_f(c/2 + d*x/2, 2)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)/cos(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=5,
        integral=2*A*a*sin(c + d*x)/(d*sqrt(cos(c + d*x))) - 2*a*(A - B)*elliptic_e(c/2 + d*x/2, 2)/d + 2*a*(A + B)*elliptic_f(c/2 + d*x/2, 2)/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)/cos(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=6,
        integral=2*A*a*sin(c + d*x)/(3*d*cos(c + d*x)**(sympy.S(3)/2)) + 2*a*(A + B)*sin(c + d*x)/(d*sqrt(cos(c + d*x))) - 2*a*(A + B)*elliptic_e(c/2 + d*x/2, 2)/d + 2*a*(A + 3*B)*elliptic_f(c/2 + d*x/2, 2)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)/cos(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=7,
        integral=2*A*a*sin(c + d*x)/(5*d*cos(c + d*x)**(sympy.S(5)/2)) + 2*a*(A + B)*sin(c + d*x)/(3*d*cos(c + d*x)**(sympy.S(3)/2)) + 2*a*(A + B)*elliptic_f(c/2 + d*x/2, 2)/(3*d) + 2*a*(3*A + 5*B)*sin(c + d*x)/(5*d*sqrt(cos(c + d*x))) - 2*a*(3*A + 5*B)*elliptic_e(c/2 + d*x/2, 2)/(5*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2*cos(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=8,
        integral=2*B*(a**2*cos(c + d*x) + a**2)*sin(c + d*x)*cos(c + d*x)**(sympy.S(5)/2)/(9*d) + 4*a**2*(6*A + 5*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(21*d) + 4*a**2*(6*A + 5*B)*elliptic_f(c/2 + d*x/2, 2)/(21*d) + 4*a**2*(9*A + 8*B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(45*d) + 4*a**2*(9*A + 8*B)*elliptic_e(c/2 + d*x/2, 2)/(15*d) + 2*a**2*(9*A + 11*B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(5)/2)/(63*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2*sqrt(cos(c + d*x)),
        variable=x,
        num_steps=7,
        integral=2*B*(a**2*cos(c + d*x) + a**2)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(7*d) + 4*a**2*(4*A + 3*B)*elliptic_e(c/2 + d*x/2, 2)/(5*d) + 4*a**2*(7*A + 6*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(21*d) + 4*a**2*(7*A + 6*B)*elliptic_f(c/2 + d*x/2, 2)/(21*d) + 2*a**2*(7*A + 9*B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(35*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2/sqrt(cos(c + d*x)),
        variable=x,
        num_steps=6,
        integral=2*B*(a**2*cos(c + d*x) + a**2)*sin(c + d*x)*sqrt(cos(c + d*x))/(5*d) + 4*a**2*(2*A + B)*elliptic_f(c/2 + d*x/2, 2)/(3*d) + 4*a**2*(5*A + 4*B)*elliptic_e(c/2 + d*x/2, 2)/(5*d) + 2*a**2*(5*A + 7*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(15*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2/cos(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=6,
        integral=2*A*(a**2*cos(c + d*x) + a**2)*sin(c + d*x)/(d*sqrt(cos(c + d*x))) + 4*B*a**2*elliptic_e(c/2 + d*x/2, 2)/d - 2*a**2*(3*A - B)*sin(c + d*x)*sqrt(cos(c + d*x))/(3*d) + 4*a**2*(3*A + 2*B)*elliptic_f(c/2 + d*x/2, 2)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2/cos(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=6,
        integral=-4*A*a**2*elliptic_e(c/2 + d*x/2, 2)/d + 2*A*(a**2*cos(c + d*x) + a**2)*sin(c + d*x)/(3*d*cos(c + d*x)**(sympy.S(3)/2)) + 4*a**2*(2*A + 3*B)*elliptic_f(c/2 + d*x/2, 2)/(3*d) + 2*a**2*(5*A + 3*B)*sin(c + d*x)/(3*d*sqrt(cos(c + d*x))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2/cos(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=7,
        integral=2*A*(a**2*cos(c + d*x) + a**2)*sin(c + d*x)/(5*d*cos(c + d*x)**(sympy.S(5)/2)) + 4*a**2*(A + 2*B)*elliptic_f(c/2 + d*x/2, 2)/(3*d) + 4*a**2*(4*A + 5*B)*sin(c + d*x)/(5*d*sqrt(cos(c + d*x))) - 4*a**2*(4*A + 5*B)*elliptic_e(c/2 + d*x/2, 2)/(5*d) + 2*a**2*(7*A + 5*B)*sin(c + d*x)/(15*d*cos(c + d*x)**(sympy.S(3)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2/cos(c + d*x)**(sympy.S(9)/2),
        variable=x,
        num_steps=8,
        integral=2*A*(a**2*cos(c + d*x) + a**2)*sin(c + d*x)/(7*d*cos(c + d*x)**(sympy.S(7)/2)) + 4*a**2*(3*A + 4*B)*sin(c + d*x)/(5*d*sqrt(cos(c + d*x))) - 4*a**2*(3*A + 4*B)*elliptic_e(c/2 + d*x/2, 2)/(5*d) + 4*a**2*(6*A + 7*B)*sin(c + d*x)/(21*d*cos(c + d*x)**(sympy.S(3)/2)) + 4*a**2*(6*A + 7*B)*elliptic_f(c/2 + d*x/2, 2)/(21*d) + 2*a**2*(9*A + 7*B)*sin(c + d*x)/(35*d*cos(c + d*x)**(sympy.S(5)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3*cos(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3*sqrt(cos(c + d*x)),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=7,
        integral=2*B*a*(a*cos(c + d*x) + a)**2*sin(c + d*x)*sqrt(cos(c + d*x))/(7*d) + 4*a**3*(9*A + 7*B)*elliptic_e(c/2 + d*x/2, 2)/(5*d) + 4*a**3*(21*A + 13*B)*elliptic_f(c/2 + d*x/2, 2)/(21*d) + 4*a**3*(42*A + 41*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(105*d) + (14*A + 22*B)*(a**3*cos(c + d*x) + a**3)*sin(c + d*x)*sqrt(cos(c + d*x))/(35*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3/cos(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=7,
        integral=2*A*a*(a*cos(c + d*x) + a)**2*sin(c + d*x)/(d*sqrt(cos(c + d*x))) - 4*a**3*(5*A - 6*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(15*d) + 4*a**3*(5*A + 3*B)*elliptic_f(c/2 + d*x/2, 2)/(3*d) + 4*a**3*(5*A + 9*B)*elliptic_e(c/2 + d*x/2, 2)/(5*d) - (10*A - 2*B)*(a**3*cos(c + d*x) + a**3)*sin(c + d*x)*sqrt(cos(c + d*x))/(5*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3/cos(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=7,
        integral=2*A*a*(a*cos(c + d*x) + a)**2*sin(c + d*x)/(3*d*cos(c + d*x)**(sympy.S(3)/2)) - 4*a**3*(A - B)*elliptic_e(c/2 + d*x/2, 2)/d + 20*a**3*(A + B)*elliptic_f(c/2 + d*x/2, 2)/(3*d) - 4*a**3*(4*A + B)*sin(c + d*x)*sqrt(cos(c + d*x))/(3*d) + (14*A + 6*B)*(a**3*cos(c + d*x) + a**3)*sin(c + d*x)/(3*d*sqrt(cos(c + d*x))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3/cos(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=7,
        integral=2*A*a*(a*cos(c + d*x) + a)**2*sin(c + d*x)/(5*d*cos(c + d*x)**(sympy.S(5)/2)) + 4*a**3*(3*A + 5*B)*elliptic_f(c/2 + d*x/2, 2)/(3*d) - 4*a**3*(9*A + 5*B)*elliptic_e(c/2 + d*x/2, 2)/(5*d) + 4*a**3*(21*A + 20*B)*sin(c + d*x)/(15*d*sqrt(cos(c + d*x))) + (18*A + 10*B)*(a**3*cos(c + d*x) + a**3)*sin(c + d*x)/(15*d*cos(c + d*x)**(sympy.S(3)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3/cos(c + d*x)**(sympy.S(9)/2),
        variable=x,
        num_steps=8,
        integral=2*A*a*(a*cos(c + d*x) + a)**2*sin(c + d*x)/(7*d*cos(c + d*x)**(sympy.S(7)/2)) + 4*a**3*(7*A + 9*B)*sin(c + d*x)/(5*d*sqrt(cos(c + d*x))) - 4*a**3*(7*A + 9*B)*elliptic_e(c/2 + d*x/2, 2)/(5*d) + 4*a**3*(13*A + 21*B)*elliptic_f(c/2 + d*x/2, 2)/(21*d) + 4*a**3*(41*A + 42*B)*sin(c + d*x)/(105*d*cos(c + d*x)**(sympy.S(3)/2)) + (22*A + 14*B)*(a**3*cos(c + d*x) + a**3)*sin(c + d*x)/(35*d*cos(c + d*x)**(sympy.S(5)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3/cos(c + d*x)**(sympy.S(11)/2),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(5)/2)/(a*cos(c + d*x) + a),
        variable=x,
        num_steps=6,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(5)/2)/(d*(a*cos(c + d*x) + a)) + (-15*A + 21*B)*elliptic_e(c/2 + d*x/2, 2)/(5*a*d) - (5*A - 7*B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(5*a*d) + (5*A - 5*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(3*a*d) + (5*A - 5*B)*elliptic_f(c/2 + d*x/2, 2)/(3*a*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(3)/2)/(a*cos(c + d*x) + a),
        variable=x,
        num_steps=5,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(d*(a*cos(c + d*x) + a)) - (3*A - 5*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(3*a*d) - (3*A - 5*B)*elliptic_f(c/2 + d*x/2, 2)/(3*a*d) + (3*A - 3*B)*elliptic_e(c/2 + d*x/2, 2)/(a*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(cos(c + d*x))/(a*cos(c + d*x) + a),
        variable=x,
        num_steps=4,
        integral=(A - B)*sin(c + d*x)*sqrt(cos(c + d*x))/(d*(a*cos(c + d*x) + a)) - (A - 3*B)*elliptic_e(c/2 + d*x/2, 2)/(a*d) + (A - B)*elliptic_f(c/2 + d*x/2, 2)/(a*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)*sqrt(cos(c + d*x))),
        variable=x,
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=5,
        integral=-(A - B)*sin(c + d*x)/(d*(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))) - (A - B)*elliptic_f(c/2 + d*x/2, 2)/(a*d) + (3*A - B)*sin(c + d*x)/(a*d*sqrt(cos(c + d*x))) - (3*A - B)*elliptic_e(c/2 + d*x/2, 2)/(a*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(5)/2)),
        variable=x,
        num_steps=6,
        integral=-(A - B)*sin(c + d*x)/(d*(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(3)/2)) - (3*A - 3*B)*sin(c + d*x)/(a*d*sqrt(cos(c + d*x))) + (3*A - 3*B)*elliptic_e(c/2 + d*x/2, 2)/(a*d) + (5*A - 3*B)*sin(c + d*x)/(3*a*d*cos(c + d*x)**(sympy.S(3)/2)) + (5*A - 3*B)*elliptic_f(c/2 + d*x/2, 2)/(3*a*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(7)/2)/(a*cos(c + d*x) + a)**2,
        variable=x,
        num_steps=7,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(7)/2)/(3*d*(a*cos(c + d*x) + a)**2) + (-35*A + 56*B)*elliptic_e(c/2 + d*x/2, 2)/(5*a**2*d) + (2*A - 3*B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(5)/2)/(a**2*d*(cos(c + d*x) + 1)) + (10*A - 15*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(3*a**2*d) + (10*A - 15*B)*elliptic_f(c/2 + d*x/2, 2)/(3*a**2*d) - (35*A - 56*B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(15*a**2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(5)/2)/(a*cos(c + d*x) + a)**2,
        variable=x,
        num_steps=6,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(5)/2)/(3*d*(a*cos(c + d*x) + a)**2) + (4*A - 7*B)*elliptic_e(c/2 + d*x/2, 2)/(a**2*d) + (4*A - 7*B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(3*a**2*d*(cos(c + d*x) + 1)) - (5*A - 10*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(3*a**2*d) - (5*A - 10*B)*elliptic_f(c/2 + d*x/2, 2)/(3*a**2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(3)/2)/(a*cos(c + d*x) + a)**2,
        variable=x,
        num_steps=5,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(3*d*(a*cos(c + d*x) + a)**2) - (A - 4*B)*elliptic_e(c/2 + d*x/2, 2)/(a**2*d) + (2*A - 5*B)*elliptic_f(c/2 + d*x/2, 2)/(3*a**2*d) + (2*A - 5*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(3*a**2*d*(cos(c + d*x) + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(cos(c + d*x))/(a*cos(c + d*x) + a)**2,
        variable=x,
        num_steps=5,
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=6,
        integral=-(A - B)*sin(c + d*x)/(3*d*(a*cos(c + d*x) + a)**2*sqrt(cos(c + d*x))) + (4*A - B)*sin(c + d*x)/(a**2*d*sqrt(cos(c + d*x))) - (4*A - B)*elliptic_e(c/2 + d*x/2, 2)/(a**2*d) - (5*A - 2*B)*elliptic_f(c/2 + d*x/2, 2)/(3*a**2*d) - (5*A - 2*B)*sin(c + d*x)/(3*a**2*d*(cos(c + d*x) + 1)*sqrt(cos(c + d*x))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**2*cos(c + d*x)**(sympy.S(5)/2)),
        variable=x,
        num_steps=7,
        integral=-(A - B)*sin(c + d*x)/(3*d*(a*cos(c + d*x) + a)**2*cos(c + d*x)**(sympy.S(3)/2)) - (7*A - 4*B)*sin(c + d*x)/(a**2*d*sqrt(cos(c + d*x))) + (7*A - 4*B)*elliptic_e(c/2 + d*x/2, 2)/(a**2*d) - (7*A - 4*B)*sin(c + d*x)/(3*a**2*d*(cos(c + d*x) + 1)*cos(c + d*x)**(sympy.S(3)/2)) + (10*A - 5*B)*sin(c + d*x)/(3*a**2*d*cos(c + d*x)**(sympy.S(3)/2)) + (10*A - 5*B)*elliptic_f(c/2 + d*x/2, 2)/(3*a**2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(9)/2)/(a*cos(c + d*x) + a)**3,
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(7)/2)/(a*cos(c + d*x) + a)**3,
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(5)/2)/(a*cos(c + d*x) + a)**3,
        variable=x,
        num_steps=6,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(5)/2)/(5*d*(a*cos(c + d*x) + a)**3) + (3*A - 13*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(6*d*(a**3*cos(c + d*x) + a**3)) + (3*A - 8*B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(15*a*d*(a*cos(c + d*x) + a)**2) + (3*A - 13*B)*elliptic_f(c/2 + d*x/2, 2)/(6*a**3*d) - (9*A - 49*B)*elliptic_e(c/2 + d*x/2, 2)/(10*a**3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(3)/2)/(a*cos(c + d*x) + a)**3,
        variable=x,
        num_steps=6,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(5*d*(a*cos(c + d*x) + a)**3) + (A + 9*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(10*d*(a**3*cos(c + d*x) + a**3)) + (A - 6*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(15*a*d*(a*cos(c + d*x) + a)**2) + (A + 3*B)*elliptic_f(c/2 + d*x/2, 2)/(6*a**3*d) - (A + 9*B)*elliptic_e(c/2 + d*x/2, 2)/(10*a**3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(cos(c + d*x))/(a*cos(c + d*x) + a)**3,
        variable=x,
        num_steps=6,
        integral=-(A - B)*sin(c + d*x)*sqrt(cos(c + d*x))/(10*d*(a**3*cos(c + d*x) + a**3)) + (A - B)*sin(c + d*x)*sqrt(cos(c + d*x))/(5*d*(a*cos(c + d*x) + a)**3) + (A + 4*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(15*a*d*(a*cos(c + d*x) + a)**2) + (A - B)*elliptic_e(c/2 + d*x/2, 2)/(10*a**3*d) + (A + B)*elliptic_f(c/2 + d*x/2, 2)/(6*a**3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**3*sqrt(cos(c + d*x))),
        variable=x,
        num_steps=6,
        integral=-(A - B)*sin(c + d*x)*sqrt(cos(c + d*x))/(5*d*(a*cos(c + d*x) + a)**3) - (9*A + B)*sin(c + d*x)*sqrt(cos(c + d*x))/(10*d*(a**3*cos(c + d*x) + a**3)) - (6*A - B)*sin(c + d*x)*sqrt(cos(c + d*x))/(15*a*d*(a*cos(c + d*x) + a)**2) + (3*A + B)*elliptic_f(c/2 + d*x/2, 2)/(6*a**3*d) + (9*A + B)*elliptic_e(c/2 + d*x/2, 2)/(10*a**3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**3*cos(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=7,
        integral=-(A - B)*sin(c + d*x)/(5*d*(a*cos(c + d*x) + a)**3*sqrt(cos(c + d*x))) - (13*A - 3*B)*sin(c + d*x)/(6*d*(a**3*cos(c + d*x) + a**3)*sqrt(cos(c + d*x))) - (8*A - 3*B)*sin(c + d*x)/(15*a*d*(a*cos(c + d*x) + a)**2*sqrt(cos(c + d*x))) - (13*A - 3*B)*elliptic_f(c/2 + d*x/2, 2)/(6*a**3*d) + (49*A - 9*B)*sin(c + d*x)/(10*a**3*d*sqrt(cos(c + d*x))) - (49*A - 9*B)*elliptic_e(c/2 + d*x/2, 2)/(10*a**3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**3*cos(c + d*x)**(sympy.S(5)/2)),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=6,
        integral=B*a*sin(c + d*x)*cos(c + d*x)**(sympy.S(7)/2)/(4*d*sqrt(a*cos(c + d*x) + a)) + 5*sqrt(a)*(8*A + 7*B)*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(64*d) + a*(8*A + 7*B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(5)/2)/(24*d*sqrt(a*cos(c + d*x) + a)) + 5*a*(8*A + 7*B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(96*d*sqrt(a*cos(c + d*x) + a)) + 5*a*(8*A + 7*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(64*d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=5,
        integral=B*a*sin(c + d*x)*cos(c + d*x)**(sympy.S(5)/2)/(3*d*sqrt(a*cos(c + d*x) + a)) + sqrt(a)*(6*A + 5*B)*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(8*d) + a*(6*A + 5*B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(12*d*sqrt(a*cos(c + d*x) + a)) + a*(6*A + 5*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(8*d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x)),
        variable=x,
        num_steps=4,
        integral=B*a*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(2*d*sqrt(a*cos(c + d*x) + a)) + sqrt(a)*(4*A + 3*B)*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(4*d) + a*(4*A + 3*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(4*d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)/sqrt(cos(c + d*x)),
        variable=x,
        num_steps=3,
        integral=B*a*sin(c + d*x)*sqrt(cos(c + d*x))/(d*sqrt(a*cos(c + d*x) + a)) + sqrt(a)*(2*A + B)*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)/cos(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=3,
        integral=2*A*a*sin(c + d*x)/(d*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))) + 2*B*sqrt(a)*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)/cos(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=2,
        integral=2*A*a*sin(c + d*x)/(3*d*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(3)/2)) + 2*a*(2*A + 3*B)*sin(c + d*x)/(3*d*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)/cos(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=3,
        integral=2*A*a*sin(c + d*x)/(5*d*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(5)/2)) + 4*a*(4*A + 5*B)*sin(c + d*x)/(15*d*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))) + 2*a*(4*A + 5*B)*sin(c + d*x)/(15*d*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(3)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)/cos(c + d*x)**(sympy.S(9)/2),
        variable=x,
        num_steps=4,
        integral=2*A*a*sin(c + d*x)/(7*d*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(7)/2)) + 16*a*(6*A + 7*B)*sin(c + d*x)/(105*d*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))) + 8*a*(6*A + 7*B)*sin(c + d*x)/(105*d*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(3)/2)) + 2*a*(6*A + 7*B)*sin(c + d*x)/(35*d*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(5)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*cos(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=6,
        integral=B*a*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)*cos(c + d*x)**(sympy.S(5)/2)/(4*d) + a**(sympy.S(3)/2)*(88*A + 75*B)*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(64*d) + a**2*(8*A + 9*B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(5)/2)/(24*d*sqrt(a*cos(c + d*x) + a)) + a**2*(88*A + 75*B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(96*d*sqrt(a*cos(c + d*x) + a)) + a**2*(88*A + 75*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(64*d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sqrt(cos(c + d*x)),
        variable=x,
        num_steps=5,
        integral=B*a*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(3*d) + a**(sympy.S(3)/2)*(14*A + 11*B)*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(8*d) + a**2*(6*A + 7*B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(12*d*sqrt(a*cos(c + d*x) + a)) + a**2*(14*A + 11*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(8*d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)/sqrt(cos(c + d*x)),
        variable=x,
        num_steps=4,
        integral=B*a*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)*sqrt(cos(c + d*x))/(2*d) + a**(sympy.S(3)/2)*(12*A + 7*B)*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(4*d) + a**2*(4*A + 5*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(4*d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)/cos(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=4,
        integral=2*A*a*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(d*sqrt(cos(c + d*x))) + a**(sympy.S(3)/2)*(2*A + 3*B)*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/d - a**2*(2*A - B)*sin(c + d*x)*sqrt(cos(c + d*x))/(d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)/cos(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=4,
        integral=2*A*a*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(3*d*cos(c + d*x)**(sympy.S(3)/2)) + 2*B*a**(sympy.S(3)/2)*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/d + 2*a**2*(4*A + 3*B)*sin(c + d*x)/(3*d*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)/cos(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=3,
        integral=2*A*a*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(5*d*cos(c + d*x)**(sympy.S(5)/2)) + 2*a**2*(6*A + 5*B)*sin(c + d*x)/(15*d*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(3)/2)) + 2*a**2*(18*A + 25*B)*sin(c + d*x)/(15*d*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)/cos(c + d*x)**(sympy.S(9)/2),
        variable=x,
        num_steps=4,
        integral=2*A*a*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(7*d*cos(c + d*x)**(sympy.S(7)/2)) + 2*a**2*(8*A + 7*B)*sin(c + d*x)/(35*d*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(5)/2)) + 4*a**2*(52*A + 63*B)*sin(c + d*x)/(105*d*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))) + 2*a**2*(52*A + 63*B)*sin(c + d*x)/(105*d*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(3)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)/cos(c + d*x)**(sympy.S(11)/2),
        variable=x,
        num_steps=5,
        integral=2*A*a*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(9*d*cos(c + d*x)**(sympy.S(9)/2)) + 2*a**2*(10*A + 9*B)*sin(c + d*x)/(63*d*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(7)/2)) + 16*a**2*(34*A + 39*B)*sin(c + d*x)/(315*d*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))) + 8*a**2*(34*A + 39*B)*sin(c + d*x)/(315*d*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(3)/2)) + 2*a**2*(34*A + 39*B)*sin(c + d*x)/(105*d*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(5)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*cos(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sqrt(cos(c + d*x)),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=5,
        integral=B*a*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)*sqrt(cos(c + d*x))/(3*d) + a**(sympy.S(5)/2)*(38*A + 25*B)*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(8*d) + a**3*(54*A + 49*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(24*d*sqrt(a*cos(c + d*x) + a)) + a**2*(2*A + 3*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)*sqrt(cos(c + d*x))/(4*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)/cos(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=5,
        integral=2*A*a*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)/(d*sqrt(cos(c + d*x))) + a**(sympy.S(5)/2)*(20*A + 19*B)*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(4*d) - a**3*(4*A - 9*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(4*d*sqrt(a*cos(c + d*x) + a)) - a**2*(4*A - B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)*sqrt(cos(c + d*x))/(2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)/cos(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=5,
        integral=2*A*a*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)/(3*d*cos(c + d*x)**(sympy.S(3)/2)) + a**(sympy.S(5)/2)*(2*A + 5*B)*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/d - a**3*(14*A + 3*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(3*d*sqrt(a*cos(c + d*x) + a)) + 2*a**2*(2*A + B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(d*sqrt(cos(c + d*x))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)/cos(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=5,
        integral=2*A*a*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)/(5*d*cos(c + d*x)**(sympy.S(5)/2)) + 2*B*a**(sympy.S(5)/2)*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/d + 2*a**3*(32*A + 35*B)*sin(c + d*x)/(15*d*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))) + 2*a**2*(8*A + 5*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(15*d*cos(c + d*x)**(sympy.S(3)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)/cos(c + d*x)**(sympy.S(9)/2),
        variable=x,
        num_steps=4,
        integral=2*A*a*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)/(7*d*cos(c + d*x)**(sympy.S(7)/2)) + 2*a**3*(10*A + 11*B)*sin(c + d*x)/(15*d*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(3)/2)) + 2*a**3*(230*A + 301*B)*sin(c + d*x)/(105*d*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))) + 2*a**2*(10*A + 7*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(35*d*cos(c + d*x)**(sympy.S(5)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)/cos(c + d*x)**(sympy.S(11)/2),
        variable=x,
        num_steps=5,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)/cos(c + d*x)**(sympy.S(13)/2),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(3)/2)/sqrt(a*cos(c + d*x) + a),
        variable=x,
        num_steps=7,
        integral=B*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(2*d*sqrt(a*cos(c + d*x) + a)) + (4*A - B)*sin(c + d*x)*sqrt(cos(c + d*x))/(4*d*sqrt(a*cos(c + d*x) + a)) + sqrt(2)*(A - B)*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))/(sqrt(a)*d) - (4*A - 7*B)*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(4*sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(cos(c + d*x))/sqrt(a*cos(c + d*x) + a),
        variable=x,
        num_steps=6,
        integral=B*sin(c + d*x)*sqrt(cos(c + d*x))/(d*sqrt(a*cos(c + d*x) + a)) - sqrt(2)*(A - B)*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))/(sqrt(a)*d) + (2*A - B)*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/(sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))),
        variable=x,
        num_steps=5,
        integral=2*B*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(sqrt(a)*d) + sqrt(2)*(A - B)*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))/(sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/(sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=4,
        integral=2*A*sin(c + d*x)/(d*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))) - sqrt(2)*(A - B)*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))/(sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/(sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(5)/2)),
        variable=x,
        num_steps=5,
        integral=2*A*sin(c + d*x)/(3*d*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(3)/2)) - (2*A - 6*B)*sin(c + d*x)/(3*d*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))) + sqrt(2)*(A - B)*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))/(sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/(sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(7)/2)),
        variable=x,
        num_steps=6,
        integral=2*A*sin(c + d*x)/(5*d*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(5)/2)) - (2*A - 10*B)*sin(c + d*x)/(15*d*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(3)/2)) + (26*A - 10*B)*sin(c + d*x)/(15*d*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))) - sqrt(2)*(A - B)*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))/(sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(3)/2)/(a*cos(c + d*x) + a)**(sympy.S(3)/2),
        variable=x,
        num_steps=7,
        integral=(A - B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) - (A - 3*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(2*a*d*sqrt(a*cos(c + d*x) + a)) + (2*A - 3*B)*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(a**(sympy.S(3)/2)*d) - sqrt(2)*(5*A - 9*B)*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))/(4*a**(sympy.S(3)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(cos(c + d*x))/(a*cos(c + d*x) + a)**(sympy.S(3)/2),
        variable=x,
        num_steps=6,
        integral=2*B*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(a**(sympy.S(3)/2)*d) + (A - B)*sin(c + d*x)*sqrt(cos(c + d*x))/(2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) + sqrt(2)*(A - 5*B)*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))/(4*a**(sympy.S(3)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**(sympy.S(3)/2)*sqrt(cos(c + d*x))),
        variable=x,
        num_steps=4,
        integral=-(A - B)*sin(c + d*x)*sqrt(cos(c + d*x))/(2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) + sqrt(2)*(3*A + B)*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))/(4*a**(sympy.S(3)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**(sympy.S(3)/2)*cos(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=5,
        integral=-(A - B)*sin(c + d*x)/(2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sqrt(cos(c + d*x))) + (5*A - B)*sin(c + d*x)/(2*a*d*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))) - sqrt(2)*(7*A - 3*B)*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))/(4*a**(sympy.S(3)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**(sympy.S(3)/2)*cos(c + d*x)**(sympy.S(5)/2)),
        variable=x,
        num_steps=6,
        integral=-(A - B)*sin(c + d*x)/(2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*cos(c + d*x)**(sympy.S(3)/2)) + (7*A - 3*B)*sin(c + d*x)/(6*a*d*sqrt(a*cos(c + d*x) + a)*cos(c + d*x)**(sympy.S(3)/2)) - (19*A - 15*B)*sin(c + d*x)/(6*a*d*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))) + sqrt(2)*(11*A - 7*B)*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))/(4*a**(sympy.S(3)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(5)/2)/(a*cos(c + d*x) + a)**(sympy.S(5)/2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(3)/2)/(a*cos(c + d*x) + a)**(sympy.S(5)/2),
        variable=x,
        num_steps=7,
        integral=2*B*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))/(a**(sympy.S(5)/2)*d) + (A - B)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(4*d*(a*cos(c + d*x) + a)**(sympy.S(5)/2)) + (3*A - 11*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(16*a*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) + sqrt(2)*(3*A - 43*B)*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))/(32*a**(sympy.S(5)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(cos(c + d*x))/(a*cos(c + d*x) + a)**(sympy.S(5)/2),
        variable=x,
        num_steps=5,
        integral=(A - B)*sin(c + d*x)*sqrt(cos(c + d*x))/(4*d*(a*cos(c + d*x) + a)**(sympy.S(5)/2)) + (A + 7*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(16*a*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) + sqrt(2)*(5*A + 3*B)*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))/(32*a**(sympy.S(5)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**(sympy.S(5)/2)*sqrt(cos(c + d*x))),
        variable=x,
        num_steps=5,
        integral=-(A - B)*sin(c + d*x)*sqrt(cos(c + d*x))/(4*d*(a*cos(c + d*x) + a)**(sympy.S(5)/2)) - (9*A - B)*sin(c + d*x)*sqrt(cos(c + d*x))/(16*a*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) + sqrt(2)*(19*A + 5*B)*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))/(32*a**(sympy.S(5)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**(sympy.S(5)/2)*cos(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=6,
        integral=-(A - B)*sin(c + d*x)/(4*d*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sqrt(cos(c + d*x))) - (13*A - 5*B)*sin(c + d*x)/(16*a*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sqrt(cos(c + d*x))) + (49*A - 9*B)*sin(c + d*x)/(16*a**2*d*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))) - sqrt(2)*(75*A - 19*B)*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))/(32*a**(sympy.S(5)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**(sympy.S(5)/2)*cos(c + d*x)**(sympy.S(5)/2)),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(7)/2)/(a*cos(c + d*x) + a)**(sympy.S(7)/2),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(5)/2)/(a*cos(c + d*x) + a)**(sympy.S(7)/2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(3)/2)/(a*cos(c + d*x) + a)**(sympy.S(7)/2),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(cos(c + d*x))/(a*cos(c + d*x) + a)**(sympy.S(7)/2),
        variable=x,
        num_steps=6,
        integral=(A - B)*sin(c + d*x)*sqrt(cos(c + d*x))/(6*d*(a*cos(c + d*x) + a)**(sympy.S(7)/2)) + (A + 3*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(16*a*d*(a*cos(c + d*x) + a)**(sympy.S(5)/2)) - (5*A - 17*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(192*a**2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) + sqrt(2)*(13*A + 7*B)*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))/(128*a**(sympy.S(7)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**(sympy.S(7)/2)*sqrt(cos(c + d*x))),
        variable=x,
        num_steps=6,
        integral=-(A - B)*sin(c + d*x)*sqrt(cos(c + d*x))/(6*d*(a*cos(c + d*x) + a)**(sympy.S(7)/2)) - (5*A - B)*sin(c + d*x)*sqrt(cos(c + d*x))/(16*a*d*(a*cos(c + d*x) + a)**(sympy.S(5)/2)) - (103*A + 5*B)*sin(c + d*x)*sqrt(cos(c + d*x))/(192*a**2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) + sqrt(2)*(63*A + 13*B)*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))/(128*a**(sympy.S(7)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**(sympy.S(7)/2)*cos(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**(sympy.S(7)/2)*cos(c + d*x)**(sympy.S(5)/2)),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))*cos(c + d*x)**2,
        variable=x,
        num_steps=7,
        integral=B*b*sin(c + d*x)*cos(c + d*x)**3/(4*d) + x*(A*a/2 + 3*B*b/8) + (4*A*a + 3*B*b)*sin(c + d*x)*cos(c + d*x)/(8*d) - (A*b + B*a)*sin(c + d*x)**3/(3*d) + (A*b + B*a)*sin(c + d*x)/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))*cos(c + d*x),
        variable=x,
        num_steps=3,
        integral=B*b*sin(c + d*x)*cos(c + d*x)**2/(3*d) + x*(A*b/2 + B*a/2) + (3*A*a + 2*B*b)*sin(c + d*x)/(3*d) + (A*b + B*a)*sin(c + d*x)*cos(c + d*x)/(2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x)),
        variable=x,
        num_steps=1,
        integral=B*b*sin(c + d*x)*cos(c + d*x)/(2*d) + x*(A*a + B*b/2) + (A*b + B*a)*sin(c + d*x)/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))*sec(c + d*x),
        variable=x,
        num_steps=4,
        integral=A*a*atanh(sin(c + d*x))/d + B*b*sin(c + d*x)/d + x*(A*b + B*a),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))*sec(c + d*x)**2,
        variable=x,
        num_steps=4,
        integral=A*a*tan(c + d*x)/d + B*b*x + (A*b + B*a)*atanh(sin(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))*sec(c + d*x)**3,
        variable=x,
        num_steps=6,
        integral=A*a*tan(c + d*x)*sec(c + d*x)/(2*d) + (A*a + 2*B*b)*atanh(sin(c + d*x))/(2*d) + (A*b + B*a)*tan(c + d*x)/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))*sec(c + d*x)**4,
        variable=x,
        num_steps=7,
        integral=A*a*tan(c + d*x)*sec(c + d*x)**2/(3*d) + (2*A*a + 3*B*b)*tan(c + d*x)/(3*d) + (A*b + B*a)*tan(c + d*x)*sec(c + d*x)/(2*d) + (A*b + B*a)*atanh(sin(c + d*x))/(2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))*sec(c + d*x)**5,
        variable=x,
        num_steps=7,
        integral=A*a*tan(c + d*x)*sec(c + d*x)**3/(4*d) + (3*A*a + 4*B*b)*tan(c + d*x)*sec(c + d*x)/(8*d) + (3*A*a + 4*B*b)*atanh(sin(c + d*x))/(8*d) + (A*b + B*a)*tan(c + d*x)**3/(3*d) + (A*b + B*a)*tan(c + d*x)/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**2*cos(c + d*x)**2,
        variable=x,
        num_steps=7,
        integral=B*b*(a + b*cos(c + d*x))*sin(c + d*x)*cos(c + d*x)**3/(5*d) + b*(5*A*b + 6*B*a)*sin(c + d*x)*cos(c + d*x)**3/(20*d) + x*(A*a**2/2 + 3*A*b**2/8 + 3*B*a*b/4) - (4*B*b**2 + 5*a*(2*A*b + B*a))*sin(c + d*x)**3/(15*d) + (4*B*b**2 + 5*a*(2*A*b + B*a))*sin(c + d*x)/(5*d) + (4*A*a**2 + 3*A*b**2 + 6*B*a*b)*sin(c + d*x)*cos(c + d*x)/(8*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**2*cos(c + d*x),
        variable=x,
        num_steps=4,
        integral=B*(a + b*cos(c + d*x))**3*sin(c + d*x)/(4*b*d) + x*(A*a*b + B*a**2/2 + 3*B*b**2/8) + (8*A*a*b - 2*B*a**2 + 9*B*b**2)*sin(c + d*x)*cos(c + d*x)/(24*d) + (a + b*cos(c + d*x))**2*(4*A*b - B*a)*sin(c + d*x)/(12*b*d) + (4*A*a**2*b + 4*A*b**3 - B*a**3 + 8*B*a*b**2)*sin(c + d*x)/(6*b*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=2,
        integral=B*(a + b*cos(c + d*x))**2*sin(c + d*x)/(3*d) + b*(3*A*b + 2*B*a)*sin(c + d*x)*cos(c + d*x)/(6*d) + x*(A*a**2 + A*b**2/2 + B*a*b) + (6*A*a*b + 2*B*a**2 + 2*B*b**2)*sin(c + d*x)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**2*sec(c + d*x),
        variable=x,
        num_steps=4,
        integral=A*a**2*atanh(sin(c + d*x))/d + B*b*(a + b*cos(c + d*x))*sin(c + d*x)/(2*d) + b*(2*A*b + 3*B*a)*sin(c + d*x)/(2*d) + x*(4*A*a*b + 2*B*a**2 + B*b**2)/2,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**2*sec(c + d*x)**2,
        variable=x,
        num_steps=4,
        integral=A*a**2*tan(c + d*x)/d + B*b**2*sin(c + d*x)/d + a*(2*A*b + B*a)*atanh(sin(c + d*x))/d + b*x*(A*b + 2*B*a),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**2*sec(c + d*x)**3,
        variable=x,
        num_steps=4,
        integral=A*a**2*tan(c + d*x)*sec(c + d*x)/(2*d) + B*b**2*x + a*(2*A*b + B*a)*tan(c + d*x)/d + (A*a**2 + 2*A*b**2 + 4*B*a*b)*atanh(sin(c + d*x))/(2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**2*sec(c + d*x)**4,
        variable=x,
        num_steps=6,
        integral=A*a**2*tan(c + d*x)*sec(c + d*x)**2/(3*d) + a*(2*A*b + B*a)*tan(c + d*x)*sec(c + d*x)/(2*d) + (2*A*a**2 + 3*A*b**2 + 6*B*a*b)*tan(c + d*x)/(3*d) + (2*A*a*b + B*a**2 + 2*B*b**2)*atanh(sin(c + d*x))/(2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**2*sec(c + d*x)**5,
        variable=x,
        num_steps=7,
        integral=A*a**2*tan(c + d*x)*sec(c + d*x)**3/(4*d) + a*(2*A*b + B*a)*tan(c + d*x)*sec(c + d*x)**2/(3*d) + (3*A*a**2 + 4*A*b**2 + 8*B*a*b)*tan(c + d*x)*sec(c + d*x)/(8*d) + (3*A*a**2 + 4*A*b**2 + 8*B*a*b)*atanh(sin(c + d*x))/(8*d) + (4*A*a*b + 2*B*a**2 + 3*B*b**2)*tan(c + d*x)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**3*cos(c + d*x)**2,
        variable=x,
        num_steps=8,
        integral=B*b*(a + b*cos(c + d*x))**2*sin(c + d*x)*cos(c + d*x)**3/(6*d) + b**2*(3*A*b + 4*B*a)*sin(c + d*x)*cos(c + d*x)**4/(15*d) + b*(18*A*a*b + 14*B*a**2 + 5*B*b**2)*sin(c + d*x)*cos(c + d*x)**3/(24*d) + x*(A*a**3/2 + 9*A*a*b**2/8 + 9*B*a**2*b/8 + 5*B*b**3/16) + (8*A*a**3 + 18*A*a*b**2 + 18*B*a**2*b + 5*B*b**3)*sin(c + d*x)*cos(c + d*x)/(16*d) - (15*A*a**2*b + 4*A*b**3 + 5*B*a**3 + 12*B*a*b**2)*sin(c + d*x)**3/(15*d) + (15*A*a**2*b + 4*A*b**3 + 5*B*a**3 + 12*B*a*b**2)*sin(c + d*x)/(5*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**3*cos(c + d*x),
        variable=x,
        num_steps=5,
        integral=B*(a + b*cos(c + d*x))**4*sin(c + d*x)/(5*b*d) + x*(3*A*a**2*b/2 + 3*A*b**3/8 + B*a**3/2 + 9*B*a*b**2/8) + (30*A*a**2*b + 45*A*b**3 - 6*B*a**3 + 71*B*a*b**2)*sin(c + d*x)*cos(c + d*x)/(120*d) + (a + b*cos(c + d*x))**3*(5*A*b - B*a)*sin(c + d*x)/(20*b*d) + (a + b*cos(c + d*x))**2*(15*A*a*b - 3*B*a**2 + 16*B*b**2)*sin(c + d*x)/(60*b*d) + (15*A*a**3*b + 60*A*a*b**3 - 3*B*a**4 + 52*B*a**2*b**2 + 16*B*b**4)*sin(c + d*x)/(30*b*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**3,
        variable=x,
        num_steps=3,
        integral=B*(a + b*cos(c + d*x))**3*sin(c + d*x)/(4*d) + b*(20*A*a*b + 6*B*a**2 + 9*B*b**2)*sin(c + d*x)*cos(c + d*x)/(24*d) + x*(A*a**3 + 3*A*a*b**2/2 + 3*B*a**2*b/2 + 3*B*b**3/8) + (a + b*cos(c + d*x))**2*(4*A*b + 3*B*a)*sin(c + d*x)/(12*d) + (16*A*a**2*b + 4*A*b**3 + 3*B*a**3 + 12*B*a*b**2)*sin(c + d*x)/(6*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**3*sec(c + d*x),
        variable=x,
        num_steps=5,
        integral=A*a**3*atanh(sin(c + d*x))/d + B*b*(a + b*cos(c + d*x))**2*sin(c + d*x)/(3*d) + b**2*(3*A*b + 5*B*a)*sin(c + d*x)*cos(c + d*x)/(6*d) + b*(9*A*a*b + 8*B*a**2 + 2*B*b**2)*sin(c + d*x)/(3*d) + x*(3*A*a**2*b + A*b**3/2 + B*a**3 + 3*B*a*b**2/2),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**3*sec(c + d*x)**2,
        variable=x,
        num_steps=5,
        integral=A*a*(a + b*cos(c + d*x))**2*tan(c + d*x)/d + a**2*(3*A*b + B*a)*atanh(sin(c + d*x))/d - b**2*(2*A*a - B*b)*sin(c + d*x)*cos(c + d*x)/(2*d) + b*x*(6*A*a*b + 6*B*a**2 + B*b**2)/2 - b*(2*A*a**2 - A*b**2 - 3*B*a*b)*sin(c + d*x)/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**3*sec(c + d*x)**3,
        variable=x,
        num_steps=5,
        integral=A*a*(a + b*cos(c + d*x))**2*tan(c + d*x)*sec(c + d*x)/(2*d) + a**2*(2*A*b + B*a)*tan(c + d*x)/d + a*(A*a**2 + 6*A*b**2 + 6*B*a*b)*atanh(sin(c + d*x))/(2*d) + b**2*x*(A*b + 3*B*a) - b**2*(A*a - 2*B*b)*sin(c + d*x)/(2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**3*sec(c + d*x)**4,
        variable=x,
        num_steps=5,
        integral=A*a*(a + b*cos(c + d*x))**2*tan(c + d*x)*sec(c + d*x)**2/(3*d) + B*b**3*x + a**2*(5*A*b + 3*B*a)*tan(c + d*x)*sec(c + d*x)/(6*d) + a*(2*A*a**2 + 8*A*b**2 + 9*B*a*b)*tan(c + d*x)/(3*d) + (3*A*a**2*b + 2*A*b**3 + B*a**3 + 6*B*a*b**2)*atanh(sin(c + d*x))/(2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**3*sec(c + d*x)**5,
        variable=x,
        num_steps=7,
        integral=A*a*(a + b*cos(c + d*x))**2*tan(c + d*x)*sec(c + d*x)**3/(4*d) + a**2*(3*A*b + 2*B*a)*tan(c + d*x)*sec(c + d*x)**2/(6*d) + a*(3*A*a**2 + 10*A*b**2 + 12*B*a*b)*tan(c + d*x)*sec(c + d*x)/(8*d) + (3*A*a**3 + 12*A*a*b**2 + 12*B*a**2*b + 8*B*b**3)*atanh(sin(c + d*x))/(8*d) + (6*A*a**2*b + 3*A*b**3 + 2*B*a**3 + 9*B*a*b**2)*tan(c + d*x)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**3*sec(c + d*x)**6,
        variable=x,
        num_steps=8,
        integral=A*a*(a + b*cos(c + d*x))**2*tan(c + d*x)*sec(c + d*x)**4/(5*d) + a**2*(7*A*b + 5*B*a)*tan(c + d*x)*sec(c + d*x)**3/(20*d) + a*(4*A*a**2 + 12*A*b**2 + 15*B*a*b)*tan(c + d*x)*sec(c + d*x)**2/(15*d) + (8*A*a**3 + 30*A*a*b**2 + 30*B*a**2*b + 15*B*b**3)*tan(c + d*x)/(15*d) + (9*A*a**2*b + 4*A*b**3 + 3*B*a**3 + 12*B*a*b**2)*tan(c + d*x)*sec(c + d*x)/(8*d) + (9*A*a**2*b + 4*A*b**3 + 3*B*a**3 + 12*B*a*b**2)*atanh(sin(c + d*x))/(8*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**4*cos(c + d*x)**2,
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**4*cos(c + d*x),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**4,
        variable=x,
        num_steps=4,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**4*sec(c + d*x),
        variable=x,
        num_steps=6,
        integral=A*a**4*atanh(sin(c + d*x))/d + B*b*(a + b*cos(c + d*x))**3*sin(c + d*x)/(4*d) + b**2*(32*A*a*b + 26*B*a**2 + 9*B*b**2)*sin(c + d*x)*cos(c + d*x)/(24*d) + b*(a + b*cos(c + d*x))**2*(4*A*b + 7*B*a)*sin(c + d*x)/(12*d) + b*(34*A*a**2*b + 4*A*b**3 + 19*B*a**3 + 16*B*a*b**2)*sin(c + d*x)/(6*d) + x*(4*A*a**3*b + 2*A*a*b**3 + B*a**4 + 3*B*a**2*b**2 + 3*B*b**4/8),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**4*sec(c + d*x)**2,
        variable=x,
        num_steps=6,
        integral=A*a*(a + b*cos(c + d*x))**3*tan(c + d*x)/d + a**3*(4*A*b + B*a)*atanh(sin(c + d*x))/d - b**2*(6*A*a**2 - 3*A*b**2 - 8*B*a*b)*sin(c + d*x)*cos(c + d*x)/(6*d) + b*x*(12*A*a**2*b + A*b**3 + 8*B*a**3 + 4*B*a*b**2)/2 - b*(a + b*cos(c + d*x))**2*(3*A*a - B*b)*sin(c + d*x)/(3*d) - b*(6*A*a**3 - 12*A*a*b**2 - 17*B*a**2*b - 2*B*b**3)*sin(c + d*x)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**4*sec(c + d*x)**3,
        variable=x,
        num_steps=6,
        integral=A*a*(a + b*cos(c + d*x))**3*tan(c + d*x)*sec(c + d*x)/(2*d) + a**2*(A*a**2 + 12*A*b**2 + 8*B*a*b)*atanh(sin(c + d*x))/(2*d) + a*(a + b*cos(c + d*x))**2*(5*A*b + 2*B*a)*tan(c + d*x)/(2*d) + b**2*x*(8*A*a*b + 12*B*a**2 + B*b**2)/2 - b**2*(6*A*a*b + 2*B*a**2 - B*b**2)*sin(c + d*x)*cos(c + d*x)/(2*d) - b*(13*A*a**2*b - 2*A*b**3 + 4*B*a**3 - 8*B*a*b**2)*sin(c + d*x)/(2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**4*sec(c + d*x)**4,
        variable=x,
        num_steps=6,
        integral=A*a*(a + b*cos(c + d*x))**3*tan(c + d*x)*sec(c + d*x)**2/(3*d) + a**2*(2*A*a**2 + 9*A*b**2 + 9*B*a*b)*tan(c + d*x)/(3*d) + a*(a + b*cos(c + d*x))**2*(2*A*b + B*a)*tan(c + d*x)*sec(c + d*x)/(2*d) + a*(4*A*a**2*b + 8*A*b**3 + B*a**3 + 12*B*a*b**2)*atanh(sin(c + d*x))/(2*d) + b**3*x*(A*b + 4*B*a) - b**2*(8*A*a*b + 3*B*a**2 - 6*B*b**2)*sin(c + d*x)/(6*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**4*sec(c + d*x)**5,
        variable=x,
        num_steps=6,
        integral=A*a*(a + b*cos(c + d*x))**3*tan(c + d*x)*sec(c + d*x)**3/(4*d) + B*b**4*x + a**2*(9*A*a**2 + 26*A*b**2 + 32*B*a*b)*tan(c + d*x)*sec(c + d*x)/(24*d) + a*(a + b*cos(c + d*x))**2*(7*A*b + 4*B*a)*tan(c + d*x)*sec(c + d*x)**2/(12*d) + a*(16*A*a**2*b + 19*A*b**3 + 4*B*a**3 + 34*B*a*b**2)*tan(c + d*x)/(6*d) + (3*A*a**4 + 24*A*a**2*b**2 + 8*A*b**4 + 16*B*a**3*b + 32*B*a*b**3)*atanh(sin(c + d*x))/(8*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**4*sec(c + d*x)**6,
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**4*sec(c + d*x)**7,
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**3/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=6,
        integral=B*sin(c + d*x)*cos(c + d*x)**2/(3*b*d) - 2*a**3*(A*b - B*a)*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(b**4*d*sqrt(a - b)*sqrt(a + b)) + (A*b - B*a)*sin(c + d*x)*cos(c + d*x)/(2*b**2*d) - (3*A*a*b - 3*B*a**2 - 2*B*b**2)*sin(c + d*x)/(3*b**3*d) + x*(2*a**2 + b**2)*(A*b - B*a)/(2*b**4),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**2/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=5,
        integral=B*sin(c + d*x)*cos(c + d*x)/(2*b*d) + 2*a**2*(A*b - B*a)*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(b**3*d*sqrt(a - b)*sqrt(a + b)) + (A*b - B*a)*sin(c + d*x)/(b**2*d) - x*(2*A*a*b - 2*B*a**2 - B*b**2)/(2*b**3),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=6,
        integral=B*sin(c + d*x)/(b*d) - 2*a*(A*b - B*a)*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(b**2*d*sqrt(a - b)*sqrt(a + b)) + x*(A*b - B*a)/b**2,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=3,
        integral=B*x/b + (2*A*b - 2*B*a)*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(b*d*sqrt(a - b)*sqrt(a + b)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=4,
        integral=A*atanh(sin(c + d*x))/(a*d) - (2*A*b - 2*B*a)*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(a*d*sqrt(a - b)*sqrt(a + b)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**2/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=6,
        integral=A*tan(c + d*x)/(a*d) + 2*b*(A*b - B*a)*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(a**2*d*sqrt(a - b)*sqrt(a + b)) - (A*b - B*a)*atanh(sin(c + d*x))/(a**2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**3/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=6,
        integral=A*tan(c + d*x)*sec(c + d*x)/(2*a*d) - (A*b - B*a)*tan(c + d*x)/(a**2*d) - 2*b**2*(A*b - B*a)*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(a**3*d*sqrt(a - b)*sqrt(a + b)) + (A*a**2 + 2*A*b**2 - 2*B*a*b)*atanh(sin(c + d*x))/(2*a**3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**4/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=7,
        integral=A*tan(c + d*x)*sec(c + d*x)**2/(3*a*d) - (A*b - B*a)*tan(c + d*x)*sec(c + d*x)/(2*a**2*d) + (2*A*a**2 + 3*A*b**2 - 3*B*a*b)*tan(c + d*x)/(3*a**3*d) + 2*b**3*(A*b - B*a)*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(a**4*d*sqrt(a - b)*sqrt(a + b)) - (a**2 + 2*b**2)*(A*b - B*a)*atanh(sin(c + d*x))/(2*a**4*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**3/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**2/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=5,
        integral=B*sin(c + d*x)/(b**2*d) - a**2*(A*b - B*a)*sin(c + d*x)/(b**2*d*(a + b*cos(c + d*x))*(a**2 - b**2)) - 2*a*(A*a**2*b - 2*A*b**3 - 2*B*a**3 + 3*B*a*b**2)*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(b**3*d*(a - b)**(sympy.S(3)/2)*(a + b)**(sympy.S(3)/2)) + x*(A*b - 2*B*a)/b**3,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=5,
        integral=B*x/b**2 + a*(A*b - B*a)*sin(c + d*x)/(b*d*(a + b*cos(c + d*x))*(a**2 - b**2)) - (2*A*b**3 + 2*B*a**3 - 4*B*a*b**2)*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(b**2*d*(a - b)**(sympy.S(3)/2)*(a + b)**(sympy.S(3)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=4,
        integral=-(A*b - B*a)*sin(c + d*x)/(d*(a + b*cos(c + d*x))*(a**2 - b**2)) + (2*A*a - 2*B*b)*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(d*(a - b)**(sympy.S(3)/2)*(a + b)**(sympy.S(3)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=5,
        integral=A*atanh(sin(c + d*x))/(a**2*d) + b*(A*b - B*a)*sin(c + d*x)/(a*d*(a + b*cos(c + d*x))*(a**2 - b**2)) - (4*A*a**2*b - 2*A*b**3 - 2*B*a**3)*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(a**2*d*(a - b)**(sympy.S(3)/2)*(a + b)**(sympy.S(3)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**2/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=6,
        integral=b*(A*b - B*a)*tan(c + d*x)/(a*d*(a + b*cos(c + d*x))*(a**2 - b**2)) + (A*a**2 - 2*A*b**2 + B*a*b)*tan(c + d*x)/(a**2*d*(a**2 - b**2)) + 2*b*(3*A*a**2*b - 2*A*b**3 - 2*B*a**3 + B*a*b**2)*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(a**3*d*(a - b)**(sympy.S(3)/2)*(a + b)**(sympy.S(3)/2)) - (2*A*b - B*a)*atanh(sin(c + d*x))/(a**3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**3/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=7,
        integral=b*(A*b - B*a)*tan(c + d*x)*sec(c + d*x)/(a*d*(a + b*cos(c + d*x))*(a**2 - b**2)) + (A*a**2 - 3*A*b**2 + 2*B*a*b)*tan(c + d*x)*sec(c + d*x)/(2*a**2*d*(a**2 - b**2)) - (2*A*a**2*b - 3*A*b**3 - B*a**3 + 2*B*a*b**2)*tan(c + d*x)/(a**3*d*(a**2 - b**2)) - 2*b**2*(4*A*a**2*b - 3*A*b**3 - 3*B*a**3 + 2*B*a*b**2)*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(a**4*d*(a - b)**(sympy.S(3)/2)*(a + b)**(sympy.S(3)/2)) + (A*a**2 + 6*A*b**2 - 4*B*a*b)*atanh(sin(c + d*x))/(2*a**4*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**4/(a + b*cos(c + d*x))**3,
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**3/(a + b*cos(c + d*x))**3,
        variable=x,
        num_steps=6,
        integral=-a**2*(A*a**2*b - 4*A*b**3 - 3*B*a**3 + 6*B*a*b**2)*sin(c + d*x)/(2*b**3*d*(a + b*cos(c + d*x))*(a**2 - b**2)**2) + a*(A*b - B*a)*sin(c + d*x)*cos(c + d*x)**2/(2*b*d*(a + b*cos(c + d*x))**2*(a**2 - b**2)) - a*(2*A*a**4*b - 5*A*a**2*b**3 + 6*A*b**5 - 6*B*a**5 + 15*B*a**3*b**2 - 12*B*a*b**4)*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(b**4*d*(a - b)**(sympy.S(5)/2)*(a + b)**(sympy.S(5)/2)) - (A*a*b - 3*B*a**2 + 2*B*b**2)*sin(c + d*x)/(2*b**3*d*(a**2 - b**2)) + x*(A*b - 3*B*a)/b**4,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**2/(a + b*cos(c + d*x))**3,
        variable=x,
        num_steps=5,
        integral=B*x/b**3 - a**2*(A*b - B*a)*sin(c + d*x)/(2*b**2*d*(a + b*cos(c + d*x))**2*(a**2 - b**2)) + a*(A*a**2*b - 4*A*b**3 - 3*B*a**3 + 6*B*a*b**2)*sin(c + d*x)/(2*b**2*d*(a + b*cos(c + d*x))*(a**2 - b**2)**2) + (A*a**2*b**3 + 2*A*b**5 - 2*B*a**5 + 5*B*a**3*b**2 - 6*B*a*b**4)*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(b**3*d*(a - b)**(sympy.S(5)/2)*(a + b)**(sympy.S(5)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)/(a + b*cos(c + d*x))**3,
        variable=x,
        num_steps=6,
        integral=a*(A*b - B*a)*sin(c + d*x)/(2*b*d*(a + b*cos(c + d*x))**2*(a**2 - b**2)) - (3*A*a*b - B*a**2 - 2*B*b**2)*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(d*(a - b)**(sympy.S(5)/2)*(a + b)**(sympy.S(5)/2)) + (A*a**2*b + 2*A*b**3 + B*a**3 - 4*B*a*b**2)*sin(c + d*x)/(2*b*d*(a + b*cos(c + d*x))*(a**2 - b**2)**2),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/(a + b*cos(c + d*x))**3,
        variable=x,
        num_steps=5,
        integral=-(3*A*a*b - B*a**2 - 2*B*b**2)*sin(c + d*x)/(2*d*(a + b*cos(c + d*x))*(a**2 - b**2)**2) - (A*b - B*a)*sin(c + d*x)/(d*(a + b*cos(c + d*x))**2*(2*a**2 - 2*b**2)) + (2*A*a**2 + A*b**2 - 3*B*a*b)*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(d*(a - b)**(sympy.S(5)/2)*(a + b)**(sympy.S(5)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)/(a + b*cos(c + d*x))**3,
        variable=x,
        num_steps=6,
        integral=A*atanh(sin(c + d*x))/(a**3*d) + b*(A*b - B*a)*sin(c + d*x)/(2*a*d*(a + b*cos(c + d*x))**2*(a**2 - b**2)) + b*(5*A*a**2*b - 2*A*b**3 - 3*B*a**3)*sin(c + d*x)/(2*a**2*d*(a + b*cos(c + d*x))*(a**2 - b**2)**2) - (6*A*a**4*b - 5*A*a**2*b**3 + 2*A*b**5 - 2*B*a**5 - B*a**3*b**2)*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(a**3*d*(a - b)**(sympy.S(5)/2)*(a + b)**(sympy.S(5)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**2/(a + b*cos(c + d*x))**3,
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**3/(a + b*cos(c + d*x))**3,
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**4/(a + b*cos(c + d*x))**4,
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**3/(a + b*cos(c + d*x))**4,
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*cos(c + d*x)**3/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=3,
        integral=-B*sin(c + d*x)**3/(3*d) + B*sin(c + d*x)/d,
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*cos(c + d*x)**2/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=3,
        integral=B*x/2 + B*sin(c + d*x)*cos(c + d*x)/(2*d),
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*cos(c + d*x)/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=2,
        integral=B*sin(c + d*x)/d,
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=2,
        integral=B*x,
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*sec(c + d*x)/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=2,
        integral=B*atanh(sin(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*sec(c + d*x)**2/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=3,
        integral=B*tan(c + d*x)/d,
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*sec(c + d*x)**3/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=3,
        integral=B*tan(c + d*x)*sec(c + d*x)/(2*d) + B*atanh(sin(c + d*x))/(2*d),
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*sec(c + d*x)**4/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=3,
        integral=B*tan(c + d*x)**3/(3*d) + B*tan(c + d*x)/d,
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*cos(c + d*x)**3/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=6,
        integral=-2*B*a**3*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(b**3*d*sqrt(a - b)*sqrt(a + b)) - B*a*sin(c + d*x)/(b**2*d) + B*sin(c + d*x)*cos(c + d*x)/(2*b*d) + B*x*(2*a**2 + b**2)/(2*b**3),
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*cos(c + d*x)**2/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=6,
        integral=2*B*a**2*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(b**2*d*sqrt(a - b)*sqrt(a + b)) - B*a*x/b**2 + B*sin(c + d*x)/(b*d),
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*cos(c + d*x)/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=4,
        integral=-2*B*a*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(b*d*sqrt(a - b)*sqrt(a + b)) + B*x/b,
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=3,
        integral=2*B*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(d*sqrt(a - b)*sqrt(a + b)),
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*sec(c + d*x)/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=5,
        integral=-2*B*b*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(a*d*sqrt(a - b)*sqrt(a + b)) + B*atanh(sin(c + d*x))/(a*d),
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*sec(c + d*x)**2/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=7,
        integral=B*tan(c + d*x)/(a*d) + 2*B*b**2*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(a**2*d*sqrt(a - b)*sqrt(a + b)) - B*b*atanh(sin(c + d*x))/(a**2*d),
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*sec(c + d*x)**3/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=7,
        integral=B*tan(c + d*x)*sec(c + d*x)/(2*a*d) - B*b*tan(c + d*x)/(a**2*d) - 2*B*b**3*atan(sqrt(a - b)*tan(c/2 + d*x/2)/sqrt(a + b))/(a**3*d*sqrt(a - b)*sqrt(a + b)) + B*(a**2 + 2*b**2)*atanh(sin(c + d*x))/(2*a**3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a + b*cos(c + d*x))*cos(c + d*x)**3,
        variable=x,
        num_steps=9,
        integral=2*B*(a + b*cos(c + d*x))**(sympy.S(3)/2)*sin(c + d*x)*cos(c + d*x)**2/(9*b*d) + (a + b*cos(c + d*x))**(sympy.S(3)/2)*(6*A*b - 4*B*a)*sin(c + d*x)*cos(c + d*x)/(21*b**2*d) - (a + b*cos(c + d*x))**(sympy.S(3)/2)*(72*A*a*b - 48*B*a**2 - 98*B*b**2)*sin(c + d*x)/(315*b**3*d) + sqrt(a + b*cos(c + d*x))*(48*A*a**2*b + 150*A*b**3 - 32*B*a**3 - 72*B*a*b**2)*sin(c + d*x)/(315*b**3*d) - sqrt((a + b*cos(c + d*x))/(a + b))*(2*a**2 - 2*b**2)*(24*A*a**2*b + 75*A*b**3 - 16*B*a**3 - 36*B*a*b**2)*elliptic_f(c/2 + d*x/2, 2*b/(a + b))/(315*b**4*d*sqrt(a + b*cos(c + d*x))) + sqrt(a + b*cos(c + d*x))*(48*A*a**3*b + 114*A*a*b**3 - 32*B*a**4 - 48*B*a**2*b**2 + 294*B*b**4)*elliptic_e(c/2 + d*x/2, 2*b/(a + b))/(315*b**4*d*sqrt((a + b*cos(c + d*x))/(a + b))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a + b*cos(c + d*x))*cos(c + d*x)**2,
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a + b*cos(c + d*x))*cos(c + d*x),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a + b*cos(c + d*x)),
        variable=x,
        num_steps=6,
        integral=2*B*sqrt(a + b*cos(c + d*x))*sin(c + d*x)/(3*d) - B*sqrt((a + b*cos(c + d*x))/(a + b))*(2*a**2 - 2*b**2)*elliptic_f(c/2 + d*x/2, 2*b/(a + b))/(3*b*d*sqrt(a + b*cos(c + d*x))) + sqrt(a + b*cos(c + d*x))*(6*A*b + 2*B*a)*elliptic_e(c/2 + d*x/2, 2*b/(a + b))/(3*b*d*sqrt((a + b*cos(c + d*x))/(a + b))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a + b*cos(c + d*x))*sec(c + d*x),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a + b*cos(c + d*x))*sec(c + d*x)**2,
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(3)/2)*cos(c + d*x),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(5)/2)*cos(c + d*x),
        variable=x,
        num_steps=10,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(5)/2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)/sqrt(a + b*cos(c + d*x)),
        variable=x,
        num_steps=7,
        integral=2*B*sqrt(a + b*cos(c + d*x))*sin(c + d*x)/(3*b*d) - sqrt((a + b*cos(c + d*x))/(a + b))*(6*A*a*b - 4*B*a**2 - 2*B*b**2)*elliptic_f(c/2 + d*x/2, 2*b/(a + b))/(3*b**2*d*sqrt(a + b*cos(c + d*x))) + sqrt(a + b*cos(c + d*x))*(6*A*b - 4*B*a)*elliptic_e(c/2 + d*x/2, 2*b/(a + b))/(3*b**2*d*sqrt((a + b*cos(c + d*x))/(a + b))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/sqrt(a + b*cos(c + d*x)),
        variable=x,
        num_steps=5,
        integral=2*B*sqrt(a + b*cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2*b/(a + b))/(b*d*sqrt((a + b*cos(c + d*x))/(a + b))) + sqrt((a + b*cos(c + d*x))/(a + b))*(2*A*b - 2*B*a)*elliptic_f(c/2 + d*x/2, 2*b/(a + b))/(b*d*sqrt(a + b*cos(c + d*x))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)/sqrt(a + b*cos(c + d*x)),
        variable=x,
        num_steps=5,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**2/sqrt(a + b*cos(c + d*x)),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**2/(a + b*cos(c + d*x))**(sympy.S(3)/2),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**3/(a + b*cos(c + d*x))**(sympy.S(5)/2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**2*sqrt(cos(c + d*x)),
        variable=x,
        num_steps=6,
        integral=2*B*b*(a + b*cos(c + d*x))*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(7*d) + 2*b*(7*A*b + 9*B*a)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(35*d) + (10*B*b**2 + 14*a*(2*A*b + B*a))*sin(c + d*x)*sqrt(cos(c + d*x))/(21*d) + (10*B*b**2 + 14*a*(2*A*b + B*a))*elliptic_f(c/2 + d*x/2, 2)/(21*d) + (10*A*a**2 + 6*A*b**2 + 12*B*a*b)*elliptic_e(c/2 + d*x/2, 2)/(5*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**2/sqrt(cos(c + d*x)),
        variable=x,
        num_steps=5,
        integral=2*B*b*(a + b*cos(c + d*x))*sin(c + d*x)*sqrt(cos(c + d*x))/(5*d) + 2*b*(5*A*b + 7*B*a)*sin(c + d*x)*sqrt(cos(c + d*x))/(15*d) + (6*B*b**2 + 10*a*(2*A*b + B*a))*elliptic_e(c/2 + d*x/2, 2)/(5*d) + (6*A*a**2 + 2*A*b**2 + 4*B*a*b)*elliptic_f(c/2 + d*x/2, 2)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**2/cos(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=5,
        integral=2*A*a**2*sin(c + d*x)/(d*sqrt(cos(c + d*x))) + 2*B*b**2*sin(c + d*x)*sqrt(cos(c + d*x))/(3*d) - (2*A*a**2 - 2*A*b**2 - 4*B*a*b)*elliptic_e(c/2 + d*x/2, 2)/d + (12*A*a*b + 6*B*a**2 + 2*B*b**2)*elliptic_f(c/2 + d*x/2, 2)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**2/cos(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=5,
        integral=2*A*a**2*sin(c + d*x)/(3*d*cos(c + d*x)**(sympy.S(3)/2)) + 2*a*(2*A*b + B*a)*sin(c + d*x)/(d*sqrt(cos(c + d*x))) + (2*A*a**2 + 6*A*b**2 + 12*B*a*b)*elliptic_f(c/2 + d*x/2, 2)/(3*d) - (4*A*a*b + 2*B*a**2 - 2*B*b**2)*elliptic_e(c/2 + d*x/2, 2)/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**2/cos(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=6,
        integral=2*A*a**2*sin(c + d*x)/(5*d*cos(c + d*x)**(sympy.S(5)/2)) + 2*a*(2*A*b + B*a)*sin(c + d*x)/(3*d*cos(c + d*x)**(sympy.S(3)/2)) + (6*A*a**2 + 10*A*b**2 + 20*B*a*b)*sin(c + d*x)/(5*d*sqrt(cos(c + d*x))) - (6*A*a**2 + 10*A*b**2 + 20*B*a*b)*elliptic_e(c/2 + d*x/2, 2)/(5*d) + (4*A*a*b + 2*B*a**2 + 6*B*b**2)*elliptic_f(c/2 + d*x/2, 2)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**3*cos(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**3*sqrt(cos(c + d*x)),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=6,
        integral=2*A*a*(a + b*cos(c + d*x))**2*sin(c + d*x)/(d*sqrt(cos(c + d*x))) - 2*b**2*(5*A*a - B*b)*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(5*d) - 2*b*(6*A*a**2 - A*b**2 - 3*B*a*b)*sin(c + d*x)*sqrt(cos(c + d*x))/(3*d) - (10*A*a**3 - 30*A*a*b**2 - 30*B*a**2*b - 6*B*b**3)*elliptic_e(c/2 + d*x/2, 2)/(5*d) + (18*A*a**2*b + 2*A*b**3 + 6*B*a**3 + 6*B*a*b**2)*elliptic_f(c/2 + d*x/2, 2)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**3/cos(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=6,
        integral=2*A*a*(a + b*cos(c + d*x))**2*sin(c + d*x)/(3*d*cos(c + d*x)**(sympy.S(3)/2)) + 2*a**2*(7*A*b + 3*B*a)*sin(c + d*x)/(3*d*sqrt(cos(c + d*x))) - 2*b**2*(A*a - B*b)*sin(c + d*x)*sqrt(cos(c + d*x))/(3*d) + (2*A*a**3 + 18*A*a*b**2 + 18*B*a**2*b + 2*B*b**3)*elliptic_f(c/2 + d*x/2, 2)/(3*d) - (6*A*a**2*b - 2*A*b**3 + 2*B*a**3 - 6*B*a*b**2)*elliptic_e(c/2 + d*x/2, 2)/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**3/cos(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=6,
        integral=2*A*a*(a + b*cos(c + d*x))**2*sin(c + d*x)/(5*d*cos(c + d*x)**(sympy.S(5)/2)) + 2*a**2*(9*A*b + 5*B*a)*sin(c + d*x)/(15*d*cos(c + d*x)**(sympy.S(3)/2)) + 2*a*(3*A*a**2 + 14*A*b**2 + 15*B*a*b)*sin(c + d*x)/(5*d*sqrt(cos(c + d*x))) - (6*A*a**3 + 30*A*a*b**2 + 30*B*a**2*b - 10*B*b**3)*elliptic_e(c/2 + d*x/2, 2)/(5*d) + (6*A*a**2*b + 6*A*b**3 + 2*B*a**3 + 18*B*a*b**2)*elliptic_f(c/2 + d*x/2, 2)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(5)/2)/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=7,
        integral=((Integer(-1) * ((Integer(2) * ((Integer(5) * Symbol('a') * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(5) * (Symbol('a'))**(Integer(2)) * Symbol('B'))) + (Integer(-1) * (Integer(3) * (Symbol('b'))**(Integer(2)) * Symbol('B')))) * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(5) * (Symbol('b'))**(Integer(3)) * Symbol('d')))**(Integer(-1)))) + ((Integer(2) * ((Integer(3) * (Symbol('a'))**(Integer(2))) + (Symbol('b'))**(Integer(2))) * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(3) * (Symbol('b'))**(Integer(4)) * Symbol('d')))**(Integer(-1))) + (Integer(-1) * ((Integer(2) * (Symbol('a'))**(Integer(3)) * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('b'))**(Integer(4)) * (Symbol('a') + Symbol('b')) * Symbol('d')))**(Integer(-1)))) + ((Integer(2) * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x)))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(3) * (Symbol('b'))**(Integer(2)) * Symbol('d')))**(Integer(-1))) + ((Integer(2) * Symbol('B') * (sympy.cos((Symbol('c') + (Symbol('d') * x))))**((Integer(3) * (Integer(2))**(Integer(-1)))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(5) * Symbol('b') * Symbol('d')))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(3)/2)/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=6,
        integral=(((Integer(2) * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('b'))**(Integer(2)) * Symbol('d')))**(Integer(-1))) + (Integer(-1) * ((Integer(2) * ((Integer(3) * Symbol('a') * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(3) * (Symbol('a'))**(Integer(2)) * Symbol('B'))) + (Integer(-1) * ((Symbol('b'))**(Integer(2)) * Symbol('B')))) * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(3) * (Symbol('b'))**(Integer(3)) * Symbol('d')))**(Integer(-1)))) + ((Integer(2) * (Symbol('a'))**(Integer(2)) * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('b'))**(Integer(3)) * (Symbol('a') + Symbol('b')) * Symbol('d')))**(Integer(-1))) + ((Integer(2) * Symbol('B') * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x)))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(3) * Symbol('b') * Symbol('d')))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(cos(c + d*x))/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=5,
        integral=(((Integer(2) * Symbol('B') * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Symbol('b') * Symbol('d')))**(Integer(-1))) + ((Integer(2) * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('b'))**(Integer(2)) * Symbol('d')))**(Integer(-1))) + (Integer(-1) * ((Integer(2) * Symbol('a') * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('b'))**(Integer(2)) * (Symbol('a') + Symbol('b')) * Symbol('d')))**(Integer(-1))))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a + b*cos(c + d*x))*sqrt(cos(c + d*x))),
        variable=x,
        num_steps=3,
        integral=(((Integer(2) * Symbol('B') * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Symbol('b') * Symbol('d')))**(Integer(-1))) + ((Integer(2) * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Symbol('b') * (Symbol('a') + Symbol('b')) * Symbol('d')))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a + b*cos(c + d*x))*cos(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=5,
        integral=((Integer(-1) * ((Integer(2) * Symbol('A') * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Symbol('a') * Symbol('d')))**(Integer(-1)))) + (Integer(-1) * ((Integer(2) * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Symbol('a') * (Symbol('a') + Symbol('b')) * Symbol('d')))**(Integer(-1)))) + ((Integer(2) * Symbol('A') * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Symbol('a') * Symbol('d') * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x))))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a + b*cos(c + d*x))*cos(c + d*x)**(sympy.S(5)/2)),
        variable=x,
        num_steps=7,
        integral=(((Integer(2) * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('a'))**(Integer(2)) * Symbol('d')))**(Integer(-1))) + ((Integer(2) * Symbol('A') * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(3) * Symbol('a') * Symbol('d')))**(Integer(-1))) + ((Integer(2) * Symbol('b') * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('a'))**(Integer(2)) * (Symbol('a') + Symbol('b')) * Symbol('d')))**(Integer(-1))) + ((Integer(2) * Symbol('A') * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(3) * Symbol('a') * Symbol('d') * (sympy.cos((Symbol('c') + (Symbol('d') * x))))**((Integer(3) * (Integer(2))**(Integer(-1))))))**(Integer(-1))) + (Integer(-1) * ((Integer(2) * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * (((Symbol('a'))**(Integer(2)) * Symbol('d') * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x))))))**(Integer(-1))))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(5)/2)/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=7,
        integral=(((((Integer(3) * (Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(2) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(-1) * (Integer(5) * (Symbol('a'))**(Integer(3)) * Symbol('B'))) + (Integer(4) * Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B'))) * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('b'))**(Integer(3)) * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d')))**(Integer(-1))) + (Integer(-1) * ((((Integer(9) * (Symbol('a'))**(Integer(3)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(12) * Symbol('a') * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(-1) * (Integer(15) * (Symbol('a'))**(Integer(4)) * Symbol('B'))) + (Integer(16) * (Symbol('a'))**(Integer(2)) * (Symbol('b'))**(Integer(2)) * Symbol('B')) + (Integer(2) * (Symbol('b'))**(Integer(4)) * Symbol('B'))) * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(3) * (Symbol('b'))**(Integer(4)) * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d')))**(Integer(-1)))) + (((Symbol('a'))**(Integer(2)) * ((Integer(3) * (Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(5) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(-1) * (Integer(5) * (Symbol('a'))**(Integer(3)) * Symbol('B'))) + (Integer(7) * Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B'))) * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('a') + (Integer(-1) * Symbol('b'))) * (Symbol('b'))**(Integer(4)) * ((Symbol('a') + Symbol('b')))**(Integer(2)) * Symbol('d')))**(Integer(-1))) + (Integer(-1) * ((((Integer(3) * Symbol('a') * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(5) * (Symbol('a'))**(Integer(2)) * Symbol('B'))) + (Integer(2) * (Symbol('b'))**(Integer(2)) * Symbol('B'))) * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x)))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(3) * (Symbol('b'))**(Integer(2)) * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d')))**(Integer(-1)))) + ((Symbol('a') * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * (sympy.cos((Symbol('c') + (Symbol('d') * x))))**((Integer(3) * (Integer(2))**(Integer(-1)))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Symbol('b') * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d') * (Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x)))))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(3)/2)/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=6,
        integral=((Integer(-1) * ((((Symbol('a') * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(3) * (Symbol('a'))**(Integer(2)) * Symbol('B'))) + (Integer(2) * (Symbol('b'))**(Integer(2)) * Symbol('B'))) * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('b'))**(Integer(2)) * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d')))**(Integer(-1)))) + (((((Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(2) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(-1) * (Integer(3) * (Symbol('a'))**(Integer(3)) * Symbol('B'))) + (Integer(4) * Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B'))) * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('b'))**(Integer(3)) * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d')))**(Integer(-1))) + (Integer(-1) * ((Symbol('a') * (((Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(3) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(-1) * (Integer(3) * (Symbol('a'))**(Integer(3)) * Symbol('B'))) + (Integer(5) * Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B'))) * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('a') + (Integer(-1) * Symbol('b'))) * (Symbol('b'))**(Integer(3)) * ((Symbol('a') + Symbol('b')))**(Integer(2)) * Symbol('d')))**(Integer(-1)))) + ((Symbol('a') * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x)))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Symbol('b') * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d') * (Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x)))))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(cos(c + d*x))/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=6,
        integral=(((((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Symbol('b') * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d')))**(Integer(-1))) + ((((Symbol('a') * Symbol('A') * Symbol('b')) + ((Symbol('a'))**(Integer(2)) * Symbol('B')) + (Integer(-1) * (Integer(2) * (Symbol('b'))**(Integer(2)) * Symbol('B')))) * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('b'))**(Integer(2)) * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d')))**(Integer(-1))) + (Integer(-1) * (((((Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Symbol('A') * (Symbol('b'))**(Integer(3))) + ((Symbol('a'))**(Integer(3)) * Symbol('B')) + (Integer(-1) * (Integer(3) * Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B')))) * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('a') + (Integer(-1) * Symbol('b'))) * (Symbol('b'))**(Integer(2)) * ((Symbol('a') + Symbol('b')))**(Integer(2)) * Symbol('d')))**(Integer(-1)))) + (Integer(-1) * ((((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x)))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d') * (Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x)))))))**(Integer(-1))))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a + b*cos(c + d*x))**2*sqrt(cos(c + d*x))),
        variable=x,
        num_steps=6,
        integral=((Integer(-1) * ((((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Symbol('a') * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d')))**(Integer(-1)))) + (Integer(-1) * ((((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Symbol('b') * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d')))**(Integer(-1)))) + ((((Integer(3) * (Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(-1) * ((Symbol('a'))**(Integer(3)) * Symbol('B'))) + (Integer(-1) * (Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B')))) * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Symbol('a') * (Symbol('a') + (Integer(-1) * Symbol('b'))) * Symbol('b') * ((Symbol('a') + Symbol('b')))**(Integer(2)) * Symbol('d')))**(Integer(-1))) + ((Symbol('b') * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x)))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Symbol('a') * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d') * (Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x)))))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a + b*cos(c + d*x))**2*cos(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=7,
        integral=((Integer(-1) * ((((Integer(2) * (Symbol('a'))**(Integer(2)) * Symbol('A')) + (Integer(-1) * (Integer(3) * Symbol('A') * (Symbol('b'))**(Integer(2)))) + (Symbol('a') * Symbol('b') * Symbol('B'))) * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('a'))**(Integer(2)) * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d')))**(Integer(-1)))) + ((((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Symbol('a') * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d')))**(Integer(-1))) + (Integer(-1) * ((((Integer(5) * (Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(3) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(-1) * (Integer(3) * (Symbol('a'))**(Integer(3)) * Symbol('B'))) + (Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B'))) * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('a'))**(Integer(2)) * (Symbol('a') + (Integer(-1) * Symbol('b'))) * ((Symbol('a') + Symbol('b')))**(Integer(2)) * Symbol('d')))**(Integer(-1)))) + ((((Integer(2) * (Symbol('a'))**(Integer(2)) * Symbol('A')) + (Integer(-1) * (Integer(3) * Symbol('A') * (Symbol('b'))**(Integer(2)))) + (Symbol('a') * Symbol('b') * Symbol('B'))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * (((Symbol('a'))**(Integer(2)) * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d') * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x))))))**(Integer(-1))) + ((Symbol('b') * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Symbol('a') * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d') * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x)))) * (Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x)))))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a + b*cos(c + d*x))**2*cos(c + d*x)**(sympy.S(5)/2)),
        variable=x,
        num_steps=8,
        integral=(((((Integer(4) * (Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(5) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(-1) * (Integer(2) * (Symbol('a'))**(Integer(3)) * Symbol('B'))) + (Integer(3) * Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B'))) * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('a'))**(Integer(3)) * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d')))**(Integer(-1))) + ((((Integer(2) * (Symbol('a'))**(Integer(2)) * Symbol('A')) + (Integer(-1) * (Integer(5) * Symbol('A') * (Symbol('b'))**(Integer(2)))) + (Integer(3) * Symbol('a') * Symbol('b') * Symbol('B'))) * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(3) * (Symbol('a'))**(Integer(2)) * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d')))**(Integer(-1))) + ((Symbol('b') * ((Integer(7) * (Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(5) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(-1) * (Integer(5) * (Symbol('a'))**(Integer(3)) * Symbol('B'))) + (Integer(3) * Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B'))) * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('a'))**(Integer(3)) * (Symbol('a') + (Integer(-1) * Symbol('b'))) * ((Symbol('a') + Symbol('b')))**(Integer(2)) * Symbol('d')))**(Integer(-1))) + ((((Integer(2) * (Symbol('a'))**(Integer(2)) * Symbol('A')) + (Integer(-1) * (Integer(5) * Symbol('A') * (Symbol('b'))**(Integer(2)))) + (Integer(3) * Symbol('a') * Symbol('b') * Symbol('B'))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(3) * (Symbol('a'))**(Integer(2)) * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d') * (sympy.cos((Symbol('c') + (Symbol('d') * x))))**((Integer(3) * (Integer(2))**(Integer(-1))))))**(Integer(-1))) + (Integer(-1) * ((((Integer(4) * (Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(5) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(-1) * (Integer(2) * (Symbol('a'))**(Integer(3)) * Symbol('B'))) + (Integer(3) * Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B'))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * (((Symbol('a'))**(Integer(3)) * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d') * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x))))))**(Integer(-1)))) + ((Symbol('b') * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Symbol('a') * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d') * (sympy.cos((Symbol('c') + (Symbol('d') * x))))**((Integer(3) * (Integer(2))**(Integer(-1)))) * (Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x)))))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(5)/2)/(a + b*cos(c + d*x))**3,
        variable=x,
        num_steps=7,
        integral=((Integer(-1) * ((((Integer(3) * (Symbol('a'))**(Integer(3)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(9) * Symbol('a') * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(-1) * (Integer(15) * (Symbol('a'))**(Integer(4)) * Symbol('B'))) + (Integer(29) * (Symbol('a'))**(Integer(2)) * (Symbol('b'))**(Integer(2)) * Symbol('B')) + (Integer(-1) * (Integer(8) * (Symbol('b'))**(Integer(4)) * Symbol('B')))) * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(4) * (Symbol('b'))**(Integer(3)) * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d')))**(Integer(-1)))) + ((((Integer(3) * (Symbol('a'))**(Integer(4)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(5) * (Symbol('a'))**(Integer(2)) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(8) * Symbol('A') * (Symbol('b'))**(Integer(5))) + (Integer(-1) * (Integer(15) * (Symbol('a'))**(Integer(5)) * Symbol('B'))) + (Integer(33) * (Symbol('a'))**(Integer(3)) * (Symbol('b'))**(Integer(2)) * Symbol('B')) + (Integer(-1) * (Integer(24) * Symbol('a') * (Symbol('b'))**(Integer(4)) * Symbol('B')))) * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(4) * (Symbol('b'))**(Integer(4)) * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d')))**(Integer(-1))) + (Integer(-1) * ((Symbol('a') * ((Integer(3) * (Symbol('a'))**(Integer(4)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(6) * (Symbol('a'))**(Integer(2)) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(15) * Symbol('A') * (Symbol('b'))**(Integer(5))) + (Integer(-1) * (Integer(15) * (Symbol('a'))**(Integer(5)) * Symbol('B'))) + (Integer(38) * (Symbol('a'))**(Integer(3)) * (Symbol('b'))**(Integer(2)) * Symbol('B')) + (Integer(-1) * (Integer(35) * Symbol('a') * (Symbol('b'))**(Integer(4)) * Symbol('B')))) * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(4) * ((Symbol('a') + (Integer(-1) * Symbol('b'))))**(Integer(2)) * (Symbol('b'))**(Integer(4)) * ((Symbol('a') + Symbol('b')))**(Integer(3)) * Symbol('d')))**(Integer(-1)))) + ((Symbol('a') * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * (sympy.cos((Symbol('c') + (Symbol('d') * x))))**((Integer(3) * (Integer(2))**(Integer(-1)))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(2) * Symbol('b') * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d') * ((Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x))))))**(Integer(2))))**(Integer(-1))) + ((Symbol('a') * (((Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(7) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(-1) * (Integer(5) * (Symbol('a'))**(Integer(3)) * Symbol('B'))) + (Integer(11) * Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B'))) * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x)))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(4) * (Symbol('b'))**(Integer(2)) * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d') * (Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x)))))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(3)/2)/(a + b*cos(c + d*x))**3,
        variable=x,
        num_steps=7,
        integral=((Integer(-1) * (((((Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Integer(5) * Symbol('A') * (Symbol('b'))**(Integer(3))) + (Integer(3) * (Symbol('a'))**(Integer(3)) * Symbol('B')) + (Integer(-1) * (Integer(9) * Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B')))) * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(4) * (Symbol('b'))**(Integer(2)) * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d')))**(Integer(-1)))) + (((((Symbol('a'))**(Integer(3)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(7) * Symbol('a') * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(3) * (Symbol('a'))**(Integer(4)) * Symbol('B')) + (Integer(-1) * (Integer(5) * (Symbol('a'))**(Integer(2)) * (Symbol('b'))**(Integer(2)) * Symbol('B'))) + (Integer(8) * (Symbol('b'))**(Integer(4)) * Symbol('B'))) * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(4) * (Symbol('b'))**(Integer(3)) * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d')))**(Integer(-1))) + (Integer(-1) * (((((Symbol('a'))**(Integer(4)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(10) * (Symbol('a'))**(Integer(2)) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(-1) * (Integer(3) * Symbol('A') * (Symbol('b'))**(Integer(5)))) + (Integer(3) * (Symbol('a'))**(Integer(5)) * Symbol('B')) + (Integer(-1) * (Integer(6) * (Symbol('a'))**(Integer(3)) * (Symbol('b'))**(Integer(2)) * Symbol('B'))) + (Integer(15) * Symbol('a') * (Symbol('b'))**(Integer(4)) * Symbol('B'))) * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(4) * ((Symbol('a') + (Integer(-1) * Symbol('b'))))**(Integer(2)) * (Symbol('b'))**(Integer(3)) * ((Symbol('a') + Symbol('b')))**(Integer(3)) * Symbol('d')))**(Integer(-1)))) + ((Symbol('a') * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x)))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(2) * Symbol('b') * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d') * ((Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x))))))**(Integer(2))))**(Integer(-1))) + (((((Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Integer(5) * Symbol('A') * (Symbol('b'))**(Integer(3))) + (Integer(3) * (Symbol('a'))**(Integer(3)) * Symbol('B')) + (Integer(-1) * (Integer(9) * Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B')))) * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x)))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(4) * Symbol('b') * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d') * (Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x)))))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(cos(c + d*x))/(a + b*cos(c + d*x))**3,
        variable=x,
        num_steps=7,
        integral=(((((Integer(5) * (Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Symbol('A') * (Symbol('b'))**(Integer(3))) + (Integer(-1) * ((Symbol('a'))**(Integer(3)) * Symbol('B'))) + (Integer(-1) * (Integer(5) * Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B')))) * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(4) * Symbol('a') * Symbol('b') * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d')))**(Integer(-1))) + ((((Integer(3) * (Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Integer(3) * Symbol('A') * (Symbol('b'))**(Integer(3))) + ((Symbol('a'))**(Integer(3)) * Symbol('B')) + (Integer(-1) * (Integer(7) * Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B')))) * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(4) * (Symbol('b'))**(Integer(2)) * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d')))**(Integer(-1))) + (Integer(-1) * ((((Integer(3) * (Symbol('a'))**(Integer(4)) * Symbol('A') * Symbol('b')) + (Integer(10) * (Symbol('a'))**(Integer(2)) * Symbol('A') * (Symbol('b'))**(Integer(3))) + (Integer(-1) * (Symbol('A') * (Symbol('b'))**(Integer(5)))) + ((Symbol('a'))**(Integer(5)) * Symbol('B')) + (Integer(-1) * (Integer(10) * (Symbol('a'))**(Integer(3)) * (Symbol('b'))**(Integer(2)) * Symbol('B'))) + (Integer(-1) * (Integer(3) * Symbol('a') * (Symbol('b'))**(Integer(4)) * Symbol('B')))) * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(4) * Symbol('a') * ((Symbol('a') + (Integer(-1) * Symbol('b'))))**(Integer(2)) * (Symbol('b'))**(Integer(2)) * ((Symbol('a') + Symbol('b')))**(Integer(3)) * Symbol('d')))**(Integer(-1)))) + (Integer(-1) * ((((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x)))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(2) * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d') * ((Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x))))))**(Integer(2))))**(Integer(-1)))) + (Integer(-1) * ((((Integer(5) * (Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Symbol('A') * (Symbol('b'))**(Integer(3))) + (Integer(-1) * ((Symbol('a'))**(Integer(3)) * Symbol('B'))) + (Integer(-1) * (Integer(5) * Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B')))) * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x)))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(4) * Symbol('a') * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d') * (Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x)))))))**(Integer(-1))))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a + b*cos(c + d*x))**3*sqrt(cos(c + d*x))),
        variable=x,
        num_steps=7,
        integral=((Integer(-1) * ((((Integer(9) * (Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(3) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(-1) * (Integer(5) * (Symbol('a'))**(Integer(3)) * Symbol('B'))) + (Integer(-1) * (Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B')))) * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(4) * (Symbol('a'))**(Integer(2)) * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d')))**(Integer(-1)))) + (Integer(-1) * ((((Integer(7) * (Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(-1) * (Integer(3) * (Symbol('a'))**(Integer(3)) * Symbol('B'))) + (Integer(-1) * (Integer(3) * Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B')))) * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(4) * Symbol('a') * Symbol('b') * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d')))**(Integer(-1)))) + ((((Integer(15) * (Symbol('a'))**(Integer(4)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(6) * (Symbol('a'))**(Integer(2)) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(3) * Symbol('A') * (Symbol('b'))**(Integer(5))) + (Integer(-1) * (Integer(3) * (Symbol('a'))**(Integer(5)) * Symbol('B'))) + (Integer(-1) * (Integer(10) * (Symbol('a'))**(Integer(3)) * (Symbol('b'))**(Integer(2)) * Symbol('B'))) + (Symbol('a') * (Symbol('b'))**(Integer(4)) * Symbol('B'))) * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(4) * (Symbol('a'))**(Integer(2)) * ((Symbol('a') + (Integer(-1) * Symbol('b'))))**(Integer(2)) * Symbol('b') * ((Symbol('a') + Symbol('b')))**(Integer(3)) * Symbol('d')))**(Integer(-1))) + ((Symbol('b') * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x)))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(2) * Symbol('a') * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d') * ((Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x))))))**(Integer(2))))**(Integer(-1))) + ((Symbol('b') * ((Integer(9) * (Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(3) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(-1) * (Integer(5) * (Symbol('a'))**(Integer(3)) * Symbol('B'))) + (Integer(-1) * (Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B')))) * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x)))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(4) * (Symbol('a'))**(Integer(2)) * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d') * (Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x)))))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a + b*cos(c + d*x))**3*cos(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=8,
        integral=((Integer(-1) * ((((Integer(8) * (Symbol('a'))**(Integer(4)) * Symbol('A')) + (Integer(-1) * (Integer(29) * (Symbol('a'))**(Integer(2)) * Symbol('A') * (Symbol('b'))**(Integer(2)))) + (Integer(15) * Symbol('A') * (Symbol('b'))**(Integer(4))) + (Integer(9) * (Symbol('a'))**(Integer(3)) * Symbol('b') * Symbol('B')) + (Integer(-1) * (Integer(3) * Symbol('a') * (Symbol('b'))**(Integer(3)) * Symbol('B')))) * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(4) * (Symbol('a'))**(Integer(3)) * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d')))**(Integer(-1)))) + ((((Integer(11) * (Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(5) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(-1) * (Integer(7) * (Symbol('a'))**(Integer(3)) * Symbol('B'))) + (Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B'))) * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(4) * (Symbol('a'))**(Integer(2)) * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d')))**(Integer(-1))) + (Integer(-1) * ((((Integer(35) * (Symbol('a'))**(Integer(4)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(38) * (Symbol('a'))**(Integer(2)) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(15) * Symbol('A') * (Symbol('b'))**(Integer(5))) + (Integer(-1) * (Integer(15) * (Symbol('a'))**(Integer(5)) * Symbol('B'))) + (Integer(6) * (Symbol('a'))**(Integer(3)) * (Symbol('b'))**(Integer(2)) * Symbol('B')) + (Integer(-1) * (Integer(3) * Symbol('a') * (Symbol('b'))**(Integer(4)) * Symbol('B')))) * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(4) * (Symbol('a'))**(Integer(3)) * ((Symbol('a') + (Integer(-1) * Symbol('b'))))**(Integer(2)) * ((Symbol('a') + Symbol('b')))**(Integer(3)) * Symbol('d')))**(Integer(-1)))) + ((((Integer(8) * (Symbol('a'))**(Integer(4)) * Symbol('A')) + (Integer(-1) * (Integer(29) * (Symbol('a'))**(Integer(2)) * Symbol('A') * (Symbol('b'))**(Integer(2)))) + (Integer(15) * Symbol('A') * (Symbol('b'))**(Integer(4))) + (Integer(9) * (Symbol('a'))**(Integer(3)) * Symbol('b') * Symbol('B')) + (Integer(-1) * (Integer(3) * Symbol('a') * (Symbol('b'))**(Integer(3)) * Symbol('B')))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(4) * (Symbol('a'))**(Integer(3)) * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d') * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x))))))**(Integer(-1))) + ((Symbol('b') * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(2) * Symbol('a') * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d') * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x)))) * ((Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x))))))**(Integer(2))))**(Integer(-1))) + ((Symbol('b') * ((Integer(11) * (Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(5) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(-1) * (Integer(7) * (Symbol('a'))**(Integer(3)) * Symbol('B'))) + (Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B'))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(4) * (Symbol('a'))**(Integer(2)) * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d') * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x)))) * (Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x)))))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a + b*cos(c + d*x))**3*cos(c + d*x)**(sympy.S(5)/2)),
        variable=x,
        num_steps=9,
        integral=(((((Integer(24) * (Symbol('a'))**(Integer(4)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(65) * (Symbol('a'))**(Integer(2)) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(35) * Symbol('A') * (Symbol('b'))**(Integer(5))) + (Integer(-1) * (Integer(8) * (Symbol('a'))**(Integer(5)) * Symbol('B'))) + (Integer(29) * (Symbol('a'))**(Integer(3)) * (Symbol('b'))**(Integer(2)) * Symbol('B')) + (Integer(-1) * (Integer(15) * Symbol('a') * (Symbol('b'))**(Integer(4)) * Symbol('B')))) * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(4) * (Symbol('a'))**(Integer(4)) * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d')))**(Integer(-1))) + ((((Integer(8) * (Symbol('a'))**(Integer(4)) * Symbol('A')) + (Integer(-1) * (Integer(61) * (Symbol('a'))**(Integer(2)) * Symbol('A') * (Symbol('b'))**(Integer(2)))) + (Integer(35) * Symbol('A') * (Symbol('b'))**(Integer(4))) + (Integer(33) * (Symbol('a'))**(Integer(3)) * Symbol('b') * Symbol('B')) + (Integer(-1) * (Integer(15) * Symbol('a') * (Symbol('b'))**(Integer(3)) * Symbol('B')))) * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(12) * (Symbol('a'))**(Integer(3)) * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d')))**(Integer(-1))) + ((Symbol('b') * ((Integer(63) * (Symbol('a'))**(Integer(4)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(86) * (Symbol('a'))**(Integer(2)) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(35) * Symbol('A') * (Symbol('b'))**(Integer(5))) + (Integer(-1) * (Integer(35) * (Symbol('a'))**(Integer(5)) * Symbol('B'))) + (Integer(38) * (Symbol('a'))**(Integer(3)) * (Symbol('b'))**(Integer(2)) * Symbol('B')) + (Integer(-1) * (Integer(15) * Symbol('a') * (Symbol('b'))**(Integer(4)) * Symbol('B')))) * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(4) * (Symbol('a'))**(Integer(4)) * ((Symbol('a') + (Integer(-1) * Symbol('b'))))**(Integer(2)) * ((Symbol('a') + Symbol('b')))**(Integer(3)) * Symbol('d')))**(Integer(-1))) + ((((Integer(8) * (Symbol('a'))**(Integer(4)) * Symbol('A')) + (Integer(-1) * (Integer(61) * (Symbol('a'))**(Integer(2)) * Symbol('A') * (Symbol('b'))**(Integer(2)))) + (Integer(35) * Symbol('A') * (Symbol('b'))**(Integer(4))) + (Integer(33) * (Symbol('a'))**(Integer(3)) * Symbol('b') * Symbol('B')) + (Integer(-1) * (Integer(15) * Symbol('a') * (Symbol('b'))**(Integer(3)) * Symbol('B')))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(12) * (Symbol('a'))**(Integer(3)) * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d') * (sympy.cos((Symbol('c') + (Symbol('d') * x))))**((Integer(3) * (Integer(2))**(Integer(-1))))))**(Integer(-1))) + (Integer(-1) * ((((Integer(24) * (Symbol('a'))**(Integer(4)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(65) * (Symbol('a'))**(Integer(2)) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(35) * Symbol('A') * (Symbol('b'))**(Integer(5))) + (Integer(-1) * (Integer(8) * (Symbol('a'))**(Integer(5)) * Symbol('B'))) + (Integer(29) * (Symbol('a'))**(Integer(3)) * (Symbol('b'))**(Integer(2)) * Symbol('B')) + (Integer(-1) * (Integer(15) * Symbol('a') * (Symbol('b'))**(Integer(4)) * Symbol('B')))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(4) * (Symbol('a'))**(Integer(4)) * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d') * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x))))))**(Integer(-1)))) + ((Symbol('b') * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(2) * Symbol('a') * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('d') * (sympy.cos((Symbol('c') + (Symbol('d') * x))))**((Integer(3) * (Integer(2))**(Integer(-1)))) * ((Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x))))))**(Integer(2))))**(Integer(-1))) + ((Symbol('b') * ((Integer(13) * (Symbol('a'))**(Integer(2)) * Symbol('A') * Symbol('b')) + (Integer(-1) * (Integer(7) * Symbol('A') * (Symbol('b'))**(Integer(3)))) + (Integer(-1) * (Integer(9) * (Symbol('a'))**(Integer(3)) * Symbol('B'))) + (Integer(3) * Symbol('a') * (Symbol('b'))**(Integer(2)) * Symbol('B'))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(4) * (Symbol('a'))**(Integer(2)) * (((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))))**(Integer(2)) * Symbol('d') * (sympy.cos((Symbol('c') + (Symbol('d') * x))))**((Integer(3) * (Integer(2))**(Integer(-1)))) * (Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x)))))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*cos(c + d*x)**(sympy.S(5)/2)/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=3,
        integral=2*B*sin(c + d*x)*cos(c + d*x)**(sympy.S(3)/2)/(5*d) + 6*B*elliptic_e(c/2 + d*x/2, 2)/(5*d),
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*cos(c + d*x)**(sympy.S(3)/2)/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=3,
        integral=2*B*sin(c + d*x)*sqrt(cos(c + d*x))/(3*d) + 2*B*elliptic_f(c/2 + d*x/2, 2)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*sqrt(cos(c + d*x))/(a + b*cos(c + d*x)),
        variable=x,
        num_steps=2,
        integral=2*B*elliptic_e(c/2 + d*x/2, 2)/d,
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))/((a + b*cos(c + d*x))*sqrt(cos(c + d*x))),
        variable=x,
        num_steps=2,
        integral=2*B*elliptic_f(c/2 + d*x/2, 2)/d,
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))/((a + b*cos(c + d*x))*cos(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=3,
        integral=2*B*sin(c + d*x)/(d*sqrt(cos(c + d*x))) - 2*B*elliptic_e(c/2 + d*x/2, 2)/d,
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))/((a + b*cos(c + d*x))*cos(c + d*x)**(sympy.S(5)/2)),
        variable=x,
        num_steps=3,
        integral=2*B*sin(c + d*x)/(3*d*cos(c + d*x)**(sympy.S(3)/2)) + 2*B*elliptic_f(c/2 + d*x/2, 2)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*cos(c + d*x)**(sympy.S(5)/2)/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=7,
        integral=((Integer(-1) * ((Integer(2) * Symbol('a') * Symbol('B') * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('b'))**(Integer(2)) * Symbol('d')))**(Integer(-1)))) + ((Integer(2) * ((Integer(3) * (Symbol('a'))**(Integer(2))) + (Symbol('b'))**(Integer(2))) * Symbol('B') * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(3) * (Symbol('b'))**(Integer(3)) * Symbol('d')))**(Integer(-1))) + (Integer(-1) * ((Integer(2) * (Symbol('a'))**(Integer(3)) * Symbol('B') * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('b'))**(Integer(3)) * (Symbol('a') + Symbol('b')) * Symbol('d')))**(Integer(-1)))) + ((Integer(2) * Symbol('B') * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x)))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(3) * Symbol('b') * Symbol('d')))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*cos(c + d*x)**(sympy.S(3)/2)/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=6,
        integral=(((Integer(2) * Symbol('B') * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Symbol('b') * Symbol('d')))**(Integer(-1))) + (Integer(-1) * ((Integer(2) * Symbol('a') * Symbol('B') * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('b'))**(Integer(2)) * Symbol('d')))**(Integer(-1)))) + ((Integer(2) * (Symbol('a'))**(Integer(2)) * Symbol('B') * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('b'))**(Integer(2)) * (Symbol('a') + Symbol('b')) * Symbol('d')))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*sqrt(cos(c + d*x))/(a + b*cos(c + d*x))**2,
        variable=x,
        num_steps=4,
        integral=(((Integer(2) * Symbol('B') * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Symbol('b') * Symbol('d')))**(Integer(-1))) + (Integer(-1) * ((Integer(2) * Symbol('a') * Symbol('B') * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Symbol('b') * (Symbol('a') + Symbol('b')) * Symbol('d')))**(Integer(-1))))),
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))/((a + b*cos(c + d*x))**2*sqrt(cos(c + d*x))),
        variable=x,
        num_steps=2,
        integral=((Integer(2) * Symbol('B') * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('a') + Symbol('b')) * Symbol('d')))**(Integer(-1))),
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))/((a + b*cos(c + d*x))**2*cos(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=6,
        integral=((Integer(-1) * ((Integer(2) * Symbol('B') * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Symbol('a') * Symbol('d')))**(Integer(-1)))) + (Integer(-1) * ((Integer(2) * Symbol('b') * Symbol('B') * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Symbol('a') * (Symbol('a') + Symbol('b')) * Symbol('d')))**(Integer(-1)))) + ((Integer(2) * Symbol('B') * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Symbol('a') * Symbol('d') * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x))))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))/((a + b*cos(c + d*x))**2*cos(c + d*x)**(sympy.S(5)/2)),
        variable=x,
        num_steps=8,
        integral=(((Integer(2) * Symbol('b') * Symbol('B') * sympy.elliptic_e(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('a'))**(Integer(2)) * Symbol('d')))**(Integer(-1))) + ((Integer(2) * Symbol('B') * sympy.elliptic_f(((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * ((Integer(3) * Symbol('a') * Symbol('d')))**(Integer(-1))) + ((Integer(2) * (Symbol('b'))**(Integer(2)) * Symbol('B') * sympy.Function('EllipticPi')(((Integer(2) * Symbol('b')) * ((Symbol('a') + Symbol('b')))**(Integer(-1))), ((Integer(2))**(Integer(-1)) * (Symbol('c') + (Symbol('d') * x))), Integer(2))) * (((Symbol('a'))**(Integer(2)) * (Symbol('a') + Symbol('b')) * Symbol('d')))**(Integer(-1))) + ((Integer(2) * Symbol('B') * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Integer(3) * Symbol('a') * Symbol('d') * (sympy.cos((Symbol('c') + (Symbol('d') * x))))**((Integer(3) * (Integer(2))**(Integer(-1))))))**(Integer(-1))) + (Integer(-1) * ((Integer(2) * Symbol('b') * Symbol('B') * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * (((Symbol('a'))**(Integer(2)) * Symbol('d') * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x))))))**(Integer(-1))))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a + b*cos(c + d*x))*cos(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a + b*cos(c + d*x))*sqrt(cos(c + d*x)),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a + b*cos(c + d*x))/cos(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=5,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a + b*cos(c + d*x))/cos(c + d*x)**(sympy.S(9)/2),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(3)/2)*cos(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(3)/2)*sqrt(cos(c + d*x)),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(3)/2)/cos(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(3)/2)/cos(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=5,
        integral=2*A*a*sqrt(a + b*cos(c + d*x))*sin(c + d*x)/(5*d*cos(c + d*x)**(sympy.S(5)/2)) + sqrt(a + b*cos(c + d*x))*(12*A*b + 10*B*a)*sin(c + d*x)/(15*d*cos(c + d*x)**(sympy.S(3)/2)) - sqrt(a*(1 - sec(c + d*x))/(a + b))*sqrt(a*(sec(c + d*x) + 1)/(a - b))*sqrt(a + b)*(2*a - 2*b)*(9*A*a - 3*A*b - 5*B*a + 15*B*b)*cot(c + d*x)*elliptic_f(asin(sqrt(a + b*cos(c + d*x))/(sqrt(a + b)*sqrt(cos(c + d*x)))), -(a + b)/(a - b))/(15*a*d) + sqrt(a*(1 - sec(c + d*x))/(a + b))*sqrt(a*(sec(c + d*x) + 1)/(a - b))*sqrt(a + b)*(2*a - 2*b)*(9*A*a**2 + 3*A*b**2 + 20*B*a*b)*cot(c + d*x)*elliptic_e(asin(sqrt(a + b*cos(c + d*x))/(sqrt(a + b)*sqrt(cos(c + d*x)))), -(a + b)/(a - b))/(15*a**2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(3)/2)/cos(c + d*x)**(sympy.S(9)/2),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(3)/2)/cos(c + d*x)**(sympy.S(11)/2),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(5)/2)*cos(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=10,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(5)/2)*sqrt(cos(c + d*x)),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(5)/2)/cos(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(5)/2)/cos(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(5)/2)/cos(c + d*x)**(sympy.S(9)/2),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(5)/2)/cos(c + d*x)**(sympy.S(11)/2),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(5)/2)/cos(c + d*x)**(sympy.S(13)/2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*cos(c + d*x))**(sympy.S(5)/2)*(B*cos(c + d*x) + 3*B*b/(2*a))/cos(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*cos(c + d*x)**(sympy.S(3)/2)/sqrt(a + b*cos(c + d*x)),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(cos(c + d*x))/sqrt(a + b*cos(c + d*x)),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=3,
        integral=2*A*sqrt(a*(1 - sec(c + d*x))/(a + b))*sqrt(a*(sec(c + d*x) + 1)/(a - b))*(a - b)*sqrt(a + b)*cot(c + d*x)*elliptic_e(asin(sqrt(a + b*cos(c + d*x))/(sqrt(a + b)*sqrt(cos(c + d*x)))), -(a + b)/(a - b))/(a**2*d) - 2*sqrt(a*(1 - sec(c + d*x))/(a + b))*sqrt(a*(sec(c + d*x) + 1)/(a - b))*(A - B)*sqrt(a + b)*cot(c + d*x)*elliptic_f(asin(sqrt(a + b*cos(c + d*x))/(sqrt(a + b)*sqrt(cos(c + d*x)))), -(a + b)/(a - b))/(a*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/(sqrt(a + b*cos(c + d*x))*cos(c + d*x)**(sympy.S(5)/2)),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*cos(c + d*x)**(sympy.S(3)/2)/(a + b*cos(c + d*x))**(sympy.S(3)/2),
        variable=x,
        num_steps=9,
        integral=((Integer(-1) * (((Symbol('a') + (Integer(-1) * Symbol('b'))) * sympy.sqrt((Symbol('a') + Symbol('b'))) * Symbol('B') * sympy.cot((Symbol('c') + (Symbol('d') * x))) * sympy.elliptic_e(sympy.asin((sympy.sqrt((Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x)))))) * ((sympy.sqrt((Symbol('a') + Symbol('b'))) * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x))))))**(Integer(-1)))), (Integer(-1) * ((Symbol('a') + Symbol('b')) * ((Symbol('a') + (Integer(-1) * Symbol('b'))))**(Integer(-1))))) * sympy.sqrt(((Symbol('a') * (Integer(1) + (Integer(-1) * sympy.sec((Symbol('c') + (Symbol('d') * x)))))) * ((Symbol('a') + Symbol('b')))**(Integer(-1)))) * sympy.sqrt(((Symbol('a') * (Integer(1) + sympy.sec((Symbol('c') + (Symbol('d') * x))))) * ((Symbol('a') + (Integer(-1) * Symbol('b'))))**(Integer(-1))))) * ((Symbol('a') * Symbol('b') * Symbol('d')))**(Integer(-1)))) + ((sympy.sqrt((Symbol('a') + Symbol('b'))) * Symbol('B') * sympy.cot((Symbol('c') + (Symbol('d') * x))) * sympy.elliptic_f(sympy.asin((sympy.sqrt((Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x)))))) * ((sympy.sqrt((Symbol('a') + Symbol('b'))) * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x))))))**(Integer(-1)))), (Integer(-1) * ((Symbol('a') + Symbol('b')) * ((Symbol('a') + (Integer(-1) * Symbol('b'))))**(Integer(-1))))) * sympy.sqrt(((Symbol('a') * (Integer(1) + (Integer(-1) * sympy.sec((Symbol('c') + (Symbol('d') * x)))))) * ((Symbol('a') + Symbol('b')))**(Integer(-1)))) * sympy.sqrt(((Symbol('a') * (Integer(1) + sympy.sec((Symbol('c') + (Symbol('d') * x))))) * ((Symbol('a') + (Integer(-1) * Symbol('b'))))**(Integer(-1))))) * ((Symbol('b') * Symbol('d')))**(Integer(-1))) + ((Symbol('a') * sympy.sqrt((Symbol('a') + Symbol('b'))) * Symbol('B') * sympy.cot((Symbol('c') + (Symbol('d') * x))) * sympy.Function('EllipticPi')(((Symbol('a') + Symbol('b')) * (Symbol('b'))**(Integer(-1))), sympy.asin((sympy.sqrt((Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x)))))) * ((sympy.sqrt((Symbol('a') + Symbol('b'))) * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x))))))**(Integer(-1)))), (Integer(-1) * ((Symbol('a') + Symbol('b')) * ((Symbol('a') + (Integer(-1) * Symbol('b'))))**(Integer(-1))))) * sympy.sqrt(((Symbol('a') * (Integer(1) + (Integer(-1) * sympy.sec((Symbol('c') + (Symbol('d') * x)))))) * ((Symbol('a') + Symbol('b')))**(Integer(-1)))) * sympy.sqrt(((Symbol('a') * (Integer(1) + sympy.sec((Symbol('c') + (Symbol('d') * x))))) * ((Symbol('a') + (Integer(-1) * Symbol('b'))))**(Integer(-1))))) * (((Symbol('b'))**(Integer(2)) * Symbol('d')))**(Integer(-1))) + ((Symbol('a') * Symbol('B') * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Symbol('b') * Symbol('d') * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x)))) * sympy.sqrt((Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x))))))))**(Integer(-1))) + ((Symbol('B') * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x)))) * sympy.sin((Symbol('c') + (Symbol('d') * x)))) * ((Symbol('d') * sympy.sqrt((Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x))))))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))*sqrt(cos(c + d*x))/(a + b*cos(c + d*x))**(sympy.S(3)/2),
        variable=x,
        num_steps=2,
        integral=(Integer(-1) * ((Integer(2) * sympy.sqrt((Symbol('a') + Symbol('b'))) * Symbol('B') * sympy.cot((Symbol('c') + (Symbol('d') * x))) * sympy.Function('EllipticPi')(((Symbol('a') + Symbol('b')) * (Symbol('b'))**(Integer(-1))), sympy.asin((sympy.sqrt((Symbol('a') + (Symbol('b') * sympy.cos((Symbol('c') + (Symbol('d') * x)))))) * ((sympy.sqrt((Symbol('a') + Symbol('b'))) * sympy.sqrt(sympy.cos((Symbol('c') + (Symbol('d') * x))))))**(Integer(-1)))), (Integer(-1) * ((Symbol('a') + Symbol('b')) * ((Symbol('a') + (Integer(-1) * Symbol('b'))))**(Integer(-1))))) * sympy.sqrt(((Symbol('a') * (Integer(1) + (Integer(-1) * sympy.sec((Symbol('c') + (Symbol('d') * x)))))) * ((Symbol('a') + Symbol('b')))**(Integer(-1)))) * sympy.sqrt(((Symbol('a') * (Integer(1) + sympy.sec((Symbol('c') + (Symbol('d') * x))))) * ((Symbol('a') + (Integer(-1) * Symbol('b'))))**(Integer(-1))))) * ((Symbol('b') * Symbol('d')))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))/((a + b*cos(c + d*x))**(sympy.S(3)/2)*sqrt(cos(c + d*x))),
        variable=x,
        num_steps=2,
        integral=2*B*sqrt(a*(1 - sec(c + d*x))/(a + b))*sqrt(a*(sec(c + d*x) + 1)/(a - b))*sqrt(a + b)*cot(c + d*x)*elliptic_f(asin(sqrt(a + b*cos(c + d*x))/(sqrt(a + b)*sqrt(cos(c + d*x)))), -(a + b)/(a - b))/(a*d),
    ),
    RubiTestSuiteCase(
        integrand=(B*a + B*b*cos(c + d*x))/((a + b*cos(c + d*x))**(sympy.S(3)/2)*cos(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=4,
        integral=-2*B*sqrt(a*(1 - sec(c + d*x))/(a + b))*sqrt(a*(sec(c + d*x) + 1)/(a - b))*sqrt(a + b)*cot(c + d*x)*elliptic_f(asin(sqrt(a + b*cos(c + d*x))/(sqrt(a + b)*sqrt(cos(c + d*x)))), -(a + b)/(a - b))/(a*d) + B*sqrt(a*(1 - sec(c + d*x))/(a + b))*sqrt(a*(sec(c + d*x) + 1)/(a - b))*sqrt(a + b)*(2*a - 2*b)*cot(c + d*x)*elliptic_e(asin(sqrt(a + b*cos(c + d*x))/(sqrt(a + b)*sqrt(cos(c + d*x)))), -(a + b)/(a - b))/(a**2*d),
    ),
    RubiTestSuiteCase(
        integrand=(cos(c + d*x) + 1)/(sqrt(3*cos(c + d*x) + 2)*cos(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=1,
        integral=-sqrt(1 - sec(c + d*x))*sqrt(-sec(c + d*x) - 1)*cot(c + d*x)*elliptic_e(asin(sqrt(5)*sqrt(3*cos(c + d*x) + 2)/(5*sqrt(cos(c + d*x)))), 5)/d,
    ),
    RubiTestSuiteCase(
        integrand=(cos(c + d*x) + 1)/(sqrt(3*cos(c + d*x) - 2)*cos(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=1,
        integral=-sqrt(5)*sqrt(sec(c + d*x) - 1)*sqrt(sec(c + d*x) + 1)*cot(c + d*x)*elliptic_e(asin(sqrt(3*cos(c + d*x) - 2)/sqrt(cos(c + d*x))), sympy.S(1)/5)/d,
    ),
    RubiTestSuiteCase(
        integrand=(cos(c + d*x) + 1)/(sqrt(2 - 3*cos(c + d*x))*cos(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=2,
        integral=sqrt(5)*sqrt(-cos(c + d*x))*sqrt(sec(c + d*x) - 1)*sqrt(sec(c + d*x) + 1)*sqrt(cos(c + d*x))*csc(c + d*x)*elliptic_e(asin(sqrt(2 - 3*cos(c + d*x))/sqrt(-cos(c + d*x))), sympy.S(1)/5)/d,
    ),
    RubiTestSuiteCase(
        integrand=(cos(c + d*x) + 1)/(sqrt(-3*cos(c + d*x) - 2)*cos(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=2,
        integral=sqrt(-cos(c + d*x))*sqrt(1 - sec(c + d*x))*sqrt(-sec(c + d*x) - 1)*sqrt(cos(c + d*x))*csc(c + d*x)*elliptic_e(asin(sqrt(5)*sqrt(-3*cos(c + d*x) - 2)/(5*sqrt(-cos(c + d*x)))), 5)/d,
    ),
    RubiTestSuiteCase(
        integrand=(cos(c + d*x) + 1)/(sqrt(2*cos(c + d*x) + 3)*cos(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=1,
        integral=2*sqrt(1 - sec(c + d*x))*sqrt(sec(c + d*x) + 1)*cot(c + d*x)*elliptic_e(asin(sqrt(5)*sqrt(2*cos(c + d*x) + 3)/(5*sqrt(cos(c + d*x)))), -5)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(cos(c + d*x) + 1)/(sqrt(3 - 2*cos(c + d*x))*cos(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=1,
        integral=2*sqrt(5)*sqrt(1 - sec(c + d*x))*sqrt(sec(c + d*x) + 1)*cot(c + d*x)*elliptic_e(asin(sqrt(3 - 2*cos(c + d*x))/sqrt(cos(c + d*x))), sympy.S(-1)/5)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(cos(c + d*x) + 1)/(sqrt(2*cos(c + d*x) - 3)*cos(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=2,
        integral=-2*sqrt(5)*sqrt(-cos(c + d*x))*sqrt(1 - sec(c + d*x))*sqrt(sec(c + d*x) + 1)*sqrt(cos(c + d*x))*csc(c + d*x)*elliptic_e(asin(sqrt(2*cos(c + d*x) - 3)/sqrt(-cos(c + d*x))), sympy.S(-1)/5)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(cos(c + d*x) + 1)/(sqrt(-2*cos(c + d*x) - 3)*cos(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=2,
        integral=-2*sqrt(-cos(c + d*x))*sqrt(1 - sec(c + d*x))*sqrt(sec(c + d*x) + 1)*sqrt(cos(c + d*x))*csc(c + d*x)*elliptic_e(asin(sqrt(5)*sqrt(-2*cos(c + d*x) - 3)/(5*sqrt(-cos(c + d*x)))), -5)/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(c*cos(e + f*x))**m*(A + B*cos(e + f*x))*(a + b*cos(e + f*x))**n,
        variable=x,
        num_steps=0,
        integral=sympy.Function('Unintegrable')((((Symbol('c') * sympy.cos((Symbol('e') + (Symbol('f') * x)))))**(Symbol('m')) * ((Symbol('a') + (Symbol('b') * sympy.cos((Symbol('e') + (Symbol('f') * x))))))**(Symbol('n')) * (Symbol('A') + (Symbol('B') * sympy.cos((Symbol('e') + (Symbol('f') * x)))))), x),
    ),
    RubiTestSuiteCase(
        integrand=(c*cos(e + f*x))**m*(A + B*cos(e + f*x))*(a + b*cos(e + f*x))**4,
        variable=x,
        num_steps=7,
        integral=B*b*(c*cos(e + f*x))**(m + 1)*(a + b*cos(e + f*x))**3*sin(e + f*x)/(c*f*(m + 5)) + b**2*(c*cos(e + f*x))**(m + 1)*(2*A*a*b*(m + 5)**2 + B*a**2*(m**2 + 11*m + 36) + B*b**2*(m + 4)**2)*sin(e + f*x)*cos(e + f*x)/(c*f*(m + 3)*(m + 4)*(m + 5)) + b*(c*cos(e + f*x))**(m + 1)*(a + b*cos(e + f*x))**2*(A*b*(m + 5) + B*a*(m + 8))*sin(e + f*x)/(c*f*(m + 4)*(m + 5)) + b*(c*cos(e + f*x))**(m + 1)*(A*a**2*b*(5*m**2 + 47*m + 110) + A*b**3*(m**2 + 8*m + 15) + 2*B*a**3*(m**2 + 10*m + 28) + 4*B*a*b**2*(m**2 + 8*m + 15))*sin(e + f*x)/(c*f*(m + 2)*(m + 4)*(m + 5)) - (c*cos(e + f*x))**(m + 1)*(A*a**4*(m**2 + 6*m + 8) + 6*A*a**2*b**2*(m**2 + 5*m + 4) + A*b**4*(m**2 + 4*m + 3) + 4*B*a**3*b*(m**2 + 5*m + 4) + 4*B*a*b**3*(m**2 + 4*m + 3))*sin(e + f*x)*hyper((sympy.S.Half, m/2 + sympy.S.Half), (m/2 + sympy.S(3)/2,), cos(e + f*x)**2)/(c*f*(m + 1)*(m + 2)*(m + 4)*sqrt(sin(e + f*x)**2)) - (c*cos(e + f*x))**(m + 2)*(4*A*a**3*b*(m**2 + 8*m + 15) + 4*A*a*b**3*(m**2 + 7*m + 10) + B*a**4*(m**2 + 8*m + 15) + 6*B*a**2*b**2*(m**2 + 7*m + 10) + B*b**4*(m**2 + 6*m + 8))*sin(e + f*x)*hyper((sympy.S.Half, m/2 + 1), (m/2 + 2,), cos(e + f*x)**2)/(c**2*f*(m + 2)*(m + 3)*(m + 5)*sqrt(sin(e + f*x)**2)),
    ),
    RubiTestSuiteCase(
        integrand=(c*cos(e + f*x))**m*(A + B*cos(e + f*x))*(a + b*cos(e + f*x))**3,
        variable=x,
        num_steps=6,
        integral=B*b*(c*cos(e + f*x))**(m + 1)*(a + b*cos(e + f*x))**2*sin(e + f*x)/(c*f*(m + 4)) + b**2*(c*cos(e + f*x))**(m + 1)*(A*b*(m + 4) + B*a*(m + 6))*sin(e + f*x)*cos(e + f*x)/(c*f*(m + 3)*(m + 4)) + b*(c*cos(e + f*x))**(m + 1)*(3*A*a*b*(m + 4) + 2*B*a**2*(m + 5) + B*b**2*(m + 3))*sin(e + f*x)/(c*f*(m + 2)*(m + 4)) - (c*cos(e + f*x))**(m + 1)*(a**2*(m + 2)*(A*a*(m + 4) + B*b*(m + 1)) + b*(m + 1)*(3*A*a*b*(m + 4) + 2*B*a**2*(m + 5) + B*b**2*(m + 3)))*sin(e + f*x)*hyper((sympy.S.Half, m/2 + sympy.S.Half), (m/2 + sympy.S(3)/2,), cos(e + f*x)**2)/(c*f*(m + 1)*(m + 2)*(m + 4)*sqrt(sin(e + f*x)**2)) - (c*cos(e + f*x))**(m + 2)*(3*A*a**2*b*(m + 3) + A*b**3*(m + 2) + B*a**3*(m + 3) + 3*B*a*b**2*(m + 2))*sin(e + f*x)*hyper((sympy.S.Half, m/2 + 1), (m/2 + 2,), cos(e + f*x)**2)/(c**2*f*(m + 2)*(m + 3)*sqrt(sin(e + f*x)**2)),
    ),
    RubiTestSuiteCase(
        integrand=(c*cos(e + f*x))**m*(A + B*cos(e + f*x))*(a + b*cos(e + f*x))**2,
        variable=x,
        num_steps=5,
        integral=B*b*(c*cos(e + f*x))**(m + 1)*(a + b*cos(e + f*x))*sin(e + f*x)/(c*f*(m + 3)) + b*(c*cos(e + f*x))**(m + 1)*(A*b*(m + 3) + B*a*(m + 4))*sin(e + f*x)/(c*f*(m + 2)*(m + 3)) - (c*cos(e + f*x))**(m + 1)*(A*a**2*(m + 2) + A*b**2*(m + 1) + 2*B*a*b*(m + 1))*sin(e + f*x)*hyper((sympy.S.Half, m/2 + sympy.S.Half), (m/2 + sympy.S(3)/2,), cos(e + f*x)**2)/(c*f*(m + 1)*(m + 2)*sqrt(sin(e + f*x)**2)) - (c*cos(e + f*x))**(m + 2)*(B*b**2*(m + 2) + a*(m + 3)*(2*A*b + B*a))*sin(e + f*x)*hyper((sympy.S.Half, m/2 + 1), (m/2 + 2,), cos(e + f*x)**2)/(c**2*f*(m + 2)*(m + 3)*sqrt(sin(e + f*x)**2)),
    ),
    RubiTestSuiteCase(
        integrand=(c*cos(e + f*x))**m*(A + B*cos(e + f*x))*(a + b*cos(e + f*x)),
        variable=x,
        num_steps=5,
        integral=B*b*(c*cos(e + f*x))**(m + 1)*sin(e + f*x)/(c*f*(m + 2)) - (c*cos(e + f*x))**(m + 1)*(A*a*(m + 2) + B*b*(m + 1))*sin(e + f*x)*hyper((sympy.S.Half, m/2 + sympy.S.Half), (m/2 + sympy.S(3)/2,), cos(e + f*x)**2)/(c*f*(m + 1)*(m + 2)*sqrt(sin(e + f*x)**2)) - (c*cos(e + f*x))**(m + 2)*(A*b + B*a)*sin(e + f*x)*hyper((sympy.S.Half, m/2 + 1), (m/2 + 2,), cos(e + f*x)**2)/(c**2*f*(m + 2)*sqrt(sin(e + f*x)**2)),
    ),
    RubiTestSuiteCase(
        integrand=(c*cos(e + f*x))**m*(A + B*cos(e + f*x))/(a + b*cos(e + f*x)),
        variable=x,
        num_steps=7,
        integral=-B*(c*cos(e + f*x))**(m + 1)*sin(e + f*x)*hyper((sympy.S.Half, m/2 + sympy.S.Half), (m/2 + sympy.S(3)/2,), cos(e + f*x)**2)/(b*c*f*(m + 1)*sqrt(sin(e + f*x)**2)) + a*c*(c*cos(e + f*x))**(m - 1)*(A*b - B*a)*(cos(e + f*x)**2)**(sympy.S.Half - m/2)*sin(e + f*x)*appellf1(sympy.S.Half, 1, sympy.S.Half - m/2, sympy.S(3)/2, -b**2*sin(e + f*x)**2/(a**2 - b**2), sin(e + f*x)**2)/(b*f*(a**2 - b**2)) - (c*cos(e + f*x))**m*(A*b - B*a)*sin(e + f*x)*appellf1(sympy.S.Half, 1, -m/2, sympy.S(3)/2, -b**2*sin(e + f*x)**2/(a**2 - b**2), sin(e + f*x)**2)/(f*(a**2 - b**2)*(cos(e + f*x)**2)**(m/2)),
    ),
    RubiTestSuiteCase(
        integrand=(c*cos(e + f*x))**m*(A + B*cos(e + f*x))*(a + b*cos(e + f*x))**(sympy.S(3)/2),
        variable=x,
        num_steps=1,
        integral=(((Integer(2) * Symbol('b') * Symbol('B') * ((Symbol('c') * sympy.cos((Symbol('e') + (Symbol('f') * x)))))**((Integer(1) + Symbol('m'))) * sympy.sqrt((Symbol('a') + (Symbol('b') * sympy.cos((Symbol('e') + (Symbol('f') * x)))))) * sympy.sin((Symbol('e') + (Symbol('f') * x)))) * ((Symbol('c') * Symbol('f') * (Integer(5) + (Integer(2) * Symbol('m')))))**(Integer(-1))) + ((Integer(2) * sympy.Function('Unintegrable')(((((Symbol('c') * sympy.cos((Symbol('e') + (Symbol('f') * x)))))**(Symbol('m')) * (((Integer(2))**(Integer(-1)) * Symbol('a') * Symbol('c') * ((Integer(2) * Symbol('b') * Symbol('B') * (Integer(1) + Symbol('m'))) + (Integer(2) * Symbol('a') * Symbol('A') * ((Integer(5) * (Integer(2))**(Integer(-1))) + Symbol('m'))))) + ((Integer(2))**(Integer(-1)) * Symbol('c') * (((Symbol('b'))**(Integer(2)) * Symbol('B') * (Integer(3) + (Integer(2) * Symbol('m')))) + (Symbol('a') * ((Integer(2) * Symbol('A') * Symbol('b')) + (Symbol('a') * Symbol('B'))) * (Integer(5) + (Integer(2) * Symbol('m'))))) * sympy.cos((Symbol('e') + (Symbol('f') * x)))) + ((Integer(2))**(Integer(-1)) * Symbol('b') * Symbol('c') * ((Integer(2) * Symbol('a') * Symbol('B') * (Integer(3) + Symbol('m'))) + (Symbol('A') * Symbol('b') * (Integer(5) + (Integer(2) * Symbol('m'))))) * (sympy.cos((Symbol('e') + (Symbol('f') * x))))**(Integer(2))))) * (sympy.sqrt((Symbol('a') + (Symbol('b') * sympy.cos((Symbol('e') + (Symbol('f') * x)))))))**(Integer(-1))), x)) * ((Symbol('c') * (Integer(5) + (Integer(2) * Symbol('m')))))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(c*cos(e + f*x))**m*(A + B*cos(e + f*x))*sqrt(a + b*cos(e + f*x)),
        variable=x,
        num_steps=0,
        integral=sympy.Function('Unintegrable')((((Symbol('c') * sympy.cos((Symbol('e') + (Symbol('f') * x)))))**(Symbol('m')) * sympy.sqrt((Symbol('a') + (Symbol('b') * sympy.cos((Symbol('e') + (Symbol('f') * x)))))) * (Symbol('A') + (Symbol('B') * sympy.cos((Symbol('e') + (Symbol('f') * x)))))), x),
    ),
    RubiTestSuiteCase(
        integrand=(c*cos(e + f*x))**m*(A + B*cos(e + f*x))/sqrt(a + b*cos(e + f*x)),
        variable=x,
        num_steps=0,
        integral=sympy.Function('Unintegrable')(((((Symbol('c') * sympy.cos((Symbol('e') + (Symbol('f') * x)))))**(Symbol('m')) * (Symbol('A') + (Symbol('B') * sympy.cos((Symbol('e') + (Symbol('f') * x)))))) * (sympy.sqrt((Symbol('a') + (Symbol('b') * sympy.cos((Symbol('e') + (Symbol('f') * x)))))))**(Integer(-1))), x),
    ),
    RubiTestSuiteCase(
        integrand=(c*cos(e + f*x))**m*(A + B*cos(e + f*x))/(a + b*cos(e + f*x))**(sympy.S(3)/2),
        variable=x,
        num_steps=1,
        integral=(((Integer(2) * Symbol('b') * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * ((Symbol('c') * sympy.cos((Symbol('e') + (Symbol('f') * x)))))**((Integer(1) + Symbol('m'))) * sympy.sin((Symbol('e') + (Symbol('f') * x)))) * ((Symbol('a') * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('c') * Symbol('f') * sympy.sqrt((Symbol('a') + (Symbol('b') * sympy.cos((Symbol('e') + (Symbol('f') * x))))))))**(Integer(-1))) + ((Integer(2) * sympy.Function('Unintegrable')(((((Symbol('c') * sympy.cos((Symbol('e') + (Symbol('f') * x)))))**(Symbol('m')) * (((Integer(2))**(Integer(-1)) * Symbol('c') * ((Symbol('a') * ((Symbol('a') * Symbol('A')) + (Integer(-1) * (Symbol('b') * Symbol('B'))))) + (Integer(2) * Symbol('b') * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * ((Integer(2))**(Integer(-1)) + Symbol('m'))))) + (Integer(-1) * ((Integer(2))**(Integer(-1)) * Symbol('a') * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * Symbol('c') * sympy.cos((Symbol('e') + (Symbol('f') * x))))) + (Integer(-1) * ((Integer(2))**(Integer(-1)) * Symbol('b') * ((Symbol('A') * Symbol('b')) + (Integer(-1) * (Symbol('a') * Symbol('B')))) * Symbol('c') * (Integer(3) + (Integer(2) * Symbol('m'))) * (sympy.cos((Symbol('e') + (Symbol('f') * x))))**(Integer(2)))))) * (sympy.sqrt((Symbol('a') + (Symbol('b') * sympy.cos((Symbol('e') + (Symbol('f') * x)))))))**(Integer(-1))), x)) * ((Symbol('a') * ((Symbol('a'))**(Integer(2)) + (Integer(-1) * (Symbol('b'))**(Integer(2)))) * Symbol('c')))**(Integer(-1)))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)*sec(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=9,
        integral=2*A*a*sin(c + d*x)*sec(c + d*x)**(sympy.S(5)/2)/(5*d) + 2*a*(A + B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(3*d) + 2*a*(A + B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*d) + 2*a*(3*A + 5*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(5*d) - 2*a*(3*A + 5*B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(5*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)*sec(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=8,
        integral=2*A*a*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(3*d) + 2*a*(A + B)*sin(c + d*x)*sqrt(sec(c + d*x))/d - 2*a*(A + B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/d + 2*a*(A + 3*B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)*sec(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=7,
        integral=2*A*a*sin(c + d*x)*sqrt(sec(c + d*x))/d - 2*a*(A - B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/d + 2*a*(A + B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)*sqrt(sec(c + d*x)),
        variable=x,
        num_steps=7,
        integral=2*B*a*sin(c + d*x)/(3*d*sqrt(sec(c + d*x))) + 2*a*(A + B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/d + 2*a*(3*A + B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)/sqrt(sec(c + d*x)),
        variable=x,
        num_steps=8,
        integral=2*B*a*sin(c + d*x)/(5*d*sec(c + d*x)**(sympy.S(3)/2)) + 2*a*(A + B)*sin(c + d*x)/(3*d*sqrt(sec(c + d*x))) + 2*a*(A + B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*d) + 2*a*(5*A + 3*B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(5*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)/sec(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=9,
        integral=2*B*a*sin(c + d*x)/(7*d*sec(c + d*x)**(sympy.S(5)/2)) + 2*a*(A + B)*sin(c + d*x)/(5*d*sec(c + d*x)**(sympy.S(3)/2)) + 6*a*(A + B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(5*d) + 2*a*(7*A + 5*B)*sin(c + d*x)/(21*d*sqrt(sec(c + d*x))) + 2*a*(7*A + 5*B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(21*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2*sec(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=9,
        integral=2*A*(a**2*sec(c + d*x) + a**2)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(5*d) + 4*a**2*(A + 2*B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*d) + 4*a**2*(4*A + 5*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(5*d) - 4*a**2*(4*A + 5*B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(5*d) + 2*a**2*(7*A + 5*B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(15*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2*sec(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=8,
        integral=-4*A*a**2*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/d + 2*A*(a**2*sec(c + d*x) + a**2)*sin(c + d*x)*sqrt(sec(c + d*x))/(3*d) + 4*a**2*(2*A + 3*B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*d) + 2*a**2*(5*A + 3*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2*sec(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=8,
        integral=4*B*a**2*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/d + 2*B*(a**2*sec(c + d*x) + a**2)*sin(c + d*x)/(3*d*sqrt(sec(c + d*x))) + 2*a**2*(3*A - B)*sin(c + d*x)*sqrt(sec(c + d*x))/(3*d) + 4*a**2*(3*A + 2*B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2*sqrt(sec(c + d*x)),
        variable=x,
        num_steps=8,
        integral=2*B*(a**2*sec(c + d*x) + a**2)*sin(c + d*x)/(5*d*sec(c + d*x)**(sympy.S(3)/2)) + 4*a**2*(2*A + B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*d) + 4*a**2*(5*A + 4*B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(5*d) + 2*a**2*(5*A + 7*B)*sin(c + d*x)/(15*d*sqrt(sec(c + d*x))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**2/sqrt(sec(c + d*x)),
        variable=x,
        num_steps=9,
        integral=2*B*(a**2*sec(c + d*x) + a**2)*sin(c + d*x)/(7*d*sec(c + d*x)**(sympy.S(5)/2)) + 4*a**2*(4*A + 3*B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(5*d) + 4*a**2*(7*A + 6*B)*sin(c + d*x)/(21*d*sqrt(sec(c + d*x))) + 4*a**2*(7*A + 6*B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(21*d) + 2*a**2*(7*A + 9*B)*sin(c + d*x)/(35*d*sec(c + d*x)**(sympy.S(3)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3*sec(c + d*x)**(sympy.S(9)/2),
        variable=x,
        num_steps=10,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3*sec(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=9,
        integral=2*A*a*(a*sec(c + d*x) + a)**2*sin(c + d*x)*sqrt(sec(c + d*x))/(5*d) + 4*a**3*(3*A + 5*B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*d) - 4*a**3*(9*A + 5*B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(5*d) + 4*a**3*(21*A + 20*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(15*d) + (18*A + 10*B)*(a**3*sec(c + d*x) + a**3)*sin(c + d*x)*sqrt(sec(c + d*x))/(15*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3*sec(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=9,
        integral=2*B*a*(a*sec(c + d*x) + a)**2*sin(c + d*x)/(3*d*sqrt(sec(c + d*x))) - 4*a**3*(A - B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/d + 20*a**3*(A + B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*d) + 4*a**3*(4*A + B)*sin(c + d*x)*sqrt(sec(c + d*x))/(3*d) + (2*A - 2*B)*(a**3*sec(c + d*x) + a**3)*sin(c + d*x)*sqrt(sec(c + d*x))/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3*sec(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**3*sqrt(sec(c + d*x)),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(5)/2)/(a*cos(c + d*x) + a),
        variable=x,
        num_steps=9,
        integral=-(A - B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(5)/2)/(d*(a*sec(c + d*x) + a)) - (3*A - 3*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(a*d) + (3*A - 3*B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(a*d) + (5*A - 3*B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(3*a*d) + (5*A - 3*B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*a*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(3)/2)/(a*cos(c + d*x) + a),
        variable=x,
        num_steps=8,
        integral=-(A - B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(d*(a*sec(c + d*x) + a)) - (A - B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(a*d) + (3*A - B)*sin(c + d*x)*sqrt(sec(c + d*x))/(a*d) - (3*A - B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(a*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(sec(c + d*x))/(a*cos(c + d*x) + a),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=7,
        integral=(A - B)*sin(c + d*x)*sqrt(sec(c + d*x))/(d*(a*sec(c + d*x) + a)) - (A - 3*B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(a*d) + (A - B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(a*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)*sec(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=8,
        integral=(A - B)*sin(c + d*x)/(d*(a*sec(c + d*x) + a)*sqrt(sec(c + d*x))) - (3*A - 5*B)*sin(c + d*x)/(3*a*d*sqrt(sec(c + d*x))) - (3*A - 5*B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*a*d) + (3*A - 3*B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(a*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)*sec(c + d*x)**(sympy.S(5)/2)),
        variable=x,
        num_steps=9,
        integral=(A - B)*sin(c + d*x)/(d*(a*sec(c + d*x) + a)*sec(c + d*x)**(sympy.S(3)/2)) - (5*A - 7*B)*sin(c + d*x)/(5*a*d*sec(c + d*x)**(sympy.S(3)/2)) + (5*A - 5*B)*sin(c + d*x)/(3*a*d*sqrt(sec(c + d*x))) + (5*A - 5*B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*a*d) - (15*A - 21*B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(5*a*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(3)/2)/(a*cos(c + d*x) + a)**2,
        variable=x,
        num_steps=9,
        integral=-(A - B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(5)/2)/(3*d*(a*sec(c + d*x) + a)**2) + (4*A - B)*sin(c + d*x)*sqrt(sec(c + d*x))/(a**2*d) - (4*A - B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(a**2*d) - (5*A - 2*B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*a**2*d) - (5*A - 2*B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(3*a**2*d*(sec(c + d*x) + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(sec(c + d*x))/(a*cos(c + d*x) + a)**2,
        variable=x,
        num_steps=8,
        integral=A*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(a**2*d) - A*sin(c + d*x)*sqrt(sec(c + d*x))/(a**2*d*(sec(c + d*x) + 1)) - (A - B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(3*d*(a*sec(c + d*x) + a)**2) + (2*A + B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*a**2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**2*sqrt(sec(c + d*x))),
        variable=x,
        num_steps=8,
        integral=-B*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(a**2*d) - (A - B)*sin(c + d*x)*sqrt(sec(c + d*x))/(3*d*(a*sec(c + d*x) + a)**2) + (A + 2*B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*a**2*d) + (A + 2*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(3*a**2*d*(sec(c + d*x) + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**2*sec(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=8,
        integral=(A - B)*sin(c + d*x)*sqrt(sec(c + d*x))/(3*d*(a*sec(c + d*x) + a)**2) - (A - 4*B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(a**2*d) + (2*A - 5*B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*a**2*d) + (2*A - 5*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(3*a**2*d*(sec(c + d*x) + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**2*sec(c + d*x)**(sympy.S(5)/2)),
        variable=x,
        num_steps=9,
        integral=(A - B)*sin(c + d*x)/(3*d*(a*sec(c + d*x) + a)**2*sqrt(sec(c + d*x))) + (4*A - 7*B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(a**2*d) + (4*A - 7*B)*sin(c + d*x)/(3*a**2*d*(sec(c + d*x) + 1)*sqrt(sec(c + d*x))) - (5*A - 10*B)*sin(c + d*x)/(3*a**2*d*sqrt(sec(c + d*x))) - (5*A - 10*B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*a**2*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(3)/2)/(a*cos(c + d*x) + a)**3,
        variable=x,
        num_steps=10,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(sec(c + d*x))/(a*cos(c + d*x) + a)**3,
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        ...
        variable=x,
        num_steps=9,
        integral=-(A - B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(5*d*(a*sec(c + d*x) + a)**3) + (A + B)*sin(c + d*x)*sqrt(sec(c + d*x))/(6*d*(a**3*sec(c + d*x) + a**3)) - (4*A + B)*sin(c + d*x)*sqrt(sec(c + d*x))/(15*a*d*(a*sec(c + d*x) + a)**2) + (A - B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(10*a**3*d) + (A + B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(6*a**3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**3*sec(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=9,
        integral=-(A - B)*sin(c + d*x)*sqrt(sec(c + d*x))/(5*d*(a*sec(c + d*x) + a)**3) + (A + 3*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(6*d*(a**3*sec(c + d*x) + a**3)) + (2*A + 3*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(15*a*d*(a*sec(c + d*x) + a)**2) + (A + 3*B)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(6*a**3*d) - (A + 9*B)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(10*a**3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**3*sec(c + d*x)**(sympy.S(5)/2)),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)*sec(c + d*x)**(sympy.S(11)/2),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)*sec(c + d*x)**(sympy.S(9)/2),
        variable=x,
        num_steps=5,
        integral=2*A*a*sin(c + d*x)*sec(c + d*x)**(sympy.S(7)/2)/(7*d*sqrt(a*cos(c + d*x) + a)) + 2*a*(6*A + 7*B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(5)/2)/(35*d*sqrt(a*cos(c + d*x) + a)) + 8*a*(6*A + 7*B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(105*d*sqrt(a*cos(c + d*x) + a)) + 16*a*(6*A + 7*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(105*d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)*sec(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=4,
        integral=2*A*a*sin(c + d*x)*sec(c + d*x)**(sympy.S(5)/2)/(5*d*sqrt(a*cos(c + d*x) + a)) + 2*a*(4*A + 5*B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(15*d*sqrt(a*cos(c + d*x) + a)) + 4*a*(4*A + 5*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(15*d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)*sec(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=3,
        integral=2*A*a*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(3*d*sqrt(a*cos(c + d*x) + a)) + 2*a*(2*A + 3*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(3*d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)*sec(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=4,
        integral=2*A*a*sin(c + d*x)*sqrt(sec(c + d*x))/(d*sqrt(a*cos(c + d*x) + a)) + 2*B*sqrt(a)*sqrt(cos(c + d*x))*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))*sqrt(sec(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)*sqrt(sec(c + d*x)),
        variable=x,
        num_steps=4,
        integral=B*a*sin(c + d*x)/(d*sqrt(a*cos(c + d*x) + a)*sqrt(sec(c + d*x))) + sqrt(a)*(2*A + B)*sqrt(cos(c + d*x))*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))*sqrt(sec(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)/sqrt(sec(c + d*x)),
        variable=x,
        num_steps=5,
        integral=B*a*sin(c + d*x)/(2*d*sqrt(a*cos(c + d*x) + a)*sec(c + d*x)**(sympy.S(3)/2)) + sqrt(a)*(4*A + 3*B)*sqrt(cos(c + d*x))*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))*sqrt(sec(c + d*x))/(4*d) + a*(4*A + 3*B)*sin(c + d*x)/(4*d*sqrt(a*cos(c + d*x) + a)*sqrt(sec(c + d*x))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a*cos(c + d*x) + a)/sec(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=6,
        integral=B*a*sin(c + d*x)/(3*d*sqrt(a*cos(c + d*x) + a)*sec(c + d*x)**(sympy.S(5)/2)) + sqrt(a)*(6*A + 5*B)*sqrt(cos(c + d*x))*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))*sqrt(sec(c + d*x))/(8*d) + a*(6*A + 5*B)*sin(c + d*x)/(8*d*sqrt(a*cos(c + d*x) + a)*sqrt(sec(c + d*x))) + a*(6*A + 5*B)*sin(c + d*x)/(12*d*sqrt(a*cos(c + d*x) + a)*sec(c + d*x)**(sympy.S(3)/2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sec(c + d*x)**(sympy.S(13)/2),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sec(c + d*x)**(sympy.S(11)/2),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sec(c + d*x)**(sympy.S(9)/2),
        variable=x,
        num_steps=5,
        integral=2*A*a*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)*sec(c + d*x)**(sympy.S(7)/2)/(7*d) + 2*a**2*(8*A + 7*B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(5)/2)/(35*d*sqrt(a*cos(c + d*x) + a)) + 2*a**2*(52*A + 63*B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(105*d*sqrt(a*cos(c + d*x) + a)) + 4*a**2*(52*A + 63*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(105*d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sec(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=4,
        integral=2*A*a*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)*sec(c + d*x)**(sympy.S(5)/2)/(5*d) + 2*a**2*(6*A + 5*B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(15*d*sqrt(a*cos(c + d*x) + a)) + 2*a**2*(18*A + 25*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(15*d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sec(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=5,
        integral=2*A*a*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(3*d) + 2*B*a**(sympy.S(3)/2)*sqrt(cos(c + d*x))*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))*sqrt(sec(c + d*x))/d + 2*a**2*(4*A + 3*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(3*d*sqrt(a*cos(c + d*x) + a)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sec(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=5,
        integral=2*A*a*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)*sqrt(sec(c + d*x))/d + a**(sympy.S(3)/2)*(2*A + 3*B)*sqrt(cos(c + d*x))*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))*sqrt(sec(c + d*x))/d - a**2*(2*A - B)*sin(c + d*x)/(d*sqrt(a*cos(c + d*x) + a)*sqrt(sec(c + d*x))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sqrt(sec(c + d*x)),
        variable=x,
        num_steps=5,
        integral=B*a*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(2*d*sqrt(sec(c + d*x))) + a**(sympy.S(3)/2)*(12*A + 7*B)*sqrt(cos(c + d*x))*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))*sqrt(sec(c + d*x))/(4*d) + a**2*(4*A + 5*B)*sin(c + d*x)/(4*d*sqrt(a*cos(c + d*x) + a)*sqrt(sec(c + d*x))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)/sqrt(sec(c + d*x)),
        variable=x,
        num_steps=6,
        integral=B*a*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(3*d*sec(c + d*x)**(sympy.S(3)/2)) + a**(sympy.S(3)/2)*(14*A + 11*B)*sqrt(cos(c + d*x))*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))*sqrt(sec(c + d*x))/(8*d) + a**2*(6*A + 7*B)*sin(c + d*x)/(12*d*sqrt(a*cos(c + d*x) + a)*sec(c + d*x)**(sympy.S(3)/2)) + a**2*(14*A + 11*B)*sin(c + d*x)/(8*d*sqrt(a*cos(c + d*x) + a)*sqrt(sec(c + d*x))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(3)/2)/sec(c + d*x)**(sympy.S(3)/2),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sec(c + d*x)**(sympy.S(15)/2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sec(c + d*x)**(sympy.S(13)/2),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sec(c + d*x)**(sympy.S(11)/2),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sec(c + d*x)**(sympy.S(9)/2),
        variable=x,
        num_steps=5,
        integral=2*A*a*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)*sec(c + d*x)**(sympy.S(7)/2)/(7*d) + 2*a**3*(10*A + 11*B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(15*d*sqrt(a*cos(c + d*x) + a)) + 2*a**3*(230*A + 301*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(105*d*sqrt(a*cos(c + d*x) + a)) + 2*a**2*(10*A + 7*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)*sec(c + d*x)**(sympy.S(5)/2)/(35*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sec(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=6,
        integral=2*A*a*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)*sec(c + d*x)**(sympy.S(5)/2)/(5*d) + 2*B*a**(sympy.S(5)/2)*sqrt(cos(c + d*x))*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))*sqrt(sec(c + d*x))/d + 2*a**3*(32*A + 35*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(15*d*sqrt(a*cos(c + d*x) + a)) + 2*a**2*(8*A + 5*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(15*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sec(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=6,
        integral=2*A*a*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(3*d) + a**(sympy.S(5)/2)*(2*A + 5*B)*sqrt(cos(c + d*x))*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))*sqrt(sec(c + d*x))/d - a**3*(14*A + 3*B)*sin(c + d*x)/(3*d*sqrt(a*cos(c + d*x) + a)*sqrt(sec(c + d*x))) + 2*a**2*(2*A + B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)*sqrt(sec(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sec(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=6,
        integral=2*A*a*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)*sqrt(sec(c + d*x))/d + a**(sympy.S(5)/2)*(20*A + 19*B)*sqrt(cos(c + d*x))*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))*sqrt(sec(c + d*x))/(4*d) - a**3*(4*A - 9*B)*sin(c + d*x)/(4*d*sqrt(a*cos(c + d*x) + a)*sqrt(sec(c + d*x))) - a**2*(4*A - B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(2*d*sqrt(sec(c + d*x))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sqrt(sec(c + d*x)),
        variable=x,
        num_steps=6,
        integral=B*a*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sin(c + d*x)/(3*d*sqrt(sec(c + d*x))) + a**(sympy.S(5)/2)*(38*A + 25*B)*sqrt(cos(c + d*x))*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))*sqrt(sec(c + d*x))/(8*d) + a**3*(54*A + 49*B)*sin(c + d*x)/(24*d*sqrt(a*cos(c + d*x) + a)*sqrt(sec(c + d*x))) + a**2*(2*A + 3*B)*sqrt(a*cos(c + d*x) + a)*sin(c + d*x)/(4*d*sqrt(sec(c + d*x))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a*cos(c + d*x) + a)**(sympy.S(5)/2)/sqrt(sec(c + d*x)),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(11)/2)/sqrt(a*cos(c + d*x) + a),
        variable=x,
        num_steps=9,
        integral=2*A*sin(c + d*x)*sec(c + d*x)**(sympy.S(9)/2)/(9*d*sqrt(a*cos(c + d*x) + a)) - (2*A - 18*B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(7)/2)/(63*d*sqrt(a*cos(c + d*x) + a)) + (38*A - 6*B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(5)/2)/(105*d*sqrt(a*cos(c + d*x) + a)) - (58*A - 186*B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(315*d*sqrt(a*cos(c + d*x) + a)) + (514*A - 258*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(315*d*sqrt(a*cos(c + d*x) + a)) - sqrt(2)*(A - B)*sqrt(cos(c + d*x))*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))*sqrt(sec(c + d*x))/(sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(9)/2)/sqrt(a*cos(c + d*x) + a),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(7)/2)/sqrt(a*cos(c + d*x) + a),
        variable=x,
        num_steps=7,
        integral=2*A*sin(c + d*x)*sec(c + d*x)**(sympy.S(5)/2)/(5*d*sqrt(a*cos(c + d*x) + a)) - (2*A - 10*B)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(15*d*sqrt(a*cos(c + d*x) + a)) + (26*A - 10*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(15*d*sqrt(a*cos(c + d*x) + a)) - sqrt(2)*(A - B)*sqrt(cos(c + d*x))*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))*sqrt(sec(c + d*x))/(sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(5)/2)/sqrt(a*cos(c + d*x) + a),
        variable=x,
        num_steps=6,
        integral=2*A*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(3*d*sqrt(a*cos(c + d*x) + a)) - (2*A - 6*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(3*d*sqrt(a*cos(c + d*x) + a)) + sqrt(2)*(A - B)*sqrt(cos(c + d*x))*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))*sqrt(sec(c + d*x))/(sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(3)/2)/sqrt(a*cos(c + d*x) + a),
        variable=x,
        num_steps=5,
        integral=2*A*sin(c + d*x)*sqrt(sec(c + d*x))/(d*sqrt(a*cos(c + d*x) + a)) - sqrt(2)*(A - B)*sqrt(cos(c + d*x))*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))*sqrt(sec(c + d*x))/(sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(sec(c + d*x))/sqrt(a*cos(c + d*x) + a),
        variable=x,
        num_steps=6,
        integral=2*B*sqrt(cos(c + d*x))*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))*sqrt(sec(c + d*x))/(sqrt(a)*d) + sqrt(2)*(A - B)*sqrt(cos(c + d*x))*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))*sqrt(sec(c + d*x))/(sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/(sqrt(a*cos(c + d*x) + a)*sqrt(sec(c + d*x))),
        variable=x,
        num_steps=7,
        integral=B*sin(c + d*x)/(d*sqrt(a*cos(c + d*x) + a)*sqrt(sec(c + d*x))) - sqrt(2)*(A - B)*sqrt(cos(c + d*x))*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))*sqrt(sec(c + d*x))/(sqrt(a)*d) + (2*A - B)*sqrt(cos(c + d*x))*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))*sqrt(sec(c + d*x))/(sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/(sqrt(a*cos(c + d*x) + a)*sec(c + d*x)**(sympy.S(3)/2)),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=(A*a + B*b*cos(c + d*x)**2 + (A*b + B*a)*cos(c + d*x))*sqrt(sec(c + d*x))/sqrt(a*cos(c + d*x) + a),
        variable=x,
        num_steps=7,
        integral=B*b*sin(c + d*x)/(d*sqrt(a*cos(c + d*x) + a)*sqrt(sec(c + d*x))) + sqrt(2)*(A - B)*(a - b)*sqrt(cos(c + d*x))*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))*sqrt(sec(c + d*x))/(sqrt(a)*d) + (2*A*b + 2*B*a - B*b)*sqrt(cos(c + d*x))*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))*sqrt(sec(c + d*x))/(sqrt(a)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(9)/2)/(a*cos(c + d*x) + a)**(sympy.S(3)/2),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(7)/2)/(a*cos(c + d*x) + a)**(sympy.S(3)/2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(5)/2)/(a*cos(c + d*x) + a)**(sympy.S(3)/2),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(3)/2)/(a*cos(c + d*x) + a)**(sympy.S(3)/2),
        variable=x,
        num_steps=6,
        integral=-(A - B)*sin(c + d*x)*sqrt(sec(c + d*x))/(2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) + (5*A - B)*sin(c + d*x)*sqrt(sec(c + d*x))/(2*a*d*sqrt(a*cos(c + d*x) + a)) - sqrt(2)*(7*A - 3*B)*sqrt(cos(c + d*x))*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))*sqrt(sec(c + d*x))/(4*a**(sympy.S(3)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(sec(c + d*x))/(a*cos(c + d*x) + a)**(sympy.S(3)/2),
        variable=x,
        num_steps=5,
        integral=-(A - B)*sin(c + d*x)/(2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sqrt(sec(c + d*x))) + sqrt(2)*(3*A + B)*sqrt(cos(c + d*x))*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))*sqrt(sec(c + d*x))/(4*a**(sympy.S(3)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**(sympy.S(3)/2)*sqrt(sec(c + d*x))),
        variable=x,
        num_steps=7,
        integral=2*B*sqrt(cos(c + d*x))*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))*sqrt(sec(c + d*x))/(a**(sympy.S(3)/2)*d) + (A - B)*sin(c + d*x)/(2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sqrt(sec(c + d*x))) + sqrt(2)*(A - 5*B)*sqrt(cos(c + d*x))*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))*sqrt(sec(c + d*x))/(4*a**(sympy.S(3)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**(sympy.S(3)/2)*sec(c + d*x)**(sympy.S(3)/2)),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(7)/2)/(a*cos(c + d*x) + a)**(sympy.S(5)/2),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(5)/2)/(a*cos(c + d*x) + a)**(sympy.S(5)/2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(3)/2)/(a*cos(c + d*x) + a)**(sympy.S(5)/2),
        variable=x,
        num_steps=7,
        integral=-(A - B)*sin(c + d*x)*sqrt(sec(c + d*x))/(4*d*(a*cos(c + d*x) + a)**(sympy.S(5)/2)) - (13*A - 5*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(16*a*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)) + (49*A - 9*B)*sin(c + d*x)*sqrt(sec(c + d*x))/(16*a**2*d*sqrt(a*cos(c + d*x) + a)) - sqrt(2)*(75*A - 19*B)*sqrt(cos(c + d*x))*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))*sqrt(sec(c + d*x))/(32*a**(sympy.S(5)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(sec(c + d*x))/(a*cos(c + d*x) + a)**(sympy.S(5)/2),
        variable=x,
        num_steps=6,
        integral=-(A - B)*sin(c + d*x)/(4*d*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sqrt(sec(c + d*x))) - (9*A - B)*sin(c + d*x)/(16*a*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sqrt(sec(c + d*x))) + sqrt(2)*(19*A + 5*B)*sqrt(cos(c + d*x))*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))*sqrt(sec(c + d*x))/(32*a**(sympy.S(5)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**(sympy.S(5)/2)*sqrt(sec(c + d*x))),
        variable=x,
        num_steps=6,
        integral=(A - B)*sin(c + d*x)/(4*d*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sqrt(sec(c + d*x))) + (A + 7*B)*sin(c + d*x)/(16*a*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sqrt(sec(c + d*x))) + sqrt(2)*(5*A + 3*B)*sqrt(cos(c + d*x))*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))*sqrt(sec(c + d*x))/(32*a**(sympy.S(5)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**(sympy.S(5)/2)*sec(c + d*x)**(sympy.S(3)/2)),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(5)/2)/(a*cos(c + d*x) + a)**(sympy.S(7)/2),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(3)/2)/(a*cos(c + d*x) + a)**(sympy.S(7)/2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(sec(c + d*x))/(a*cos(c + d*x) + a)**(sympy.S(7)/2),
        variable=x,
        num_steps=7,
        integral=-(A - B)*sin(c + d*x)/(6*d*(a*cos(c + d*x) + a)**(sympy.S(7)/2)*sqrt(sec(c + d*x))) - (5*A - B)*sin(c + d*x)/(16*a*d*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sqrt(sec(c + d*x))) - (103*A + 5*B)*sin(c + d*x)/(192*a**2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sqrt(sec(c + d*x))) + sqrt(2)*(63*A + 13*B)*sqrt(cos(c + d*x))*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))*sqrt(sec(c + d*x))/(128*a**(sympy.S(7)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**(sympy.S(7)/2)*sqrt(sec(c + d*x))),
        variable=x,
        num_steps=7,
        integral=(A - B)*sin(c + d*x)/(6*d*(a*cos(c + d*x) + a)**(sympy.S(7)/2)*sqrt(sec(c + d*x))) + (A + 3*B)*sin(c + d*x)/(16*a*d*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sqrt(sec(c + d*x))) - (5*A - 17*B)*sin(c + d*x)/(192*a**2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sqrt(sec(c + d*x))) + sqrt(2)*(13*A + 7*B)*sqrt(cos(c + d*x))*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))*sqrt(sec(c + d*x))/(128*a**(sympy.S(7)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**(sympy.S(7)/2)*sec(c + d*x)**(sympy.S(3)/2)),
        variable=x,
        num_steps=7,
        integral=(A - B)*sin(c + d*x)/(6*d*(a*cos(c + d*x) + a)**(sympy.S(7)/2)*sec(c + d*x)**(sympy.S(3)/2)) + (A - 13*B)*sin(c + d*x)/(48*a*d*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sqrt(sec(c + d*x))) + (17*A + 67*B)*sin(c + d*x)/(192*a**2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sqrt(sec(c + d*x))) + sqrt(2)*(7*A + 5*B)*sqrt(cos(c + d*x))*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))*sqrt(sec(c + d*x))/(128*a**(sympy.S(7)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**(sympy.S(7)/2)*sec(c + d*x)**(sympy.S(5)/2)),
        variable=x,
        num_steps=9,
        integral=2*B*sqrt(cos(c + d*x))*asin(sqrt(a)*sin(c + d*x)/sqrt(a*cos(c + d*x) + a))*sqrt(sec(c + d*x))/(a**(sympy.S(7)/2)*d) + (A - B)*sin(c + d*x)/(6*d*(a*cos(c + d*x) + a)**(sympy.S(7)/2)*sec(c + d*x)**(sympy.S(5)/2)) + (5*A - 17*B)*sin(c + d*x)/(48*a*d*(a*cos(c + d*x) + a)**(sympy.S(5)/2)*sec(c + d*x)**(sympy.S(3)/2)) + (5*A - 49*B)*sin(c + d*x)/(64*a**2*d*(a*cos(c + d*x) + a)**(sympy.S(3)/2)*sqrt(sec(c + d*x))) + sqrt(2)*(5*A - 177*B)*sqrt(cos(c + d*x))*atan(sqrt(2)*sqrt(a)*sin(c + d*x)/(2*sqrt(a*cos(c + d*x) + a)*sqrt(cos(c + d*x))))*sqrt(sec(c + d*x))/(128*a**(sympy.S(7)/2)*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))/((a*cos(c + d*x) + a)**(sympy.S(7)/2)*sec(c + d*x)**(sympy.S(7)/2)),
        variable=x,
        num_steps=10,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))*sec(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=9,
        integral=2*A*a*sin(c + d*x)*sec(c + d*x)**(sympy.S(5)/2)/(5*d) + (6*A*a + 10*B*b)*sin(c + d*x)*sqrt(sec(c + d*x))/(5*d) - (6*A*a + 10*B*b)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(5*d) + (2*A*b + 2*B*a)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(3*d) + (2*A*b + 2*B*a)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))*sec(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=8,
        integral=2*A*a*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(3*d) + (2*A*a + 6*B*b)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*d) + (-2*A*b - 2*B*a)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/d + (2*A*b + 2*B*a)*sin(c + d*x)*sqrt(sec(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))*sec(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=7,
        integral=2*A*a*sin(c + d*x)*sqrt(sec(c + d*x))/d + (-2*A*a + 2*B*b)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/d + (2*A*b + 2*B*a)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))*sqrt(sec(c + d*x)),
        variable=x,
        num_steps=7,
        integral=2*B*b*sin(c + d*x)/(3*d*sqrt(sec(c + d*x))) + (6*A*a + 2*B*b)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*d) + (2*A*b + 2*B*a)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))/sqrt(sec(c + d*x)),
        variable=x,
        num_steps=8,
        integral=2*B*b*sin(c + d*x)/(5*d*sec(c + d*x)**(sympy.S(3)/2)) + (10*A*a + 6*B*b)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(5*d) + (2*A*b + 2*B*a)*sin(c + d*x)/(3*d*sqrt(sec(c + d*x))) + (2*A*b + 2*B*a)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))/sec(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=9,
        integral=2*B*b*sin(c + d*x)/(7*d*sec(c + d*x)**(sympy.S(5)/2)) + (14*A*a + 10*B*b)*sin(c + d*x)/(21*d*sqrt(sec(c + d*x))) + (14*A*a + 10*B*b)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(21*d) + (2*A*b + 2*B*a)*sin(c + d*x)/(5*d*sec(c + d*x)**(sympy.S(3)/2)) + (6*A*b + 6*B*a)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(5*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**2*sec(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**2*sec(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=8,
        integral=2*A*a*(a*sec(c + d*x) + b)*sin(c + d*x)*sqrt(sec(c + d*x))/(3*d) + 2*a*(5*A*b + 3*B*a)*sin(c + d*x)*sqrt(sec(c + d*x))/(3*d) + (2*A*a**2 + 6*A*b**2 + 12*B*a*b)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*d) - (4*A*a*b + 2*B*a**2 - 2*B*b**2)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**2*sec(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=8,
        integral=2*A*a**2*sin(c + d*x)*sqrt(sec(c + d*x))/d + 2*B*b**2*sin(c + d*x)/(3*d*sqrt(sec(c + d*x))) - (2*A*a**2 - 2*b*(A*b + 2*B*a))*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/d + (12*A*a*b + 6*B*a**2 + 2*B*b**2)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**2*sqrt(sec(c + d*x)),
        variable=x,
        num_steps=8,
        integral=2*B*b**2*sin(c + d*x)/(5*d*sec(c + d*x)**(sympy.S(3)/2)) + 2*b*(A*b + 2*B*a)*sin(c + d*x)/(3*d*sqrt(sec(c + d*x))) + (6*A*a**2 + 2*A*b**2 + 4*B*a*b)*sqrt(cos(c + d*x))*elliptic_f(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(3*d) + (20*A*a*b + 10*B*a**2 + 6*B*b**2)*sqrt(cos(c + d*x))*elliptic_e(c/2 + d*x/2, 2)*sqrt(sec(c + d*x))/(5*d),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**2/sqrt(sec(c + d*x)),
        variable=x,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**3*sec(c + d*x)**(sympy.S(9)/2),
        variable=x,
        num_steps=10,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**3*sec(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**3*sqrt(sec(c + d*x)),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a + b*cos(c + d*x))*sec(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a + b*cos(c + d*x))*sec(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=5,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a + b*cos(c + d*x))*sec(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(a + b*cos(c + d*x))*sqrt(sec(c + d*x)),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(3)/2)*sec(c + d*x)**(sympy.S(11)/2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(3)/2)*sec(c + d*x)**(sympy.S(9)/2),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(3)/2)*sec(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=6,
        integral=2*A*a*sqrt(a + b*cos(c + d*x))*sin(c + d*x)*sec(c + d*x)**(sympy.S(5)/2)/(5*d) + sqrt(a + b*cos(c + d*x))*(12*A*b + 10*B*a)*sin(c + d*x)*sec(c + d*x)**(sympy.S(3)/2)/(15*d) - sqrt(a*(1 - sec(c + d*x))/(a + b))*sqrt(a*(sec(c + d*x) + 1)/(a - b))*sqrt(a + b)*(2*a - 2*b)*(9*A*a - 3*A*b - 5*B*a + 15*B*b)*sqrt(cos(c + d*x))*csc(c + d*x)*elliptic_f(asin(sqrt(a + b*cos(c + d*x))/(sqrt(a + b)*sqrt(cos(c + d*x)))), -(a + b)/(a - b))/(15*a*d*sqrt(sec(c + d*x))) + sqrt(a*(1 - sec(c + d*x))/(a + b))*sqrt(a*(sec(c + d*x) + 1)/(a - b))*sqrt(a + b)*(2*a - 2*b)*(9*A*a**2 + 3*A*b**2 + 20*B*a*b)*sqrt(cos(c + d*x))*csc(c + d*x)*elliptic_e(asin(sqrt(a + b*cos(c + d*x))/(sqrt(a + b)*sqrt(cos(c + d*x)))), -(a + b)/(a - b))/(15*a**2*d*sqrt(sec(c + d*x))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(3)/2)*sec(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(3)/2)*sec(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(3)/2)*sqrt(sec(c + d*x)),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(5)/2)*sec(c + d*x)**(sympy.S(13)/2),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(5)/2)*sec(c + d*x)**(sympy.S(11)/2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(5)/2)*sec(c + d*x)**(sympy.S(9)/2),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(5)/2)*sec(c + d*x)**(sympy.S(7)/2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(5)/2)*sec(c + d*x)**(sympy.S(5)/2),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(5)/2)*sec(c + d*x)**(sympy.S(3)/2),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*(a + b*cos(c + d*x))**(sympy.S(5)/2)*sqrt(sec(c + d*x)),
        variable=x,
        num_steps=9,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(7)/2)/sqrt(a + b*cos(c + d*x)),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(5)/2)/(a + b*cos(c + d*x))**(sympy.S(3)/2),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(3)/2)/(a + b*cos(c + d*x))**(sympy.S(3)/2),
        variable=x,
        num_steps=5,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(sec(c + d*x))/(a + b*cos(c + d*x))**(sympy.S(3)/2),
        variable=x,
        num_steps=5,
    ...
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sec(c + d*x)**(sympy.S(3)/2)/(a + b*cos(c + d*x))**(sympy.S(5)/2),
        variable=x,
        num_steps=6,
        integral=2*b*(A*b - B*a)*sin(c + d*x)*sqrt(sec(c + d*x))/(3*a*d*(a + b*cos(c + d*x))**(sympy.S(3)/2)*(a**2 - b**2)) + 2*b*(8*A*a**2*b - 4*A*b**3 - 5*B*a**3 + B*a*b**2)*sin(c + d*x)*sqrt(sec(c + d*x))/(3*a**2*d*sqrt(a + b*cos(c + d*x))*(a**2 - b**2)**2) + sqrt(a*(1 - sec(c + d*x))/(a + b))*sqrt(a*(sec(c + d*x) + 1)/(a - b))*(16*A*b**3 - 6*a**3*(A - B) - 6*a**2*b*(3*A + B) + 4*a*b**2*(3*A - B))*sqrt(cos(c + d*x))*csc(c + d*x)*elliptic_f(asin(sqrt(a + b*cos(c + d*x))/(sqrt(a + b)*sqrt(cos(c + d*x)))), -(a + b)/(a - b))/(3*a**3*d*sqrt(a + b)*(a**2 - b**2)*sqrt(sec(c + d*x))) + sqrt(a*(1 - sec(c + d*x))/(a + b))*sqrt(a*(sec(c + d*x) + 1)/(a - b))*(6*A*a**4 - 30*A*a**2*b**2 + 16*A*b**4 + 12*B*a**3*b - 4*B*a*b**3)*sqrt(cos(c + d*x))*csc(c + d*x)*elliptic_e(asin(sqrt(a + b*cos(c + d*x))/(sqrt(a + b)*sqrt(cos(c + d*x)))), -(a + b)/(a - b))/(3*a**4*d*(a - b)*(a + b)**(sympy.S(3)/2)*sqrt(sec(c + d*x))),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*cos(c + d*x))*sqrt(sec(c + d*x))/(a + b*cos(c + d*x))**(sympy.S(5)/2),
        variable=x,
        num_steps=6,
