...
SOURCE_FILE = '4 Trig functions/4.3 Tangent/4.3.4.2 (a+b tan)^m (c+d tan)^n (A+B tan+C tan^2).m'
...
TEST_CASES = [
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))*(B*tan(c + d*x) + C*tan(c + d*x)**2)*tan(c + d*x),
        variable=x,
        num_steps=5,
        integral=C*b*tan(c + d*x)**3/(3*d) - x*(B*a - C*b) + (B*a - C*b)*tan(c + d*x)/d + (B*b + C*a)*log(cos(c + d*x))/d + (B*b + C*a)*tan(c + d*x)**2/(2*d),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))*(B*tan(c + d*x) + C*tan(c + d*x)**2),
        variable=x,
        num_steps=3,
        integral=B*b*tan(c + d*x)/d + C*(a + b*tan(c + d*x))**2/(2*b*d) - x*(B*b + C*a) - (B*a - C*b)*log(cos(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))*(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x),
        variable=x,
        num_steps=3,
        integral=C*b*tan(c + d*x)/d + x*(B*a - C*b) - (B*b + C*a)*log(cos(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))*(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**2,
        variable=x,
        num_steps=5,
        integral=B*a*log(sin(c + d*x))/d - C*b*log(cos(c + d*x))/d + x*(B*b + C*a),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))*(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**3,
        variable=x,
        num_steps=4,
        integral=-B*a*cot(c + d*x)/d - x*(B*a - C*b) + (B*b + C*a)*log(sin(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))*(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**4,
        variable=x,
        num_steps=5,
        integral=-B*a*cot(c + d*x)**2/(2*d) - x*(B*b + C*a) - (B*a - C*b)*log(sin(c + d*x))/d - (B*b + C*a)*cot(c + d*x)/d,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))*(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**5,
        variable=x,
        num_steps=6,
        integral=-B*a*cot(c + d*x)**3/(3*d) + x*(B*a - C*b) + (B*a - C*b)*cot(c + d*x)/d - (B*b + C*a)*log(sin(c + d*x))/d - (B*b + C*a)*cot(c + d*x)**2/(2*d),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))*(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**6,
        variable=x,
        num_steps=7,
        integral=-B*a*cot(c + d*x)**4/(4*d) + x*(B*b + C*a) + (B*a - C*b)*log(sin(c + d*x))/d + (B*a - C*b)*cot(c + d*x)**2/(2*d) - (B*b + C*a)*cot(c + d*x)**3/(3*d) + (B*b + C*a)*cot(c + d*x)/d,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))**2*(B*tan(c + d*x) + C*tan(c + d*x)**2)*tan(c + d*x),
        variable=x,
        num_steps=6,
        integral=-C*(a + b*tan(c + d*x))**2/(2*d) + C*(a + b*tan(c + d*x))**3*tan(c + d*x)/(4*b*d) - b*(B*b + C*a)*tan(c + d*x)/d - x*(B*a**2 - B*b**2 - 2*C*a*b) + (2*B*a*b + C*a**2 - C*b**2)*log(cos(c + d*x))/d + (a + b*tan(c + d*x))**3*(4*B*b - C*a)/(12*b**2*d),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))**2*(B*tan(c + d*x) + C*tan(c + d*x)**2),
        variable=x,
        num_steps=4,
        integral=B*(a + b*tan(c + d*x))**2/(2*d) + C*(a + b*tan(c + d*x))**3/(3*b*d) + b*(B*a - C*b)*tan(c + d*x)/d - x*(2*B*a*b + C*a**2 - C*b**2) - (B*a**2 - B*b**2 - 2*C*a*b)*log(cos(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))**2*(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x),
        variable=x,
        num_steps=4,
        integral=C*(a + b*tan(c + d*x))**2/(2*d) + b*(B*b + C*a)*tan(c + d*x)/d + x*(B*a**2 - B*b**2 - 2*C*a*b) - (2*B*a*b + C*a**2 - C*b**2)*log(cos(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))**2*(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**2,
        variable=x,
        num_steps=5,
        integral=B*a**2*log(sin(c + d*x))/d + C*b**2*tan(c + d*x)/d - b*(B*b + 2*C*a)*log(cos(c + d*x))/d + x*(2*B*a*b + C*a**2 - C*b**2),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))**2*(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**3,
        variable=x,
        num_steps=5,
        integral=-B*a**2*cot(c + d*x)/d - C*b**2*log(cos(c + d*x))/d + a*(2*B*b + C*a)*log(sin(c + d*x))/d - x*(B*a**2 - B*b**2 - 2*C*a*b),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))**2*(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**4,
        variable=x,
        num_steps=5,
        integral=-B*a**2*cot(c + d*x)**2/(2*d) - a*(2*B*b + C*a)*cot(c + d*x)/d + x*(C*b**2 - a*(2*B*b + C*a)) - (B*a**2 - B*b**2 - 2*C*a*b)*log(sin(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))**2*(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**5,
        variable=x,
        num_steps=6,
        integral=-B*a**2*cot(c + d*x)**3/(3*d) - a*(2*B*b + C*a)*cot(c + d*x)**2/(2*d) + x*(B*a**2 - B*b**2 - 2*C*a*b) + (C*b**2 - a*(2*B*b + C*a))*log(sin(c + d*x))/d + (B*a**2 - B*b**2 - 2*C*a*b)*cot(c + d*x)/d,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))**2*(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**6,
        variable=x,
        num_steps=7,
        integral=-B*a**2*cot(c + d*x)**4/(4*d) - a*(2*B*b + C*a)*cot(c + d*x)**3/(3*d) + x*(2*B*a*b + C*a**2 - C*b**2) - (C*b**2 - a*(2*B*b + C*a))*cot(c + d*x)/d + (B*a**2 - B*b**2 - 2*C*a*b)*log(sin(c + d*x))/d + (B*a**2 - B*b**2 - 2*C*a*b)*cot(c + d*x)**2/(2*d),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))**3*(B*tan(c + d*x) + C*tan(c + d*x)**2),
        variable=x,
        num_steps=5,
        integral=B*(a + b*tan(c + d*x))**3/(3*d) + C*(a + b*tan(c + d*x))**4/(4*b*d) + b*(B*a**2 - B*b**2 - 2*C*a*b)*tan(c + d*x)/d - x*(3*B*a**2*b - B*b**3 + C*a**3 - 3*C*a*b**2) + (a + b*tan(c + d*x))**2*(B*a - C*b)/(2*d) - (B*a**3 - 3*B*a*b**2 - 3*C*a**2*b + C*b**3)*log(cos(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))**3*(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x),
        variable=x,
        num_steps=5,
        integral=C*(a + b*tan(c + d*x))**3/(3*d) + b*(2*B*a*b + C*a**2 - C*b**2)*tan(c + d*x)/d + x*(B*a**3 - 3*B*a*b**2 - 3*C*a**2*b + C*b**3) + (a + b*tan(c + d*x))**2*(B*b + C*a)/(2*d) - (3*B*a**2*b - B*b**3 + C*a**3 - 3*C*a*b**2)*log(cos(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))**3*(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**2,
        variable=x,
        num_steps=6,
        integral=B*a**3*log(sin(c + d*x))/d + C*b*(a + b*tan(c + d*x))**2/(2*d) + b**2*(B*b + 2*C*a)*tan(c + d*x)/d - b*(3*B*a*b + 3*C*a**2 - C*b**2)*log(cos(c + d*x))/d + x*(3*B*a**2*b - B*b**3 + C*a**3 - 3*C*a*b**2),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))**3*(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**3,
        variable=x,
        num_steps=6,
        integral=-B*a*(a + b*tan(c + d*x))**2*cot(c + d*x)/d + a**2*(3*B*b + C*a)*log(sin(c + d*x))/d + b**2*(B*a + C*b)*tan(c + d*x)/d - b**2*(B*b + 3*C*a)*log(cos(c + d*x))/d - x*(B*a**3 - 3*B*a*b**2 - 3*C*a**2*b + C*b**3),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))**3*(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**4,
        variable=x,
        num_steps=6,
        integral=-B*a*(a + b*tan(c + d*x))**2*cot(c + d*x)**2/(2*d) - C*b**3*log(cos(c + d*x))/d - a**2*(2*B*b + C*a)*cot(c + d*x)/d - a*(B*a**2 - 3*B*b**2 - 3*C*a*b)*log(sin(c + d*x))/d - x*(3*B*a**2*b - B*b**3 + C*a**3 - 3*C*a*b**2),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))**3*(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**5,
        variable=x,
        num_steps=6,
        integral=-B*a*(a + b*tan(c + d*x))**2*cot(c + d*x)**3/(3*d) - a**2*(5*B*b + 3*C*a)*cot(c + d*x)**2/(6*d) + a*(3*B*a**2 - 8*B*b**2 - 9*C*a*b)*cot(c + d*x)/(3*d) + x*(B*a**3 - 3*B*a*b**2 - 3*C*a**2*b + C*b**3) - (3*B*a**2*b - B*b**3 + C*a**3 - 3*C*a*b**2)*log(sin(c + d*x))/d,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))**3*(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**6,
        variable=x,
        num_steps=7,
        integral=-B*a*(a + b*tan(c + d*x))**2*cot(c + d*x)**4/(4*d) - a**2*(3*B*b + 2*C*a)*cot(c + d*x)**3/(6*d) + a*(2*B*a**2 - 5*B*b**2 - 6*C*a*b)*cot(c + d*x)**2/(4*d) + x*(3*B*a**2*b - B*b**3 + C*a**3 - 3*C*a*b**2) + (B*a**3 - 3*B*a*b**2 - 3*C*a**2*b + C*b**3)*log(sin(c + d*x))/d + (3*B*a**2*b - B*b**3 + C*a**3 - 3*C*a*b**2)*cot(c + d*x)/d,
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(c + d*x))**3*(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**7,
        variable=x,
        num_steps=8,
        integral=-B*a*(a + b*tan(c + d*x))**2*cot(c + d*x)**5/(5*d) - a**2*(7*B*b + 5*C*a)*cot(c + d*x)**4/(20*d) + a*(5*B*a**2 - 12*B*b**2 - 15*C*a*b)*cot(c + d*x)**3/(15*d) - x*(B*a**3 - 3*B*a*b**2 - 3*C*a**2*b + C*b**3) - (B*a**3 - 3*B*a*b**2 - 3*C*a**2*b + C*b**3)*cot(c + d*x)/d + (3*B*a**2*b - B*b**3 + C*a**3 - 3*C*a*b**2)*log(sin(c + d*x))/d + (3*B*a**2*b - B*b**3 + C*a**3 - 3*C*a*b**2)*cot(c + d*x)**2/(2*d),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)*tan(c + d*x)**2/(a + b*tan(c + d*x)),
        variable=x,
        num_steps=7,
        integral=C*tan(c + d*x)**2/(2*b*d) - a**3*(B*b - C*a)*log(a + b*tan(c + d*x))/(b**3*d*(a**2 + b**2)) - x*(B*b - C*a)/(a**2 + b**2) + (B*a + C*b)*log(cos(c + d*x))/(d*(a**2 + b**2)) + (B*b - C*a)*tan(c + d*x)/(b**2*d),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)*tan(c + d*x)/(a + b*tan(c + d*x)),
        variable=x,
        num_steps=6,
        integral=C*tan(c + d*x)/(b*d) + a**2*(B*b - C*a)*log(a + b*tan(c + d*x))/(b**2*d*(a**2 + b**2)) - x*(B*a + C*b)/(a**2 + b**2) - (B*b - C*a)*log(cos(c + d*x))/(d*(a**2 + b**2)),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)/(a + b*tan(c + d*x)),
        variable=x,
        num_steps=6,
        integral=-a*(B*b - C*a)*log(a + b*tan(c + d*x))/(b*d*(a**2 + b**2)) + x*(B*b - C*a)/(a**2 + b**2) - (B*a + C*b)*log(cos(c + d*x))/(d*(a**2 + b**2)),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)/(a + b*tan(c + d*x)),
        variable=x,
        num_steps=3,
        integral=x*(B*a + C*b)/(a**2 + b**2) + (B*b - C*a)*log(a*cos(c + d*x) + b*sin(c + d*x))/(d*(a**2 + b**2)),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**2/(a + b*tan(c + d*x)),
        variable=x,
        num_steps=4,
        integral=B*log(sin(c + d*x))/(a*d) - x*(B*b - C*a)/(a**2 + b**2) - b*(B*b - C*a)*log(a*cos(c + d*x) + b*sin(c + d*x))/(a*d*(a**2 + b**2)),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**3/(a + b*tan(c + d*x)),
        variable=x,
        num_steps=5,
        integral=-B*cot(c + d*x)/(a*d) - x*(B*a + C*b)/(a**2 + b**2) + b**2*(B*b - C*a)*log(a*cos(c + d*x) + b*sin(c + d*x))/(a**2*d*(a**2 + b**2)) - (B*b - C*a)*log(sin(c + d*x))/(a**2*d),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**4/(a + b*tan(c + d*x)),
        variable=x,
        num_steps=6,
        integral=-B*cot(c + d*x)**2/(2*a*d) + x*(B*b - C*a)/(a**2 + b**2) + (B*b - C*a)*cot(c + d*x)/(a**2*d) - b**3*(B*b - C*a)*log(a*cos(c + d*x) + b*sin(c + d*x))/(a**3*d*(a**2 + b**2)) - (B*a**2 - B*b**2 + C*a*b)*log(sin(c + d*x))/(a**3*d),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)*tan(c + d*x)**2/(a + b*tan(c + d*x))**2,
        variable=x,
        num_steps=7,
        integral=a**2*(B*a**2*b + 3*B*b**3 - 2*C*a**3 - 4*C*a*b**2)*log(a + b*tan(c + d*x))/(b**3*d*(a**2 + b**2)**2) + a*(B*b - C*a)*tan(c + d*x)**2/(b*d*(a + b*tan(c + d*x))*(a**2 + b**2)) - x*(2*B*a*b - C*a**2 + C*b**2)/(a**2 + b**2)**2 + (B*a**2 - B*b**2 + 2*C*a*b)*log(cos(c + d*x))/(d*(a**2 + b**2)**2) - (B*a*b - 2*C*a**2 - C*b**2)*tan(c + d*x)/(b**2*d*(a**2 + b**2)),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)*tan(c + d*x)/(a + b*tan(c + d*x))**2,
        variable=x,
        num_steps=6,
        integral=-a**2*(B*b - C*a)/(b**2*d*(a + b*tan(c + d*x))*(a**2 + b**2)) - a*(2*B*b**3 - C*a**3 - 3*C*a*b**2)*log(a + b*tan(c + d*x))/(b**2*d*(a**2 + b**2)**2) - x*(B*a**2 - B*b**2 + 2*C*a*b)/(a**2 + b**2)**2 - (2*B*a*b - C*a**2 + C*b**2)*log(cos(c + d*x))/(d*(a**2 + b**2)**2),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)/(a + b*tan(c + d*x))**2,
        variable=x,
        num_steps=3,
        integral=a*(B*b - C*a)/(b*d*(a + b*tan(c + d*x))*(a**2 + b**2)) + x*(2*B*a*b - C*a**2 + C*b**2)/(a**2 + b**2)**2 - (B*a**2 - B*b**2 + 2*C*a*b)*log(a*cos(c + d*x) + b*sin(c + d*x))/(d*(a**2 + b**2)**2),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)/(a + b*tan(c + d*x))**2,
        variable=x,
        num_steps=4,
        integral=x*(B*a**2 - B*b**2 + 2*C*a*b)/(a**2 + b**2)**2 + (2*B*a*b - C*a**2 + C*b**2)*log(a*cos(c + d*x) + b*sin(c + d*x))/(d*(a**2 + b**2)**2) - (B*b - C*a)/(d*(a + b*tan(c + d*x))*(a**2 + b**2)),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**2/(a + b*tan(c + d*x))**2,
        variable=x,
        num_steps=5,
        integral=B*log(sin(c + d*x))/(a**2*d) - x*(2*B*a*b - C*a**2 + C*b**2)/(a**2 + b**2)**2 + b*(B*b - C*a)/(a*d*(a + b*tan(c + d*x))*(a**2 + b**2)) - b*(3*B*a**2*b + B*b**3 - 2*C*a**3)*log(a*cos(c + d*x) + b*sin(c + d*x))/(a**2*d*(a**2 + b**2)**2),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**3/(a + b*tan(c + d*x))**2,
        variable=x,
        num_steps=6,
        integral=-B*cot(c + d*x)/(a*d*(a + b*tan(c + d*x))) - x*(B*a**2 - B*b**2 + 2*C*a*b)/(a**2 + b**2)**2 - b*(B*a**2 + 2*B*b**2 - C*a*b)/(a**2*d*(a + b*tan(c + d*x))*(a**2 + b**2)) + b**2*(4*B*a**2*b + 2*B*b**3 - 3*C*a**3 - C*a*b**2)*log(a*cos(c + d*x) + b*sin(c + d*x))/(a**3*d*(a**2 + b**2)**2) - (2*B*b - C*a)*log(sin(c + d*x))/(a**3*d),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)*tan(c + d*x)**3/(a + b*tan(c + d*x))**3,
        variable=x,
        num_steps=8,
        integral=a**2*(B*a**4*b + 3*B*a**2*b**3 + 6*B*b**5 - 3*C*a**5 - 9*C*a**3*b**2 - 10*C*a*b**4)*log(a + b*tan(c + d*x))/(b**4*d*(a**2 + b**2)**3) + a*(B*b - C*a)*tan(c + d*x)**3/(2*b*d*(a + b*tan(c + d*x))**2*(a**2 + b**2)) + a*(B*a**2*b + 5*B*b**3 - 3*C*a**3 - 7*C*a*b**2)*tan(c + d*x)**2/(2*b**2*d*(a + b*tan(c + d*x))*(a**2 + b**2)**2) + x*(B*a**3 - 3*B*a*b**2 + 3*C*a**2*b - C*b**3)/(a**2 + b**2)**3 + (3*B*a**2*b - B*b**3 - C*a**3 + 3*C*a*b**2)*log(cos(c + d*x))/(d*(a**2 + b**2)**3) - (B*a**3*b + 3*B*a*b**3 - 3*C*a**4 - 6*C*a**2*b**2 - C*b**4)*tan(c + d*x)/(b**3*d*(a**2 + b**2)**2),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)*tan(c + d*x)**2/(a + b*tan(c + d*x))**3,
        variable=x,
        num_steps=7,
        integral=-a**2*(2*B*b**3 - C*a**3 - 3*C*a*b**2)/(b**3*d*(a + b*tan(c + d*x))*(a**2 + b**2)**2) + a*(B*b - C*a)*tan(c + d*x)**2/(2*b*d*(a + b*tan(c + d*x))**2*(a**2 + b**2)) + a*(B*a**2*b**3 - 3*B*b**5 + C*a**5 + 3*C*a**3*b**2 + 6*C*a*b**4)*log(a + b*tan(c + d*x))/(b**3*d*(a**2 + b**2)**3) - x*(3*B*a**2*b - B*b**3 - C*a**3 + 3*C*a*b**2)/(a**2 + b**2)**3 + (B*a**3 - 3*B*a*b**2 + 3*C*a**2*b - C*b**3)*log(cos(c + d*x))/(d*(a**2 + b**2)**3),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)*tan(c + d*x)/(a + b*tan(c + d*x))**3,
        variable=x,
        num_steps=5,
        integral=-a**2*(B*b - C*a)/(2*b**2*d*(a + b*tan(c + d*x))**2*(a**2 + b**2)) + a*(2*B*b**3 - C*a**3 - 3*C*a*b**2)/(b**2*d*(a + b*tan(c + d*x))*(a**2 + b**2)**2) - x*(B*a**3 - 3*B*a*b**2 + 3*C*a**2*b - C*b**3)/(a**2 + b**2)**3 - (3*B*a**2*b - B*b**3 - C*a**3 + 3*C*a*b**2)*log(a*cos(c + d*x) + b*sin(c + d*x))/(d*(a**2 + b**2)**3),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)/(a + b*tan(c + d*x))**3,
        variable=x,
        num_steps=4,
        integral=a*(B*b - C*a)/(2*b*d*(a + b*tan(c + d*x))**2*(a**2 + b**2)) + x*(3*B*a**2*b - B*b**3 - C*a**3 + 3*C*a*b**2)/(a**2 + b**2)**3 - (B*a**3 - 3*B*a*b**2 + 3*C*a**2*b - C*b**3)*log(a*cos(c + d*x) + b*sin(c + d*x))/(d*(a**2 + b**2)**3) + (B*a**2 - B*b**2 + 2*C*a*b)/(d*(a + b*tan(c + d*x))*(a**2 + b**2)**2),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)/(a + b*tan(c + d*x))**3,
        variable=x,
        num_steps=5,
        integral=x*(B*a**3 - 3*B*a*b**2 + 3*C*a**2*b - C*b**3)/(a**2 + b**2)**3 + (3*B*a**2*b - B*b**3 - C*a**3 + 3*C*a*b**2)*log(a*cos(c + d*x) + b*sin(c + d*x))/(d*(a**2 + b**2)**3) - (2*B*a*b - C*a**2 + C*b**2)/(d*(a + b*tan(c + d*x))*(a**2 + b**2)**2) - (B*b - C*a)/(d*(a + b*tan(c + d*x))**2*(2*a**2 + 2*b**2)),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**2/(a + b*tan(c + d*x))**3,
        variable=x,
        num_steps=6,
        integral=B*log(sin(c + d*x))/(a**3*d) - x*(3*B*a**2*b - B*b**3 - C*a**3 + 3*C*a*b**2)/(a**2 + b**2)**3 + b*(B*b - C*a)/(2*a*d*(a + b*tan(c + d*x))**2*(a**2 + b**2)) + b*(3*B*a**2*b + B*b**3 - 2*C*a**3)/(a**2*d*(a + b*tan(c + d*x))*(a**2 + b**2)**2) - b*(6*B*a**4*b + 3*B*a**2*b**3 + B*b**5 - 3*C*a**5 + C*a**3*b**2)*log(a*cos(c + d*x) + b*sin(c + d*x))/(a**3*d*(a**2 + b**2)**3),
    ),
    RubiTestSuiteCase(
        integrand=(B*tan(c + d*x) + C*tan(c + d*x)**2)*cot(c + d*x)**3/(a + b*tan(c + d*x))**3,
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(b*tan(c + d*x))**n*(A + B*tan(c + d*x) + C*tan(c + d*x)**2)*tan(c + d*x)**2,
        variable=x,
        num_steps=7,
        integral=B*(b*tan(c + d*x))**(n + 4)*hyper((1, n/2 + 2), (n/2 + 3,), -tan(c + d*x)**2)/(b**4*d*(n + 4)) + C*(b*tan(c + d*x))**(n + 3)/(b**3*d*(n + 3)) + (b*tan(c + d*x))**(n + 3)*(A - C)*hyper((1, n/2 + sympy.S(3)/2), (n/2 + sympy.S(5)/2,), -tan(c + d*x)**2)/(b**3*d*(n + 3)),
    ),
    RubiTestSuiteCase(
        integrand=(b*tan(c + d*x))**n*(A + B*tan(c + d*x) + C*tan(c + d*x)**2)*tan(c + d*x)**m,
        variable=x,
        num_steps=7,
        integral=B*(b*tan(c + d*x))**n*tan(c + d*x)**(m + 2)*hyper((1, m/2 + n/2 + 1), (m/2 + n/2 + 2,), -tan(c + d*x)**2)/(d*(m + n + 2)) + C*(b*tan(c + d*x))**n*tan(c + d*x)**(m + 1)/(d*(m + n + 1)) + (b*tan(c + d*x))**n*(A - C)*tan(c + d*x)**(m + 1)*hyper((1, m/2 + n/2 + sympy.S.Half), (m/2 + n/2 + sympy.S(3)/2,), -tan(c + d*x)**2)/(d*(m + n + 1)),
    ),
    RubiTestSuiteCase(
        integrand=sqrt(b*tan(c + d*x))*(A + B*tan(c + d*x) + C*tan(c + d*x)**2)*tan(c + d*x)**m,
        variable=x,
        num_steps=7,
        integral=2*B*sqrt(b*tan(c + d*x))*tan(c + d*x)**(m + 2)*hyper((1, m/2 + sympy.S(5)/4), (m/2 + sympy.S(9)/4,), -tan(c + d*x)**2)/(d*(2*m + 5)) + 2*C*sqrt(b*tan(c + d*x))*tan(c + d*x)**(m + 1)/(d*(2*m + 3)) + sqrt(b*tan(c + d*x))*(2*A - 2*C)*tan(c + d*x)**(m + 1)*hyper((1, m/2 + sympy.S(3)/4), (m/2 + sympy.S(7)/4,), -tan(c + d*x)**2)/(d*(2*m + 3)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*tan(c + d*x) + C*tan(c + d*x)**2)*tan(c + d*x)**m/sqrt(b*tan(c + d*x)),
        variable=x,
        num_steps=7,
        integral=2*B*tan(c + d*x)**(m + 2)*hyper((1, m/2 + sympy.S(3)/4), (m/2 + sympy.S(7)/4,), -tan(c + d*x)**2)/(d*sqrt(b*tan(c + d*x))*(2*m + 3)) + 2*C*tan(c + d*x)**(m + 1)/(d*sqrt(b*tan(c + d*x))*(2*m + 1)) + (2*A - 2*C)*tan(c + d*x)**(m + 1)*hyper((1, m/2 + sympy.S(1)/4), (m/2 + sympy.S(5)/4,), -tan(c + d*x)**2)/(d*sqrt(b*tan(c + d*x))*(2*m + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*tan(c + d*x) + C*tan(c + d*x)**2)*tan(c + d*x)**m/sqrt(a + b*tan(c + d*x)),
        variable=x,
        num_steps=13,
        integral=2*C*sqrt(a + b*tan(c + d*x))*tan(c + d*x)**m*hyper((sympy.S.Half, -m), (sympy.S(3)/2,), 1 + b*tan(c + d*x)/a)/(b*d*(-b*tan(c + d*x)/a)**m) - sqrt(a + b*tan(c + d*x))*(B*b - sqrt(-b**2)*(A - C))*tan(c + d*x)**m*appellf1(sympy.S.Half, 1, -m, sympy.S(3)/2, (a + b*tan(c + d*x))/(a + sqrt(-b**2)), 1 + b*tan(c + d*x)/a)/(b*d*(-b*tan(c + d*x)/a)**m*(a + sqrt(-b**2))) - sqrt(a + b*tan(c + d*x))*(B*b + sqrt(-b**2)*(A - C))*tan(c + d*x)**m*appellf1(sympy.S.Half, 1, -m, sympy.S(3)/2, (a + b*tan(c + d*x))/(a - sqrt(-b**2)), 1 + b*tan(c + d*x)/a)/(b*d*(-b*tan(c + d*x)/a)**m*(a - sqrt(-b**2))),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))**3*(c + d*tan(e + f*x))*(A + B*tan(e + f*x) + C*tan(e + f*x)**2),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))**2*(c + d*tan(e + f*x))*(A + B*tan(e + f*x) + C*tan(e + f*x)**2),
        variable=x,
        num_steps=5,
        integral=C*d*(a + b*tan(e + f*x))**3*tan(e + f*x)/(4*b*f) + b*(A*a*d + A*b*c + B*a*c - B*b*d - C*a*d - C*b*c)*tan(e + f*x)/f + x*(a**2*(A*c - B*d - C*c) - 2*a*b*(B*c + d*(A - C)) - b**2*(A*c - B*d - C*c)) + (a + b*tan(e + f*x))**2*(B*c + d*(A - C))/(2*f) - (a**2*(B*c + d*(A - C)) + 2*a*b*(A*c - B*d - C*c) - b**2*(B*c + d*(A - C)))*log(cos(e + f*x))/f - (a + b*tan(e + f*x))**3*(C*a*d - 4*b*(B*d + C*c))/(12*b**2*f),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))*(c + d*tan(e + f*x))*(A + B*tan(e + f*x) + C*tan(e + f*x)**2),
        variable=x,
        num_steps=4,
        integral=C*b*(c + d*tan(e + f*x))**2*tan(e + f*x)/(3*d*f) + d*(A*b + B*a - C*b)*tan(e + f*x)/f + x*(a*(A*c - B*d - C*c) - b*(B*c + d*(A - C))) - (A*a*d + A*b*c + B*a*c - B*b*d - C*a*d - C*b*c)*log(cos(e + f*x))/f - (c + d*tan(e + f*x))**2*(-3*B*b*d - 3*C*a*d + C*b*c)/(6*d**2*f),
    ),
    RubiTestSuiteCase(
        integrand=(c + d*tan(e + f*x))*(A + B*tan(e + f*x) + C*tan(e + f*x)**2),
        variable=x,
        num_steps=3,
        integral=B*d*tan(e + f*x)/f + C*(c + d*tan(e + f*x))**2/(2*d*f) + x*(A*c - B*d - C*c) - (B*c + d*(A - C))*log(cos(e + f*x))/f,
    ),
    RubiTestSuiteCase(
        integrand=(c + d*tan(e + f*x))*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(a + b*tan(e + f*x)),
        variable=x,
        num_steps=5,
        integral=C*d*tan(e + f*x)/(b*f) + x*(a*(A*c - B*d - C*c) + b*(B*c + d*(A - C)))/(a**2 + b**2) + (-A*a*d + A*b*c - B*a*c - B*b*d + C*a*d - C*b*c)*log(cos(e + f*x))/(f*(a**2 + b**2)) + (A*b**2 - a*(B*b - C*a))*(-a*d + b*c)*log(a + b*tan(e + f*x))/(b**2*f*(a**2 + b**2)),
    ),
    RubiTestSuiteCase(
        integrand=(c + d*tan(e + f*x))*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(a + b*tan(e + f*x))**2,
        variable=x,
        num_steps=5,
        integral=x*(a**2*(A*c - B*d - C*c) + 2*a*b*(B*c + d*(A - C)) - b**2*(A*c - B*d - C*c))/(a**2 + b**2)**2 + (-a**2*(B*c + d*(A - C)) + 2*a*b*(A*c - B*d - C*c) + b**2*(B*c + d*(A - C)))*log(cos(e + f*x))/(f*(a**2 + b**2)**2) + (C*a**4*d - a**2*b**2*(B*c + d*(A - 3*C)) + 2*a*b**3*(A*c - B*d - C*c) + b**4*(A*d + B*c))*log(a + b*tan(e + f*x))/(b**2*f*(a**2 + b**2)**2) - (A*b**2 - a*(B*b - C*a))*(-a*d + b*c)/(b**2*f*(a + b*tan(e + f*x))*(a**2 + b**2)),
    ),
    RubiTestSuiteCase(
        integrand=(c + d*tan(e + f*x))*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(a + b*tan(e + f*x))**3,
        variable=x,
        num_steps=4,
    ...
    RubiTestSuiteCase(
        integrand=(c + d*tan(e + f*x))**2*(A + B*tan(e + f*x) + C*tan(e + f*x)**2),
        variable=x,
        num_steps=4,
        integral=B*(c + d*tan(e + f*x))**2/(2*f) + C*(c + d*tan(e + f*x))**3/(3*d*f) + d*(B*c + d*(A - C))*tan(e + f*x)/f - x*(-A*(c**2 - d**2) + 2*B*c*d + C*c**2 - C*d**2) - (B*(c**2 - d**2) + 2*c*d*(A - C))*log(cos(e + f*x))/f,
    ),
    RubiTestSuiteCase(
        integrand=(c + d*tan(e + f*x))**2*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(a + b*tan(e + f*x)),
        variable=x,
        num_steps=6,
        integral=C*(c + d*tan(e + f*x))**2/(2*b*f) - x*(a*(-A*(c**2 - d**2) + 2*B*c*d + C*c**2 - C*d**2) - b*(B*(c**2 - d**2) + 2*c*d*(A - C)))/(a**2 + b**2) - (A*(2*a*c*d - b*(c**2 - d**2)) + a*(B*c**2 - B*d**2 - 2*C*c*d) + b*(2*B*c*d + C*c**2 - C*d**2))*log(cos(e + f*x))/(f*(a**2 + b**2)) + d*(B*b*d - C*a*d + C*b*c)*tan(e + f*x)/(b**2*f) + (A*b**2 - a*(B*b - C*a))*(-a*d + b*c)**2*log(a + b*tan(e + f*x))/(b**3*f*(a**2 + b**2)),
    ),
    RubiTestSuiteCase(
        integrand=(c + d*tan(e + f*x))**2*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(a + b*tan(e + f*x))**2,
        variable=x,
        num_steps=6,
        integral=-x*(a**2*(-A*(c**2 - d**2) + 2*B*c*d + C*c**2 - C*d**2) - 2*a*b*(B*(c**2 - d**2) + 2*c*d*(A - C)) - b**2*(-A*(c**2 - d**2) + 2*B*c*d + C*c**2 - C*d**2))/(a**2 + b**2)**2 - (a**2*(B*(c**2 - d**2) + 2*c*d*(A - C)) + 2*a*b*(-A*(c**2 - d**2) + 2*B*c*d + C*c**2 - C*d**2) - b**2*(B*(c**2 - d**2) + 2*c*d*(A - C)))*log(cos(e + f*x))/(f*(a**2 + b**2)**2) - (c + d*tan(e + f*x))**2*(A*b**2 - a*(B*b - C*a))/(b*f*(a + b*tan(e + f*x))*(a**2 + b**2)) + d**2*(A*b**2 - B*a*b + 2*C*a**2 + C*b**2)*tan(e + f*x)/(b**2*f*(a**2 + b**2)) - (-a*d + b*c)*(B*a**3*b*d - 2*C*a**4*d + a**2*b**2*(B*c - 4*C*d) - a*b**3*(2*A*c - 3*B*d - 2*C*c) - b**4*(2*A*d + B*c))*log(a + b*tan(e + f*x))/(b**3*f*(a**2 + b**2)**2),
    ),
    RubiTestSuiteCase(
        integrand=(c + d*tan(e + f*x))**2*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(a + b*tan(e + f*x))**3,
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))**2*(c + d*tan(e + f*x))**3*(A + B*tan(e + f*x) + C*tan(e + f*x)**2),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))*(c + d*tan(e + f*x))**3*(A + B*tan(e + f*x) + C*tan(e + f*x)**2),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(c + d*tan(e + f*x))**3*(A + B*tan(e + f*x) + C*tan(e + f*x)**2),
        variable=x,
        num_steps=5,
        integral=B*(c + d*tan(e + f*x))**3/(3*f) + C*(c + d*tan(e + f*x))**4/(4*d*f) + d*(B*(c**2 - d**2) + 2*c*d*(A - C))*tan(e + f*x)/f - x*(-A*(c**3 - 3*c*d**2) + 3*B*c**2*d - B*d**3 + C*c**3 - 3*C*c*d**2) + (c + d*tan(e + f*x))**2*(B*c + d*(A - C))/(2*f) - (B*(c**3 - 3*c*d**2) + d*(A - C)*(3*c**2 - d**2))*log(cos(e + f*x))/f,
    ),
    RubiTestSuiteCase(
        integrand=(c + d*tan(e + f*x))**3*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(a + b*tan(e + f*x)),
        variable=x,
        num_steps=7,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))**3*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(c + d*tan(e + f*x)),
        variable=x,
        num_steps=7,
        integral=C*(a + b*tan(e + f*x))**3/(3*d*f) + b*(b*d**2*(A*b + B*a - C*b) + (-a*d + b*c)*(-B*b*d - C*a*d + C*b*c))*tan(e + f*x)/(d**3*f) + x*(a**3*(A*c + B*d - C*c) - 3*a**2*b*(B*c - d*(A - C)) - 3*a*b**2*(A*c + B*d - C*c) + b**3*(B*c - d*(A - C)))/(c**2 + d**2) - (a**3*(B*c - d*(A - C)) + 3*a**2*b*(A*c + B*d - C*c) - 3*a*b**2*(B*c - d*(A - C)) - b**3*(A*c + B*d - C*c))*log(cos(e + f*x))/(f*(c**2 + d**2)) - (a + b*tan(e + f*x))**2*(-B*b*d - C*a*d + C*b*c)/(2*d**2*f) - (-a*d + b*c)**3*(A*d**2 - B*c*d + C*c**2)*log(c + d*tan(e + f*x))/(d**4*f*(c**2 + d**2)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))**2*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(c + d*tan(e + f*x)),
        variable=x,
        num_steps=6,
        integral=C*(a + b*tan(e + f*x))**2/(2*d*f) - b*(-B*b*d - C*a*d + C*b*c)*tan(e + f*x)/(d**2*f) + x*(a**2*(A*c + B*d - C*c) - 2*a*b*(B*c - d*(A - C)) - b**2*(A*c + B*d - C*c))/(c**2 + d**2) - (a**2*(B*c - d*(A - C)) + 2*a*b*(A*c + B*d - C*c) - b**2*(B*c - d*(A - C)))*log(cos(e + f*x))/(f*(c**2 + d**2)) + (-a*d + b*c)**2*(A*d**2 - B*c*d + C*c**2)*log(c + d*tan(e + f*x))/(d**3*f*(c**2 + d**2)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(c + d*tan(e + f*x)),
        variable=x,
        num_steps=5,
        integral=C*b*tan(e + f*x)/(d*f) + x*(a*(A*c + B*d - C*c) - b*(B*c - d*(A - C)))/(c**2 + d**2) - (-A*a*d + A*b*c + B*a*c + B*b*d + C*a*d - C*b*c)*log(cos(e + f*x))/(f*(c**2 + d**2)) - (-a*d + b*c)*(A*d**2 - B*c*d + C*c**2)*log(c + d*tan(e + f*x))/(d**2*f*(c**2 + d**2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(c + d*tan(e + f*x)),
        variable=x,
        num_steps=4,
        integral=x*(A*c + B*d - C*c)/(c**2 + d**2) - (B*c - d*(A - C))*log(cos(e + f*x))/(f*(c**2 + d**2)) + (A*d**2 - B*c*d + C*c**2)*log(c + d*tan(e + f*x))/(d*f*(c**2 + d**2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/((a + b*tan(e + f*x))*(c + d*tan(e + f*x))),
        variable=x,
        num_steps=3,
        integral=x*(a*(A*c + B*d - C*c) + b*(B*c - d*(A - C)))/((a**2 + b**2)*(c**2 + d**2)) - (A*d**2 - B*c*d + C*c**2)*log(c*cos(e + f*x) + d*sin(e + f*x))/(f*(c**2 + d**2)*(-a*d + b*c)) + (A*b**2 - a*(B*b - C*a))*log(a*cos(e + f*x) + b*sin(e + f*x))/(f*(a**2 + b**2)*(-a*d + b*c)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/((a + b*tan(e + f*x))**2*(c + d*tan(e + f*x))),
        variable=x,
        num_steps=4,
        integral=d*(A*d**2 - B*c*d + C*c**2)*log(c*cos(e + f*x) + d*sin(e + f*x))/(f*(c**2 + d**2)*(-a*d + b*c)**2) + x*(a**2*(A*c + B*d - C*c) + 2*a*b*(B*c - d*(A - C)) - b**2*(A*c + B*d - C*c))/((a**2 + b**2)**2*(c**2 + d**2)) + (2*B*a**3*b*d - C*a**4*d - a**2*b**2*(3*A*d + B*c - C*d) + 2*a*b**3*c*(A - C) + b**4*(-A*d + B*c))*log(a*cos(e + f*x) + b*sin(e + f*x))/(f*(a**2 + b**2)**2*(-a*d + b*c)**2) - (A*b**2 - a*(B*b - C*a))/(f*(a + b*tan(e + f*x))*(a**2 + b**2)*(-a*d + b*c)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/((a + b*tan(e + f*x))**3*(c + d*tan(e + f*x))),
        variable=x,
        num_steps=5,
        integral=-d**2*(A*d**2 - B*c*d + C*c**2)*log(c*cos(e + f*x) + d*sin(e + f*x))/(f*(c**2 + d**2)*(-a*d + b*c)**3) + x*(a**3*(A*c + B*d - C*c) + 3*a**2*b*(B*c - d*(A - C)) - 3*a*b**2*(A*c + B*d - C*c) - b**3*(B*c - d*(A - C)))/((a**2 + b**2)**3*(c**2 + d**2)) + (-3*B*a**5*b*d**2 + 3*B*a*b**5*c**2 + C*a**6*d**2 + 3*a**4*b**2*d*(2*A*d + B*c - C*d) - a**3*b**3*(B*(c**2 - d**2) + 8*c*d*(A - C)) - 3*a**2*b**4*(-A*(c**2 + d**2) + c*(2*B*d + C*c)) + b**6*(-A*(c**2 - d**2) + c*(-B*d + C*c)))*log(a*cos(e + f*x) + b*sin(e + f*x))/(f*(a**2 + b**2)**3*(-a*d + b*c)**3) - (2*B*a**3*b*d - C*a**4*d - a**2*b**2*(3*A*d + B*c - C*d) + 2*a*b**3*c*(A - C) + b**4*(-A*d + B*c))/(f*(a + b*tan(e + f*x))*(a**2 + b**2)**2*(-a*d + b*c)**2) - (A*b**2 - a*(B*b - C*a))/(f*(a + b*tan(e + f*x))**2*(2*a**2 + 2*b**2)*(-a*d + b*c)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))**3*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(c + d*tan(e + f*x))**2,
        variable=x,
        num_steps=7,
        integral=b**2*(a*d*(-B*c*d + 3*C*c**2 + d**2*(A + 2*C)) - b*(-2*B*c**2*d - B*d**3 + 3*C*c**3 + c*d**2*(A + 2*C)))*tan(e + f*x)/(d**3*f*(c**2 + d**2)) + b*(a + b*tan(e + f*x))**2*(-2*B*c*d + 3*C*c**2 + d**2*(2*A + C))/(2*d**2*f*(c**2 + d**2)) - x*(a**3*(-A*(c**2 - d**2) - 2*B*c*d + C*c**2 - C*d**2) - 3*a**2*b*(-B*(c**2 - d**2) + 2*c*d*(A - C)) - 3*a*b**2*(-A*(c**2 - d**2) - 2*B*c*d + C*c**2 - C*d**2) + b**3*(-B*(c**2 - d**2) + 2*c*d*(A - C)))/(c**2 + d**2)**2 + (a**3*(-B*(c**2 - d**2) + 2*c*d*(A - C)) + 3*a**2*b*(-A*(c**2 - d**2) - 2*B*c*d + C*c**2 - C*d**2) - 3*a*b**2*(-B*(c**2 - d**2) + 2*c*d*(A - C)) - b**3*(-A*(c**2 - d**2) - 2*B*c*d + C*c**2 - C*d**2))*log(cos(e + f*x))/(f*(c**2 + d**2)**2) - (a + b*tan(e + f*x))**3*(A*d**2 - B*c*d + C*c**2)/(d*f*(c + d*tan(e + f*x))*(c**2 + d**2)) + (-a*d + b*c)**2*(a*d**2*(-B*(c**2 - d**2) + 2*c*d*(A - C)) + b*(3*A*d**4 - 2*B*c**3*d - 4*B*c*d**3 + 3*C*c**4 + c**2*d**2*(A + 5*C)))*log(c + d*tan(e + f*x))/(d**4*f*(c**2 + d**2)**2),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))**2*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(c + d*tan(e + f*x))**2,
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(c + d*tan(e + f*x))**3,
        variable=x,
        num_steps=4,
        integral=-x*(a*(-A*(c**3 - 3*c*d**2) - 3*B*c**2*d + B*d**3 + C*c**3 - 3*C*c*d**2) - b*(-B*(c**3 - 3*c*d**2) + d*(A - C)*(3*c**2 - d**2)))/(c**2 + d**2)**3 + (A*(a*d*(3*c**2 - d**2) - b*(c**3 - 3*c*d**2)) - a*(B*c**3 - 3*B*c*d**2 + 3*C*c**2*d - C*d**3) + b*(-3*B*c**2*d + B*d**3 + C*c**3 - 3*C*c*d**2))*log(c*cos(e + f*x) + d*sin(e + f*x))/(f*(c**2 + d**2)**3) - (a*d**2*(-B*(c**2 - d**2) + 2*c*d*(A - C)) + b*(A*d**4 - 2*B*c*d**3 + C*c**4 - c**2*d**2*(A - 3*C)))/(d**2*f*(c + d*tan(e + f*x))*(c**2 + d**2)**2) + (-a*d + b*c)*(A*d**2 - B*c*d + C*c**2)/(2*d**2*f*(c + d*tan(e + f*x))**2*(c**2 + d**2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(c + d*tan(e + f*x))**3,
        variable=x,
        num_steps=4,
        integral=-x*(-A*(c**3 - 3*c*d**2) - 3*B*c**2*d + B*d**3 + C*c**3 - 3*C*c*d**2)/(c**2 + d**2)**3 + (-B*(c**3 - 3*c*d**2) + d*(A - C)*(3*c**2 - d**2))*log(c*cos(e + f*x) + d*sin(e + f*x))/(f*(c**2 + d**2)**3) - (-B*(c**2 - d**2) + 2*c*d*(A - C))/(f*(c + d*tan(e + f*x))*(c**2 + d**2)**2) - (A*d**2 - B*c*d + C*c**2)/(2*d*f*(c + d*tan(e + f*x))**2*(c**2 + d**2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/((a + b*tan(e + f*x))*(c + d*tan(e + f*x))**3),
        variable=x,
        num_steps=5,
        integral=b**2*(A*b**2 - a*(B*b - C*a))*log(a*cos(e + f*x) + b*sin(e + f*x))/(f*(a**2 + b**2)*(-a*d + b*c)**3) - x*(a*(-A*(c**3 - 3*c*d**2) - 3*B*c**2*d + B*d**3 + C*c**3 - 3*C*c*d**2) + b*(-B*(c**3 - 3*c*d**2) + d*(A - C)*(3*c**2 - d**2)))/((a**2 + b**2)*(c**2 + d**2)**3) - (a**2*d**3*(-B*(c**3 - 3*c*d**2) + d*(A - C)*(3*c**2 - d**2)) - a*b*d**2*(-B*(3*c**4 - 6*c**2*d**2 - d**4) + 8*c**3*d*(A - C)) + b**2*(3*A*c**2*d**4 + A*d**6 - 3*B*c**5*d + B*c**3*d**3 + C*c**6 + 3*c**4*d**2*(2*A - C)))*log(c*cos(e + f*x) + d*sin(e + f*x))/(f*(c**2 + d**2)**3*(-a*d + b*c)**3) + (-a*d**2*(-B*(c**2 - d**2) + 2*c*d*(A - C)) + b*(A*d**4 - 2*B*c**3*d + C*c**4 + c**2*d**2*(3*A - C)))/(f*(c + d*tan(e + f*x))*(c**2 + d**2)**2*(-a*d + b*c)**2) + (A*d**2 - B*c*d + C*c**2)/(f*(c + d*tan(e + f*x))**2*(c**2 + d**2)*(-2*a*d + 2*b*c)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/((a + b*tan(e + f*x))**2*(c + d*tan(e + f*x))**3),
        variable=x,
        num_steps=6,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))**2*(c + d*tan(e + f*x))**(sympy.S(3)/2)*(A + B*tan(e + f*x) + C*tan(e + f*x)**2),
        variable=x,
        num_steps=12,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))*(c + d*tan(e + f*x))**(sympy.S(3)/2)*(A + B*tan(e + f*x) + C*tan(e + f*x)**2),
        variable=x,
        num_steps=11,
    ...
    RubiTestSuiteCase(
        integrand=(c + d*tan(e + f*x))**(sympy.S(3)/2)*(A + B*tan(e + f*x) + C*tan(e + f*x)**2),
        variable=x,
        num_steps=10,
        integral=2*B*(c + d*tan(e + f*x))**(sympy.S(3)/2)/(3*f) + 2*C*(c + d*tan(e + f*x))**(sympy.S(5)/2)/(5*d*f) - (B - I*(A - C))*(c + I*d)**(sympy.S(3)/2)*atanh(sqrt(c + d*tan(e + f*x))/sqrt(c + I*d))/f - (c - I*d)**(sympy.S(3)/2)*(I*A + B - I*C)*atanh(sqrt(c + d*tan(e + f*x))/sqrt(c - I*d))/f + sqrt(c + d*tan(e + f*x))*(2*B*c + 2*d*(A - C))/f,
    ),
    RubiTestSuiteCase(
        integrand=(c + d*tan(e + f*x))**(sympy.S(3)/2)*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(a + b*tan(e + f*x)),
        variable=x,
        num_steps=13,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))*(c + d*tan(e + f*x))**(sympy.S(5)/2)*(A + B*tan(e + f*x) + C*tan(e + f*x)**2),
        variable=x,
        num_steps=12,
    ...
    RubiTestSuiteCase(
        integrand=(c + d*tan(e + f*x))**(sympy.S(5)/2)*(A + B*tan(e + f*x) + C*tan(e + f*x)**2),
        variable=x,
        num_steps=11,
        integral=2*B*(c + d*tan(e + f*x))**(sympy.S(5)/2)/(5*f) + 2*C*(c + d*tan(e + f*x))**(sympy.S(7)/2)/(7*d*f) - (B - I*(A - C))*(c + I*d)**(sympy.S(5)/2)*atanh(sqrt(c + d*tan(e + f*x))/sqrt(c + I*d))/f - (c - I*d)**(sympy.S(5)/2)*(I*A + B - I*C)*atanh(sqrt(c + d*tan(e + f*x))/sqrt(c - I*d))/f + (c + d*tan(e + f*x))**(sympy.S(3)/2)*(2*B*c + 2*d*(A - C))/(3*f) + sqrt(c + d*tan(e + f*x))*(2*B*(c**2 - d**2) + 4*c*d*(A - C))/f,
    ),
    RubiTestSuiteCase(
        integrand=(c + d*tan(e + f*x))**(sympy.S(5)/2)*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(a + b*tan(e + f*x)),
        variable=x,
        num_steps=14,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))**2*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(c + d*tan(e + f*x))**(sympy.S(3)/2),
        variable=x,
        num_steps=10,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(c + d*tan(e + f*x))**(sympy.S(3)/2),
        variable=x,
        num_steps=9,
        integral=2*C*b*sqrt(c + d*tan(e + f*x))/(d**2*f) + (I*a - b)*(A + I*B - C)*atanh(sqrt(c + d*tan(e + f*x))/sqrt(c + I*d))/(f*(c + I*d)**(sympy.S(3)/2)) - (I*a + b)*(A - I*B - C)*atanh(sqrt(c + d*tan(e + f*x))/sqrt(c - I*d))/(f*(c - I*d)**(sympy.S(3)/2)) + (-2*a*d + 2*b*c)*(A*d**2 - B*c*d + C*c**2)/(d**2*f*sqrt(c + d*tan(e + f*x))*(c**2 + d**2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(c + d*tan(e + f*x))**(sympy.S(3)/2),
        variable=x,
        num_steps=8,
        integral=-(B - I*(A - C))*atanh(sqrt(c + d*tan(e + f*x))/sqrt(c + I*d))/(f*(c + I*d)**(sympy.S(3)/2)) - (I*A + B - I*C)*atanh(sqrt(c + d*tan(e + f*x))/sqrt(c - I*d))/(f*(c - I*d)**(sympy.S(3)/2)) - (2*A*d**2 - 2*B*c*d + 2*C*c**2)/(d*f*sqrt(c + d*tan(e + f*x))*(c**2 + d**2)),
    ),
    RubiTestSuiteCase(
        integrand=(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/((a + b*tan(e + f*x))*(c + d*tan(e + f*x))**(sympy.S(3)/2)),
        variable=x,
        num_steps=12,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))**2*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(c + d*tan(e + f*x))**(sympy.S(5)/2),
        variable=x,
        num_steps=10,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))**(sympy.S(3)/2)*(c + d*tan(e + f*x))**(sympy.S(3)/2)*(A + B*tan(e + f*x) + C*tan(e + f*x)**2),
        variable=x,
        num_steps=16,
    ...
    RubiTestSuiteCase(
        integrand=sqrt(a + b*tan(e + f*x))*(c + d*tan(e + f*x))**(sympy.S(3)/2)*(A + B*tan(e + f*x) + C*tan(e + f*x)**2),
        variable=x,
        num_steps=15,
    ...
    RubiTestSuiteCase(
        integrand=(c + d*tan(e + f*x))**(sympy.S(3)/2)*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/sqrt(a + b*tan(e + f*x)),
        variable=x,
        num_steps=14,
    ...
    RubiTestSuiteCase(
        integrand=(c + d*tan(e + f*x))**(sympy.S(3)/2)*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(a + b*tan(e + f*x))**(sympy.S(7)/2),
        variable=x,
        num_steps=10,
    ...
    RubiTestSuiteCase(
        integrand=sqrt(a + b*tan(e + f*x))*(c + d*tan(e + f*x))**(sympy.S(5)/2)*(A + B*tan(e + f*x) + C*tan(e + f*x)**2),
        variable=x,
        num_steps=16,
    ...
    RubiTestSuiteCase(
        integrand=(c + d*tan(e + f*x))**(sympy.S(5)/2)*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/sqrt(a + b*tan(e + f*x)),
        variable=x,
        num_steps=15,
    ...
    RubiTestSuiteCase(
        integrand=(c + d*tan(e + f*x))**(sympy.S(5)/2)*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(a + b*tan(e + f*x))**(sympy.S(7)/2),
        variable=x,
        num_steps=15,
    ...
    RubiTestSuiteCase(
        integrand=(c + d*tan(e + f*x))**(sympy.S(5)/2)*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(a + b*tan(e + f*x))**(sympy.S(9)/2),
        variable=x,
        num_steps=11,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))**m*(c + d*tan(e + f*x))**2*(A + B*tan(e + f*x) + C*tan(e + f*x)**2),
        variable=x,
        num_steps=8,
    ...
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))**m*(c + d*tan(e + f*x))*(A + B*tan(e + f*x) + C*tan(e + f*x)**2),
        variable=x,
        num_steps=7,
        integral=C*d*(a + b*tan(e + f*x))**(m + 1)*tan(e + f*x)/(b*f*(m + 2)) + (a + b*tan(e + f*x))**(m + 1)*(c - I*d)*(A - I*B - C)*hyper((1, m + 1), (m + 2,), (a + b*tan(e + f*x))/(a - I*b))/(f*(m + 1)*(2*I*a + 2*b)) - (a + b*tan(e + f*x))**(m + 1)*(c + I*d)*(A + I*B - C)*hyper((1, m + 1), (m + 2,), (a + b*tan(e + f*x))/(a + I*b))/(f*(m + 1)*(2*I*a - 2*b)) - (a + b*tan(e + f*x))**(m + 1)*(C*a*d - b*(m + 2)*(B*d + C*c))/(b**2*f*(m + 1)*(m + 2)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))**m*(A + B*tan(e + f*x) + C*tan(e + f*x)**2),
        variable=x,
        num_steps=6,
        integral=C*(a + b*tan(e + f*x))**(m + 1)/(b*f*(m + 1)) + (a + b*tan(e + f*x))**(m + 1)*(A - I*B - C)*hyper((1, m + 1), (m + 2,), (a + b*tan(e + f*x))/(a - I*b))/(f*(m + 1)*(2*I*a + 2*b)) + (a + b*tan(e + f*x))**(m + 1)*(I*A - B - I*C)*hyper((1, m + 1), (m + 2,), (a + b*tan(e + f*x))/(a + I*b))/(f*(2*a + 2*I*b)*(m + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))**m*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(c + d*tan(e + f*x)),
        variable=x,
        num_steps=8,
        integral=(a + b*tan(e + f*x))**(m + 1)*(A*d**2 - B*c*d + C*c**2)*hyper((1, m + 1), (m + 2,), -d*(a + b*tan(e + f*x))/(-a*d + b*c))/(f*(c**2 + d**2)*(m + 1)*(-a*d + b*c)) - (a + b*tan(e + f*x))**(m + 1)*(A + I*B - C)*hyper((1, m + 1), (m + 2,), (a + b*tan(e + f*x))/(a + I*b))/(f*(c + I*d)*(m + 1)*(2*I*a - 2*b)) - (a + b*tan(e + f*x))**(m + 1)*(I*A + B - I*C)*hyper((1, m + 1), (m + 2,), (a + b*tan(e + f*x))/(a - I*b))/(f*(2*a - 2*I*b)*(c - I*d)*(m + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))**m*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(c + d*tan(e + f*x))**2,
        variable=x,
        num_steps=9,
        integral=-(a + b*tan(e + f*x))**(m + 1)*(a*d**2*(-B*(c**2 - d**2) + 2*c*d*(A - C)) - b*(A*d**2*(c**2*(2 - m) - d**2*m) - B*c*d*(c**2*(1 - m) - d**2*(m + 1)) - C*c**2*(c**2*m + d**2*(m + 2))))*hyper((1, m + 1), (m + 2,), -d*(a + b*tan(e + f*x))/(-a*d + b*c))/(f*(c**2 + d**2)**2*(m + 1)*(-a*d + b*c)**2) + (a + b*tan(e + f*x))**(m + 1)*(A*d**2 - B*c*d + C*c**2)/(f*(c + d*tan(e + f*x))*(c**2 + d**2)*(-a*d + b*c)) + (a + b*tan(e + f*x))**(m + 1)*(A - I*B - C)*hyper((1, m + 1), (m + 2,), (a + b*tan(e + f*x))/(a - I*b))/(f*(c - I*d)**2*(m + 1)*(2*I*a + 2*b)) + (a + b*tan(e + f*x))**(m + 1)*(I*A - B - I*C)*hyper((1, m + 1), (m + 2,), (a + b*tan(e + f*x))/(a + I*b))/(f*(2*a + 2*I*b)*(c + I*d)**2*(m + 1)),
    ),
    RubiTestSuiteCase(
        integrand=(a + b*tan(e + f*x))**m*(A + B*tan(e + f*x) + C*tan(e + f*x)**2)/(c + d*tan(e + f*x))**3,
        variable=x,
        num_steps=10,
        integral=(a + b*tan(e + f*x))**(m + 1)*(2*a**2*d**3*(-B*(c**3 - 3*c*d**2) + d*(A - C)*(3*c**2 - d**2)) - 2*a*b*d**2*(B*(-c**4*(2 - m) + 6*c**2*d**2 - d**4*m) + 2*c*d*(A - C)*(c**2*(3 - m) - d**2*(m + 1))) - b**2*(A*d**2*(-c**4*(m**2 - 5*m + 6) + 2*c**2*d**2*(-m**2 + 3*m + 1) + d**4*m*(1 - m)) + B*c*d*(c**4*(m**2 - 3*m + 2) - 2*c**2*d**2*(-m**2 + m + 3) + d**4*m*(m + 1)) + C*c**2*(c**4*m*(1 - m) + 2*c**2*d**2*(-m**2 - m + 3) - d**4*(m**2 + 3*m + 2))))*hyper((1, m + 1), (m + 2,), -d*(a + b*tan(e + f*x))/(-a*d + b*c))/(2*f*(c**2 + d**2)**3*(m + 1)*(-a*d + b*c)**3) - (a + b*tan(e + f*x))**(m + 1)*(2*a*d**2*(-B*(c**2 - d**2) + 2*c*d*(A - C)) - b*(A*d**4*(1 - m) - B*c**3*d*(3 - m) + B*c*d**3*(m + 1) + C*c**4*(1 - m) + c**2*d**2*(A*(5 - m) - C*(m + 3))))/(2*f*(c + d*tan(e + f*x))*(c**2 + d**2)**2*(-a*d + b*c)**2) + (a + b*tan(e + f*x))**(m + 1)*(A*d**2 - B*c*d + C*c**2)/(f*(c + d*tan(e + f*x))**2*(c**2 + d**2)*(-2*a*d + 2*b*c)) + (a + b*tan(e + f*x))**(m + 1)*(A - I*B - C)*hyper((1, m + 1), (m + 2,), (a + b*tan(e + f*x))/(a - I*b))/(f*(c - I*d)**3*(m + 1)*(2*I*a + 2*b)) + (a + b*tan(e + f*x))**(m + 1)*(A + I*B - C)*hyper((1, m + 1), (m + 2,), (a + b*tan(e + f*x))/(a + I*b))/(f*(2*a + 2*I*b)*(m + 1)*(I*c - d)**3),
    ),
]
